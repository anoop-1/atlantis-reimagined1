...
const RICH_CITY_CONTENT: Partial<Record<string, Partial<CorporateTrainingCityProfile>>> = {
  'houston': {
    ...
    priceRangeUSD: '$11,500 – $16,500 per 20-seat batch (method-dependent)',
  ...
  'dubai': {
    ...
    priceRangeUSD: '$12,000 – $17,500 per 15-seat batch',
  ...
  'abu-dhabi': {
    ...
    priceRangeUSD: '$12,500 – $18,000 per 20-seat batch',
  ...
  'mumbai': {
    ...
    priceRangeUSD: '$4,500 – $7,500 per 20-seat batch',
  ...
  'hyderabad': {
    ...
    priceRangeUSD: '$4,000 – $7,000 per 20-seat batch',
  ...
  'chennai': {
    ...
    priceRangeUSD: '$4,200 – $7,200 per 20-seat batch',
  ...
  'aberdeen': {
    ...
    priceRangeUSD: '$13,500 – $18,500 per 12-seat batch',
  ...
  'singapore': {
    ...
    priceRangeUSD: '$13,000 – $18,000 per 14-seat batch',
  ...
  'muscat': {
    ...
    priceRangeUSD: '$10,500 – $14,500 per 16-seat batch',
  ...
  'jubail': {
    ...
    priceRangeUSD: '$12,000 – $16,500 per 20-seat batch',
  ...
  'calgary': {
    ...
    priceRangeUSD: '$12,500 – $16,500 per 14-seat batch',
  ...
  'london': {
    ...
    priceRangeUSD: '$14,500 – $19,000 per 12-seat batch',
    localPriceNote: 'GBP invoice; VAT 20%',
  ...
  'rotterdam': {
    ...
    priceRangeUSD: '$13,000 – $17,500 per 15-seat batch',
  ...
  'perth': {
    ...
    priceRangeUSD: '$13,500 – $18,000 per 14-seat batch',
...
function composeProfile(slug: string): CorporateTrainingCityProfile | null {
  ...
  const compactFaqs: FaqItem[] = [
    ...
    },
    {
      ...
      answer: `${arch.priceNote}. A typical 20-seat UT-II or PAUT cohort runs in the $12,000-$16,500 USD band depending on method and onsite travel; quoted both in local currency and USD by default.`,
    },
    {
  ...
  return {
    ...
    priceRangeUSD: rich.priceRangeUSD || '$11,000 – $16,000 per 20-seat batch',
