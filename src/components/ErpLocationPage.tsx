...
const erpCityRichContent: Record<string, CityRichContent> = {
  ...
  "Baytown": {
    ...
    currencyExample: { currency: "USD", amount: "USD 18,000/year", note: "Standard USD pricing for US Gulf Coast inspection contractors" },
  ...
  "Long Beach": {
    ...
    currencyExample: { currency: "USD", amount: "USD 18,000/year", note: "Standard USD pricing for California (premium rates may apply due to Cal/OSHA cost-of-compliance)" },
