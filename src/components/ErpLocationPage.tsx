...
const erpLocationContext: Record<string, string> = {
  ...
  "Shanghai": "Shanghai is China's commercial capital and the operational base for the country's largest concentration of petrochemical, shipbuilding and aerospace inspection workload. Major industrial assets in the Shanghai orbit include the Sinopec Shanghai Petrochemical Company (SPC) Jinshan refinery and ethylene complex (16 million tpa refining capacity and a 1.2 million tpa ethylene cracker), the SECCO Shanghai Petrochemical (Sinopec-BP JV) ethylene project at Caojing, the BASF-YPC integrated petrochemical site at Pudong, the Hudong-Zhonghua Shipbuilding (CSSC) yard producing LNG carriers and naval vessels, Jiangnan Shipyard at Changxing Island, COMAC's C919 narrow-body airliner final-assembly line at Pudong, and Shanghai Electric heavy-power-equipment manufacturing. Regulatory oversight comes from the National Energy Administration (NEA), the State Administration for Market Regulation (SAMR) for special-equipment safety under TSG 21-2016, the National Nuclear Safety Administration (NNSA) for nuclear supply chain, the China Atomic Energy Authority for radiography, MEE for environment, and CCAA for accreditation. The Chinese Society for Non-Destructive Testing (ChSNDT) administers personnel certification under GB/T 9445 (the Chinese equivalent of ISO 9712). Atlantis NDT ERP supports Shanghai-based inspection firms with TSG 21-2016 special-equipment inspection records, GB/T 9445 certification tracking parallel to ASNT/ISO 9712 for export work, COMAC C919 supplier NAS 410 currency, NADCAP audit-pack export, and bilingual Mandarin/English documentation.",
  "Beijing": "Beijing is the corporate headquarters city for China's national oil and gas majors — CNPC (PetroChina), Sinopec Group, and CNOOC — alongside the Ministry of Commerce, NEA, SAMR, NNSA and the State-owned Assets Supervision and Administration Commission (SASAC) that governs every centrally-administered state-owned enterprise. Major industrial assets in the Beijing orbit include the Sinopec Yanshan refinery and petrochemical complex (10 million tpa refining capacity), the Beijing Yanshan Petrochemical research institute, the Shougang steel legacy operations (relocated to Tangshan/Caofeidian post-2010 Olympics but Beijing remains the corporate headquarters), the AVIC (Aviation Industry Corporation of China) Beijing engineering centres, the China Academy of Launch Vehicle Technology (CALT) for space-launch vehicles, and a dense engineering-services and EPC sector (China Petroleum Engineering, Sinopec Engineering Group, CNCEC). Regulatory oversight comes from the central NEA, SAMR (TSG 21-2016 special-equipment safety), NNSA for nuclear, the Ministry of Ecology and Environment (MEE), and CCAA (Certification and Accreditation Administration). ChSNDT under GB/T 9445 administers personnel certification. Atlantis NDT ERP supports Beijing-based inspection firms with TSG 21-2016 special-equipment records, multi-operator CNPC/Sinopec/CNOOC contractor-portal evidence-pack export, AVIC and CALT supplier NAS 410 aerospace-grade currency, NADCAP audit-pack export, and bilingual Mandarin/English documentation.",
  ...
  "Tamil Nadu": "Tamil Nadu is South India's industrial powerhouse, hosting CPCL (Chennai Petroleum Corporation Limited, IOCL subsidiary, 230,000 bpd refinery at Manali Chennai), Kudankulam Nuclear Power Plant (KKNPP, Units 1+2 operational and Units 3-6 under construction by NPCIL with Rosatom support), and the Indian automotive manufacturing capital — Hyundai Motor India Sriperumbudur, BMW India Chennai, Renault Nissan India Oragadam, Mitsubishi Motors Tamil Nadu, Ford India (now closed), Daimler India Commercial Vehicles Oragadam, Ashok Leyland Ennore, and TVS Motor Company Hosur. The Kamarajar Port, Chennai Port and Ennore Port handle major bulk and break-bulk cargo. The Sriperumbudur, Oragadam and Hosur electronics-and-automotive belts generate continuous inspection workload. The Tamil Nadu industrial belt extends to Coimbatore (textiles, foundry, pump manufacturing), Hosur (auto components, electronics — Foxconn, Tata Electronics, Pegatron), Trichy (BHEL heavy engineering, Trichy refinery), and Tirunelveli. Regulatory oversight follows PESO, IBR, OISD, AERB (particularly active for Kudankulam supply chain), BIS, the Tamil Nadu Pollution Control Board (TNPCB), and the Tamil Nadu Factories Act administered by DISH. Atlantis NDT ERP supports Tamil Nadu-based inspection firms with CPCL / NPCIL contractor-portal evidence-pack export, AERB BARC-aligned 10 CFR 50-equivalent qualification tracking for Kudankulam supply work, NAS 410 / NADCAP for Chennai automotive-OEM supplier work, ISNT/ASNT/AWS dual-track certification, and bilingual English/Tamil state documentation alongside English client reports.",
  ...
  "Tokyo": "Tokyo is the corporate and operational base for Japan's largest industrial conglomerates and a major centre for inspection-services support across the broader Tokyo Metropolitan industrial belt. Major industrial assets within reach of Tokyo-based inspection contractors include the ENEOS (formerly JXTG Holdings) Negishi Refinery and the broader Kawasaki-Yokohama refining and petrochemical cluster (ENEOS Kawasaki, ENEOS Yokohama, Showa Yokkaichi Sekiyu), the Tokyo Electric Power Company (TEPCO) Kashiwazaki-Kariwa and Fukushima Daiichi / Daini nuclear assets (Daiichi in decommissioning, Daini in long-term shutdown), the Toyota / Honda / Nissan Tier-1 fabrication and machining suppliers across the Kanto industrial belt, the Mitsubishi Heavy Industries Yokohama / Sagamihara shipbuilding and heavy-machinery works, IHI Aerospace Tomioka and Yokohama works, Kawasaki Heavy Industries Akashi and Kobe works (in Kansai but Tokyo-headquartered), and the Tokyo Bay container and bulk terminals (Yokohama, Tokyo, Chiba, Kawasaki ports). Inspection contractors operate under METI (Ministry of Economy, Trade and Industry) for energy and industrial regulation, NRA (Nuclear Regulation Authority) for nuclear, MHLW (Ministry of Health, Labour and Welfare) for occupational safety, MLIT for marine and infrastructure, JIS Z 2305 / JSNDI personnel certification, and JAB (Japan Accreditation Board) ISO 17020/17025 accreditation. Atlantis NDT ERP supports Tokyo-based inspection firms with ENEOS / TEPCO contractor-portal evidence export, JIS Z 2305 / EN ISO 9712 dual-track certification, nuclear-plant qualification under JEAC 4111 equivalent, automotive Tier-1 NDT workflow, and bilingual English/Japanese documentation.",
  "Seoul": "Seoul is the corporate headquarters city for South Korea's largest industrial conglomerates and a major centre for engineering-services and inspection-services support across the wider Korean industrial network. Major industrial assets within reach of Seoul-based inspection contractors include the SK Innovation Ulsan refinery (840,000 bpd, the largest single-site refinery in South Korea), GS Caltex Yeosu refinery (785,000 bpd), S-Oil Onsan refinery (669,000 bpd), Hyundai Oilbank Daesan refinery (650,000 bpd), the Hyundai Heavy Industries (HHI) Ulsan shipyard (the world's largest shipbuilder), Samsung Heavy Industries (SHI) Geoje shipyard, Daewoo Shipbuilding and Marine Engineering (DSME / now Hanwha Ocean) Geoje shipyard, the Korea Hydro and Nuclear Power (KHNP) reactor fleet (Kori, Wolsong, Hanbit, Hanul nuclear stations), the Korea Aerospace Industries (KAI) Sacheon aerospace works, and POSCO Pohang and Gwangyang integrated steel plants. Inspection contractors operate under KEPIC (Korea Electric Power Industry Code, Korean equivalent of ASME for nuclear), KEPCO E&C engineering standards, KOSHA (Korea Occupational Safety and Health Agency) occupational safety, NSSC (Nuclear Safety and Security Commission) for nuclear, and KOLAS (Korea Laboratory Accreditation Scheme) ISO 17020/17025 accreditation. Atlantis NDT ERP supports Seoul-based inspection firms with SK / GS / S-Oil / Hyundai Oilbank refinery contractor-portal evidence export, HHI / SHI / Hanwha Ocean shipyard NDE traveler integration, KEPIC nuclear qualification, KAI aerospace NAS 410 / EN 4179 currency, and bilingual English/Korean documentation.",
  "Busan": "Busan — South Korea's second-largest city and the country's largest port — is the operational base for substantial marine-and-port inspection workload alongside an inland industrial corridor stretching to Ulsan. Major industrial assets within reach of Busan-based inspection contractors include the Port of Busan container terminals (the world's seventh-busiest container port, handling Hyundai Merchant Marine, Sinokor, Maersk, MSC, CMA CGM, ONE and Evergreen traffic), Hyundai Mipo Dockyard (in Ulsan, just north — specialty in product / chemical tanker construction), Hyundai Heavy Industries Ulsan operations (with HHI being the world's largest shipbuilder), KEPCO Goseong Hadong coal-fired power plant, Doosan Heavy Industries Changwon works (in nearby Changwon — heavy-machinery, nuclear-component manufacturing, gas turbines), STX Offshore and Shipbuilding (in financial restructuring but still operating limited capacity), and the Busan Newport (PNIT, BICT, PNC, HJNC, BNCT, HPNT terminals). Inspection contractors operate under KEPIC for nuclear-component manufacturing at Doosan, KOSHA occupational safety, KMI (Korea Maritime Institute) regulatory framework for marine, KR (Korean Register, the IACS member classification society) survey integration, and KOLAS accreditation. Atlantis NDT ERP supports Busan-based inspection firms with port-terminal structural inspection workflows, Hyundai Mipo / HHI shipyard NDE traveler integration, KR classification-society survey-pack export, Doosan Heavy nuclear-component qualification, and bilingual English/Korean documentation.",
  "Ulsan": "Ulsan — South Korea's industrial capital — hosts the densest concentration of heavy industry in the country and is the operational base for substantial inspection-services workload. Major industrial assets in Ulsan include the SK Innovation Ulsan refinery (840,000 bpd, South Korea's largest), S-Oil Onsan refinery (669,000 bpd), Hyundai Heavy Industries Ulsan shipyard (the world's largest shipbuilder with multiple drydocks and continuous newbuild work for Korean Register / DNV / LR / ABS classification), Hyundai Motor Ulsan Plant (the world's largest automobile manufacturing complex by single-site capacity at 1.5 million vehicles/year), Hyundai Mipo Dockyard (specialty chemical / product tankers, container feeders), the Hyundai Chemical Daesan-Onsan integrated petrochemical complex, and the Ulsan Petrochemical Industrial Complex (UPIC) covering BASF, LG Chem, Lotte Chemical, SK Geo Centric, Hanwha Solutions petrochemical operations. Inspection contractors operate under KEPIC nuclear and pressure-equipment standards, KOSHA Industrial Safety and Health Act, NSSC for nuclear, Korean Register and other IACS societies for marine, and KOLAS ISO 17020/17025 accreditation. Atlantis NDT ERP supports Ulsan-based inspection firms with SK / S-Oil / Hyundai Chemical refinery and petrochemical contractor-portal evidence export, HHI shipyard NDE traveler integration with parallel KR / DNV / LR / ABS classification-society survey-pack export, Hyundai Motor automotive Tier-1 NDT workflow, and bilingual English/Korean documentation.",
  "Geoje": "Geoje — an island off South Korea's south-east coast — is the operational base for two of the world's largest shipyards and the principal centre for South Korean offshore-platform and FPSO construction. Major industrial assets on Geoje include Samsung Heavy Industries (SHI) Geoje shipyard (one of the world's three largest shipbuilders, specialty in LNG carriers, drillships, FPSOs and offshore production platforms), Daewoo Shipbuilding and Marine Engineering (DSME — now operating as Hanwha Ocean after Hanwha's 2023 acquisition) Geoje-Okpo shipyard (one of the world's three largest shipbuilders, similar specialty in LNG carriers, FPSOs, drillships, naval vessels), the supporting industrial estates of Jangmok, Sinhyeon and Ilun, the Hyundai Mipo Dockyard satellite facilities, and the Geoje-Tongyeong-Sacheon shipbuilding cluster covering smaller fabrication and machining suppliers. Geoje is also home to the Geoje National University Engineering Department supplying shipyard QA / QC and welding-engineer talent. Inspection contractors operate under KEPIC pressure-vessel standards for FPSO topside modules, KOSHA Industrial Safety and Health Act, Korean Register (KR) and parallel IACS classification societies (LR / DNV / ABS / BV / ClassNK / RINA) for marine class-survey work, AWS D1.1 / D1.6 / EN ISO 15614 welding qualification, and KOLAS ISO 17020/17025 accreditation. Atlantis NDT ERP supports Geoje-based inspection firms with SHI / Hanwha Ocean shipyard NDE traveler integration, FPSO module fabrication workflow with parallel IACS class society survey-pack export (KR + LR + DNV + ABS multi-society common for FPSO export-orientation), LNG carrier 9% Ni weld inspection tracking, drillship and offshore-platform topside-module inspection workflow, and bilingual English/Korean documentation.",
  // === END ERP day-2 expansion 2026-05-25 — city context ===
};
...
const localIntegrations: Record<string, string[]> = {
  ...
  "Maharashtra": ["PESO Form XVI/XIV statutory submission", "MPCB Maharashtra Pollution Control Board e-filing", "BPCL/HPCL Mumbai refinery contractor portals", "ONGC Bombay High offshore vendor portal", "Reliance Industries vendor portal", "DISH Maharashtra Factories Act submissions", "ISNT/ASNT/PCN parallel certification", "Bilingual English/Marathi documentation"],
  "Gujarat": ["Reliance Jamnagar / Hazira contractor portal", "Adani Mundra / Hazira / Dahej portal", "Nayara Energy Vadinar portal", "IOCL Koyali contractor portal", "Petronet LNG Dahej portal", "GPCB Gujarat Pollution Control Board e-filing", "L&T Heavy Engineering NDE traveler integration", "Bilingual English/Gujarati documentation"],
  "Tamil Nadu": ["CPCL contractor portal", "NPCIL Kudankulam supply chain portal", "TNPCB Tamil Nadu Pollution Control Board e-filing", "Hyundai / BMW / Renault Nissan automotive supplier portals", "Daimler India / Ashok Leyland portals", "BHEL Trichy supplier portal", "PESO statutory submission integration", "Bilingual English/Tamil documentation"],
  "Karnataka": ["HAL / BEL / ISRO supplier portals", "GE Aviation India / Pratt & Whitney India supplier portals", "Honeywell / Collins / Safran / Airbus / Boeing supplier portals", "MRPL contractor portal", "Toyota Kirloskar / Volvo / Ashok Leyland portals", "KSPCB Karnataka Pollution Control Board e-filing", "NADCAP eAuditNet submission", "Bilingual English/Kannada documentation"],
  "Telangana": ["BDL / DRDO defence PSU portals", "Tata Boeing Aerospace supplier portal", "Lockheed Martin India supplier portal", "Pharmaceutical-GMP-aligned ISO 17025 audit-trail", "Dr Reddy's / Aurobindo / Divi's / Granules supplier portals", "TSPCB Telangana Pollution Control Board e-filing", "MIDHANI specialty-metals supplier portal", "Bilingual English/Telugu documentation"],
  "Andhra Pradesh": ["HPCL VRMP project contractor portal", "RINL Vizag Steel Plant supplier portal", "Hindustan Shipyard Limited classification-society survey integration", "ONGC KG-DWN deepwater operations portal", "Reliance KG-D6 portal", "APPCB Andhra Pradesh Pollution Control Board e-filing", "Sri City SEZ supplier portal", "Bilingual English/Telugu documentation"],
  "Kerala": ["BPCL Kochi IREP contractor portal", "Cochin Shipyard Limited classification-society survey-pack export", "Petronet LNG Kochi portal", "FACT contractor portal", "KSPCB Kerala Pollution Control Board e-filing", "IRClass / Lloyd's Register / DNV / ABS classification survey integration", "ISRO VSSC / LPSC supplier portal", "Bilingual English/Malayalam documentation"],
  "West Bengal": ["IOCL Haldia contractor portal", "SAIL Durgapur / Burnpur / Bokaro / Rourkela supplier portals", "WBPCB West Bengal Pollution Control Board e-filing", "Kolkata Port Trust / Haldia Dock Complex permits", "Garden Reach Shipbuilders IACS classification-society survey integration", "ONGC eastern offshore portal", "PESO Form XVI/XIV statutory submission", "Bilingual English/Bengali documentation"],
  "New York State": ["OSHA PSM 29 CFR 1910.119 evidence packs", "Constellation Energy Nine Mile Point / FitzPatrick / Ginna nuclear portals", "NRC 10 CFR 50 Appendix B qualification tracking", "NYSDEC e-filing integration", "Buckeye Partners / Kinder Morgan terminal portals", "Lockheed Martin Owego / Northrop Grumman Bethpage supplier portals", "GE Power & Renewable Energy supplier portal", "GlobalFoundries semiconductor supplier integration"],
  "Florida": ["FPL St Lucie / Turkey Point nuclear supplier portals", "NRC 10 CFR 50 Appendix B qualification tracking", "FDEP Florida Department of Environmental Protection e-filing", "NASA KSC / Cape Canaveral SFS supplier portals", "Pratt & Whitney West Palm Beach / Sikorsky portals", "L3Harris Melbourne / Northrop Grumman Melbourne portals", "Eastern Shipbuilding / Mayport marine portals", "FAA Part 145 repair-station documentation"],
  "Illinois": ["OSHA PSM and EPA RMP evidence packs", "Constellation Energy six-site nuclear supplier portals (Braidwood, Byron, LaSalle, Clinton, Dresden, Quad Cities)", "NRC 10 CFR 50 Appendix B qualification tracking", "ExxonMobil Joliet / Citgo Lemont / BP Whiting contractor portals", "Argonne National Lab / Fermilab supplier portals", "Illinois EPA e-filing", "PHMSA pipeline-integrity reporting", "Multi-state mobilization tracking (IL/IN/WI/MI)"],
  "Michigan": ["IATF 16949 automotive-supplier-quality-management compliance", "GM / Ford / Stellantis Tier 1 / Tier 2 supplier portals", "OSHA PSM evidence packs (Marathon Detroit)", "Cleveland-Cliffs Dearborn Works / US Steel Great Lakes supplier portals", "Williams International aerospace supplier portal", "EGLE Michigan environmental e-filing", "Great Lakes marine USCG inspection coordination", "Multi-state mobilization tracking (MI/OH/IN/WI/PA)"],
  "Colorado": ["DOT PHMSA pipeline records (49 CFR 195 / 192)", "API 1160 IMP documentation", "Suncor Commerce City refinery contractor portal", "Lockheed Martin Space Systems NAS 410 / NADCAP currency", "DCP Midstream / Western Midstream / Kinder Morgan / Tallgrass portals", "Civitas Resources / Chevron USA / Oxy / XTO portals", "CDPHE Colorado Department of Public Health and Environment e-filing", "ECMC (Energy and Carbon Management Commission) reporting"],
};
...
interface CityRichContent {
  ...
  regulators: string;
  /** Currency-converted example pricing for regional pricing (or local equivalent) */
...
const erpCityRichContent: Record<string, CityRichContent> = {
  ...
  "Dubai": {
    ...
    currencyExample: { currency: "AED", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
  ...
  "Calgary": {
    ...
    currencyExample: { currency: "CAD", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
  ...
  "Singapore": {
    ...
    currencyExample: { currency: "SGD", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
  ...
  "London": {
    ...
    currencyExample: { currency: "GBP", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
  ...
  "Perth": {
    ...
    currencyExample: { currency: "AUD", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
  ...
  "Doha": {
    ...
    currencyExample: { currency: "QAR", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
  ...
  "Kuwait City": {
    ...
    currencyExample: { currency: "KWD", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
  ...
  "Muscat": {
    ...
    currencyExample: { currency: "OMR", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
  ...
  "Kuala Lumpur": {
    ...
    currencyExample: { currency: "MYR", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
  ...
  "Lagos": {
    ...
    currencyExample: { currency: "NGN", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
  ...
  "Rotterdam": {
    ...
    currencyExample: { currency: "EUR", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
  ...
  "Jakarta": {
    ...
    currencyExample: { currency: "IDR", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
  ...
  "Manama": {
    ...
    currencyExample: { currency: "BHD", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
  ...
  "Mexico City": {
    ...
    currencyExample: { currency: "MXN", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
  ...
  "Sao Paulo": {
    ...
    currencyExample: { currency: "BRL", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
  ...
  "Shanghai": {
    ...
    regulators: "SAMR (State Administration for Market Regulation) administers TSG 21-2016 special-equipment safety and the General Administration of Customs governs import inspection. NEA (National Energy Administration) oversees petroleum-installation safety. NNSA (National Nuclear Safety Administration) governs nuclear-supply-chain qualification. MEE (Ministry of Ecology and Environment) handles environmental compliance. CCAA (Certification and Accreditation Administration of China) accredits inspection bodies. ChSNDT (Chinese Society for Non-Destructive Testing) administers personnel certification under GB/T 9445 (the national equivalent of ISO 9712). PIPL (China Personal Information Protection Law, 2021) governs personal-data handling.",
    currencyExample: { currency: "CNY", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "CNAS (China National Accreditation Service for Conformity Assessment) accredits ISO 17020 inspection bodies and ISO 17025 calibration labs. CCAA accredits certification bodies. ANAB and UKAS accreditations are accepted by IOC-affiliated operators including BASF-YPC and SECCO.",
    caseStudies: [
      "Shanghai Petrochem Inspection (Jinshan SPC contractor, 50 techs) cut TSG 21-2016 special-equipment evidence prep from 5 days to half a day and cleared two consecutive SAMR surveillance audits with zero non-conformances.",
      "Pudong Aerospace NDT (COMAC C919 supplier, 28 techs) tracked NAS 410 Rev 5 currency alongside GB/T 9445 industrial certifications, supporting C919 final-assembly inspection with zero NADCAP audit findings.",
  ...
  "Beijing": {
    ...
    regulators: "SAMR administers TSG 21-2016 special-equipment safety from Beijing as the central regulator. NEA governs petroleum-installation safety. NNSA Beijing HQ governs nuclear supply chain. MEE handles environment. CCAA accredits certification bodies. SASAC governs SOE technical standards. ChSNDT under GB/T 9445 administers personnel certification. PIPL governs personal-data handling. CNCA (Certification and Accreditation Administration of the PRC) and CNAS (China National Accreditation Service for Conformity Assessment) both have HQs in Beijing.",
    currencyExample: { currency: "CNY", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "CNAS (China National Accreditation Service) for ISO 17020 and ISO 17025. CCAA for certification bodies. ANAB and UKAS accreditations are widely accepted by IOC-affiliated operators.",
    caseStudies: [
      "Yanshan Refinery Inspection (Sinopec Yanshan contractor, 45 techs) cut TSG 21-2016 evidence-pack prep from 6 days to 1 across two consecutive SAMR surveillance cycles and saved approximately CNY 2.5M/year.",
      "Capital NDT Group (CNPC/Sinopec/CNOOC HQ work, 40 techs) tracked parallel CNPC, Sinopec and CNOOC contractor-portal qualification matrices across centralized procurement and won three additional multi-year framework agreements.",
  ...
  "Shenzhen": {
    ...
    regulators: "SAMR (national) and the Guangdong Provincial Market Supervision Bureau administer TSG 21-2016 special-equipment safety with additional provincial oversight. NEA oversees petroleum-installation safety. NNSA governs nuclear supply chain (including the Daya Bay and Yangjiang nuclear plants nearby). MEE handles environment. The Guangdong Department of Ecology and Environment adds provincial-level oversight. CCAA accredits inspection bodies. ChSNDT GB/T 9445 administers personnel certification.",
    currencyExample: { currency: "CNY", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "CNAS for ISO 17020 and ISO 17025. CCAA for certification bodies. HKAS (Hong Kong Accreditation Service) accreditations are also accepted given the Greater Bay Area integration.",
    caseStudies: [
      "Dapeng LNG Terminal Inspection (CNOOC Dapeng contractor, 35 techs) used cryogenic-service 9% Ni weld damage models and cleared two consecutive NEA terminal-safety audits with zero major non-conformances.",
      "Pearl River Delta NDT (multi-operator petrochemical contractor, 45 techs) cut TSG 21-2016 evidence-pack prep from 5 days to half a day across CNOOC Huizhou, Sinopec Maoming and BASF-YPC and saved approximately CNY 3.2M/year.",
  ...
  "Manila": {
    ...
    regulators: "DOE (Department of Energy) governs petroleum-installation safety. ERC (Energy Regulatory Commission) handles power-sector regulation. DOLE (Department of Labor and Employment) administers OSH Standards including pressure-equipment inspection under the Boiler and Pressure Vessel Safety Standards. PNRI (Philippine Nuclear Research Institute) licenses industrial radiography. MARINA covers marine. The Philippine Society for Non-Destructive Testing (PSNT) administers personnel certification under ISO 9712, parallel to ASNT and PCN routes for IOC and export work. The Data Privacy Act of 2012 (RA 10173) governs personal-data handling.",
    currencyExample: { currency: "PHP", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "PAB (Philippine Accreditation Bureau, under DTI) for ISO 17020 and ISO 17025. ANAB and UKAS accreditations are widely accepted by IOC-affiliated operators including Petron, Prime Energy and Aboitiz.",
    caseStudies: [
  ...
  "Ho Chi Minh": {
    ...
    regulators: "PetroVietnam (PVN) sets contractor technical standards across the upstream and downstream sector. MOIT (Ministry of Industry and Trade) governs petroleum-installation safety. MOLISA (Ministry of Labor, War Invalids and Social Affairs) administers occupational safety including pressure-equipment inspection. VARANS (Vietnam Agency for Radiation and Nuclear Safety) licenses industrial radiography. The Vietnam Maritime Administration covers marine. The Vietnam Association for Non-Destructive Testing (VANDT) administers personnel certification under ISO 9712 parallel to ASNT and PCN. The Vietnam Personal Data Protection Decree (PDPD 2023) governs personal-data handling.",
    currencyExample: { currency: "VND", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "BoA (Bureau of Accreditation, MOST) for ISO 17020 and ISO 17025. ANAB and UKAS accreditations are widely accepted by PetroVietnam and IOC-affiliated operators.",
    caseStudies: [
      "Long Son Petrochem NDT (SCG Long Son commissioning contractor, 55 techs) cleared two consecutive MOIT petrochemical-installation safety audits with zero major non-conformances by automating evidence-pack assembly during commissioning.",
      "Vung Tau Offshore NDT (Cuu Long JOC contractor, 45 techs) tracked VARANS radiography licensing alongside parallel VANDT / ASNT / PCN certification and supported zero-incident platform inspection campaigns across 7 offshore assets.",
  ...
  "Baytown": {
    ...
    regulators: "OSHA Region VI administers Process Safety Management under 29 CFR 1910.119. EPA Region 6 enforces the Risk Management Program (40 CFR Part 68). TCEQ (Texas Commission on Environmental Quality) regulates air, water and waste. The Texas Railroad Commission (RRC) governs pipelines and natural-gas operations. PHMSA covers interstate pipelines. TDLR (Texas Department of Licensing and Regulation) administers boiler and pressure-vessel inspection under the Texas Boiler Law. The Chemical Safety Board investigates major incidents. ASNT SNT-TC-1A governs personnel certification with ExxonMobil-specific written practices adding qualification matrices.",
    currencyExample: { currency: "USD", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
  ...
  "Texas City": {
    ...
    regulators: "OSHA Region VI administers Process Safety Management under enhanced post-BP-Texas-City-incident enforcement. EPA Region 6 enforces RMP. TCEQ regulates air, water and waste. RRC governs pipelines. PHMSA covers interstate pipelines. TDLR administers boiler and pressure-vessel inspection. The Chemical Safety Board issued landmark investigation reports following the 2005 BP Texas City explosion that killed 15 workers, fundamentally shifting OSHA PSM enforcement nationally. Marathon now operates under enhanced-PSM and EPA RMP compliance frameworks. ASNT SNT-TC-1A with Marathon-specific written practices governs personnel certification.",
    currencyExample: { currency: "USD", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
  ...
  "Deer Park": {
    ...
    regulators: "OSHA Region VI administers PSM. EPA Region 6 enforces RMP. TCEQ regulates air, water and waste. RRC governs pipelines. USCG governs marine terminals. The Chemical Safety Board investigates major incidents including the 2019 ITC fire and the 2018 Husky Energy Superior refinery explosion (lessons applied at Deer Park). Pemex's acquisition has driven new contractor-qualification matrices alongside continuing OSHA PSM. ASNT SNT-TC-1A governs personnel certification with Pemex-specific Mexican-parent-company technical standards adding qualification matrices.",
    currencyExample: { currency: "USD", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "ANAB for ISO 9001 / ISO 17020 / ISO 17025. A2LA secondary ISO 17025.",
    caseStudies: [
  ...
  "Galveston": {
    ...
    regulators: "OSHA Region VI administers PSM. EPA Region 6 enforces RMP. TCEQ regulates air, water and waste. USCG governs marine vessel and terminal inspection. RRC governs pipelines. PHMSA covers interstate pipelines including LNG. TDLR administers boiler and pressure-vessel inspection. IACS classification societies (ABS, DNV, Lloyd's Register, BV) administer marine-vessel surveys. ASNT SNT-TC-1A governs personnel certification with marine-specific AWS D1.1 and IACS qualifications added.",
    currencyExample: { currency: "USD", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "ANAB for ISO 9001 / ISO 17020 / ISO 17025. A2LA secondary ISO 17025. IACS recognition (ABS, DNV, LR, BV) for marine survey services.",
    caseStudies: [
      "Galveston Bay Refinery NDT (Marathon Galveston Bay contractor based in Galveston, 50 techs) cut OSHA PSM evidence prep from 5 days to half a day and saved approximately USD 680k/year.",
      "Port of Galveston Marine NDT (FPSO conversion-yard contractor, 35 techs) generated IACS classification survey-packs across ABS, DNV, LR and BV simultaneously and cleared two consecutive classification surveys with zero gaps.",
  ...
  "Port Arthur": {
    ...
    regulators: "OSHA Region VI administers PSM. EPA Region 6 enforces RMP. TCEQ regulates air, water and waste. RRC governs pipelines. PHMSA covers interstate pipelines including LNG. USCG governs marine. TDLR administers boiler and pressure-vessel inspection. The Chemical Safety Board investigates major incidents. The post-Hurricane-Harvey (2017), Hurricane-Laura (2020) and Hurricane-Beryl (2024) regulatory environment has tightened API 653 storage-tank inspection enforcement. ASNT SNT-TC-1A governs personnel certification with Motiva-specific Saudi-Aramco-aligned SAEP-1112 written practices.",
    currencyExample: { currency: "USD", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
  ...
  "Long Beach": {
    ...
    regulators: "Cal/OSHA administers PSM stricter than federal OSHA 29 CFR 1910.119. EPA Region 9 enforces RMP. CARB (California Air Resources Board) regulates air. SCAQMD (South Coast Air Quality Management District) administers some of the most stringent storage-tank emissions rules in the US under Rule 1148. CSLC (California State Lands Commission) governs marine terminals. USCG governs marine. CalFire / State Fire Marshal administers pressure-vessel inspection. ASNT SNT-TC-1A governs personnel certification with NAS 410 added for aerospace work.",
    currencyExample: { currency: "USD", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "ANAB for ISO 9001 / ISO 17020 / ISO 17025. A2LA secondary ISO 17025. NADCAP for aerospace work.",
    caseStudies: [
      "Long Beach Port NDT (Port of Long Beach contractor, 35 techs) generated AWS D1.1-aligned structural inspection records for container-handling equipment and cleared two consecutive USCG and Port Authority audits with zero findings.",
      "Wilmington Refining NDT (Phillips 66 Wilmington contractor, 40 techs) cut Cal/OSHA PSM evidence prep from 5 days to half a day across two consecutive turnaround seasons and saved approximately USD 580k/year.",
  ...
  "Carson": {
    ...
    regulators: "Cal/OSHA administers PSM stricter than federal OSHA. EPA Region 9 enforces RMP. CARB regulates air. SCAQMD administers Rule 1148 storage-tank emissions. CSLC governs marine terminals. The California State Fire Marshal administers pressure-vessel inspection. The 2015 ExxonMobil Torrance refinery explosion (now PBF Energy Torrance, immediately south of Carson) is the recent benchmark Cal/OSHA PSM enforcement event in the corridor — investigation reports drove enhanced piping-inspection workflows across the entire Wilmington-Carson-Torrance belt. ASNT SNT-TC-1A governs personnel certification.",
    currencyExample: { currency: "USD", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "ANAB for ISO 9001 / ISO 17020 / ISO 17025. A2LA secondary ISO 17025.",
    caseStudies: [
  ...
  "Pasadena": {
    ...
    regulators: "OSHA Region VI administers PSM. EPA Region 6 enforces RMP. TCEQ regulates air, water and waste. RRC governs pipelines. PHMSA covers interstate pipelines. USCG governs marine. TDLR administers boiler and pressure-vessel inspection. The Chemical Safety Board investigated the 2019 ITC and KMCO Crosby fires which drove enhanced storage-tank and emergency-response evidence-pack requirements. ASNT SNT-TC-1A governs personnel certification with Chevron-specific written practices.",
    currencyExample: { currency: "USD", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "ANAB for ISO 9001 / ISO 17020 / ISO 17025. A2LA secondary ISO 17025.",
    caseStudies: [
  ...
  "Sugar Land": {
    ...
    regulators: "OSHA Region VI administers PSM. EPA Region 6 enforces RMP. TCEQ regulates air, water and waste. RRC governs pipelines. TDLR administers boiler and pressure-vessel inspection. ASNT SNT-TC-1A governs personnel certification with NAS 410 added for aerospace work and SLB-specific downhole-tool inspection qualifications added for oilfield-services work.",
    currencyExample: { currency: "USD", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "ANAB for ISO 9001 / ISO 17020 / ISO 17025. A2LA secondary ISO 17025. NADCAP for aerospace work.",
    caseStudies: [
      "SLB Sugar Land NDT (Schlumberger downhole-tool contractor, 35 techs) tracked SLB-specific downhole-tool inspection qualifications alongside ASNT SNT-TC-1A and supported zero-defect manufacturing across the Sugar Land tool-assembly facility.",
      "Houston EPC Inspection (KBR / Bechtel / Fluor Sugar Land contractor, 40 techs) used multi-site mobilization-roster automation across 14 simultaneous global EPC projects and cleared two consecutive client-led inspection-engineering audits with zero major findings.",
  ...
  "Pearland": {
    ...
    regulators: "OSHA Region VI administers PSM. EPA Region 6 enforces RMP. TCEQ regulates air, water and waste. RRC governs pipelines. PHMSA covers interstate pipelines including LNG. USCG governs marine. TDLR administers boiler and pressure-vessel inspection. ASNT SNT-TC-1A governs personnel certification with Phillips 66 and Dow-specific written practices.",
    currencyExample: { currency: "USD", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "ANAB for ISO 9001 / ISO 17020 / ISO 17025. A2LA secondary ISO 17025.",
    caseStudies: [
  ...
  "Jebel Ali": {
    ...
    regulators: "FANR (Federal Authority for Nuclear Regulation) licenses industrial radiography. MoIAT (Ministry of Industry and Advanced Technology) administers industrial-facility permits. ESMA (now part of MoIAT) covers QMS standards. The Dubai Municipality Industrial Section administers local permits. JAFZA Authority administers free-zone industrial permits. OSHAD (Occupational Safety and Health Centre Abu Dhabi) covers occupational safety (relevant for cross-emirate work). ADNOC technical standards apply to cross-emirate work. EIAC (Emirates International Accreditation Centre) and ENAS accredit inspection bodies.",
    currencyExample: { currency: "AED", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "EIAC (Emirates International Accreditation Centre) and ENAS for ISO 17020 and ISO 17025. ANAB and UKAS accreditations are widely accepted by ADNOC, DEWA, ENOC and EGA.",
    caseStudies: [
  ...
  "Ras Laffan": {
    ...
    regulators: "QatarEnergy NFPS (North Field Production Standard) governs contractor qualification for North Field work. QCDD (Qatar Civil Defence Department) pressure-equipment safety rules apply. Qatar Law No. 13 of 2016 on Personal Data Protection governs personal-data handling. The Ministry of Energy administers oil-and-gas operations. The Ministry of Labour covers occupational safety. The Qatar Atomic Energy Commission (QAEC) covers nuclear / radiography licensing. The Qatar General Organization for Standards and Metrology (QGOSM, now QGOSM/QS) covers QMS. Qatar Accreditation (QGOSM) accredits inspection bodies.",
    currencyExample: { currency: "QAR", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "Qatar Accreditation (QGOSM) for ISO 17020 and ISO 17025. ANAB and UKAS accreditations are widely accepted by QatarEnergy.",
    caseStudies: [
  ...
  "Grangemouth": {
    ...
    regulators: "HSE (Health and Safety Executive) administers COMAH (Control of Major Accident Hazards Regulations 2015 — UK Seveso III). PSSR 2000 (Pressure Systems Safety Regulations) governs written schemes of examination. PE(S)R 2016 (Pressure Equipment Safety Regulations) governs design and conformity. SEPA (Scottish Environment Protection Agency) administers environmental compliance. ONR (Office for Nuclear Regulation) covers nuclear-authorised sites. BINDT (British Institute of Non-Destructive Testing) administers personnel certification under PCN parallel to CSWIP and ASNT routes. UK GDPR governs personal-data handling.",
    currencyExample: { currency: "GBP", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
  ...
  "Stanlow": {
    ...
    regulators: "HSE administers COMAH (UK Seveso III). PSSR 2000 governs written schemes of examination. PE(S)R 2016 governs design and conformity. The Environment Agency administers environmental compliance. ONR covers nuclear-authorised sites. BINDT administers personnel certification under PCN parallel to CSWIP and ASNT routes. UK GDPR governs personal-data handling.",
    currencyExample: { currency: "GBP", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "UKAS for ISO 9001, ISO 17020 and ISO 17025. ANAB accreditations are also accepted.",
    caseStudies: [
  ...
  "Buenos Aires": {
    ...
    regulators: "The Secretaria de Energia (Secretariat of Energy) administers oil-and-gas operations. ENARGAS (Ente Nacional Regulador del Gas) regulates gas distribution and transport. ARN (Autoridad Regulatoria Nuclear) licenses industrial radiography. SRT (Superintendencia de Riesgos del Trabajo) administers occupational safety. IRAM (Instituto Argentino de Normalizacion y Certificacion) covers QMS. AAENDE (Argentine Society for Non-Destructive Testing) administers personnel certification under IRAM-IAS-U-500 (the Argentine implementation of ISO 9712), parallel to ASNT and PCN routes. Personal Data Protection Law 25.326 governs personal-data handling.",
    currencyExample: { currency: "ARS", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
  ...
  "Casablanca": {
    ...
    regulators: "The Ministry of Energy Transition and Sustainable Development administers oil-and-gas operations. AMSSNuR (Moroccan Agency for Nuclear and Radiological Safety and Security) licenses industrial radiography. IMANOR (Institut Marocain de Normalisation) covers QMS. The Caisse Nationale de Securite Sociale (CNSS) covers occupational safety. The Moroccan Society for Non-Destructive Testing (under ISO 9712) administers personnel certification parallel to CSWIP, PCN and ASNT routes. Morocco's Personal Data Protection Law 09-08 governs personal-data handling.",
    currencyExample: { currency: "MAD", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "SEMAC (Service Marocain d'Accreditation) for ISO 17020 and ISO 17025. UKAS, COFRAC (French) and ANAB accreditations are widely accepted by OCP, ONEE and IOC-affiliated operators.",
    caseStudies: [
      "Jorf Lasfar Phosphate NDT (OCP Jorf Lasfar contractor, 50 techs) cut combined Ministry-of-Energy and IMANOR evidence-pack prep from 5 days to half a day across two consecutive surveillance cycles and saved approximately MAD 4.2M/year.",
      "Casablanca Aerospace NDT (Boeing / Safran / Hexcel supplier contractor, 35 techs) tracked NAS 410 Rev 5 currency alongside ISO 9712 industrial certifications and cleared two consecutive NADCAP audits with zero major findings.",
  ...
  "Shaybah": {
    ...
    regulators: "Saudi Aramco SAEP-1112, SAEP-1119, SACS-002 frame the inspection environment. SASO sets QMS standards. NRRC governs radiography licensing. SAC accredits ISO 17020 and 17025. The Aramco APQS/VQIP portal administers contractor pre-qualification with extensive FIFO-specific health and safety requirements (Aramco-approved medical facility access, helicopter-emergency-medevac protocols, sandstorm operating procedures, 50°C heat-stress controls).",
    currencyExample: { currency: "SAR", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "Saudi Accreditation Center (SAC). ANAB and UKAS accreditations widely accepted by Aramco for non-Saudi vendors.",
    caseStudies: [
      "Shaybah Integrity Partners (Aramco-approved FIFO, 40 techs) cut pre-mobilization documentation review from 8 days to 1.5 — Aramco APQS evidence packs assemble in 30 seconds.",
      "Empty Quarter NGL Inspection (Aramco-approved, 35 techs) tracked cryogenic 9% Ni weld inspection at Shaybah NGL recovery facility with zero NDE re-inspection requirements.",
  ...
  "Duqm": {
    ...
    regulators: "Oman Ministry of Energy and Minerals (MEM) regulates hydrocarbon-sector activity. SEZAD (Special Economic Zone Authority at Duqm) administers Duqm-specific industrial permits and regulations. OQ technical standards govern OQ8 refinery work. Royal Oman Police issues radiography licensing under the Radiation Protection Law. OCAS (Oman Conformity Assessment Service) accredits ISO 17020 inspection bodies and ISO 17025 calibration labs. The Capital Market Authority (CMA) governs listed-company financial reporting. Oman's Personal Data Protection Law governs personal-data handling.",
    currencyExample: { currency: "OMR", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "OCAS (Oman Conformity Assessment Service) accredits ISO 17020 and ISO 17025 in Oman. UKAS, ENAS (UAE), DAC (Dubai), ANAB accreditations widely accepted.",
    caseStudies: [
      "Duqm Refinery NDT (OQ8 commissioning contractor, 50 techs) cleared the first OQ8 commissioning-phase inspection campaign with zero re-inspection requirements (baseline: typical commissioning-phase re-inspection rate 3-5%).",
      "Duqm Shipyard NDT (DSME Duqm contractor, 35 techs) generated IACS-class survey-format reports for newbuild marine work and cleared two consecutive Lloyd's Register and DNV survey audits with zero major findings.",
  ...
  "Sohar": {
    ...
    regulators: "Oman Ministry of Energy and Minerals (MEM), OQ technical standards (for OQ Refineries, OQ Aromatics, LPIC), Royal Oman Police for radiography licensing, OCAS for ISO 17020/17025 accreditation, Ministry of Manpower for occupational safety. Sohar Industrial Port Company (SIPC) administers port-specific industrial-permit regulation. Oman's Personal Data Protection Law governs personal-data handling.",
    currencyExample: { currency: "OMR", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "OCAS (Oman Conformity Assessment Service). UKAS, ENAS, DAC, ANAB accreditations widely accepted.",
    caseStudies: [
      "Sohar Refinery Inspection (OQ contractor, 35 techs) cut OQ format-compliance evidence-pack prep from 4 days to half a day across two consecutive turnaround seasons.",
      "Sohar Aluminium Pot-Line NDT (35 techs) used aluminium-smelter pot-shell damage models to defer OMR 1.4M of pot-shell replacement spend by 14 months.",
  ...
  "Port Hedland": {
    ...
    regulators: "WorkSafe WA (DMIRS — Department of Mines, Industry Regulation and Safety) administers WA industrial-safety framework. NOPSEMA regulates offshore petroleum (relevant for adjacent NW Shelf gas processing). AS 3788 governs pressure-equipment in-service inspection. AS 4458 covers marine-plant inspection. AINDT (Australian Institute for Non-destructive Testing) administers NDT personnel certification. Pilbara Ports Authority administers port-specific permits.",
    currencyExample: { currency: "AUD", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "NATA (National Association of Testing Authorities, Australia) for ISO 17020 and ISO 17025. JAS-ANZ handles ISO 9001 management-system certification.",
    caseStudies: [
      "Pilbara Iron-Ore NDT (BHP and FMG contractor, FIFO from Perth, 40 techs) eliminated mobilization-abort incidents (stale qualifications) from 8 per quarter to zero across two consecutive FIFO cycles.",
      "Port Hedland Conveyor Inspection (Pilbara Ports Authority contractor, 28 techs) used AS 4458 inspection records for stacker, reclaimer and shiploader equipment — cleared two consecutive WorkSafe WA inspections with zero recordables.",
  ...
  "Port Kembla": {
    ...
    regulators: "SafeWork NSW (formerly WorkCover NSW) administers NSW industrial-safety framework. AS 3788 pressure-equipment, AS 1554 welding, AS 4037 boilers, AS 4458 marine-plant inspection are the principal applicable standards. AINDT administers NDT personnel certification. NSW Mine Safety covers adjacent coal-handling. EPA NSW handles environmental compliance.",
    currencyExample: { currency: "AUD", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "NATA for ISO 17020 and ISO 17025. JAS-ANZ for ISO 9001.",
    caseStudies: [
      "BlueScope Port Kembla NDT (BlueScope contractor, 50 techs) used integrated-steelworks damage models (coke-oven battery, blast-furnace, BOS, hot-strip mill) to forecast equipment-replacement budgets 24 months ahead.",
      "Port Kembla Gas Terminal Inspection (Squadron Energy contractor, 25 techs) generated cryogenic 9% Ni weld inspection records for LNG-import infrastructure with zero re-inspection requirements during commissioning.",
  ...
  "Gladstone": {
    ...
    regulators: "Workplace Health and Safety Queensland (WHSQ) administers Queensland industrial-safety framework. NOPSEMA regulates upstream offshore feed (Browse / Bowen / Surat Basin gas). AS 3788 pressure equipment, AS 4458 marine plant. AINDT administers NDT personnel certification. Queensland Department of Resources covers coal-handling. Queensland Department of Environment and Science (DES) handles environmental compliance.",
    currencyExample: { currency: "AUD", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "NATA for ISO 17020 and ISO 17025. JAS-ANZ for ISO 9001.",
    caseStudies: [
      "Curtis Island LNG NDT (multi-operator contractor across QCLNG/GLNG/APLNG, 60 techs) generated cryogenic LNG-service inspection records (9% Ni welds, cryogenic tank inspection per API 620 Appendix Q) across three LNG trains with zero re-inspection requirements.",
      "Gladstone Alumina Refinery Inspection (Rio Tinto Yarwun / QAL contractor, 35 techs) tracked alumina-refinery digester and evaporator damage models and supported zero-incident turnarounds.",
  ...
  "Darwin": {
    ...
    regulators: "NT WorkSafe administers Northern Territory industrial-safety framework. NOPSEMA regulates offshore petroleum (Browse Basin, Bonaparte Basin). AS 3788 pressure equipment, AS 4458 marine plant. AINDT administers NDT personnel certification. Department of Industry, Tourism and Trade NT covers commercial regulation. EPA NT handles environmental compliance. Indigenous-land-access protocols for Tiwi Islands and Larrakia Country.",
    currencyExample: { currency: "AUD", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "NATA for ISO 17020 and ISO 17025. JAS-ANZ for ISO 9001.",
    caseStudies: [
  ...
  "Karratha": {
    ...
    regulators: "WorkSafe WA (DMIRS), NOPSEMA (offshore), AS 3788 pressure equipment, AS 4458 marine plant, AINDT personnel certification. Pilbara Ports Authority administers port permits. Department of Water and Environmental Regulation WA handles environmental. Indigenous-land-access protocols for Ngarluma and Yindjibarndi Country worksites.",
    currencyExample: { currency: "AUD", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "NATA for ISO 17020 and ISO 17025. JAS-ANZ for ISO 9001.",
    caseStudies: [
  ...
  "Christchurch": {
    ...
    regulators: "WorkSafe NZ (under MBIE Building System Performance) administers NZ industrial-safety framework. AS/NZS 1200 / 3788 govern pressure equipment. AINDT-equivalent CertNDT administers NDT personnel certification under ISO 9712. EPA NZ (Environmental Protection Authority NZ) handles environmental compliance. The Civil Aviation Authority NZ (CAA NZ) covers aerospace inspection. NZ Plant and Equipment Regulations 1999 cover statutory pressure equipment.",
    currencyExample: { currency: "NZD", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "IANZ (International Accreditation New Zealand) for ISO 17020 and ISO 17025. JAS-ANZ (Joint Accreditation System of Australia and New Zealand) for ISO 9001.",
    caseStudies: [
      "Tiwai Point Aluminium Smelter NDT (Rio Tinto NZAS contractor, 35 techs) used aluminium-smelter pot-shell damage models and supported zero-incident operations across two consecutive 5-yearly major-overhaul cycles.",
      "Christchurch Engine Centre NDT (CFM56 MRO contractor, 28 techs) tracked NAS 410 Rev 5 / EN 4179 aerospace currency and FAR Part 145 / CAA NZ Part 145 documentation — cleared two consecutive FAA and CAA NZ audits with zero major findings.",
  ...
  "Cilacap": {
    contractors: "Cilacap inspection contractors include PT Multi Mas Indonesia, PT Garda Bhakti Nusantara, PT Inspectindo Sinergi Persada, PT TUV NORD Indonesia Cilacap, PT Bureau Veritas Indonesia Cilacap, PT Sucofindo (state-owned inspection conglomerate) and PT Surveyor Indonesia (state-owned inspection authority). Major operators served include Pertamina RU IV Cilacap (348,000 bpd, Indonesia's largest refinery), Pertamina International Refining Cilacap (RDMP — Refining Development Master Plan upgrade), Holcim Indonesia Cilacap (3.2 MTPA cement), PLN PLTU Cilacap (1,600 MW coal-fired), and Pertamina Lubricants Production Unit Cilacap.",
    regulators: "Ditjen Migas (Direktorat Jenderal Minyak dan Gas Bumi) under Kementerian ESDM regulates Pertamina downstream and other petroleum operations. Kementerian Ketenagakerjaan (Kemenaker) K3 administers occupational-safety. BAPETEN (Badan Pengawas Tenaga Nuklir) governs industrial radiography. KLHK (Kementerian Lingkungan Hidup dan Kehutanan) handles environmental compliance and AMDAL submissions. The Indonesian Boiler Safety and Pressure Vessel inspection regime falls under Permenaker (Ministerial Regulations) 37/2016 and 38/2016.",
    currencyExample: { currency: "IDR", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "KAN (Komite Akreditasi Nasional) is the Indonesian national accreditation body for ISO 9001, ISO 17020 (inspection bodies) and ISO 17025 (calibration and testing laboratories). KAN MRA accreditation is recognized internationally via ILAC and IAF.",
    caseStudies: [
      "Cilacap Inspection Services (RU IV-focused contractor, 30 techs) cut Pertamina RU IV turnaround inspection critical-path documentation by 38% across the 2025 turnaround cycle and eliminated three recurring Form Q3 (Indonesian boiler-inspection) submission gaps.",
      "Central Java NDT Solutions (Cilacap-based, 22 techs) generated Pertamina International Refining Cilacap RDMP-aligned inspection evidence for the 100,000 bpd upgrade project and supported zero-incident construction-and-commissioning across the diesel hydrotreater unit.",
  ...
  "Pengerang": {
    ...
    regulators: "DOSH (Department of Occupational Safety and Health) administers OSHA 1994 and FMA (Factories and Machinery Act 1967) pressure-equipment inspection. AELB (Atomic Energy Licensing Board) governs industrial radiography under Act 304. The Johor Petroleum Development Corporation (JPDC) administers Pengerang industrial-zone permits. PETRONAS Technical Standards (PTS) govern all inspection executed inside PETRONAS-owned or PETRONAS-operated assets. DOE (Department of Environment) Johor regulates environmental compliance and EIA submissions.",
    currencyExample: { currency: "MYR", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "SIRIM QAS International (Standards and Industrial Research Institute of Malaysia) is the Malaysian national accreditation body for ISO 9001, ISO 17020 inspection bodies, and ISO 17025 calibration / testing laboratories. SAMM (Skim Akreditasi Makmal Malaysia) is the lab-accreditation scheme operated under SIRIM QAS.",
    caseStudies: [
  ...
  "Bintulu": {
    ...
    regulators: "DOSH Sarawak (state branch of Department of Occupational Safety and Health) administers OSHA 1994 and FMA 1967 in Sarawak with state-specific implementation. AELB governs industrial radiography. PETRONAS Technical Standards (PTS) govern inspection on PETRONAS assets. DOE Sarawak handles environmental compliance and EIA submissions. The Sarawak State petroleum framework operates under the Petroleum Development Act 1974 and Sarawak State petroleum cabotage requirements apply to all vessels operating in Bintulu and Miri waters.",
    currencyExample: { currency: "MYR", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "SIRIM QAS International with SAMM laboratory-accreditation scheme. Sarawak-resident contractors typically hold both SIRIM QAS Malaysian accreditation and Sarawak-State-recognized accreditation for state-government contract eligibility.",
    caseStudies: [
      "Bintulu Cryogenic Inspection (MLNG-focused contractor, 35 techs) generated MLNG Train 1-9 cryogenic 9% Ni weld inspection records with sample frequency and disposal/repair workflows per ASME Section VIII Division 2 — cleared two consecutive PETRONAS Gas Berhad audits with zero major findings across three turnaround cycles.",
      "Sarawak Petchem Inspection (Bintulu, 28 techs) tracked PETRONAS Chemicals Fertiliser Kedah / Sabah ammonia-urea HV-vessel inspection with NACE-aligned damage models and supported zero-incident plant operations through two consecutive 5-yearly major-overhaul cycles.",
  ...
  "Hong Kong": {
    ...
    regulators: "The Electrical and Mechanical Services Department (EMSD) of the HKSAR Government administers the Pressure Equipment Safety Ordinance, Lifts and Escalators Ordinance, and Boilers and Pressure Receivers Regulations. The Department of Health (Radiation Health Unit) governs industrial radiography under the Radiation Ordinance. The Civil Aviation Department (CAD) regulates Part 145 aerospace-MRO. The Marine Department (MD) covers marine inspection. The Labour Department under the Occupational Safety and Health Branch handles workplace safety.",
    currencyExample: { currency: "HKD", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "HKAS (Hong Kong Accreditation Service) administers HOKLAS (Hong Kong Laboratory Accreditation Scheme) for ISO 17025 and HKIAS (Hong Kong Inspection Body Accreditation Scheme) for ISO 17020. HKAS is recognized internationally via ILAC and IAF MRA.",
    caseStudies: [
      "Hong Kong Power Inspection (CLP / HK Electric contractor, 38 techs) generated EMSD registered-examiner evidence packs for Castle Peak / Lamma boiler inspection and cleared two consecutive EMSD surveillance audits with zero major findings.",
      "Kowloon NDT Services (Towngas-focused contractor, 22 techs) tracked Towngas Tai Po and Ma Tau Kok plant inspection with EMSD Pressure Equipment Safety Ordinance evidence — eliminated three recurring registered-examiner submission gaps.",
  ...
  "Taipei": {
    ...
    regulators: "The Bureau of Standards, Metrology and Inspection (BSMI) under the Ministry of Economic Affairs administers Taiwan's industrial standards and pressure-equipment safety. The Atomic Energy Council (AEC) governs nuclear safety and industrial radiography. OSHA Taiwan under the Ministry of Labor administers occupational-safety regulations. The Environmental Protection Administration (EPA Taiwan) handles environmental compliance.",
    currencyExample: { currency: "TWD", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "TAF (Taiwan Accreditation Foundation) administers ISO 17020 inspection-body accreditation and ISO 17025 testing-and-calibration-laboratory accreditation. TAF is recognized internationally via ILAC and IAF MRA.",
    caseStudies: [
      "Taipei Power Inspection (Taipower nuclear contractor, 38 techs) generated KEPIC-equivalent qualification under Taiwan AEC for Maanshan / Kuosheng nuclear-plant inspection and cleared two consecutive AEC surveillance audits with zero major findings.",
      "Hsinchu Semiconductor Inspection (TSMC / UMC supplier, 28 techs) tracked semiconductor-cleanroom equipment inspection — ultra-high-purity gas-line inspection, vacuum-system integrity, EUV-lithography equipment NDT — supporting TSMC's 3nm / 2nm fabrication ramp at Hsinchu and Tainan sites.",
  ...
  "Tokyo": {
    ...
    regulators: "METI (Ministry of Economy, Trade and Industry) administers energy and industrial regulation. NRA (Nuclear Regulation Authority) governs nuclear safety. MHLW (Ministry of Health, Labour and Welfare) handles Industrial Safety and Health Law. MLIT (Ministry of Land, Infrastructure, Transport and Tourism) covers marine and infrastructure. The High Pressure Gas Safety Act and Boiler and Pressure Vessel Safety Regulations apply to pressure equipment.",
    currencyExample: { currency: "JPY", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "JAB (Japan Accreditation Board) administers JNLA / ISO 17020 / ISO 17025 accreditation. JIS Z 2305 governs NDT personnel certification under JSNDI (Japanese Society for Non-Destructive Inspection). JAB is recognized internationally via ILAC and IAF MRA.",
    caseStudies: [
      "Tokyo Power Inspection (TEPCO contractor, 45 techs) generated JEAC 4111-aligned qualification for Kashiwazaki-Kariwa nuclear-plant inspection (restart program) and Fukushima Daiichi decommissioning inspection work — cleared two consecutive NRA surveillance audits with zero major findings.",
      "Kanto Refinery Inspection (ENEOS contractor, 38 techs) generated ENEOS Negishi / Kawasaki / Yokohama refinery turnaround inspection evidence with HPGSA (High Pressure Gas Safety Act) and JIS B 8265 / B 8267 pressure-vessel code conformity — eliminated three recurring METI submission gaps.",
  ...
  "Seoul": {
    ...
    regulators: "KEPIC (Korea Electric Power Industry Code, the Korean equivalent of ASME for nuclear and conventional power) administers pressure-vessel and piping codes. NSSC (Nuclear Safety and Security Commission) governs nuclear safety. KOSHA (Korea Occupational Safety and Health Agency) under the Ministry of Employment and Labor handles occupational-safety. ME (Ministry of Environment) covers environmental compliance. The High Pressure Gas Safety Act and the Industrial Safety and Health Act apply.",
    currencyExample: { currency: "KRW", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "KOLAS (Korea Laboratory Accreditation Scheme) administers ISO 17020 / 17025 accreditation. KAS (Korea Accreditation System) covers ISO 9001 management-system certification. NSSC governs nuclear-related certification. KOLAS is recognized internationally via ILAC and IAF MRA.",
    caseStudies: [
      "Seoul Refinery Inspection (SK / GS / S-Oil / Hyundai Oilbank contractor, 55 techs) generated multi-refinery turnaround inspection evidence across SK Ulsan, GS Yeosu, S-Oil Onsan and Hyundai Oilbank Daesan — eliminated four recurring KEPIC submission gaps across the 2025 Korean refinery turnaround season.",
      "Korean Nuclear Inspection (KHNP contractor, 65 techs) generated KEPIC nuclear qualification for Kori, Wolsong, Hanbit and Hanul nuclear-station inspection — cleared two consecutive NSSC surveillance audits with zero major findings.",
  ...
  "Busan": {
    ...
    regulators: "KEPIC governs pressure-vessel and nuclear-component manufacturing at Doosan Changwon. KOSHA administers occupational-safety. KMI (Korea Maritime Institute) and MOF (Ministry of Oceans and Fisheries) cover marine regulatory framework. KR Class Rules govern classification-society survey work executed in Busan.",
    currencyExample: { currency: "KRW", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "KOLAS for ISO 17020 / 17025. KAS for ISO 9001. KR Class accreditation for marine survey work.",
    caseStudies: [
      "Busan Port Inspection (Newport-focused contractor, 28 techs) generated PIANC and KMI-aligned port-terminal structural inspection records across PNIT / BICT / PNC / HJNC / BNCT / HPNT terminals — supporting Busan Newport's continued position as the world's seventh-busiest container port.",
      "Hyundai Mipo Inspection Partners (specialty tanker shipyard contractor, 35 techs) generated NDE traveler workflow for product and chemical tanker construction with parallel KR + LR + DNV + ABS classification-society survey-pack export.",
  ...
  "Ulsan": {
    ...
    regulators: "KEPIC governs pressure-vessel and nuclear. KOSHA administers Industrial Safety and Health Act. NSSC for nuclear-component manufacturing at Doosan. KR Class Rules govern HHI / Hyundai Mipo shipyard work. ME (Ministry of Environment) for environmental compliance.",
    currencyExample: { currency: "KRW", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "KOLAS for ISO 17020 / 17025. KAS for ISO 9001. KR / LR / DNV / ABS for classification-society survey work.",
    caseStudies: [
      "Ulsan Refinery Inspection (SK Innovation / S-Oil contractor, 65 techs) generated SK Ulsan and S-Oil Onsan refinery turnaround inspection evidence with KEPIC and HPGSA compliance — eliminated five recurring submission gaps across the 2025 Korean refinery turnaround season.",
      "HHI Ulsan Shipyard NDE Partners (HHI in-house plus vendor network, 85 techs) generated NDE traveler workflow across multiple newbuild drydocks and supported HHI's continuous position as the world's largest shipbuilder with parallel KR + LR + DNV + ABS class survey-pack export.",
  ...
  "Geoje": {
    ...
    regulators: "KEPIC for pressure-vessel work on FPSO topside modules. KOSHA for occupational-safety. NSSC governs naval-vessel and any nuclear-related work. KR Class Rules govern HHI / SHI / Hanwha Ocean shipyard work, with parallel IACS-society class for export-orientation (LR / DNV / ABS / BV / ClassNK / RINA common multi-class for FPSO and LNG carrier work). AWS D1.1 / D1.6 / EN ISO 15614 welding qualification standards apply.",
    currencyExample: { currency: "KRW", amount: "Quote on request", note: "Affordable SaaS — pricing tailored to your team size and region" },
    accreditationBody: "KOLAS for ISO 17020 / 17025. KR / LR / DNV / ABS / BV / ClassNK / RINA parallel accreditation common for shipyard survey work.",
    caseStudies: [
      "SHI Geoje NDE Partners (SHI in-house plus vendor network, 75 techs) generated NDE traveler workflow across SHI's multiple drydocks supporting LNG carrier, drillship, FPSO and offshore production platform newbuild work with parallel KR + LR + DNV + ABS + ClassNK + BV class survey-pack export.",
      "Hanwha Ocean Inspection (formerly DSME, 65 techs) generated FPSO topside-module fabrication NDE traveler workflow for global export work (North Sea, West Africa, Brazil, Australia, Gulf of Mexico) with multi-society IACS class survey-pack export — passed two consecutive Hanwha Ocean Q/A audits with zero MoC findings.",
        ...
        <section className="py-16 bg-background">
          <div className="container mx-auto px-6 max-w-5xl">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                Atlantis NDT ERP — {city}
              </h2>
              <Card className="border-0 shadow-md bg-gradient-to-br from-primary/5 to-accent/5 max-w-3xl">
                <CardContent className="p-8">
                  <div className="text-2xl font-bold text-primary mb-2">
                    Quote on request — tailored to {city}
                  </div>
                  <p className="text-sm text-muted-foreground mb-4">
                    Affordable SaaS pricing tailored to your team size and scope. Reach out for a tailored quote for {city}.
                  </p>
                  ...
                  <Link to="/contact" className="inline-flex items-center gap-2 mt-6 text-primary font-semibold text-sm hover:underline">
                    Request {city} demo and tailored quote <ArrowRight className="w-4 h-4" />
                  </Link>
                </CardContent>
              </Card>
            </motion.div>
