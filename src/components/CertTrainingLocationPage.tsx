...
const certificationDatabase: Record<string, CertificationData> = {
    ...
    "asnt-level-iii-training": {
        name: "ASNT Level III NDT Professional Certification",
