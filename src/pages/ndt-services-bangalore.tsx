...
const industries = [
    { name: "Aerospace & Defense (HAL, ISRO)", link: "/ndt-for-aerospace" },
    { name: "Power Generation", link: "/ndt-for-power-generation" },
    { name: "Heavy Engineering", link: null },
    { name: "IT Infrastructure", link: null },
    { name: "Pharmaceutical", link: null },
            ...
            <section className="py-16 bg-white">
                <div className="container mx-auto max-w-6xl px-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div>
                            <h3 className="text-xl font-bold mb-4 flex items-center gap-2"><Plane className="w-6 h-6 text-primary" />Industries We Serve</h3>
                            <ul className="space-y-3">
