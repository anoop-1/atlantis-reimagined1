...
const faqs = [
  ...
  },
  {
    ...
    { question: 'What is visual inspection in NDT?', answer: 'Visual inspection (VT) is the most fundamental NDT method, using direct or aided observation to detect surface conditions such as cracks, corrosion, misalignment, and weld-profile defects. Remote visual inspection with borescopes, videoscopes, and drones extends VT to areas that cannot be reached directly. It follows ASME Section V Article 9 and weld codes like AWS D1.1.' }, /*kw-embed*/
    { question: 'What equipment is used for visual inspection?', answer: 'Visual inspection uses tools ranging from simple gauges, mirrors, and magnifiers to rigid borescopes, flexible videoscopes, and drones or crawlers for remote visual inspection. Lighting, surface preparation, and inspector vision acuity are central to reliable results.' }, /*kw-embed*/
];
