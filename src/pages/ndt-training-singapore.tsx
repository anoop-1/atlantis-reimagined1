...
const faqs = [
  ...
  { question: "What does API 510 / 570 / 653 prep cost in Singapore?", answer: "Atlantis 5-day API exam prep is $2,495 per course (group corporate rates available). API exam fee paid separately to API ($730). Total typical investment: ~$3,500 per certification including code books." },
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <SEOHead
        ...
        description="NDT and API inspector training in Singapore: UT, RT, MT, PT, ET, PAUT, TOFD per ASNT SNT-TC-1A, ISO 9712, PCN. API 510/570/653 5-day prep. Jurong petrochem + FPSO marine focus. ASNT Level III instructors."
