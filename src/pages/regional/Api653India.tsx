...
const faqs = [
    ...
    { question: "How much does API 653 cost in India in 2026?", answer: "Total realistic first-attempt budget: ₹1.6L–₹3.0L (about $1,930–$3,625) — slightly higher than API 510/570 because the API 653 code book stack is the heaviest (10 codes including API 650, 651, 652, 653, 571, 579, plus ASME V/VIII/IX). Breakdown: exam fee ₹60K–₹85K (paid in USD); 5-day classroom prep ₹35K–₹85K; online self-paced prep ₹15K–₹35K; printed code books ₹50K–₹1.1L (often employer-supplied or shared across batches). Re-take fee within 6 months is discounted to ₹42K–₹50K." },
