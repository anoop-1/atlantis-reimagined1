...
const data: ErpIndustryCityProps = {
  ...
  "useCases": [
    "A NAS-410 NDT shop in Dubai manages 35 aerospace NDT technicians with method-and-customer-specific qualification matrices — including periodic vision and proficiency tests.",
    "An MRO facility in Dubai runs AS9100D + FAA/EASA Part 145 + customer flow-down clauses on a single platform — IMS audits unify across all schemes.",
