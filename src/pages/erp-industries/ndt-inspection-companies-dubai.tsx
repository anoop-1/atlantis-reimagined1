...
const data: ErpIndustryCityProps = {
  ...
  "lat": 25.2048,
  "lng": 55.2708,
  "title": "NDT Inspection Companies ERP Software in Dubai",
  "desc": "Purpose-built ERP for ndt inspection companies based in Dubai, UAE. Pre-loaded with ADQCC inspection schemes, ADNOC ACS-01 (vendor), ASME Section V / VIII, operator flow-down for ADNOC Distribution and ENOC Group, and ADQCC /  MOIAT compliance support. Demo: info@atlantisndt.com.",
  "introPara1": "NDT Inspection Companies operating in Dubai face a specific combination of local market structure, regulator framework, and operator-specific quality requirements that generic ERP systems cannot model. Dubai sits at the heart of the regional commercial and logistics hub for GCC oil and gas, hosting regional HQs for IOCs, EPCs, and inspection multinationals. The dominant industrial cluster — a Jebel Ali free zone industrial hub connected to ADNOC Distribution, ENOC, DUBAL, and northern emirate fabricators — sets the rhythm: winter project peak (Oct–Apr) with major shutdowns scheduled before Ramadan. For ndt inspection companies based here, that means Dubai inspection businesses serve both downstream and northern-emirate fabrication while staffing project mobilisations into KSA, Oman, and Iraq from Dubai HQ.",
  "introPara2": "NDT inspection contractors here manage rotating technician pools, expiring ASNT / ISO 9712 certifications, API code-based inspection intervals, and client-specific report formats — all simultaneously, often in 12-hour shift patterns. Atlantis NDT ERP is configured for the ndt inspection companies business as it actually operates in Dubai: pre-loaded with ADQCC inspection schemes, ADNOC ACS-01 (vendor), ASME Section V / VIII compliance templates; with a procedure-library module built to hold whichever operator-specific flow-down clauses your contracts require — such as those from ADNOC Distribution, ENOC Group, DUBAL / Emirates Global Aluminium, DEWA (Dubai Electricity & Water) — once your team uploads them; and aligned with the regulators that audit your work — ADQCC, MOIAT, ADM, UAE FANR (radiation), Dubai Civil Defence, DEWA HSE. The result: a ndt inspection companies ERP that knows the Dubai market, not a generic accounting system bolted to a spreadsheet of inspection records.",
  "features": [
    "the lower Gulf and northern emirates-aware ndt inspection companies workflow with pre-loaded ADQCC inspection schemes and ADNOC ACS-01 (vendor) compliance templates",
    ...
    "Dubai operator-specific report templates pre-loaded for ADNOC Distribution, ENOC Group, DUBAL / Emirates Global Aluminium",
    "Automated compliance dashboard for ADQCC and  MOIAT statutory inspection requirements"
  ],
  "operators": [
    "ADNOC Distribution",
    "ENOC Group",
  ...
  "useCases": [
    "A 40-technician Dubai-based NDT contractor manages ASNT and ISO 9712 expiries across rotating crews servicing ADNOC Distribution and ENOC Group, replacing six spreadsheets with a single live dashboard.",
    "An inspection startup in Dubai wins DUBAL / Emirates Global Aluminium approved-vendor status after demonstrating audit-ready ADQCC inspection schemes compliance in 30 days — historically a 9-month onboarding cycle.",
    "A multi-site inspection firm consolidates Dubai branch data with regional offices and produces a unified corrosion-rate dashboard across all the lower Gulf and northern emirates assets.",
    "A growing Dubai inspection company integrates Atlantis NDT ERP with their accounting and CMMS — eliminating duplicate data entry and accelerating customer-report turnaround from 5 days to under 24 hours."
  ],
  "faqs": [
    [
      "Is Atlantis NDT ERP configured for ndt inspection companies operating in Dubai?",
      "Yes. The platform is pre-loaded with the codes and operator flow-downs that ndt inspection companies in Dubai actually work with: ADQCC inspection schemes, ADNOC ACS-01 (vendor), ASME Section V / VIII, API 510 / 570 / 653. The procedure-library module also holds whichever operator-specific quality clauses your contracts require — such as those from ADNOC Distribution, ENOC Group, DUBAL / Emirates Global Aluminium, DEWA (Dubai Electricity & Water) — once your team uploads them. Configuration is done — your team is productive on day one, not after six months of customisation."
    ],
    [
      "Which Dubai regulators and authorities does the system align with?",
      "The compliance dashboard maps to ADQCC, MOIAT, ADM, UAE FANR (radiation), Dubai Civil Defence, DEWA HSE. Statutory inspection-interval calculation, document-format generation, and audit-ready evidence-pack assembly are all built around these authorities. For ndt inspection companies, that means Dubai inspection businesses serve both downstream and northern-emirate fabrication while staffing project mobilisations into KSA, Oman, and Iraq from Dubai HQ."
    ],
    [
      "Can ndt inspection companies in Dubai integrate with operator-specific portals such as ENOC?",
...
export default function ErpIndCity_ndt_inspection_companies_dubai() { return <ErpIndustryCityPage {...data} />; }
