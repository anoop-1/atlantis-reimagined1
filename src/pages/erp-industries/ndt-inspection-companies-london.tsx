...
const data: ErpIndustryCityProps = {
  ...
  "features": [
    ...
    "London operator-specific report templates pre-loaded for BP (corporate), Shell (corporate + Stanlow legacy), TotalEnergies UK",
    "Automated compliance dashboard for HSE and  ONR (nuclear) statutory inspection requirements"
  ],
  "operators": [
    "BP (corporate)",
  ...
  "faqs": [
    [
      "Is Atlantis NDT ERP configured for ndt inspection companies operating in London?",
      "Yes. The platform is pre-loaded with the codes and operator flow-downs that ndt inspection companies in London actually work with: PSSR 2000 (pressure systems safety), PUWER 1998, LOLER 1998 (lifting), PCN GEN / IS / ECN schemes (BINDT). The procedure-library module also holds whichever operator-specific quality clauses your contracts require — such as those from BP (corporate), Shell (corporate + Stanlow legacy), TotalEnergies UK, EDF Energy (nuclear) — once your team uploads them. Configuration is done — your team is productive on day one, not after six months of customisation."
    ],
    [
      "Which London regulators and authorities does the system align with?",
      "The compliance dashboard maps to HSE, ONR (nuclear), BINDT, CAA / EASA, MCA, Rail Safety & Standards Board (RSSB), Environment Agency. Statutory inspection-interval calculation, document-format generation, and audit-ready evidence-pack assembly are all built around these authorities. For ndt inspection companies, that means London inspection businesses run multi-sector portfolios — a single firm may serve UKCS offshore, EDF nuclear, Rolls-Royce aerospace, and Network Rail simultaneously."
    ],
    [
      "Can ndt inspection companies in London integrate with operator-specific portals such as EDF Energy?",
...
export default function ErpIndCity_ndt_inspection_companies_london() { return <ErpIndustryCityPage {...data} />; }
