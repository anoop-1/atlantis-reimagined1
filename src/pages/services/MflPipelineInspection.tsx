...
const faqs = [
    ...
    { question: "What does MFL pipeline inspection cost?", answer: "Typical 2026 ranges: $8,000–$25,000 per mile for a standard MFL run on 12\"–24\" lines; $18,000–$45,000 per mile for high-resolution MFL + TFI combos with full integrity-management deliverables. Mobilisation, cleaning runs, sour-service rigging, and remote launchers add cost. Data analysis and dig-sheet preparation are often quoted separately at $15K–$80K per project." },
