...
const compareRows = [
    { factor: "Connection method", atlantis: "REST via AspenTech aspenONE Cloud APIs", competitor: "—" },
...
const faqs = [
    ...
    { question: "Total cost when running both?", answer: "For a tier-1 refinery: Aspen Mtell ~$400K–$600K/yr for the rotating-equipment fleet, plus Atlantis enterprise at $200K/yr for fixed-equipment integrity = $600K–$800K/yr combined. The integration itself adds no additional licensing cost. Together the two platforms cover almost the entire integrity workload — rotating + fixed." },
];
...
export default function AspenMtellIntegration() {
    ...
    return (
        <ProductPageLayout
            ...
            ctaTitle="Cover Both Halves of the Integrity Workload"
            ctaSubtitle="If Mtell is on rotating, Atlantis covers fixed. Together you have full integrity coverage. Talk to us."
            ...
            bodyChildren={
                <>
                    ...
                    <ul>
                        <li><strong>Week 1:</strong> aspenONE OAuth2 setup, sandbox connection test, equipment-list export from Mtell.</li>
                        <li><strong>Week 2–3:</strong> Equipment correlation mapping (rotating → fixed asset), validation walkthrough with the integrity and reliability teams.</li>
                        <li><strong>Week 4:</strong> End-to-end event flow test, integration UI walkthrough.</li>
                        <li><strong>Week 5–6:</strong> Production cut-over, monitoring live, hypercare.</li>
                    </ul>
                </>
            }
        />
