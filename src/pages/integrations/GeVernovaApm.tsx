...
const compareRows = [
    { factor: "Connection method", atlantis: "REST + Family Manager APIs", competitor: "GE Vernova APM exposes REST APIs over OAuth2; legacy SOAP available" },
...
export default function GeVernovaApmIntegration() {
    ...
    return (
        <ProductPageLayout
            ...
            faqs={faqs}
            related={[
                { href: "/integrations/meridium-apm", title: "Meridium APM Integration", blurb: "Legacy / pre-Vernova naming — same integration." },
                { href: "/compare/atlantis-dt-vs-ge-predix", title: "vs GE Predix / APM (Comparison)", blurb: "When to use each, when to migrate." },
                { href: "/integrations/aspen-mtell", title: "Aspen Mtell Integration", blurb: "Rotating-equipment ML coverage." },
                { href: "/digital-twins/wind-farm", title: "Digital Twin for Wind Farms", blurb: "Strategic Vernova focus area — blade inspection workflow native." },
            ...
            ctaTitle="Plug Atlantis Into Your GE Vernova APM"
            ctaSubtitle="Bring your APM org and a sample asset Family export. We&rsquo;ll show the integration in 30 minutes."
