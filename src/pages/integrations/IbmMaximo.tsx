...
export default function IbmMaximoIntegration() {
    ...
    return (
        <ProductPageLayout
            title="Atlantis Digital Twin — IBM Maximo Integration: REST/OSLC, MAS, Health [2026]"
            description="IBM Maximo + MAS integration for Atlantis Digital Twin: REST + OSLC, bi-directional asset master, inspection findings → Service Requests → Work Orders. 3-4 weeks to production."
            ...
            ctaTitle="Plug Atlantis Into Your Maximo"
            ctaSubtitle="Bring your Maximo org and a sample asset export. We&rsquo;ll show the integration in 30 minutes."
            ...
            bodyChildren={
                <>
                    ...
                    <ul>
                        <li><strong>Week 1:</strong> Maximo admin kickoff, integration user provisioning, sandbox connection test, asset schema review.</li>
                        <li><strong>Week 2:</strong> Initial asset hierarchy import, mapping validation, Service Request create test.</li>
                        <li><strong>Week 3:</strong> User acceptance testing with the integrity team, edge case validation, training.</li>
                        <li><strong>Week 4:</strong> Production cut-over, monitoring dashboards live, hypercare.</li>
                    </ul>
