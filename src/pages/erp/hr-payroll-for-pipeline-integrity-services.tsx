...
export default function HrPayrollForPipelineIntegrityServices() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP HR & Payroll for pipeline integrity firms — DOT drug-and-alcohol, Davis-Bacon prevailing wage, OQ / ASNT / NACE / API 1169 certification-linked payroll, multi-state withholding for FIFO crews. Quote on request."
