...
export default function HrPayrollForPipelineIntegrityServices() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP HR & Payroll for pipeline integrity firms — DOT drug-and-alcohol, Davis-Bacon prevailing wage, OQ / ASNT / NACE / API 1169 certification-linked payroll, multi-state withholding for FIFO crews. Flat regional pricing."
      heroBody="Atlantis NDT ERP HR & Payroll configured for pipeline integrity service contractors — DOT (US Department of Transportation) drug-and-alcohol testing per 49 CFR Part 40 / 199 / 382, Davis-Bacon Act prevailing-wage compliance for federally-funded pipeline projects, certification-linked payroll (OQ / ASNT / NACE / API 1169 endorsement-driven pay differentials), multi-state withholding for FIFO crews, and IFRS-aligned multi-currency payroll. Part of the all-apps-included subscription."
      whatItIs={[
