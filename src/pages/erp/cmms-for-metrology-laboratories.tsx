...
export default function CmmsForMetrologyLaboratories() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP CMMS for metrology laboratories — ISO/IEC 17025:2017 + ISO 10012 measurement management, primary-standard upkeep, environmental-chamber control, master-artifact inter-comparison, recurring re-cal scheduling. Quote on request."
