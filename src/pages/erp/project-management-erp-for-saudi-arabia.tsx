...
export default function ProjectManagementErpForSaudiArabia() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Project Management for Saudi Arabia — Aramco turnaround scheduling, SAEP-1112 inspector mobilization, Vision 2030 mega-project tagging, bilingual Arabic/English. Flat $18,000/yr (SAR 67,500)."
