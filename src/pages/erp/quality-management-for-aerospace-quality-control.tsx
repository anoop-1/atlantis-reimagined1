...
export default function QualityManagementForAerospaceQualityControl() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP QMS for aerospace quality control — AS9100 Rev D, AS9101 audit requirements, AS9102 FAI, AS9131 nonconformance, AS9145 APQP, NADCAP MAUP. Quote on request."
