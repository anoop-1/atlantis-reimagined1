...
export default function QualityManagementForAerospaceQualityControl() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP QMS for aerospace quality control — AS9100 Rev D, AS9101 audit requirements, AS9102 FAI, AS9131 nonconformance, AS9145 APQP, NADCAP MAUP. Flat $18,000/yr."
      heroBody="Atlantis NDT ERP Quality Management for aerospace quality control firms — AS9100 Rev D / EN 9100 / SJAC 9100 quality management system, AS9101 audit requirements, AS9102 First Article Inspection, AS9131 nonconformance documentation, AS9145 APQP/PPAP, NADCAP MAUP audit cycle, FAA Part 145 / EASA Part-145 repair-station record retention. Part of the all-apps-included $18,000 / year subscription."
      whatItIs={[
