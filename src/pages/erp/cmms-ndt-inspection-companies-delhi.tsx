...
const data: ErpTripleCrossProps = {
  ...
  "faqs": [
    ...
    ["What does CMMS cost for an NDT inspection company in Delhi?", "CMMS is bundled inside the standard affordable, accessible (contact us; approximately INR 15 lakh) Atlantis NDT ERP subscription. Invoicing is supported in INR or USD with daily FX update."],
