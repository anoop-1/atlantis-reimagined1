  ...
  return (
    <ErpIndustryAppPage
      ...
      faqs={[
        ...
        { question: "What does the ERP cost?", answer: "Pricing varies by region and team size — request a tailored quote at info@atlantisndt.com. The platform is affordable, transparent SaaS that includes hosting, all 35+ Odoo apps, mobile apps, training and support. Implementation services are quoted based on scope." },
