...
export default function InventoryManagementErpForIndia() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Inventory Management for India — multi-warehouse IOCL/HPCL/BPCL/Reliance-aligned stock, AERB radioactive-source tracking, GST e-invoice IRN, bilingual English/Hindi. Flat $18,000/yr (₹15.0 lakh)."
      ...
      faqs={[
        ...
        { question: "What is the INR pricing?", answer: "Flat ₹15,00,000 (₹15 lakh) per year at the prevailing USD = 83 INR exchange rate. The fee includes hosting, all 35+ Odoo apps, mobile apps, training and support. Implementation services are typically quoted ₹4-15 lakh depending on scope." },
