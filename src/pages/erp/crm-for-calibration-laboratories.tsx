...
export default function CrmForCalibrationLaboratories() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP CRM for calibration laboratories — ISO/IEC 17025:2017 scope-of-accreditation routing, ILAC MRA cross-border traceability, NIST/NPL/PTB/NIM/NMIJ artifact lineage. Manage cal-due, on-site visits and asset-fleet relationships. Flat $18,000/yr."
      heroBody="Atlantis NDT ERP CRM tuned for ISO/IEC 17025 calibration laboratories — scope-of-accreditation-driven opportunity routing, ILAC MRA mutual-recognition awareness, NIST/NPL/PTB/NIM/NMIJ primary-standard traceability tracking, and asset-fleet relationship management for industrial clients with hundreds or thousands of calibrated instruments. Part of the all-apps-included $18,000 / year subscription."
      whatItIs={[
