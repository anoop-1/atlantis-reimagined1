...
export default function CrmForCalibrationLaboratories() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP CRM for calibration laboratories — ISO/IEC 17025:2017 scope-of-accreditation routing, ILAC MRA cross-border traceability, NIST/NPL/PTB/NIM/NMIJ artifact lineage. Manage cal-due, on-site visits and asset-fleet relationships. Quote on request."
