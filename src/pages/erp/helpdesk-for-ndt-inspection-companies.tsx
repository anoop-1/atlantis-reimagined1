...
export default function HelpdeskForNdtInspectionCompanies() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Helpdesk for NDT inspection companies — customer report-dispute resolution, NDE method support tickets, instrument-failure escalation, ISO 17020 complaint handling per §7.6, multi-customer SLA tracking. Quote on request."
