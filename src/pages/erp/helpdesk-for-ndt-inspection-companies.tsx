...
export default function HelpdeskForNdtInspectionCompanies() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Helpdesk for NDT inspection companies — customer report-dispute resolution, NDE method support tickets, instrument-failure escalation, ISO 17020 complaint handling per §7.6, multi-customer SLA tracking. Flat $18,000/yr."
      heroBody="Atlantis NDT ERP Helpdesk configured for NDT inspection companies — customer report-dispute resolution workflow, NDE method-specific support ticketing (UT, RT, MT, PT, ET, VT, AUT, PAUT, ToFD, ECT), instrument-failure escalation to OEM (Olympus, Sonatest, GE, Eddyfi, Magnaflux), ISO/IEC 17020 §7.6 complaint handling, ISO/IEC 17025 §7.9 complaint handling, and multi-customer SLA tracking with response-time and resolution-time metrics. Part of the all-apps-included $18,000 / year subscription."
      whatItIs={[
