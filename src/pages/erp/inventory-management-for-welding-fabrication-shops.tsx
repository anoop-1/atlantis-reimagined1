...
export default function InventoryManagementForWeldingFabricationShops() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Inventory Management for weld and fab shops — AWS A5 consumable lot tracking, ASTM/ASME material heat traceability, low-hydrogen electrode storage, shielding-gas cylinder management. Flat regional pricing."
