...
const data: ErpTripleCrossProps = {
  ...
  "lat": 51.0447,
  "lng": -114.0719,
  "title": "Asset Integrity & Equipment Register Software for Pipeline Integrity & ILI Services in Calgary",
  "desc": "Asset Integrity & Equipment Register ERP module for pipeline integrity service providers in Calgary, Canada. Aligned to API 510 / 570 / 653 / 571 / 580 / 581 plus ASME FFS-1 / API 579-1, with operator flow-down for Suncor Energy and Cenovus Energy and ABSA / AER compliance support. Demo: info@atlantisndt.com.",
  "introPara1": "Pipeline Integrity & ILI Services operating in Calgary, Canada face a specific combination of local market structure, regulator framework, and operator quality flow-down that generic ERP systems cannot model — and that combination shapes how asset integrity register actually has to work on the ground. Calgary sits at the heart of the head-office hub for Canadian oil sands, conventional petroleum, and trans-continental pipelines. The dominant industrial cluster — oil sands near Fort McMurray, conventional gas in Alberta / BC, plus Enbridge / TC Energy long-haul networks — sets the rhythm: extreme-cold field work, ABSA registration, and rotational FIFO crews to remote sites.",
  "introPara2": "pipeline integrity service providers aggregate ILI vendor data (MFL, UT, EMAT, caliper), dig verification campaigns, RBI assessments per API 581, and statutory submissions per API 1163 / 1160 across long-haul transmission networks. For a pipeline integrity service provider supporting 800+ km of operator network in Calgary, asset integrity register is not a back-office activity — it is the operational spine that determines audit outcomes, contract eligibility, and project margin. a missed API 1163 vendor-qualification deliverable invalidates the ILI run that paid for the campaign. Atlantis NDT ERP's asset integrity & equipment register module maintains the pressure vessel, piping circuit, storage tank, heat exchanger, pipeline, and rotating equipment register that anchors the integrity program, aligned to API 510 / 570 / 653 / 571 / 580 / 581 plus ASME FFS-1 / API 579-1. For pipeline integrity & ili services based in Calgary, that means a single live system of record that knows the market, not a generic accounting tool bolted to a spreadsheet of inspection records.",
  "introPara3": "Configured for Calgary, the module pre-loads operator flow-down clauses from Suncor Energy, Cenovus Energy, CNRL, Imperial Oil, compliance templates against ABSA AB-506 / AB-512, CSA Z662, CSA B51, AER Directive 056 / 077, and the audit frameworks that ABSA, AER, CER actually use. Field-data capture is offline-capable for Calgary project sites, multi-language reporting supports Canada-required document formats, and the platform is delivered as multi-tenant SaaS with regional data residency — a 5-person Calgary pipeline integrity service provider and a 200-person multinational both run on the same configuration baseline.",
  "features": [
  ...
  "painPoints": [
    "Asset integrity register for pipeline integrity service providers in Calgary tracked in spreadsheets — always behind operator-portal updates from Suncor Energy and Cenovus Energy",
    ...
    "Operator flow-down from Suncor Energy updates monthly — internal asset integrity register procedures lag by weeks, putting pipeline integrity & ili services contracts at risk",
  ...
  "faqs": [
    [
      "Is Asset Integrity & Equipment Register configured for pipeline integrity & ili services operating in Calgary?",
      "Yes. The asset integrity & equipment register module is pre-loaded with the codes and operator flow-downs that pipeline integrity & ili services in Calgary work with daily: ABSA AB-506 / AB-512, CSA Z662, CSA B51, AER Directive 056 / 077, plus operator-specific quality clauses from Suncor Energy, Cenovus Energy, CNRL, Imperial Oil. The module is aligned to API 510 / 570 / 653 / 571 / 580 / 581 plus ASME FFS-1 / API 579-1. Configuration is done — your pipeline integrity service provider team is productive on day one, not after six months of customisation."
    ],
    [
    ...
    [
      ...
      "Yes. The platform supports vendor-portal flow with major Canada operators including Suncor Energy, Cenovus Energy, CNRL, Imperial Oil. Operator-specific quality clauses are imported as controlled documents; internal asset integrity register procedures that implement those clauses are cross-referenced; revision changes flag affected internal documents for review. Where vendor portals expose APIs, bi-directional sync keeps customer and internal records aligned."
    ],
    [
...
export default function ErpTriple_asset_management_pipeline_integrity_services_calgary() { return <ErpTripleCrossPage {...data} />; }
