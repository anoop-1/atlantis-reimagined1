...
export default function ProjectManagementForAerospaceQualityControl() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Project Management for aerospace QA — AS9100D project gates, NADCAP MAUP-cycle aware planning, NAS 410 Rev 5 currency-driven assignment, OEM written-practice routing for Boeing / Airbus / GE / P&W / RR / Safran. Flat regional pricing."
      heroBody="Atlantis NDT ERP Project Management for aerospace quality control companies — AS9100 Rev D project-gate workflows, NADCAP MAUP-cycle aware project planning, NAS 410 Rev 5 personnel-currency-driven task assignment, customer written-practice routing (Boeing, Airbus, Embraer, Lockheed, Northrop, GE Aviation, P&W, Rolls-Royce, Safran), and FAI / PFR / NCR workflow integration. Part of the all-apps-included subscription."
      whatItIs={[
