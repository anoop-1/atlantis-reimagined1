...
export default function DocumentControlForAerospaceQualityControl() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Document Control for aerospace QA — AS9100 §7.5 documented information, FAA Part 145 §145.219 records, EASA Part-145 record retention, OEM written-practice version control, NADCAP evidence-pack lifecycle. Flat $18,000/yr."
      heroBody="Atlantis NDT ERP Document Control for aerospace QA firms — AS9100 Rev D §7.5 documented information, FAA Part 145 §145.219 record retention, EASA Part-145 record retention, customer written-practice version control (Boeing BSS, Airbus AITM, GE/CFM, P&W PWA-MCL, RR MTSP), and NADCAP MAUP evidence-pack lifecycle management. Part of the all-apps-included $18,000 / year subscription."
      whatItIs={[
