...
export default function DocumentControlForAerospaceQualityControl() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Document Control for aerospace QA — AS9100 §7.5 documented information, FAA Part 145 §145.219 records, EASA Part-145 record retention, OEM written-practice version control, NADCAP evidence-pack lifecycle. Quote on request."
