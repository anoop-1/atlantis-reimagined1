...
const data: ErpTripleCrossProps = {
  ...
  "faqs": [
    ...
    ["What does Inventory cost for an NDT inspection company in Hyderabad?", "Inventory is bundled inside the standard regionally priced (contact us; approximately INR 15 lakh) Atlantis NDT ERP subscription. Invoicing is supported in INR or USD with daily FX update."],
