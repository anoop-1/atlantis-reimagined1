...
const data: ErpTripleCrossProps = {
  ...
  "faqs": [
    ...
    ["What does Accounting cost for an NDT inspection company in Chennai?", "Accounting is bundled inside the standard $18,000 / year (approximately INR 15 lakh) Atlantis NDT ERP subscription. Invoicing is supported in INR or USD with daily FX update."],
