...
const data: ErpTripleCrossProps = {
  ...
  "introPara3": "Configured for Chennai, the module pre-loads operator flow-down from CPCL Manali, ONGC, Hyundai India, BMW India, BARC Kalpakkam, compliance templates against API 510/570/653, IBR / IS 2825, AERB SC/IR-1, DGCA CAR Section 2, automotive customer Q/A systems (Hyundai Quality, BMW Production System), and the audit frameworks that PESO, BARC, AERB, DGCA, TNPCB actually use. Bilingual Tamil / English document handling is built-in.",
  "features": [
