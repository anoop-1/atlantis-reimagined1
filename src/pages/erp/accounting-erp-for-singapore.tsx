...
export default function AccountingErpForSingapore() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Accounting for Singapore — IMDA InvoiceNow PEPPOL e-invoicing, GST 9%, SFRS chart of accounts, CPF / SDL / FWL auto-calc, IRAS e-filing. Flat $18,000/yr (S$24,300)."
      ...
      faqs={[
        ...
        { question: "What is the S$ pricing?", answer: "Flat S$24,300 per year. The fee includes hosting, all 35+ Odoo apps, mobile apps, training and support. Implementation services are typically quoted S$22,000-65,000 depending on scope." },
