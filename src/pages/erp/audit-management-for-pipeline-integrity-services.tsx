...
export default function AuditManagementForPipelineIntegrityServices() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Audit Management for pipeline integrity firms — PHMSA Integrated Inspection Tool (IIT), CER Condition 9 audit, API Q1 / Q2 audits, operator-driven supplier audits (Enbridge, Kinder Morgan, TC Energy). Flat $18,000/yr."
      heroBody="Atlantis NDT ERP Audit Management for pipeline integrity firms — PHMSA Integrated Inspection Tool (IIT) audit cycles, CER Condition 9 audit cycles, API Q1 / Q2 audit calendars, operator-driven supplier audits (Enbridge, Kinder Morgan, TC Energy, Pembina, Williams), and API 1163 ILI conformity assessments. Part of the all-apps-included $18,000 / year subscription."
      whatItIs={[
