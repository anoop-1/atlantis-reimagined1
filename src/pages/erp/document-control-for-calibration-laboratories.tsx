...
export default function DocumentControlForCalibrationLaboratories() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Document Control for ISO/IEC 17025 calibration laboratories — §8.3 control of management system documents, §7.5 technical records, §6.2 personnel records, ISO 10012 measurement procedures. Flat $18,000/yr."
      heroBody="Atlantis NDT ERP Document Control for ISO/IEC 17025:2017 calibration laboratories — §8.3 control of management system documents (Option A), §7.5 technical records, §6.2 personnel records (competence and authorisation), ISO 10012 measurement procedures, and traceability documents (calibration certificates, primary-standard certificates, NMI traceability). Part of the all-apps-included $18,000 / year subscription."
      whatItIs={[
