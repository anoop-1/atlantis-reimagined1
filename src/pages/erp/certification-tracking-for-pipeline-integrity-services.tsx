...
export default function CertificationTrackingForPipelineIntegrityServices() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Certification Tracking for pipeline integrity firms — ASNT Level II/III, API 1169 Pipeline Construction Inspector, API SIFE/SISE, NACE CIP / CP-3, CSWIP 3.x, OQ (Operator Qualification) per ASME B31Q. Flat regional pricing."
