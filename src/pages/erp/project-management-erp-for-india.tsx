...
export default function ProjectManagementErpForIndia() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Project Management for India — IOCL/HPCL/BPCL/Reliance turnaround scheduling, PESO Form XVI/XIV per project, AERB radiography per inspector, bilingual English/Hindi. Flat regional pricing."
