...
export default function ProjectManagementErpForIndia() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Project Management for India — IOCL/HPCL/BPCL/Reliance turnaround scheduling, PESO Form XVI/XIV per project, AERB radiography per inspector, bilingual English/Hindi. Flat $18,000/yr (₹15.0 lakh)."
      heroBody="Atlantis NDT ERP Project Management pre-configured for Indian inspection projects — IOCL / HPCL / BPCL / Reliance / Nayara / ONGC turnaround scheduling, PESO Form XVI/XIV statutory submission per project, AERB radiography licensing per inspector, and bilingual English/Hindi UI. Flat ₹15,00,000 / $18,000 per year."
      whatItIs={[
      ...
      faqs={[
        ...
        { question: "What is the INR pricing?", answer: "Flat ₹15,00,000 (₹15 lakh) per year. The fee includes hosting, all 35+ Odoo apps, mobile apps, training and support. Implementation services are typically quoted ₹4-15 lakh depending on scope." },
