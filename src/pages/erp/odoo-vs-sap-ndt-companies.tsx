  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 text-white">
      <SEOHead
        ...
        description="Honest 2026 comparison: Atlantis NDT ERP (Odoo 18 base, $18K/yr flat) vs SAP S/4HANA Cloud ($900K-$1.32M/yr for 50 users). 20-row capability matrix, 5-year TCO, 7 case studies, implementation timelines."
