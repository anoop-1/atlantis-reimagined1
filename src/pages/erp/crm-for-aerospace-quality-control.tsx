...
export default function CrmForAerospaceQualityControl() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP CRM for aerospace quality control companies — AS9100 / EN 9100 customer-portal flow-down, NADCAP audit-cycle awareness, NAS 410 Rev 5 surveyor matching, Boeing / Airbus / GE / Pratt & Whitney / Safran customer-specific written practices. Flat regional pricing."
      heroBody="Atlantis NDT ERP CRM for aerospace quality control firms — AS9100 / EN 9100 customer-portal opportunity flow, NADCAP MAUP audit-cycle pipeline tracking, NAS 410 Rev 5 personnel-currency-driven opportunity matching, and customer-specific written-practice opportunity routing for Boeing, Airbus, Embraer, Bombardier, Lockheed Martin, Northrop Grumman, GE Aviation, Pratt & Whitney, Rolls-Royce, Safran, Honeywell Aerospace and Collins Aerospace. Part of the all-apps-included subscription."
      whatItIs={[
