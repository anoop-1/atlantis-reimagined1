...
export default function CrmForAerospaceQualityControl() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP CRM for aerospace quality control companies — AS9100 / EN 9100 customer-portal flow-down, NADCAP audit-cycle awareness, NAS 410 Rev 5 surveyor matching, Boeing / Airbus / GE / Pratt & Whitney / Safran customer-specific written practices. Quote on request."
