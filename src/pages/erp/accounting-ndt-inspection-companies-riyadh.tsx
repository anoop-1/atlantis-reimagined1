...
const data: ErpTripleCrossProps = {
  ...
  "faqs": [
    ...
    ["What does Accounting cost for an NDT inspection company in Riyadh?", "Accounting is bundled inside the standard regionally priced (contact us; approximately SAR 67,500) Atlantis NDT ERP subscription. Invoicing is supported in SAR or USD with daily FX update. SACS-002 cybersecurity-aligned data residency is included where required."],
