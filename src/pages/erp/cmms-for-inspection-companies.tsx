...
export default function CmmsForInspectionCompanies() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 text-white">
      <SEOHead
        title="CMMS (Computerized Maintenance Management System) for NDT Companies — regional pricing All Odoo Apps Included | Atlantis NDT"
        description="Atlantis NDT ERP includes CMMS (Computerized Maintenance Management System). Designed for NDT inspection companies and certification labs. regionally priced, fully customizable, ASNT/ISO 9712 ready. Demo: info@atlantisndt.com"
