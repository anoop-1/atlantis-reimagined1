...
export default function CrmForPipelineIntegrityServices() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 text-white">
      <SEOHead
        title="CRM for Pipeline Integrity Services Companies — $18,000/yr All Odoo Apps Included | Atlantis NDT"
        description="Atlantis NDT ERP CRM for pipeline integrity services. HCA segment tracking, ILI vendor management, API 1160/1163/1173 compliance, PHMSA-aligned opportunity pipeline. $18,000/yr flat."
