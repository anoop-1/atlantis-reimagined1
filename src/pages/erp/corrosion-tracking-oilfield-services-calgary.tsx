...
const data: ErpTripleCrossProps = {
  ...
  "desc": "Corrosion Tracking & RBI ERP module for oilfield services contractors in Calgary, Canada. Aligned to API 510 / 570 / 653 / 571 / 580 / 581 corrosion and integrity methodology, with operator flow-down for Suncor Energy and Cenovus Energy and ABSA / AER compliance support. Demo: info@atlantisndt.com.",
  "introPara1": "Oilfield Services & Wellsite Inspection operating in Calgary, Canada face a specific combination of local market structure, regulator framework, and operator quality flow-down that generic ERP systems cannot model — and that combination shapes how corrosion tracking and rbi actually has to work on the ground. Calgary sits at the heart of the head-office hub for Canadian oil sands, conventional petroleum, and trans-continental pipelines. The dominant industrial cluster — oil sands near Fort McMurray, conventional gas in Alberta / BC, plus Enbridge / TC Energy long-haul networks — sets the rhythm: extreme-cold field work, ABSA registration, and rotational FIFO crews to remote sites.",
  "introPara2": "oilfield services and wellsite inspection contractors manage rig and BOP test schedules, OCTG per-joint records, field-ticket capture, and HSE certification renewals (BOSIET / HUET / H2S Alive / IADC RigPass) across rotating crews and remote pads. For a multi-pad oilfield services contractor supporting drilling and completions in Calgary, corrosion tracking and rbi is not a back-office activity — it is the operational spine that determines audit outcomes, contract eligibility, and project margin. a non-qualified technician mobilised to a sour-gas wellsite is a contract-ending event. Atlantis NDT ERP's corrosion tracking & rbi module computes corrosion rates, projects remaining life, screens damage mechanisms, and produces risk-based inspection plans per API 581, aligned to API 510 / 570 / 653 / 571 / 580 / 581 corrosion and integrity methodology. For oilfield services & wellsite inspection based in Calgary, that means a single live system of record that knows the market, not a generic accounting tool bolted to a spreadsheet of inspection records.",
  ...
  "painPoints": [
    "Corrosion tracking and RBI for oilfield services contractors in Calgary tracked in spreadsheets — always behind operator-portal updates from Suncor Energy and Cenovus Energy",
    "ABSA audit preparation for corrosion tracking and rbi workflows takes 80+ hours per cycle and finds gaps too late to remediate",
    "Operator flow-down from Suncor Energy updates monthly — internal corrosion tracking and rbi procedures lag by weeks, putting oilfield services & wellsite inspection contracts at risk",
    "Customer-format corrosion tracking and rbi reports for Suncor Energy, Cenovus Energy, CNRL require manual reformatting on every submission — margin-eating rework"
  ],
  "useCases": [
    "A mid-size Calgary oilfield services contractor deploys corrosion tracking & rbi against Suncor Energy and Cenovus Energy contracts. Within 90 days the team reports a 60–80% reduction in admin time and zero audit findings on the next ABSA surveillance visit.",
    "A Calgary-based multi-pad oilfield services contractor supporting drilling and completions integrates corrosion tracking & rbi with CNRL operator-portal flow-down. Operator specification revisions automatically flag affected internal procedures for review — eliminating the \"we missed a revision\" failure mode that previously cost contracts.",
    "A growing oilfield services contractor in Calgary consolidates corrosion tracking & rbi across oilfield services & wellsite inspection project sites in the Canada market. Customer-format reports flow to Suncor Energy portals automatically and report turnaround drops from 5 days to under 24 hours.",
    "An audit-driven Calgary oilfield services contractor uses corrosion tracking & rbi to pass ABSA and AER cycle audits with zero findings — evidence packages assemble in 30 seconds vs. the 80-hour manual prep that previously dominated audit week."
  ],
  "faqs": [
    [
      "Is Corrosion Tracking & RBI configured for oilfield services & wellsite inspection operating in Calgary?",
      "Yes. The corrosion tracking & rbi module is pre-loaded with the codes and operator flow-downs that oilfield services & wellsite inspection in Calgary work with daily: ABSA AB-506 / AB-512, CSA Z662, CSA B51, AER Directive 056 / 077. The procedure-library module also holds whichever operator-specific quality clauses your contracts require — such as those from Suncor Energy, Cenovus Energy, CNRL, Imperial Oil — once your team uploads them. The module is aligned to API 510 / 570 / 653 / 571 / 580 / 581 corrosion and integrity methodology. Configuration is done — your oilfield services contractor team is productive on day one, not after six months of customisation."
    ],
    [
      "Which Calgary regulators does the corrosion tracking and rbi workflow align with?",
    ...
    [
      ...
      "The document-control module is built to hold and version-control the operator-specific requirements your team works under — for major Canada operators such as Suncor Energy, Cenovus Energy, CNRL, Imperial Oil — as controlled documents; internal corrosion tracking and rbi procedures that implement those clauses are cross-referenced, and revision changes flag affected internal documents for review automatically. We don't claim a live system integration with any specific operator's vendor portal — check with your client for their current submission process."
    ],
    [
