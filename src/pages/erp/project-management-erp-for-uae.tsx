  ...
  return (
    <ErpIndustryAppPage
      ...
      faqs={[
        ...
        { question: "What is the AED pricing?", answer: "Flat AED 66,000 per year. The fee includes hosting, all 35+ Odoo apps, mobile apps, training and support. Implementation services are typically quoted AED 75,000-220,000 depending on scope." },
