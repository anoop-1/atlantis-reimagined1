...
export default function CmmsForOilfieldServices() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP CMMS for oilfield services — API Q1 / API Q2 quality, API Spec 4F (drilling structures), 7K (drilling equipment), 8C (drilling hoisting), 16A (BOP), 16C (choke-and-kill), DS-1 inspection categories. Quote on request."
