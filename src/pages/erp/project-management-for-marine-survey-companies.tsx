...
export default function ProjectManagementForMarineSurveyCompanies() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Project Management for marine survey firms — IACS class-society survey cycles, IMO convention milestones, IACS UR Z10 ESP plans, P&I damage-survey lifecycle, FPSO MIC programs. Quote on request."
