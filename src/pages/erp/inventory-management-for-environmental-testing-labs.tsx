...
export default function InventoryManagementForEnvironmentalTestingLabs() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Inventory Management for environmental labs — EPA SW-846 reagent lot tracking, CRM (Certified Reference Material) expiry, sample-container preservative shelf-life, GC/MS column lifecycle. Flat $18,000/yr."
      heroBody="Atlantis NDT ERP Inventory Management for ISO/IEC 17025 environmental labs — EPA-method reagent lot tracking (SW-846, EPA 500/600/200 series), CRM expiry alerts under ISO 17034, sample-container and preservative shelf-life, GC/MS column and detector consumable lifecycle, and PFAS-specific consumable lifecycle management. Part of the all-apps-included $18,000 / year subscription."
      whatItIs={[
