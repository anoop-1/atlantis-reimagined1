...
export default function InventoryManagementForEnvironmentalTestingLabs() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Inventory Management for environmental labs — EPA SW-846 reagent lot tracking, CRM (Certified Reference Material) expiry, sample-container preservative shelf-life, GC/MS column lifecycle. Quote on request."
