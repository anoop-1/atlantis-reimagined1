...
export default function HrPayrollForWeldingFabricationShops() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP HR & Payroll for welding & fabrication shops — OSHA 1910 / 1926 compliance, piecework / hourly / salaried wage structures, certification-linked pay (AWS / CWB / CWI), apprenticeship tracking, multi-jurisdiction payroll. Quote on request."
