...
export default function HrPayrollForWeldingFabricationShops() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP HR & Payroll for welding & fabrication shops — OSHA 1910 / 1926 compliance, piecework / hourly / salaried wage structures, certification-linked pay (AWS / CWB / CWI), apprenticeship tracking, multi-jurisdiction payroll. Flat $18,000/yr."
      heroBody="Atlantis NDT ERP HR & Payroll configured for welding & fabrication shops — OSHA 29 CFR 1910 (General Industry) / 1926 (Construction) compliance, piecework / hourly / salaried wage structures common in fabrication, certification-linked pay (AWS welder certification differentials, CWB W47.1 certification differentials, AWS CWI premium), apprenticeship program tracking, multi-jurisdiction payroll for cross-border shops. Part of the all-apps-included $18,000 / year subscription."
      whatItIs={[
