...
const data: ErpTripleCrossProps = {
  ...
  "faqs": [
    ...
    ["What does Inventory cost for an NDT inspection company in Riyadh?", "Inventory is bundled inside the standard affordable, accessible (contact us; approximately SAR 67,500) Atlantis NDT ERP subscription. Invoicing is supported in SAR or USD with daily FX update."],
