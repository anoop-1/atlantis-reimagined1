...
const data: ErpTripleCrossProps = {
  ...
  "faqs": [
    ...
    ["What does Inventory cost for an NDT inspection company in Delhi?", "Inventory is bundled inside the standard Atlantis NDT ERP subscription — affordable, accessible and fully customizable, quote on request. Invoicing is supported in INR or USD with daily FX update."],
