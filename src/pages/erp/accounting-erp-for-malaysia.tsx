  ...
  return (
    <ErpIndustryAppPage
      ...
      faqs={[
        ...
        { question: "What is the RM pricing?", answer: "Flat RM 84,000 per year. The fee includes hosting, all 35+ Odoo apps, mobile apps, training and support. Implementation services are typically quoted RM 50,000-180,000 depending on scope." },
