...
export default function ProjectManagementForCalibrationLaboratories() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Project Management for ISO/IEC 17025 cal labs — scope-of-accreditation gates, mobile on-site cal-van campaigns, multi-instrument-fleet projects, NMI ship-out scheduling, ILAC MRA-aware deliverables. Flat $18,000/yr."
      heroBody="Atlantis NDT ERP Project Management for ISO/IEC 17025 calibration laboratories — scope-of-accreditation gates per project, mobile on-site cal-van campaign workflows, multi-instrument-fleet project structures, NMI (NIST/NPL/PTB) ship-out scheduling, and ILAC MRA-aware deliverable routing. Part of the all-apps-included $18,000 / year subscription."
      whatItIs={[
