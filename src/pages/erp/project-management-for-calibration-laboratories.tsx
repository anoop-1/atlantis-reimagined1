...
export default function ProjectManagementForCalibrationLaboratories() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Project Management for ISO/IEC 17025 cal labs — scope-of-accreditation gates, mobile on-site cal-van campaigns, multi-instrument-fleet projects, NMI ship-out scheduling, ILAC MRA-aware deliverables. Quote on request."
