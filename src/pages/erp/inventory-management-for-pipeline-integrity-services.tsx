...
export default function InventoryManagementForPipelineIntegrityServices() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Inventory Management for pipeline integrity firms — ILI tool consumables, NACE-grade coatings, MIC coupon kits, AUT scanner spares, pipe-grade material traceability. Quote on request."
