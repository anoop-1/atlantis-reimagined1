...
export default function QualityManagementForNdtCompanies() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 text-white">
      <SEOHead
        title="Quality Management for NDT Companies — $18,000/yr All Odoo Apps Included | Atlantis NDT"
        description="Atlantis NDT ERP includes Quality Management. Designed for NDT inspection companies and certification labs. $18,000/yr flat, fully customizable, ASNT/ISO 9712 ready. Demo: info@atlantisndt.com"
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 max-w-6xl">
        ...
        <section className="mt-6 mb-16">
          ...
          <p className="text-xl text-slate-300 mb-6 max-w-3xl leading-relaxed">
            Atlantis NDT ERP includes <span className="text-emerald-400 font-semibold">Quality Management</span> — purpose-configured to help quality managers, ISO audit leads, technical authorities and Level III engineers run ISO 9001, ISO 17020 (inspection bodies), ISO 17025 (calibration labs), API Q1, API Q2 and ASNT SNT-TC-1A compliance from a single integrated quality management platform. Part of the all-apps-included $18,000 / year subscription.
          </p>
