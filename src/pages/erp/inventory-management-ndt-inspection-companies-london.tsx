...
const data: ErpTripleCrossProps = {
  ...
  "lat": 51.5074,
  "lng": -0.1278,
  "title": "Inventory Management Software for NDT Inspection Companies in London",
  "desc": "Inventory Management ERP module for NDT inspection companies in London, UK. Aligned to PCN (BINDT) primary, ASNT / ISO 9712 / CSWIP / NACE recognised in parallel, with operator flow-down for BP (St James's Square HQ) and Shell (Shell Centre HQ) and HSE (PSSR 2000) / ONR (Office for Nuclear Regulation) compliance support. Demo: info@atlantisndt.com.",
  "introPara1": "NDT inspection companies operating in London, UK face a specific combination of local market structure, regulator framework, and operator quality flow-down that generic ERP systems cannot model — and that combination shapes how inventory management actually has to work on the ground. London sits at the heart of the European HQ city for the largest oil-and-gas majors and the global hub for inspection-firm multinationals. The dominant industrial cluster — UKCS offshore programmes plus aerospace, nuclear and maritime sectors — sets the rhythm: multi-sector compliance under PSSR, LOLER, ONR and CAA simultaneously.",
  "introPara2": "NDT inspection contractors in London run rotating technician pools across multiple project sites with expiring credentials, client-specific report formats, and code-driven inspection intervals — all simultaneously, often in 12-hour shift patterns. For a mid-size London NDT inspection contractor, inventory management is not a back-office activity — it is the operational spine that determines audit outcomes, contract eligibility, and project margin. A single inventory management gap on the wrong job can cost the contract and damage the relationship with a major operator. Atlantis NDT ERP's Inventory Management module is purpose-configured for the codes, operators and regulators that matter in London — not a generic accounting tool bolted to a spreadsheet of inspection records. The module helps inspection businesses in London track every UT probe, RT source, MT yoke, calibration block and consumable across project sites, while staying audit-ready against HSE (PSSR 2000) and ONR (Office for Nuclear Regulation) surveillance cycles at all times.",
  ...
  "features": [
    "Inventory Management module configured for the London inspection-services market — operator flow-down, regulator framework and method library all pre-loaded",
  ...
  "painPoints": [
    "Inventory Management for NDT inspection companies in London tracked in spreadsheets — always behind operator-portal updates from BP (St James's Square HQ) and Shell (Shell Centre HQ)",
    "HSE (PSSR 2000) audit preparation for inventory management workflows takes 80+ hours per cycle and finds gaps too late to remediate",
    "Operator flow-down from BP (St James's Square HQ) updates monthly — internal inventory management procedures lag by weeks, putting NDT inspection company contracts at risk",
  ...
  "faqs": [
    [
      "Is Inventory Management configured for NDT inspection companies operating in London?",
      "Yes. The Inventory Management module is pre-loaded with the codes and operator flow-downs that NDT inspection companies in London work with daily: PSSR 2000, LOLER, ASME B31.3, API 510 / 570 / 653, BS EN 13445, NORSOK reference where UK-Norway joint scope. The procedure-library module also holds whichever operator-specific quality clauses your contracts require — such as those from BP (St James's Square HQ), Shell (Shell Centre HQ), TotalEnergies (London office), Wood (London hub) — once your team uploads them. The module is aligned to PCN (BINDT) primary, ASNT / ISO 9712 / CSWIP / NACE recognised in parallel. Configuration is done — your NDT inspection company team is productive on day one, not after six months of customisation."
    ],
    [
      "Which London regulators does Inventory Management align with?",
    ...
    [
      "Can NDT inspection companies in London integrate Inventory Management with operator-specific portals such as BP (St James's Square HQ)?",
      "The document-control module is built to hold and version-control the operator-specific requirements your team works under — for major UK operators such as BP (St James's Square HQ), Shell (Shell Centre HQ), TotalEnergies (London office), Wood (London hub) — as controlled documents; internal inventory management procedures that implement those clauses are cross-referenced, and revision changes flag affected internal documents for review automatically. We don't claim a live system integration with any specific operator's vendor portal — check with your client for their current submission process."
    ],
    [
      "What does Inventory Management cost for an NDT inspection company in London?",
...
export default function ErpTriple_inventory_management_ndt_inspection_companies_london() { return <ErpTripleCrossPage {...data} />; }
