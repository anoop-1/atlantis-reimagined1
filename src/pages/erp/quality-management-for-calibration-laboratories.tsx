...
export default function QualityManagementForCalibrationLaboratories() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP QMS for ISO/IEC 17025 calibration laboratories — §4 to §8 structural compliance, ISO 10012 measurement-management system, ILAC G8 conformity-statement framework, PT/ILC participation records. Quote on request."
