...
export default function AuditManagementForMetrologyLaboratories() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Audit Management for metrology laboratories. ISO/IEC 17025:2017 internal/external audit workflow, NABL/A2LA/ANAB/UKAS surveillance, proficiency testing tracking, CIPM-aligned evidence packs. $18,000/yr flat."
