...
const FAQS: { question: string; answer: string }[] = [
  {
    "question": "What is included with Inventory Management in Atlantis NDT ERP?",
    "answer": "Inventory Management for NDT Companies is bundled inside the standard Atlantis NDT ERP subscription — there is no additional licence fee. Every customer gets the full Odoo 18-based ERP suite (35+ apps including Inventory Management) pre-configured for NDT and inspection-company workflows. We do not nickel-and-dime by module. The annual fee covers hosting on Atlantis cloud infrastructure, quarterly upgrades, knowledge-base access, and email / SMS support."
  },
  {
    "question": "How is Inventory Management configured for NDT inspection companies specifically?",
    "answer": "Generic ERPs treat Inventory Management as a one-size-fits-all module. Atlantis NDT ERP layers NDT-specific pre-configuration on top: NDT-method libraries (UT, RT, MT, PT, PAUT, TOFD, ECA, LRUT, IRIS, MFL), certification-scheme tracking (ASNT SNT-TC-1A, ISO 9712, PCN, CSWIP, NACE, AWS CWI), API code intervals (510, 570, 653, 1163), and client-specific compliance templates (Aramco SAEP-1112, ADNOC AIM Standard, QatarEnergy NFPS, ABSA Alberta, OSHA PSM, HSE PSSR, PESO IBR, NORSOK). You start productive on day one, not after six months of customisation."
  },
  {
    "question": "Can Inventory Management integrate with our existing systems (SAP, Maximo, etc.)?",
  ...
  {
    "question": "What does implementation look like for Inventory Management?",
...
export default function InventoryManagementForNdtCompanies() {
  const [openIdx, setOpenIdx] = useState<number | null>(0);
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 text-white">
      <SEOHead
        title="Inventory Management for NDT Companies — Fully Customizable, All 30+ Odoo Apps Included | Atlantis NDT"
        description="Atlantis NDT ERP includes Inventory Management. Designed for NDT inspection companies and certification labs. Affordable, accessible, fully customizable, ASNT/ISO 9712 ready. Demo: info@atlantisndt.com"
        canonical="/erp/inventory-management-for-ndt-companies"
        faq={FAQS}
      />
      <Navigation />
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 max-w-6xl">
        <Breadcrumbs items={[{ label: "Home", href: "/" }, { label: "ERP", href: "/erp" }, { label: "Inventory Management for NDT Companies" }]} />
        ...
        <section className="mt-6 mb-16">
          ...
          <p className="text-xl text-slate-300 mb-6 max-w-3xl leading-relaxed">
            Atlantis NDT ERP includes <span className="text-emerald-400 font-semibold">Inventory Management</span> — purpose-configured to help equipment managers, asset coordinators, project supervisors and inspection-firm owners track every UT probe, RT source, MT yoke, calibration block, couplant drum and consumable across multiple project sites — with full traceability for audits and zero stockout surprises. Part of the all-apps-included subscription.
          </p>
          ...
          <div className="flex flex-wrap gap-3">
            <a href="mailto:info@atlantisndt.com?subject=Demo%20request%3A%20Inventory%20Management%20for%20NDT%20Companies"
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-5">What is Inventory Management inside Atlantis NDT ERP?</h2>
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-slate-300 leading-relaxed">
              Inventory Management inside Atlantis NDT ERP is the same battle-tested Odoo 18 Inventory Management app you would get from a generic Odoo deployment — but pre-configured, pre-loaded and pre-integrated for NDT and inspection businesses. We have spent thousands of hours configuring Odoo's inventory management capabilities specifically for equipment managers, asset coordinators, project supervisors and inspection-firm owners at NDT inspection contractors, calibration laboratories, pipeline integrity service providers, asset-integrity consultancies, aerospace quality-control labs, and corrosion engineering firms. The result is a system that helps you track every UT probe, RT source, MT yoke, calibration block, couplant drum and consumable across multiple project sites — with full traceability for audits and zero stockout surprises — from day one, not after a six-month consulting engagement.
            </p>
            <p className="text-slate-300 leading-relaxed mt-4">
              Critically, Inventory Management is not a stand-alone bolt-on. It lives inside the same Odoo 18 database as your CRM, accounting, inventory, project management, HR, certification tracking and inspection-report generator. That means single source of truth for every contact, every project, every technician, every invoice and every inspection record. No more spreadsheets bridging "the BD tool" and "the operations tool" and "the accounting tool". One system, configured for NDT.
            </p>
            <p className="text-slate-300 leading-relaxed mt-4">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-5">How NDT inspection companies use Inventory Management</h2>
          <div className="grid md:grid-cols-1 gap-4">
              <div className="bg-slate-800/40 border border-slate-700 rounded-lg p-5"><p className="text-sm uppercase tracking-wider text-blue-400 mb-2">Use Case 1</p><p className="text-slate-200 leading-relaxed">A Singapore inspection contractor on Jurong Island recovers an estimated SGD 180K of "lost" probe inventory in the first 6 months — half had been left in client lockers and forgotten.</p></div>
              <div className="bg-slate-800/40 border border-slate-700 rounded-lg p-5"><p className="text-sm uppercase tracking-wider text-blue-400 mb-2">Use Case 2</p><p className="text-slate-200 leading-relaxed">A Saudi RCJY-tier inspection firm tracks 240 NDT instruments across Jubail, Yanbu, Khobar and Dammam project sites; calibration audits that used to take 5 days now generate evidence packs in 30 minutes.</p></div>
              <div className="bg-slate-800/40 border border-slate-700 rounded-lg p-5"><p className="text-sm uppercase tracking-wider text-blue-400 mb-2">Use Case 3</p><p className="text-slate-200 leading-relaxed">A Mumbai NDT firm running PESO-regulated radiographic sources cuts AERB compliance overhead by 70% with automated quarterly leak-test reminders and digital licence record retention.</p></div>
          </div>
        </section>

        {/* ─── KEY FEATURES ─────────────────────────────────── */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-5">Key features for equipment managers, asset coordinators, project supervisors and inspection-firm owners</h2>
          <ul className="grid md:grid-cols-2 gap-x-8 gap-y-3 text-slate-200">
              <li className="flex items-start gap-2"><CheckCircle className="w-5 h-5 text-emerald-400 flex-shrink-0 mt-0.5" /><span>Per-asset traceability with serial number, manufacturer, purchase date, calibration record and current location</span></li>
              ...
              <li className="flex items-start gap-2"><CheckCircle className="w-5 h-5 text-emerald-400 flex-shrink-0 mt-0.5" /><span>Bonded inventory for customs-controlled assets crossing UAE / Saudi / Oman borders</span></li>
              <li className="flex items-start gap-2"><CheckCircle className="w-5 h-5 text-emerald-400 flex-shrink-0 mt-0.5" /><span>Procurement integration — low stock auto-creates draft purchase order to approved vendor</span></li>
          </ul>
        </section>
        ...
        <section className="mb-16">
          ...
          <p className="text-slate-300 mb-4 max-w-3xl">Atlantis NDT ERP plays nicely with the systems your refinery, EPC, fabrication-shop and operator clients already use. Out-of-the-box integrations for Inventory Management:</p>
          <ul className="grid md:grid-cols-2 gap-x-8 gap-y-3 text-slate-200">
        ...
        <section className="mb-16">
          <div className="bg-gradient-to-br from-blue-900/40 to-purple-900/40 border border-blue-500/30 rounded-2xl p-8 text-center">
            <h2 className="text-3xl font-bold mb-3">Ready to see Inventory Management in action?</h2>
            <p className="text-slate-200 mb-6 max-w-2xl mx-auto">Book a 30-minute demo with the Atlantis NDT team. We will walk you through Inventory Management configured for your specific inspection workflow, discuss data-migration scope, and quote your implementation timeline.</p>
            <a href="mailto:info@atlantisndt.com?subject=Demo%20request%3A%20Inventory%20Management%20for%20NDT%20Companies"
