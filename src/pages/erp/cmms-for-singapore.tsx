...
export default function CmmsForSingapore() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP CMMS for Singapore — MOM CERT NDT certification, NEA RPNS radiography, SAC-SINGLAS accreditation, BCA-graded contractor, InvoiceNow PEPPOL. Flat $18,000/yr (S$24,300)."
