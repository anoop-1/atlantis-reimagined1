...
export default function QualityManagementForPipelineIntegrityServices() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Quality Management for pipeline integrity firms — API 1173 Pipeline SMS, ISO 9001:2015 QMS, API Q1 Spec quality systems, PHMSA / CER auditable workflows, ILI verification dig records. Flat $18,000/yr."
