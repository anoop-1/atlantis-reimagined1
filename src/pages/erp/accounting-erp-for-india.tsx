...
export default function AccountingErpForIndia() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Accounting for India — GST e-invoice IRN via NIC IRP, TDS / TCS / PF / ESI / PT, Ind AS / Indian GAAP chart of accounts, MCA XBRL filing, bilingual English/Hindi. Flat $18,000/yr (₹15.0 lakh)."
