...
export default function CrmForEnvironmentalTestingLabs() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP CRM for environmental testing labs — ISO/IEC 17025:2017, NELAP / TNI, DoD ELAP, EPA SW-846, ASTM methods, multi-matrix sample-stream pipelines, chain-of-custody-aware opportunity tracking. Flat $18,000/yr."
      heroBody="Atlantis NDT ERP CRM for environmental testing laboratories — ISO/IEC 17025:2017 + NELAP / TNI + DoD ELAP + state-level certifications, EPA method-driven opportunity routing (SW-846, EPA 600, EPA 500, EPA 200, EPA Drinking Water Methods), ASTM methods, and chain-of-custody-aware multi-matrix sample pipelines (drinking water, wastewater, soil, sediment, air, biota, vapor intrusion). Part of the all-apps-included $18,000 / year subscription."
      whatItIs={[
