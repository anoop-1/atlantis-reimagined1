...
const FAQS: { question: string; answer: string }[] = [
  {
    "question": "What is included with Project Management in Atlantis NDT ERP?",
    "answer": "Project Management for NDT Companies is bundled inside the standard Atlantis NDT ERP subscription — there is no additional licence fee. Every customer gets the full Odoo 18-based ERP suite (35+ apps including Project Management) pre-configured for NDT and inspection-company workflows. We do not nickel-and-dime by module. The annual fee covers hosting on Atlantis cloud infrastructure, quarterly upgrades, knowledge-base access, and email / SMS support."
  },
  {
    "question": "How is Project Management configured for NDT inspection companies specifically?",
    "answer": "Generic ERPs treat Project Management as a one-size-fits-all module. Atlantis NDT ERP layers NDT-specific pre-configuration on top: NDT-method libraries (UT, RT, MT, PT, PAUT, TOFD, ECA, LRUT, IRIS, MFL), certification-scheme tracking (ASNT SNT-TC-1A, ISO 9712, PCN, CSWIP, NACE, AWS CWI), API code intervals (510, 570, 653, 1163), and client-specific compliance templates (Aramco SAEP-1112, ADNOC AIM Standard, QatarEnergy NFPS, ABSA Alberta, OSHA PSM, HSE PSSR, PESO IBR, NORSOK). You start productive on day one, not after six months of customisation."
  },
  {
    "question": "Can Project Management integrate with our existing systems (SAP, Maximo, etc.)?",
  ...
  {
    "question": "What does implementation look like for Project Management?",
...
export default function ProjectManagementForNdtCompanies() {
  const [openIdx, setOpenIdx] = useState<number | null>(0);
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 text-white">
      <SEOHead
        title="Project Management for NDT Companies — Fully Customizable, All 30+ Odoo Apps Included | Atlantis NDT"
        description="Atlantis NDT ERP includes Project Management. Designed for NDT inspection companies and certification labs. Affordable, accessible, fully customizable, ASNT/ISO 9712 ready. Demo: info@atlantisndt.com"
        canonical="/erp/project-management-for-ndt-companies"
        faq={FAQS}
      />
      <Navigation />
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 max-w-6xl">
        <Breadcrumbs items={[{ label: "Home", href: "/" }, { label: "ERP", href: "/erp" }, { label: "Project Management for NDT Companies" }]} />
        ...
        <section className="mt-6 mb-16">
          ...
          <p className="text-xl text-slate-300 mb-6 max-w-3xl leading-relaxed">
            Atlantis NDT ERP includes <span className="text-emerald-400 font-semibold">Project Management</span> — purpose-configured to help project managers, planners, coordinators, operations managers and inspection-firm owners plan, schedule and deliver multi-method inspection projects across multiple client sites — with technician roster planning, equipment dispatch, milestone tracking and live margin visibility. Part of the all-apps-included subscription.
          </p>
          ...
          <div className="flex flex-wrap gap-3">
            <a href="mailto:info@atlantisndt.com?subject=Demo%20request%3A%20Project%20Management%20for%20NDT%20Companies"
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-5">What is Project Management inside Atlantis NDT ERP?</h2>
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-slate-300 leading-relaxed">
              Project Management inside Atlantis NDT ERP is the same battle-tested Odoo 18 Project Management app you would get from a generic Odoo deployment — but pre-configured, pre-loaded and pre-integrated for NDT and inspection businesses. We have spent thousands of hours configuring Odoo's project management capabilities specifically for project managers, planners, coordinators, operations managers and inspection-firm owners at NDT inspection contractors, calibration laboratories, pipeline integrity service providers, asset-integrity consultancies, aerospace quality-control labs, and corrosion engineering firms. The result is a system that helps you plan, schedule and deliver multi-method inspection projects across multiple client sites — with technician roster planning, equipment dispatch, milestone tracking and live margin visibility — from day one, not after a six-month consulting engagement.
            </p>
            <p className="text-slate-300 leading-relaxed mt-4">
              Critically, Project Management is not a stand-alone bolt-on. It lives inside the same Odoo 18 database as your CRM, accounting, inventory, project management, HR, certification tracking and inspection-report generator. That means single source of truth for every contact, every project, every technician, every invoice and every inspection record. No more spreadsheets bridging "the BD tool" and "the operations tool" and "the accounting tool". One system, configured for NDT.
            </p>
            <p className="text-slate-300 leading-relaxed mt-4">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-5">How NDT inspection companies use Project Management</h2>
          <div className="grid md:grid-cols-1 gap-4">
              <div className="bg-slate-800/40 border border-slate-700 rounded-lg p-5"><p className="text-sm uppercase tracking-wider text-blue-400 mb-2">Use Case 1</p><p className="text-slate-200 leading-relaxed">A Houston inspection contractor delivering ExxonMobil Baytown turnaround support manages 38 simultaneous mini-projects across 14 process units — zero clashing-technician incidents in the 2025 turnaround season.</p></div>
              <div className="bg-slate-800/40 border border-slate-700 rounded-lg p-5"><p className="text-sm uppercase tracking-wider text-blue-400 mb-2">Use Case 2</p><p className="text-slate-200 leading-relaxed">A Doha inspection firm on QatarEnergy NFE expansion tracks 220 inspectors across cryogenic, structural and pressure-test sub-scopes — live margin reporting shows the LNG fabrication scope running 4% over baseline, allowing early commercial intervention.</p></div>
              <div className="bg-slate-800/40 border border-slate-700 rounded-lg p-5"><p className="text-sm uppercase tracking-wider text-blue-400 mb-2">Use Case 3</p><p className="text-slate-200 leading-relaxed">A Calgary NDT firm running pipeline-integrity assessments across northern Alberta saves 18 days of pre-mob planning per project by reusing technician-rotation templates from previous Suncor and CNRL programs.</p></div>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <ul className="grid md:grid-cols-2 gap-x-8 gap-y-3 text-slate-200">
              ...
              <li className="flex items-start gap-2"><CheckCircle className="w-5 h-5 text-emerald-400 flex-shrink-0 mt-0.5" /><span>Equipment-conflict detection — same UT crawler cannot be on two projects simultaneously</span></li>
              <li className="flex items-start gap-2"><CheckCircle className="w-5 h-5 text-emerald-400 flex-shrink-0 mt-0.5" /><span>Live budget vs. actual project cost (labour + travel + consumables + equipment)</span></li>
              <li className="flex items-start gap-2"><CheckCircle className="w-5 h-5 text-emerald-400 flex-shrink-0 mt-0.5" /><span>Document repository per project: SoW, ITP, procedure rev, client approvals, inspection records, NCRs, audit findings</span></li>
              <li className="flex items-start gap-2"><CheckCircle className="w-5 h-5 text-emerald-400 flex-shrink-0 mt-0.5" /><span>Kanban view for daily project standup</span></li>
              <li className="flex items-start gap-2"><CheckCircle className="w-5 h-5 text-emerald-400 flex-shrink-0 mt-0.5" /><span>Mobile timesheet entry from the field with photo-stamped GPS location</span></li>
              <li className="flex items-start gap-2"><CheckCircle className="w-5 h-5 text-emerald-400 flex-shrink-0 mt-0.5" /><span>Milestone-based progress billing automatically triggers invoice draft</span></li>
              <li className="flex items-start gap-2"><CheckCircle className="w-5 h-5 text-emerald-400 flex-shrink-0 mt-0.5" /><span>Risk register with mitigation actions and review dates</span></li>
              <li className="flex items-start gap-2"><CheckCircle className="w-5 h-5 text-emerald-400 flex-shrink-0 mt-0.5" /><span>Post-mortem template for completed projects (what went well, what to fix, lessons learned)</span></li>
          </ul>
        </section>
        ...
        <section className="mb-16">
          ...
          <p className="text-slate-300 mb-4 max-w-3xl">Atlantis NDT ERP plays nicely with the systems your refinery, EPC, fabrication-shop and operator clients already use. Out-of-the-box integrations for Project Management:</p>
          <ul className="grid md:grid-cols-2 gap-x-8 gap-y-3 text-slate-200">
              <li className="flex items-start gap-2"><Zap className="w-5 h-5 text-blue-400 flex-shrink-0 mt-0.5" /><span>Microsoft Project (one-way import)</span></li>
              <li className="flex items-start gap-2"><Zap className="w-5 h-5 text-blue-400 flex-shrink-0 mt-0.5" /><span>Primavera P6 (XML import)</span></li>
              <li className="flex items-start gap-2"><Zap className="w-5 h-5 text-blue-400 flex-shrink-0 mt-0.5" /><span>Smartsheet (legacy migration)</span></li>
              <li className="flex items-start gap-2"><Zap className="w-5 h-5 text-blue-400 flex-shrink-0 mt-0.5" /><span>Microsoft Teams and Slack for project channels</span></li>
              <li className="flex items-start gap-2"><Zap className="w-5 h-5 text-blue-400 flex-shrink-0 mt-0.5" /><span>Atlantis NDT ERP timesheet, work-order, accounting modules (native)</span></li>
              <li className="flex items-start gap-2"><Zap className="w-5 h-5 text-blue-400 flex-shrink-0 mt-0.5" /><span>Power BI dashboards for senior leadership</span></li>
          </ul>
        </section>
        ...
        <section className="mb-16">
          <div className="bg-gradient-to-br from-blue-900/40 to-purple-900/40 border border-blue-500/30 rounded-2xl p-8 text-center">
            <h2 className="text-3xl font-bold mb-3">Ready to see Project Management in action?</h2>
            <p className="text-slate-200 mb-6 max-w-2xl mx-auto">Book a 30-minute demo with the Atlantis NDT team. We will walk you through Project Management configured for your specific inspection workflow, discuss data-migration scope, and quote your implementation timeline.</p>
            <a href="mailto:info@atlantisndt.com?subject=Demo%20request%3A%20Project%20Management%20for%20NDT%20Companies"
