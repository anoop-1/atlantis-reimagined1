...
export default function ProjectManagementForNdtCompanies() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 text-white">
      <SEOHead
        title="Project Management for NDT Companies — regional pricing All Odoo Apps Included | Atlantis NDT"
        description="Atlantis NDT ERP includes Project Management. Designed for NDT inspection companies and certification labs. regionally priced, fully customizable, ASNT/ISO 9712 ready. Demo: info@atlantisndt.com"
