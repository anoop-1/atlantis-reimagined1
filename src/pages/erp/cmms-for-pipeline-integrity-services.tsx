...
export default function CmmsForPipelineIntegrityServices() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP CMMS for pipeline integrity services — PHMSA 49 CFR 192/195 asset registers, API 1160 / 1163 / 1173 integrity-management compliance, ILI fleet tracking, dig-program scheduling, HCA segment registers. Flat regional pricing."
      heroBody="Atlantis NDT ERP CMMS configured for pipeline integrity contractors — PHMSA 49 CFR 192 (gas) and 195 (hazardous liquid) pipeline asset registers, API 1160 / 1163 / 1173 integrity-management compliance, ILI (In-Line Inspection) tool-fleet tracking, dig-program scheduling, HCA (High Consequence Area) segment registers, and integrity-management plan (IMP) revision tracking. Part of the all-apps-included subscription."
      whatItIs={[
