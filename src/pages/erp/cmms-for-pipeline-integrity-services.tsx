...
export default function CmmsForPipelineIntegrityServices() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP CMMS for pipeline integrity services — PHMSA 49 CFR 192/195 asset registers, API 1160 / 1163 / 1173 integrity-management compliance, ILI fleet tracking, dig-program scheduling, HCA segment registers. Quote on request."
