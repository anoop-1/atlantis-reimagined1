...
export default function CertificationTrackingForAerospaceQualityControl() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Certification Tracking for aerospace QA — NAS 410 Rev 5 (US aerospace NDT cert), EN 4179 (European aerospace NDT cert), NADCAP-recognized written practices, OEM-specific Boeing BSS / Airbus AITM / GE / P&W / RR endorsements. Quote on request."
