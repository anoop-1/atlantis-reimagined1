...
export default function CertificationTrackingForAerospaceQualityControl() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Certification Tracking for aerospace QA — NAS 410 Rev 5 (US aerospace NDT cert), EN 4179 (European aerospace NDT cert), NADCAP-recognized written practices, OEM-specific Boeing BSS / Airbus AITM / GE / P&W / RR endorsements. Flat $18,000/yr."
      heroBody="Atlantis NDT ERP Certification Tracking for aerospace quality control firms — NAS 410 Rev 5 (the US aerospace NDT personnel qualification standard, superseding NAS 410 Rev 4 and ATA-105), EN 4179 (the European equivalent), NADCAP-recognized written practices, FAA Part 145 inspection-authorisation tracking, EASA Part-66 license categories, and OEM-specific endorsements for Boeing, Airbus, Embraer, Lockheed Martin, Northrop Grumman, GE Aviation, Pratt & Whitney, Rolls-Royce, Safran. Part of the all-apps-included $18,000 / year subscription."
      whatItIs={[
