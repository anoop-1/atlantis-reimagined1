...
const data: ErpTripleCrossProps = {
  ...
  "faqs": [
    ...
    ["What does Project Management cost for an NDT inspection company in Delhi?", "Project Management is bundled inside the standard $18,000 / year (approximately INR 15 lakh) Atlantis NDT ERP subscription. Invoicing in INR or USD."],
