...
export default function CrmForNdtCompanies() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 text-white">
      <SEOHead
        title="CRM (Customer Relationship Management) for NDT Companies — $18,000/yr All Odoo Apps Included | Atlantis NDT"
        description="Atlantis NDT ERP includes CRM (Customer Relationship Management). Designed for NDT inspection companies and certification labs. $18,000/yr flat, fully customizable, ASNT/ISO 9712 ready. Demo: info@atlantisndt.com"
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 max-w-6xl">
        ...
        <section className="mt-6 mb-16">
          ...
          <p className="text-xl text-slate-300 mb-6 max-w-3xl leading-relaxed">
            Atlantis NDT ERP includes <span className="text-emerald-400 font-semibold">CRM (Customer Relationship Management)</span> — purpose-configured to help business development managers, account leads, technical sales engineers and inspection-business owners win more inspection contracts, track every sales conversation with refinery operators and EPC contractors, and convert RFQs into invoiced jobs without dropping the ball. Part of the all-apps-included $18,000 / year subscription.
          </p>
