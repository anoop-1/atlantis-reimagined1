...
export default function FieldServiceForPipelineIntegrityServices() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Field Service for pipeline integrity firms — dig-program dispatch, ILI run scheduling, OQ task-list compliance, offline-capable mobile capture for remote pipeline ROW, GPS-tagged anomaly verification. Flat regional pricing."
