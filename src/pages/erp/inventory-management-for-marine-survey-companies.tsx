...
export default function InventoryManagementForMarineSurveyCompanies() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Inventory Management for marine survey companies. ROV/AUV/USV asset tracking, IACS classification-society survey-kit logistics, IMO compliance, vessel-survey equipment dispatch. $18,000/yr flat."
