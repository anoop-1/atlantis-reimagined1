  ...
  return (
    <ErpIndustryAppPage
      ...
      faqs={[
        ...
        { question: "What does the ERP cost?", answer: "Pricing varies by region and team size — request a tailored quote at info@atlantisndt.com. The platform is affordable, transparent SaaS pricing and includes hosting, all 35+ Odoo apps, mobile apps, training and support. Implementation services for Indian clients (data migration, custom IOCL/HPCL/BPCL/Reliance template design, GST e-invoice integration, bilingual English/regional-language template build) are quoted based on scope." },
