...
export default function CmmsForIndia() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP CMMS for India — PESO Form XVI/XIV submission, AERB radiography, IBR boiler regulations, OISD-141 asset integrity, BIS IS 2825 pressure vessels. Flat regional pricing."
