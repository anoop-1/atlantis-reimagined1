...
const data: ErpTripleCrossProps = {
  ...
  "faqs": [
    [
      ...
      "Yes. The Helpdesk module is pre-loaded with the codes and operator flow-downs that NDT inspection companies in London work with daily: PSSR 2000, LOLER, ASME B31.3, API 510 / 570 / 653, BS EN 13445, NORSOK reference where UK-Norway joint scope, plus operator-specific quality clauses from BP (St James's Square HQ), Shell (Shell Centre HQ), TotalEnergies (London office), Wood (London hub). The module is aligned to PCN (BINDT) primary, ASNT / ISO 9712 / CSWIP / NACE recognised in parallel. Configuration is done — your NDT inspection company team is productive on day one, not after six months of customisation."
    ],
    [
