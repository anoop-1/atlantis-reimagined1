...
const data: ErpTripleCrossProps = {
  ...
  "faqs": [
    ...
    ["What does Project Management cost for an NDT inspection company in Hyderabad?", "Project Management is bundled inside the standard affordable, accessible (contact us; approximately INR 15 lakh) Atlantis NDT ERP subscription. Invoicing in INR or USD."],
