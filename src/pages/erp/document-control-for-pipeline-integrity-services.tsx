...
export default function DocumentControlForPipelineIntegrityServices() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Document Control for pipeline integrity firms — API 1173 SMS document hierarchy, PHMSA 49 CFR 195.452 IMP version control, ILI verification-dig records, B31.4 / B31.8 / B31.12 code revisions, NACE coatings procedures. Quote on request."
