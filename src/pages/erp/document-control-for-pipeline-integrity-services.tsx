...
export default function DocumentControlForPipelineIntegrityServices() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Document Control for pipeline integrity firms — API 1173 SMS document hierarchy, PHMSA 49 CFR 195.452 IMP version control, ILI verification-dig records, B31.4 / B31.8 / B31.12 code revisions, NACE coatings procedures. Flat regional pricing."
      heroBody="Atlantis NDT ERP Document Control for pipeline integrity firms — API 1173 Pipeline SMS document hierarchy (Policy → Standards → Procedures → Work Instructions → Records), PHMSA 49 CFR 195.452 / 192.917 Integrity Management Plan version control, CER Condition 9 documentation, ILI verification-dig records, ASME B31.4 / B31.8 / B31.12 code revision management, and NACE SP0169 / SP0102 / SP0207 coating-and-corrosion procedures. Part of the all-apps-included subscription."
      whatItIs={[
