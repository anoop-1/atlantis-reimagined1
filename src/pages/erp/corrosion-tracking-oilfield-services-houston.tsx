...
const data: ErpTripleCrossProps = {
  ...
  "desc": "Corrosion Tracking & RBI ERP module for oilfield services contractors in Houston, USA. Aligned to API 510 / 570 / 653 / 571 / 580 / 581 corrosion and integrity methodology, with operator flow-down for ExxonMobil Baytown and Marathon Galveston Bay and TCEQ / OSHA Region 6 PSM compliance support. Demo: info@atlantisndt.com.",
  "introPara1": "Oilfield Services & Wellsite Inspection operating in Houston, USA face a specific combination of local market structure, regulator framework, and operator quality flow-down that generic ERP systems cannot model — and that combination shapes how corrosion tracking and rbi actually has to work on the ground. Houston sits at the heart of the energy capital of the world with 4,600+ oil & gas firms. The dominant industrial cluster — the 400-mile Gulf Coast refining and petrochemical complex — sets the rhythm: Houston turnarounds compress 9 months of work into 30 days.",
  "introPara2": "oilfield services and wellsite inspection contractors manage rig and BOP test schedules, OCTG per-joint records, field-ticket capture, and HSE certification renewals (BOSIET / HUET / H2S Alive / IADC RigPass) across rotating crews and remote pads. For a multi-pad oilfield services contractor supporting drilling and completions in Houston, corrosion tracking and rbi is not a back-office activity — it is the operational spine that determines audit outcomes, contract eligibility, and project margin. a non-qualified technician mobilised to a sour-gas wellsite is a contract-ending event. Atlantis NDT ERP's corrosion tracking & rbi module computes corrosion rates, projects remaining life, screens damage mechanisms, and produces risk-based inspection plans per API 581, aligned to API 510 / 570 / 653 / 571 / 580 / 581 corrosion and integrity methodology. For oilfield services & wellsite inspection based in Houston, that means a single live system of record that knows the market, not a generic accounting tool bolted to a spreadsheet of inspection records.",
  ...
  "painPoints": [
    "Corrosion tracking and RBI for oilfield services contractors in Houston tracked in spreadsheets — always behind operator-portal updates from ExxonMobil Baytown and Marathon Galveston Bay",
    "TCEQ audit preparation for corrosion tracking and rbi workflows takes 80+ hours per cycle and finds gaps too late to remediate",
    "Operator flow-down from ExxonMobil Baytown updates monthly — internal corrosion tracking and rbi procedures lag by weeks, putting oilfield services & wellsite inspection contracts at risk",
    "Customer-format corrosion tracking and rbi reports for ExxonMobil Baytown, Marathon Galveston Bay, LyondellBasell Channelview require manual reformatting on every submission — margin-eating rework"
  ],
  "useCases": [
    "A mid-size Houston oilfield services contractor deploys corrosion tracking & rbi against ExxonMobil Baytown and Marathon Galveston Bay contracts. Within 90 days the team reports a 60–80% reduction in admin time and zero audit findings on the next TCEQ surveillance visit.",
    "A Houston-based multi-pad oilfield services contractor supporting drilling and completions integrates corrosion tracking & rbi with LyondellBasell Channelview operator-portal flow-down. Operator specification revisions automatically flag affected internal procedures for review — eliminating the \"we missed a revision\" failure mode that previously cost contracts.",
    "A growing oilfield services contractor in Houston consolidates corrosion tracking & rbi across oilfield services & wellsite inspection project sites in the USA market. Customer-format reports flow to ExxonMobil Baytown portals automatically and report turnaround drops from 5 days to under 24 hours.",
    "An audit-driven Houston oilfield services contractor uses corrosion tracking & rbi to pass TCEQ and OSHA Region 6 PSM cycle audits with zero findings — evidence packages assemble in 30 seconds vs. the 80-hour manual prep that previously dominated audit week."
  ],
  "faqs": [
    [
      "Is Corrosion Tracking & RBI configured for oilfield services & wellsite inspection operating in Houston?",
      "Yes. The corrosion tracking & rbi module is pre-loaded with the codes and operator flow-downs that oilfield services & wellsite inspection in Houston work with daily: API 510 / 570 / 653, ASME B31.3 / B31.4 / B31.8, OSHA 29 CFR 1910.119 PSM, TCEQ 30 TAC Chapter 116. The procedure-library module also holds whichever operator-specific quality clauses your contracts require — such as those from ExxonMobil Baytown, Marathon Galveston Bay, LyondellBasell Channelview, Valero Houston / Texas City — once your team uploads them. The module is aligned to API 510 / 570 / 653 / 571 / 580 / 581 corrosion and integrity methodology. Configuration is done — your oilfield services contractor team is productive on day one, not after six months of customisation."
    ],
    [
      "Which Houston regulators does the corrosion tracking and rbi workflow align with?",
