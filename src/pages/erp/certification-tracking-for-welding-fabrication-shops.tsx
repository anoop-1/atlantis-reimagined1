...
export default function CertificationTrackingForWeldingFabricationShops() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Certification Tracking for weld shops — ASME Section IX welder continuity, AWS D1.1 90-day rule, ISO 9606 welder qualification, CWB W47.1 Canadian welder cert, AWS CWI / SCWI, ASNT Level II/III. Quote on request."
