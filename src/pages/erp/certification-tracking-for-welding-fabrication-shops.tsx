...
export default function CertificationTrackingForWeldingFabricationShops() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Certification Tracking for weld shops — ASME Section IX welder continuity, AWS D1.1 90-day rule, ISO 9606 welder qualification, CWB W47.1 Canadian welder cert, AWS CWI / SCWI, ASNT Level II/III. Flat $18,000/yr."
      heroBody="Atlantis NDT ERP Certification Tracking for welding & fabrication shops — ASME Section IX QW-322 6-month continuity rule, AWS D1.1 Clause 6.4 90-day rule + 3-year requalification, ISO 9606-1 employer-attestation renewal, CWB W47.1 Canadian welder certification, AWS CWI (Certified Welding Inspector) / SCWI (Senior CWI), AWS QC1 endorsements, ASNT Level II/III, IIW European Welding Engineer / Technologist / Specialist. Part of the all-apps-included $18,000 / year subscription."
      whatItIs={[
