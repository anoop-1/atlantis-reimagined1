...
const data: ErpTripleCrossProps = {
  ...
  "faqs": [
    ...
    ["What does Project Management cost for an NDT inspection company in Riyadh?", "Project Management is bundled inside the standard regionally priced (contact us; approximately SAR 67,500) Atlantis NDT ERP subscription. Invoicing in SAR or USD. SACS-002 cybersecurity-aligned data residency is included where required."],
