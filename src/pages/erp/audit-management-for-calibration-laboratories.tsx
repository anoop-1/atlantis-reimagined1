...
export default function AuditManagementForCalibrationLaboratories() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Audit Management for ISO/IEC 17025 cal labs — accreditation-body audit cycles (ANAB, UKAS, DAkkS, COFRAC, NABL), §8.8 internal audits, peer-witness audits, ILAC P9 surveillance, MoU peer reviews. Flat regional pricing."
      heroBody="Atlantis NDT ERP Audit Management for ISO/IEC 17025:2017 calibration laboratories — accreditation-body audit cycles (ANAB, UKAS, DAkkS, COFRAC, NABL, A2LA, AS, IANZ, NATA, JAB), §8.8 internal audit cycles, peer-witness audits, ILAC P9 surveillance policies, ILAC MRA Mutual-Recognition Arrangement peer reviews, and customer-specific second-party audits. Part of the all-apps-included subscription."
      whatItIs={[
