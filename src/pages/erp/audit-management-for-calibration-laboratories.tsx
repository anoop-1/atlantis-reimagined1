...
export default function AuditManagementForCalibrationLaboratories() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Audit Management for ISO/IEC 17025 cal labs — accreditation-body audit cycles (ANAB, UKAS, DAkkS, COFRAC, NABL), §8.8 internal audits, peer-witness audits, ILAC P9 surveillance, MoU peer reviews. Quote on request."
