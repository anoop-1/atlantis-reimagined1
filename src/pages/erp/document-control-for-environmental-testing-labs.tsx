...
export default function DocumentControlForEnvironmentalTestingLabs() {
  return (
    <ErpIndustryAppPage
      ...
      metaDescription="Atlantis NDT ERP Document Control for environmental testing laboratories. EPA SW-846 / TNI NELAC / NABL ISO 17025 method libraries, SOP revision control, sample chain-of-custody, regulatory submission templates. regional pricing flat."
      heroBody="Atlantis NDT ERP Document Control pre-configured for environmental testing laboratories — EPA SW-846 / TNI NELAC / NABL ISO 17025 method library management, SOP revision control with electronic-signature workflow, sample chain-of-custody documentation, ASTM / APHA Standard Methods / OSHA NIOSH method evidence, regulatory submission templates for EPA, ECHA, CPCB, SPCB, MPCB, ADWEA, MoIAT and customer-specific quality manual cross-walks. Part of the all-apps-included subscription."
      whatItIs={[
