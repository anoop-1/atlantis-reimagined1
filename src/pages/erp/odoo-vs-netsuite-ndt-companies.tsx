...
const caseStudies = [
  ...
  },
  {
    ...
    body: "Serving GE Aviation, Pratt & Whitney, Safran, Honeywell Aerospace and Boeing supplier-base work, the contractor needed NAS 410 Rev 5 currency tracking, NADCAP MAUP audit-pack export, DGCA Form CA-39 and EASA Part-145 documentation across two legal entities. NetSuite quote: quoted by vendor over 5 years. Atlantis NDT ERP quoted by vendor over 5 years (multi-entity premium). Cleared next NADCAP MAUP audit with zero findings.",
  },
  {
    title: "Marine survey company (Singapore + Dubai, 22 technicians)",
    body: "ABS / Lloyd's Register / DNV / IRClass classification-society inspection work across Singapore Jurong Island, Sembcorp Marine and Dubai Drydocks World. NetSuite OneWorld quote: quoted by vendor over 5 years for two-entity OneWorld setup. Atlantis NDT ERP quoted by vendor over 5 years. IACS classification-society survey-pack export, MPA / DM marine-jetty inspection scheduling and bilingual English/Arabic / English/Bahasa reporting all pre-built.",
  },
  {
        ...
        <section className="mt-6 mb-16">
          ...
          <div className="flex flex-wrap gap-4 mb-8">
            ...
            <div className="inline-flex items-center gap-2 bg-orange-500/10 border border-orange-500/30 rounded-lg px-4 py-2 text-orange-300">
              <DollarSign className="w-4 h-4" />
              <span className="font-semibold">quoted by vendor</span>
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-emerald-900/30 border border-emerald-500/30 rounded-2xl p-6">
              ...
              <p className="text-4xl font-bold text-white mb-4">quoted by vendor</p>
              ...
              <ul className="space-y-2 text-slate-200 text-sm">
                ...
                <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-emerald-400 flex-shrink-0 mt-0.5" />Implementation: quoted by vendor one-off</li>
                <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-emerald-400 flex-shrink-0 mt-0.5" />Customization: quoted by vendor (NDT overlay pre-built)</li>
            ...
            <div className="bg-orange-900/30 border border-orange-500/30 rounded-2xl p-6">
              ...
              <ul className="space-y-2 text-slate-200 text-sm">
                <li className="flex items-start gap-2"><DollarSign className="w-4 h-4 text-orange-400 flex-shrink-0 mt-0.5" />License: quoted by vendor (50 users)</li>
                <li className="flex items-start gap-2"><DollarSign className="w-4 h-4 text-orange-400 flex-shrink-0 mt-0.5" />Implementation (tier-1 partner): quoted by vendor</li>
                <li className="flex items-start gap-2"><DollarSign className="w-4 h-4 text-orange-400 flex-shrink-0 mt-0.5" />NDT-industry customization: quoted by vendor</li>
                ...
                <li className="flex items-start gap-2"><DollarSign className="w-4 h-4 text-orange-400 flex-shrink-0 mt-0.5" />SuiteApps + integrations: quoted by vendor</li>
              </ul>
            </div>
        ...
        <section className="mb-16">
          ...
          <div className="bg-orange-900/20 border border-orange-500/30 rounded-2xl p-6">
            ...
            <ul className="space-y-2 text-slate-200">
              ...
              <li className="flex items-start gap-2"><CheckCircle className="w-5 h-5 text-orange-400 flex-shrink-0 mt-0.5" />You require ASC 606 / IFRS 15 percent-of-completion revenue recognition on multi-year EPC contracts above quoted by vendor each</li>
