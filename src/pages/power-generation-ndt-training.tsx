        ...
        <div className="min-h-screen bg-slate-50">
            ...
            <section className="py-16 bg-gradient-to-r from-emerald-700 to-teal-700 text-white text-center">
                <div className="container mx-auto max-w-4xl px-6">
                    ...
                    <p className="text-emerald-100 mb-8 text-lg">Join our specialized training program and become certified for power industry inspections.</p>
                    <Link to="/contact" className="inline-block bg-white text-emerald-700 px-8 py-3 rounded-lg font-semibold hover:bg-slate-100 transition">Enroll Now</Link>
                </div>
            </section>
