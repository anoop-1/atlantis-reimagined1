...
export default function NDTTrainingChicago() {
  const courseSchema = {
    ...
    "@type": "Course",
    "name": "NDT Training & Certification in Chicago, IL",
  ...
  return (
    <div className="min-h-screen pt-20">
      ...
      <section className="py-20">
        <div className="container mx-auto max-w-6xl px-6">
          <h2 className="text-3xl font-bold mb-12 text-center">Manufacturing NDT Training in Chicago</h2>
          <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
            Chicago's industrial manufacturing sector includes pressure vessel fabrication, heavy equipment manufacturing, and precision machining—all requiring certified NDT personnel.
          </p>
          <div className="grid md:grid-cols-2 gap-6">
            <UICard className="h-full hover:shadow-lg transition border-0 shadow-sm">
              <UICardHeader><UICardTitle className="text-lg">Manufacturing Focus</UICardTitle></UICardHeader>
              <UICardContent><p className="text-muted-foreground text-sm">Training tailored to fabrication shops, pressure vessel manufacturers, and heavy equipment producers.</p></UICardContent>
            </UICard>
            <UICard className="h-full hover:shadow-lg transition border-0 shadow-sm">
      ...
      <section className="py-16 bg-primary/5">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-2xl font-bold text-center mb-8">Complete NDT Solutions in Chicago</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link to="/ndt-consulting-chicago" className="bg-background rounded-xl p-6 shadow-sm hover:shadow-lg transition">
              <h3 className="font-semibold text-lg mb-2">NDT Consulting</h3>
              <p className="text-muted-foreground text-sm">Expert ASNT Level III consulting, procedure development, quality assurance, and on-site technical support for Chicago industries.</p>
            </Link>
      ...
      <section className="py-16 bg-gradient-to-r from-primary/10 to-accent/10">
        <div className="container mx-auto max-w-4xl px-6 text-center">
          <h2 className="text-3xl font-bold mb-4">Start Your NDT Training in Chicago</h2>
          <p className="text-muted-foreground mb-8">Enroll today and advance your manufacturing NDT career.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
