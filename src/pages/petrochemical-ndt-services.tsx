...
export default function petrochemical-ndt-services() {
  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Petrochemical NDT Services NDT Services",
    "provider": { "@type": "Organization", "name": "Atlantis NDT", "url": "https://atlantisndt.com" },
    "serviceType": "Non-Destructive Testing",
    "description": "Professional Petrochemical NDT Services NDT inspection and testing services. Certified inspectors, advanced equipment, industry compliance."
  };
  ...
  return (
    <div className="min-h-screen pt-20">
        ...
        <div className="container mx-auto px-6">
          <motion.div className="max-w-4xl mx-auto text-center" initial={{ y: 30, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.2 }}>
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Petrochemical NDT Services <span className="gradient-text">NDT Services</span>
            </h1>
            <p className="text-xl text-muted-foreground leading-relaxed mb-8">
              Refinery and plant inspection services Professional inspection services. Certified inspectors. Advanced NDT equipment. Industry-compliant testing and reporting.
            </p>
      ...
      <section className="py-20">
        <div className="container mx-auto max-w-6xl px-6">
          <h2 className="text-3xl font-bold mb-12 text-center">Petrochemical NDT Services Industry Applications</h2>
          <div className="grid md:grid-cols-2 gap-6">
            {[{title: 'Process Equipment', description: 'Reactor vessels, heat exchangers, critical equipment'}, {title: 'Piping Systems', description: 'API 570 inspection, corrosion assessment, integrity verification'}, {title: 'Structural Assessment', description: 'Weld inspection, equipment mounting, safety systems'}].map((sector) => (
      ...
      <section className="py-16 bg-gradient-to-r from-primary/10 to-accent/10">
        <div className="container mx-auto max-w-4xl px-6 text-center">
          <h2 className="text-3xl font-bold mb-4">Get Professional Petrochemical NDT Services NDT Services</h2>
