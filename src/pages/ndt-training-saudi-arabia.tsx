...
const courses = [
    { method: "Ultrasonic Testing (UT)", levels: ["Level I", "Level II", "Level III"], price: "SAR 5,500-9,500" },
    { method: "Phased Array UT (PAUT)", levels: ["Level I", "Level II"], price: "SAR 7,500-11,000" },
    { method: "Radiographic Testing (RT)", levels: ["Level I", "Level II", "Level III"], price: "SAR 5,500-9,500" },
    { method: "Magnetic Particle Testing (MT)", levels: ["Level I", "Level II"], price: "SAR 4,500-6,500" },
    { method: "Liquid Penetrant Testing (PT)", levels: ["Level I", "Level II"], price: "SAR 3,500-5,500" },
    { method: "Eddy Current Testing (ET)", levels: ["Level I", "Level II"], price: "SAR 5,500-9,500" }
];
        ...
        <div className="min-h-screen bg-slate-50">
            ...
            <section className="bg-gradient-to-br from-green-600 to-emerald-700 text-white pt-24 pb-16">
                <div className="container mx-auto max-w-6xl px-6">
                    <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}>
                        <div className="flex items-center gap-2 text-green-200 mb-4"><GraduationCap className="w-5 h-5" /><span>Training & Certification</span></div>
                        <h1 className="text-4xl md:text-5xl font-bold mb-6">NDT Training in Saudi Arabia</h1>
                        <p className="text-xl text-green-100 max-w-3xl mb-8">ASNT and ISO 9712 certification training recognized by Saudi Aramco and major KSA operators. Dammam, Riyadh, Jubail locations.</p>
                        <div className="flex flex-col sm:flex-row gap-4">
                            <Link to="/contact" className="inline-block bg-white text-green-700 px-8 py-3 rounded-lg font-semibold hover:bg-slate-100 transition text-center">Enroll Now</Link>
            ...
            <section className="py-12 bg-white">
                <div className="container mx-auto max-w-6xl px-6">
                    <div className="grid md:grid-cols-4 gap-8 text-center">
                        <div><div className="text-4xl font-bold text-green-600 mb-2">95%</div><div className="text-slate-600">Pass Rate</div></div>
                        <div><div className="text-4xl font-bold text-green-600 mb-2">4</div><div className="text-slate-600">KSA Locations</div></div>
                        <div><div className="text-4xl font-bold text-green-600 mb-2">Aramco</div><div className="text-slate-600">Recognized</div></div>
                        <div><div className="text-4xl font-bold text-green-600 mb-2">15+</div><div className="text-slate-600">Years Experience</div></div>
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid md:grid-cols-2 gap-12">
                        <div>
                            ...
                            <ul className="space-y-2">
                                {certifications.map((cert) => (<li key={cert} className="flex items-center gap-2"><Award className="w-4 h-4 text-green-500" /><span>{cert}</span></li>))}
                            </ul>
                        </div>
                        <div>
                            <h2 className="text-2xl font-bold mb-4">Training Locations</h2>
                            <ul className="space-y-2">
                                {locations.map((loc) => (<li key={loc} className="flex items-center gap-2"><MapPin className="w-4 h-4 text-green-500" /><span>{loc}</span></li>))}
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-16 bg-gradient-to-r from-green-600 to-emerald-600 text-white text-center">
                <div className="container mx-auto max-w-4xl px-6">
                    ...
                    <p className="text-green-100 mb-8 text-lg">Enroll today or contact us for corporate training quotes.</p>
                    <Link to="/contact" className="inline-block bg-white text-green-700 px-8 py-3 rounded-lg font-semibold hover:bg-slate-100 transition">Contact Us</Link>
                </div>
            </section>
