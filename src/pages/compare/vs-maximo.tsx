    ...
    return (
        <ErpComparisonPage
            ...
            atlantisWins={[
                ...
                "Your annual software budget for inspection workflow is modest and Maximo Application Suite per-user / per-asset pricing pushes you past $250K before professional services.",
            ...
            faqs={[
                { question: "Is Atlantis NDT ERP cheaper than IBM Maximo for a mid-size inspection company?", answer: "Yes, materially. For a 50–100 user inspection company, IBM Maximo Application Suite typically lands at $250K–$700K per year in license plus a $300K–$1M implementation across 6–18 months. Atlantis NDT ERP for the same headcount is an affordable SaaS model with onboarding inside 12 weeks — pricing varies by region and scope, so contact us for a tailored quote. Five-year TCO is usually 4–6x lower on Atlantis for a pure-play NDT business." },
