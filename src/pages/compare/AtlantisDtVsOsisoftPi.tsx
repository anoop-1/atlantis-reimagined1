...
const faqs = [
    ...
    { question: "What does the 5-year TCO look like for a typical refinery?", answer: "For a single-site refinery integrity program (one process unit, 200 CMLs, 50 weld maps, RBI on 800 components): Atlantis enterprise SaaS at $200K/yr × 5 = $1.0M plus $80K implementation = $1.08M. OSIsoft / AVEVA PI Server + AF + Vision + a partner IDMS for FFS/RBI typically lands at $120K–$300K/yr for the historian stack, plus $80K–$150K/yr for the IDMS partner, plus implementation and integration of $150K–$300K — 5-year TCO commonly $1.5M–$2.5M. The gap narrows when PI is genuinely needed for process control reasons; it widens when the primary use case is inspection integrity." },
