...
const faqs = [
    ...
    { question: "What does Atlantis Digital Twin cost vs AVEVA PI?", answer: "Atlantis pricing is tiered SaaS: a starter at $50,000/year covers a single complex asset (refinery unit, FPSO module, tank farm) with up to 25 named users. The $200,000/year enterprise tier covers multi-site deployments with unlimited users and the full RBI/FFS engine. AVEVA PI System is licensed per-tag (each PLC/DCS point counts), so a mid-sized refinery commonly lands in the $150K–$400K/year range for the historian alone, with PI Vision, Asset Framework, and Asset Analytics often pushing total spend to $600K–$1.2M/year. The economics flip in your favor when you primarily need inspection integrity, not process historian depth." },
