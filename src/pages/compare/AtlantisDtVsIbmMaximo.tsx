...
const compareRows = [
    { factor: "Pricing model", atlantis: "Tiered SaaS — $50K–$200K/yr", competitor: "IBM Maximo Application Suite — per-user + per-asset, $200K–$1M+/yr" },
...
const faqs = [
    ...
    { question: "TCO when running both?", answer: "For a mid-sized refinery: Maximo Application Suite ~$400K–$700K/yr depending on user and asset count. Atlantis enterprise tier $200K/yr. Combined ~$600K–$900K/yr. Compared to Maximo + heavily-customized inspection module + separate IDMS partner for FFS/RBI ($120K–$200K/yr), the combined Maximo + Atlantis approach typically lands $200K–$500K/yr cheaper and removes one partner from the stack." },
...
export default function AtlantisDtVsIbmMaximo() {
    ...
    return (
        <ProductPageLayout
            title="Atlantis Digital Twin vs IBM Maximo: Inspection Integrity vs EAM [2026 Cost & Features]"
            description="IBM Maximo (MAS) vs Atlantis Digital Twin: tier-1 EAM vs inspection integrity twin. Pricing $200K-$1M vs $50K-$200K SaaS, FFS/RBI native, when to run both. Honest 2026 guide."
