...
const faqs = [
    ...
    { question: "What does Atlantis Digital Twin cost vs Microsoft Azure Digital Twins?", answer: "Atlantis pricing is tiered SaaS: $50,000/year starter (one complex asset, up to 25 named users) and $200,000/year enterprise (unlimited assets, unlimited users, full FFS/RBI engine). Azure Digital Twins itself is consumption-priced (~$0.001 per API operation + storage), so the platform itself is inexpensive at low scale — typical mid-sized industrial deployment lands at $80K–$600K/year Azure spend across ADT + IoT Hub + IoT Edge + Functions + Blob storage + Azure ML. The real cost is the custom-app development effort to build the inspection workflow on top: typically a 6–9 month engagement with a Microsoft partner (Accenture, Deloitte, EY, Capgemini, Avanade, ZS) at $800K–$2.5M one-time, plus ongoing maintenance ($150K–$400K/yr). First-year total: $1M–$3.5M before the inspection workflow is live and useful." },
