...
const faqs = [
    ...
    { question: "Total cost comparison?", answer: "For an inspection integrity scope only: iTwin platform usage + per-user licensing, plus the development cost of building inspection workflow on top, plus FFS/RBI partner integration — easily $400K–$700K/yr loaded for a mid-sized operator. Atlantis enterprise SaaS at $200K/yr does the same job out of the box. iTwin&rsquo;s real ROI is when you&rsquo;re using it for its core strengths (engineering CAD federation, BIM, reality modeling) — not when you&rsquo;re using it to host inspection data." },
];
