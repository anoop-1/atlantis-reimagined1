...
const faqs = [
    ...
    { question: "What does Atlantis Digital Twin cost vs Cognite Data Fusion?", answer: "Atlantis pricing is tiered SaaS: $50,000/year starter (one complex asset, up to 25 named users) and $200,000/year enterprise (unlimited assets, unlimited users, full FFS/RBI engine). Cognite Data Fusion is priced as a per-workspace + data-volume + named-user subscription that typically lands at $300K–$1.8M/year for an industrial customer (Cognite&rsquo;s tier-1 industrial deployments at Aker BP, AkzoNobel, Equinor, Saudi Aramco, ADNOC, Petronas, OMV, and similar are in the upper end of this range). The economics flip in your favor when you primarily need inspection integrity, not a broad industrial data fabric, and when you don&rsquo;t have a 6+ person data science team to feed the fabric with custom-built apps." },
