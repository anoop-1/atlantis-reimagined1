...
const faqs = [
  { question: "How much does Odoo ERP cost in 2026?", answer: "Odoo ERP 2026 pricing comes in four flavors. (1) Odoo Community Edition — free, open-source, self-hosted, requires in-house DevOps. (2) Odoo Online Standard — $7/user/month for one application or $24.90/user/month for all applications (annual billing). (3) Odoo Online Custom — $37.40/user/month for all apps with Studio customisation. (4) Odoo.sh (developer cloud) — $24.90/user/month + hosting from $58/month for small worker instance. (5) Odoo Enterprise via implementation partner — $24-49/user/month subscription + partner-led implementation typically $30-150K. (6) Atlantis NDT ERP (built on Odoo 18) — regionally priced, all-in including hosting, implementation, training, support, and NDT-vertical extensions." },
  { question: "Why does Atlantis NDT ERP charge a flat fee when Odoo charges per user?", answer: "Atlantis NDT is an Odoo Partner that sells a pre-configured, hosted, NDT-vertical-extended deployment of Odoo Enterprise. The flat regional pricing fee absorbs: (a) the per-user Odoo Enterprise licence at $24-49/user × 25 users included = ~$7,200-14,700/year passed-through; (b) AWS hosting ($3-6K/year); (c) Atlantis NDT vertical extensions (worth $100K+ in customisation cost if built from scratch); (d) implementation support (worth $30-150K standalone); (e) training, support, upgrades. The flat-fee model means Atlantis NDT absorbs the per-user margin compression in exchange for predictable customer economics, which works at scale across our 6,700+ CRM contacts and growing client base." },
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <SEOHead
        ...
        description="Odoo ERP pricing 2026 explained. Community free vs Enterprise $24-49/user vs Online $24.90/user vs Atlantis NDT ERP regional pricing flat. Implementation costs, partner pricing, real 5-yr TCO."
