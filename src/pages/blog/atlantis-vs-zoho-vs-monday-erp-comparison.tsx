...
const faqs = [
  { question: "Atlantis NDT ERP vs Zoho One vs monday.com Work OS — which is best?", answer: "All three are popular all-in-one business platforms in 2026 but they target different customer segments. Zoho One (a per-user bundle of 45+ apps including Zoho CRM, Books, Projects, People, Desk, Inventory, Analytics) is best for general-purpose small / mid business. monday.com Work OS (tiered per-user pricing) is best for project-led teams with heavy collaboration needs but light accounting / inventory requirements. Atlantis NDT ERP — affordable, accessible, fully customizable — is best for engineering services / NDT / inspection / fabrication / asset-integrity firms needing vertical-native ERP with compliance workflow. Request a region-specific quote at info@atlantisndt.com." },
