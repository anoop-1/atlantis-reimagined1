      ...
      <article className="py-16">
        <div className="container mx-auto max-w-4xl px-6">
          ...
          <section className="bg-gradient-to-br from-violet-700 to-indigo-900 text-white p-10 rounded-2xl mb-12">
            ...
            <p className="text-violet-100 text-lg mb-6">Atlantis NDT — enterprise tier/year platform with implementation services, governance support, and Asset-Level Champion training included. Phased oil &amp; gas deployment in 12 months.</p>
