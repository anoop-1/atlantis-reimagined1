...
const faqs = [
  ...
  { question: "What is the price range for a corrosion-monitoring digital twin in 2026?", answer: "Vendor-comparison price bands for refinery-class deployment (typical 200,000 BPD refinery, 8-12 process units): AVEVA Process Twin + APM: $400K-$1.2M/year all-in; Hexagon HxGN SDx + APM: $350K-$900K/year; Bentley iTwin + PlantSight + AssetWise: $300K-$800K/year; Siemens MindSphere + COMOS: $400K-$1M/year; GE Vernova APM: $350K-$900K/year (stronger in power than refining); IBM Maximo APM with Digital Twin: $300K-$700K/year (cheapest if already on Maximo); Atlantis NDT Digital Twins: $200K/year flat including hosting, support, upgrades, unlimited users. For pipeline operators, Bentley's pricing is often most competitive given the strong OpenPlant / OpenBridge / AssetWise installed base. For PI-standardized refineries, AVEVA wins on integration depth despite the price premium. For NDT-heavy asset-integrity-focused deployments, Atlantis NDT is competitive on capability and substantially better on price-to-value." },
...
const vendorMatrix = [
  { vendor: "Atlantis NDT Digital Twins", focus: "Asset integrity, NDT-integrated", refinery: "$200K/yr", pipeline: "$300K/yr", strengths: "RBI + FFS native, NDT data model, unlimited users", weaknesses: "Smaller installed base, focused scope" },
      ...
      <article className="py-16">
        <div className="container mx-auto max-w-4xl px-6">
          ...
          <section className="mb-12">
            ...
            <div className="bg-amber-50 border-l-4 border-amber-500 p-6">
              ...
              <ul className="text-amber-900 space-y-1 list-disc list-inside">
                ...
                <li>Budget ($200K to $1.5M+ per refinery deployment)</li>
          ...
          <section className="mb-12">
            ...
            <p className="text-slate-600 text-lg leading-relaxed mb-6">
              The API 580 / API 581 RBI engine and the API 579 / ASME FFS-1 fitness-for-service engine are built-in rather than partner-integrated, so the corrosion-monitoring workflow flows directly through to inspection planning and engineering assessment without third-party tooling. Pricing is the structural differentiator: $200K/year flat for refinery-class deployments, $300K/year for pipeline, including hosting, support, upgrades, and unlimited users.
            </p>
            <p className="text-slate-600 text-lg leading-relaxed mb-6">
          ...
          <section className="bg-gradient-to-br from-amber-700 to-orange-900 text-white p-10 rounded-2xl mb-12">
            <h2 className="text-3xl font-bold mb-4">$200K/year for Refinery-Class Corrosion Monitoring</h2>
