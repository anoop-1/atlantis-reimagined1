...
const faqs = [
  ...
  { question: "What is the typical 5-year TCO for an 8-metrologist lab?", answer: "5-year TCO comparison for an 8-metrologist metrology lab: Hexagon PC-DMIS Inspect Workshop $200-500K; Zeiss CALYPSO + PiWeb $250-600K; Mitutoyo MeasurLink $150-400K; Renishaw MODUS $180-460K; Atlantis NDT ERP $90K flat (all-in)." },
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <SEOHead
        ...
        description="Affordable ERP for metrology labs 2026. Atlantis NDT ERP $18K/yr vs Hexagon PC-DMIS / Zeiss CALYPSO / Mitutoyo MeasurLink. PPAP, MSA gauge R&R, ASME Y14.5 GD&T, ISO 1101 GPS, NIST/NPL traceability."
      ...
      <div className="py-6 bg-white border-b"><div className="container mx-auto max-w-4xl px-6"><SocialShare title="Affordable ERP for Metrology Labs 2026" description="$18K/yr metrology lab ERP." /></div></div>
