...
const faqs = [
  ...
  { question: "Odoo vs NetSuite — which is better for services firms in 2026?", answer: "Odoo and NetSuite both target mid-market services firms with comparable functional capability. The differentiators: (1) Cost framing — NetSuite carries an enterprise per-user license plus a major implementation project; Odoo is a per-user subscription plus partner implementation; Atlantis NDT ERP is affordable, accessible, fully customizable as a single bundled offer — quote on request. (2) Project accounting — NetSuite OpenAir is a mature project-accounting solution favored by professional-services firms; Odoo Project + Timesheets is solid for most use cases but less polished for complex revenue-recognition rules. (3) Multi-country — NetSuite OneWorld is strong for multi-country roll-out (the OneWorld brand exists specifically for this); Odoo handles multi-country well but requires more setup. (4) Customization speed — Odoo's open architecture wins clearly; NetSuite SuiteScript customization is faster than SAP ABAP but slower than Odoo Python. (5) Implementation partner ecosystem — NetSuite has more partners globally with services-firm-specific experience; Odoo's partner ecosystem skews toward general business and manufacturing." },
  { question: "Why would anyone pick SAP over Odoo if Odoo is more affordable?", answer: "Three legitimate reasons SAP remains the right choice despite the cost gap. (1) Scale — for Fortune 500 / FTSE 100 firms with revenue above $1B and operations across 20+ countries, SAP's depth in consolidation, treasury, complex tax handling, and group-level reporting genuinely justifies the cost. Odoo can scale technically but the corporate IT and finance teams of large multinationals are typically built around SAP-style ecosystems. (2) Regulatory depth — USA defense contracting requires DCAA cost accounting standards compliance that SAP S/4HANA Public Sector supports natively; aerospace firms operating under AS9100 / EN 9100 plus complex defense regulations benefit from SAP's depth; pharmaceutical firms under FDA 21 CFR Part 11 likewise. (3) Risk tolerance and audit posture — for publicly-listed firms above $1B revenue, the audit and SOX compliance overhead of running ERP-as-strategic-asset usually leans toward the deepest, most-vendor-supported platform. Net: SAP wins above ~$500M revenue with complex regulatory environment; Odoo / Atlantis NDT ERP (affordable, accessible, fully customizable) wins below that line." },
...
const headToHeadTable = [
  ...
  { capability: "5-yr TCO (50 users)", odoo: "Most affordable tier", sap: "7-figure 5-yr TCO", netsuite: "7-figure 5-yr TCO", verdict: "Odoo structurally more affordable" },
];
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <SEOHead
        ...
        description="Odoo vs SAP vs NetSuite ERP 2026 honest comparison. 11 capabilities scored head-to-head, 5-year TCO framing, when each wins, customization speed, multi-GAAP. Atlantis NDT ERP — affordable, accessible, fully customizable; quote on request."
        ...
        <div className="container mx-auto max-w-4xl px-6">
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Link to="/erp" className="bg-white p-4 rounded-lg shadow-sm border-l-4 border-purple-500 hover:shadow-md transition"><h4 className="font-bold text-purple-900">Atlantis NDT ERP (Odoo 18)</h4><p className="text-slate-600 text-sm">Affordable, accessible, fully customizable — full modules included.</p></Link>
          ...
          <section className="bg-gradient-to-br from-purple-700 to-fuchsia-900 text-white p-10 rounded-2xl mb-12">
            <h2 className="text-3xl font-bold mb-4">Affordable. Accessible. Fully Customizable. Odoo 18 with NDT Industry Overlay.</h2>
            <p className="text-purple-100 text-lg mb-6">Atlantis NDT ERP — 70-85% of SAP / NetSuite functional capability at structurally lower 5-year TCO. Built on Odoo 18 with NDT, inspection, fabrication, asset-integrity modules. Region-specific quote on request.</p>
