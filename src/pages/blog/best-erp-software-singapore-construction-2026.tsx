  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <SEOHead
        ...
        description="Construction ERP for Singapore contractors compared: SAP and NetSuite enterprise tiers versus an affordable, fully customizable alternative. BCA Grade, IRAS GST, InvoiceNow, MOM Work Pass and Jurong Island requirements covered. PSG-eligible. Quote on request."
      ...
      <article className="py-16">
        <div className="container mx-auto max-w-4xl px-6">
          ...
          <section className="mb-12">
            ...
            <p className="text-slate-600 text-lg leading-relaxed mb-6">
              IMDA's Productivity Solutions Grant subsidizes up to 50% of cloud-ERP cost for Singapore SMEs, capped at SGD 30,000 over three years. A Grade B1 contractor adopting Atlantis NDT ERP can apply the PSG against the subscription up to the scheme cap, which materially reduces the net three-year cost. Even before the grant, consolidating spreadsheets, Xero, MYOB and standalone HR onto one platform is usually the cheaper option — request a tailored quote to model it for your headcount.
            </p>
            <p className="text-slate-600 text-lg leading-relaxed mb-6">
