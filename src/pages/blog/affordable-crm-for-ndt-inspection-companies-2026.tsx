  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <SEOHead
        ...
        description="Affordable CRM for NDT inspection companies 2026. Atlantis NDT ERP CRM regional pricing vs HubSpot $300K vs Salesforce $450K 5-yr TCO. ASNT/ISNT/PCN cert tracking, Aramco/ADNOC/PETRONAS portals built-in."
      ...
      <div className="py-6 bg-white border-b">
        <div className="container mx-auto max-w-4xl px-6">
          <SocialShare title="Affordable CRM for NDT Inspection Companies 2026" description="Honest CRM buyer guide for NDT inspection firms — regional pricing flat vs $300K+ alternatives." />
        </div>
      </div>
