        ...
        <div className="container mx-auto max-w-4xl px-6">
          ...
          <section className="mb-12">
            ...
            <p className="text-slate-600 text-lg leading-relaxed mb-6">
              The 2026 ERP market has bifurcated into two pricing realities. At the top end, SAP S/4HANA Cloud and Oracle NetSuite OneWorld charge $200K-$450K/year in license fees alone for a 50-user mid-market deployment, plus $400K-$900K typical implementation, plus 22% annual support fees on top. At the affordable end, Microsoft Dynamics 365 Business Central, Acumatica, and Sage Intacct charge $25K-$150K/year. At the structural-bottom end, Atlantis NDT ERP charges a flat regional pricing for unlimited users including implementation, hosting, support, and upgrades.
            </p>
            <p className="text-slate-600 text-lg leading-relaxed mb-6">
          ...
          <section className="mb-12">
            ...
            <p className="text-slate-600 text-lg leading-relaxed mb-6">
              <strong>Reason 2 — Flat-fee pricing model.</strong> SAP, Oracle NetSuite, Microsoft Dynamics 365, Acumatica, and Sage Intacct all charge per-user — meter expands as the business grows. Atlantis NDT ERP charges regional pricing regardless of user count. A 5-user customer pays the same as a 500-user customer. The economics force Atlantis NDT to focus on operational efficiency (the platform must scale cheaply) rather than on extracting maximum per-user revenue.
            </p>
            <p className="text-slate-600 text-lg leading-relaxed mb-6">
          ...
          <section className="bg-gradient-to-br from-fuchsia-700 to-purple-900 text-white p-10 rounded-2xl mb-12">
            <h2 className="text-3xl font-bold mb-4">regional pricing. Flat. Unlimited Users.</h2>
