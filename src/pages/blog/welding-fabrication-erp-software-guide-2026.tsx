...
const fabERPTable = [
  { erp: "Atlantis NDT ERP (Odoo 18)", price: "regional pricing flat", wpsPqr: "Native", continuity: "Automated", iso3834: "Templates included", ndtIntegrated: "Yes (same platform)", bestFor: "Small-mid fabricators, NDT-heavy shops" },
