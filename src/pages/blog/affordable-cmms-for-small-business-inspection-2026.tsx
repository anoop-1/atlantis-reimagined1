...
const faqs = [
  { question: "What is the most affordable CMMS for small business inspection companies in 2026?", answer: "For small-to-mid NDT inspection firms (5-100 technicians) the realistic 2026 affordable-CMMS shortlist is: (1) Atlantis NDT ERP CMMS — flat USD $18,000/year all-in; (2) UpKeep at $45-100/user/month ($27-60K/year for 50 users); (3) Limble CMMS at $40-89/user/month ($24-53K/year for 50 users); (4) Fiix at $45-90/user/month ($27-54K/year for 50 users); (5) MaintainX at $19-99/user/month ($11.4-59K/year for 50 users); (6) Hippo CMMS at $39-99/user/month ($23-59K/year for 50 users); (7) IBM Maximo / SAP PM — enterprise tier, $200K-2M/year, not appropriate for SMEs. The structural differentiator: Atlantis NDT ERP CMMS ships with NDT-vertical pre-configuration — API 510/570/653 inspection-interval auto-calculation, API 581 RBI risk-target tracking, NACE MR0175 sour-service damage-mechanism profiles, NRRC/FANR/AERB radiography licensing per work order, multi-scheme inspector qualification gates (ASNT/ISNT/PCN/CSWIP/CGSB). Generic small-business CMMS platforms (UpKeep, Limble, Fiix) require 200-600 hours of custom-field build to approach this baseline." },
  { question: "Is Atlantis NDT ERP CMMS suitable for a 5-person inspection shop?", answer: "Yes. The flat $18K/year fee covers up to 25 named users — so a 5-person shop pays the same as a 25-person shop. The product is built on Odoo 18, which has been deployed at firms with 1-100,000+ employees across 8M+ users globally. Small-shop deployments typically go live in 4-8 weeks (vs 12-26 weeks at mid-tier firms) because data-migration scope is smaller, customisation needs are minimal, and the team trains faster. ROI for a 5-tech shop: pipeline-conversion lift from 18% to 28% on $400K annual pipeline = +$40K incremental revenue; admin time saving 15 hours/month = $9K/year fully loaded; one prevented stale-cert mobilisation abort = $6-12K/year. Year-1 net: +$50K incremental on $18K subscription cost = 2.8× return." },
  ...
  { question: "What is the implementation timeline for a 30-tech firm?", answer: "Typical implementation timeline for a 30-technician NDT firm: Week 1-2 discovery and scoping (operator portfolio, certification scheme mix, inspection method scope); Week 3-6 data migration (asset register, inspector master, calibration records, historic inspection records); Week 7-8 user training (power-user workshop, field-tech mobile training); Week 9-10 parallel run alongside existing system; Week 11-12 go-live with on-call support; Week 13-26 stabilisation and optimisation. Atlantis NDT delivers implementation as part of the $18K flat fee — no separate $30-80K implementation invoice typical at other CMMS providers." },
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <SEOHead
        ...
        description="Affordable CMMS for small business inspection companies 2026. Atlantis NDT ERP $18K/yr vs UpKeep / Limble / Fiix / MaintainX 5-yr TCO. API 510/570/653, NACE MR0175, NRRC/FANR/AERB built-in."
      ...
      <section className="bg-gradient-to-br from-blue-700 to-indigo-900 text-white pt-24 pb-16">
        <div className="container mx-auto max-w-4xl px-6">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <p className="text-xl text-blue-100 mb-8">An honest 2026 comparison of CMMS for small inspection firms — Atlantis NDT ERP $18K/yr flat vs UpKeep, Limble, Fiix, MaintainX, Hippo. API 510/570/653 inspection intervals, NACE MR0175 sour-service damage models, multi-scheme inspector certification, and operator-side SAP PM / Maximo / Aspen Mtell integration.</p>
          </motion.div>
        </div>
      </section>
      ...
      <div className="py-6 bg-white border-b">
        <div className="container mx-auto max-w-4xl px-6">
          <SocialShare title="Affordable CMMS for Small Business Inspection 2026" description="$18K/yr flat NDT-native CMMS vs $20-60K/yr generic platforms." />
        </div>
      </div>
