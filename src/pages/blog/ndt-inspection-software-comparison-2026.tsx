...
const faqs = [
  ...
  { question: "How much does NDT inspection management software cost in 2026?", answer: "Realistic 2026 pricing for NDT inspection management software, broken down by tier: Enterprise tier ($150K-1M+/year): Bentley AssetWise APM Reliability, Hexagon HxGN EAM, IBM Maximo + Inspection Module, SAP S/4HANA EAM. Mid-market tier ($25-150K/year): MISTRAS PCMS Cloud (for non-MISTRAS-employed customers), Acuren ASSET licensing, Sphera Cloud, Detechtion (formerly InSite-NXT), Wood Mackenzie Lens Inspection, Antea, PetroSync Inspector, Visions APM, IRISNDT. Specialist tier ($5-25K/year): Atlantis NDT ERP+Reporting (full ERP + inspection + technician tracking at flat $18K/year, optional $50K/year tier with advanced digital-twin features), InspectNTrack, Inspect-Pro, PROOFmate. Free-tier (project-only or limited functionality): MISTRAS Field-Inspect Lite, several open-source CMMS with light NDT extension. Pricing tends to scale on three axes: user count, asset count, and inspection volume per month." },
...
const ndtSoftwareMatrix = [
  { software: "Atlantis NDT ERP+Reporting", price: "$18K-50K/yr flat", methods: "All", instrumentFiles: "Olympus, M2M, Eddyfi, DICONDE", mobile: "Native iOS+Android offline", multiTenant: "Yes", bestFor: "Small-mid NDT vendors, ISO 9712 / ASNT certified shops" },
