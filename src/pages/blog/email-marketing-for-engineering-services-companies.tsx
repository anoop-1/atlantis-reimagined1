      ...
      <article className="py-16">
        <div className="container mx-auto max-w-4xl px-6">
          ...
          <section className="bg-gradient-to-br from-yellow-700 to-orange-900 text-white p-10 rounded-2xl mb-12">
            ...
            <p className="text-yellow-100 text-lg mb-6">Atlantis NDT ERP — cold outreach, nurture, ABM, multi-persona sending, per-country compliance, deliverability monitoring. Affordable regional pricing, quote on request.</p>
            <div className="flex flex-wrap gap-4">
              <Link to="/erp" className="bg-white text-yellow-900 px-6 py-3 rounded-lg font-semibold hover:bg-yellow-50 flex items-center gap-2">Get a Quote <ArrowRight className="w-4 h-4" /></Link>
