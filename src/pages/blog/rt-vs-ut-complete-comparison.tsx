...
const faqs = [
    ...
    { question: "What are the cost differences between UT and RT?", answer: "Ultrasonic Testing: Equipment is a significant capital item (handheld systems); labor billed per crew-hour; probe replacement a scoped, quoted figure. Total inspection cost: typically a scoped, quoted figure. Radiography: Equipment is a significant capital item+ (X-ray/gamma units); film/digital DR system; lead shielding. Labor: a scoped, quoted figure (includes radiation safety overhead, RSO coordination, film processing). Consumables: film (a scoped, quoted figure/exposure) or digital plate costs. Total inspection cost: typically a scoped, quoted figure. For equivalent weld inspection, UT costs 50-70% less than RT. However, if advanced equipment (automated UT scanner, PAUT) used, costs equalize. For cost-sensitive projects, UT is clear choice. For critical applications where both methods required, combined cost is justified by defect confidence." },
...
const rtUtComparison = [
    ...
    { criterion: "Cost", rt: "High: a scoped, quoted figure equipment and labor", ut: "Moderate: a scoped, quoted figure equipment and labor" },
    { criterion: "Equipment Investment", rt: "Very high: a scoped, quoted figure+ for X-ray/gamma unit", ut: "Moderate: a scoped, quoted figure for handheld; a scoped, quoted figure for PAUT" },
...
const caseStudyComparison = [
    { scenario: "Large diameter pipeline girth weld inspection (1,000 welds)", rtResult: "Would require 500+ hours, 2-3 month inspection period, a scoped, quoted figure cost", utResult: "50-100 hours, 1-2 week inspection, a scoped, quoted figure cost. UT wins decisively on speed/cost. If defect found, follow with spot RT.", decision: "Use UT primary" },
                    ...
                    <section className="mb-12">
                        ...
                        <div className="bg-cyan-50 border-l-4 border-cyan-500 p-6 mb-6">
                            ...
                            <ul className="text-cyan-800 space-y-2">
                                ...
                                <li>RT costs vary with scope/hour; UT costs vary with scope/hour</li>
                    ...
                    <section className="mb-12">
                        ...
                        <div className="grid md:grid-cols-2 gap-4 mb-8">
                            ...
                            <div className="bg-blue-50 p-4 rounded-lg border-l-4 border-blue-500">
                                ...
                                <p className="text-blue-800 text-sm">Equipment and labor both sit well below RT for most scopes - 50-70% cheaper than equivalent RT inspection.</p>
                            </div>
                        </div>
