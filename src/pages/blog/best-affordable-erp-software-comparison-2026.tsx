  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <SEOHead
        ...
        description="Best affordable ERP software 2026. Atlantis NDT ERP regional pricing vs Odoo Enterprise, Sage Intacct, Acumatica, Microsoft Dynamics 365 BC, NetSuite, SAP B1. Real 5-year TCO, per-user breakeven."
      ...
      <section className="bg-gradient-to-br from-indigo-700 to-blue-900 text-white pt-24 pb-16">
        <div className="container mx-auto max-w-4xl px-6">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <p className="text-xl text-indigo-100 mb-8">An honest 2026 comparison of the best affordable ERP software — Atlantis NDT ERP regional pricing flat, Odoo Enterprise, Sage Intacct + Sage 200, Acumatica, Microsoft Dynamics 365 BC, NetSuite SuiteSuccess, SAP Business One, Epicor Kinetic, IFS Cloud, Xero, QuickBooks, Zoho One, FreshBooks. 5-year TCO for 5-, 25- and 50-user deployments.</p>
          </motion.div>
        </div>
      </section>
