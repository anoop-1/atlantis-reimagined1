  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <SEOHead
        ...
        description="Affordable ERP for pipeline-integrity companies 2026. Atlantis NDT ERP regional pricing vs Quorum / MISTRAS PCM / ROSEN AIM / Penspen INTEGRATE. PHMSA 192/195, API 1160/1163/1173, ILI run management, CP surveys."
      ...
      <section className="bg-gradient-to-br from-yellow-700 to-amber-900 text-white pt-24 pb-16">
        <div className="container mx-auto max-w-4xl px-6">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <p className="text-xl text-yellow-100 mb-8">An honest 2026 ERP comparison for pipeline-integrity service providers — Atlantis NDT ERP regional pricing vs Quorum, MISTRAS PCM, ROSEN AIM, Penspen INTEGRATE. PHMSA 49 CFR 192 / 195, API 1160 / 1163 / 1173, ILI run management (MFL / TFI / UT / EMAT), cathodic-protection surveys per NACE SP0169 / SP0286, hydrostatic testing per ASME B31.4 / B31.8 / API 1110, AUT girth-weld inspection per DNV-ST-F101.</p>
          </motion.div>
        </div>
      </section>
      ...
      <div className="py-6 bg-white border-b">
        <div className="container mx-auto max-w-4xl px-6">
          <SocialShare title="Affordable ERP for Pipeline-Integrity Service Companies 2026" description="regional pricing flat pipeline-integrity ERP with PHMSA / API native." />
        </div>
      </div>
        ...
        <div className="container mx-auto max-w-4xl px-6">
          <section className="mb-12">
            ...
            <p className="text-slate-600 text-lg leading-relaxed mb-6">
              Pipeline-integrity services is a code-driven, regulatory-driven, and lawsuit-driven business. PHMSA enforcement actions following the Carlsbad NM (2000), Bellingham WA (1999), San Bruno CA (2010), Salem Township PA (2018) and Aliso Canyon CA (2015) incidents have created a regulatory environment where inspection-record completeness, ILI tool-qualification documentation, and integrity-management-program evidence directly drive operator continued-operations approval. Generic enterprise platforms (Quorum, MISTRAS PCM, ROSEN AIM) handle parts of this — but at enterprise cost levels that exclude most independent pipeline-services contractors below $20M revenue.
            </p>
            <p className="text-slate-600 text-lg leading-relaxed mb-6">
              Atlantis NDT ERP pipeline-services deployment ships with PHMSA / API workflow pre-built and ILI vendor integration native — affordable, accessible, fully customizable, with one all-in fee covering the whole ERP stack. Pricing varies by region; quote on request at info@atlantisndt.com.
            </p>
          </section>
