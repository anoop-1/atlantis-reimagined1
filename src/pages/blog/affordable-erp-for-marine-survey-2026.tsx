...
const faqs = [
  ...
  { question: "What is the typical 5-year TCO for a 20-surveyor marine firm?", answer: "5-year TCO comparison for a 20-surveyor marine-survey firm: Lloyd's Register OneOcean $150-400K; DNV Veracity $125-300K; ABS Eagle $100-275K; Marine Software MSL $75-225K; Stream BV NaviSafe $100-250K; Atlantis NDT ERP $90K flat (all-in including ERP, CRM, sales-pipeline, P&I damage-survey workflow, multi-currency invoicing, IACS class-society parallel tracking). Plus most generic marine packages still require separate accounting software (Xero / QuickBooks / Sage) at $5-15K/year." },
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <SEOHead
        ...
        description="Affordable ERP for marine survey companies 2026. Atlantis NDT ERP $18K/yr vs Lloyd's Register / DNV Veracity / ABS Eagle / Marine Software MSL. IACS class survey, IMO MARPOL/EEXI/CII, P&I damage, port-state-control."
      ...
      <div className="py-6 bg-white border-b"><div className="container mx-auto max-w-4xl px-6"><SocialShare title="Affordable ERP for Marine Survey 2026" description="$18K/yr marine survey ERP." /></div></div>
