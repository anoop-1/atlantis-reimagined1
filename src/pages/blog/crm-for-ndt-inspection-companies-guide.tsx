  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <SEOHead
        ...
        description="CRM for NDT inspection companies 2026. Tender workflow, multi-customer config, technician availability, certification coverage, cold-email + nurture, pipeline forecasting. Atlantis NDT regional pricing."
