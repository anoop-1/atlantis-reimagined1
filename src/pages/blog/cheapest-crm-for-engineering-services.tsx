  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <SEOHead
        ...
        description="Cheapest CRM for engineering services 2026. HubSpot vs Zoho vs Pipedrive vs Salesforce vs Atlantis NDT ERP regional pricing flat. Per-user breakeven, engineering-vertical features, real 5-yr TCO."
