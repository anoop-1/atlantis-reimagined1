...
const faqs = [
  ...
  { question: "How much does SAP cost in Malaysia versus Atlantis NDT ERP?", answer: "SAP S/4HANA in Malaysia: implementation typically RM 800K-2.5M for a 50-200 user mid-tier contractor (Accenture/Deloitte/PwC Malaysia local rates), plus RM 250K-600K annual SAP license fees and roughly RM 180K-400K/year in third-party support. Total Year 1: RM 1.2-3.5M. Year 2-5: RM 430K-1M/year ongoing. Atlantis NDT ERP uses affordable flat-fee regional pricing (quote on request) that includes hosting, implementation, training, support, upgrades and unlimited users, so the five-year total cost sits an order of magnitude below an enterprise-tier SAP deployment. That gap is why we focus on G3-G5 contractors and PETRONAS Tier-2/Tier-3 vendors — a small Malaysian construction firm cannot absorb a SAP-class deployment, but they still need the same functional capabilities to win and execute work." },
...
const erpComparisonMalaysia = [
  { erp: "Atlantis NDT ERP (Odoo 18)", priceMYR: "Affordable regional pricing — quote on request", users: "Unlimited", deployment: "Cloud / On-prem", sstReady: "Yes", myInvois: "Yes", petronasReady: "Yes (pre-built)", bestFor: "G3-G7 contractors, PETRONAS Tier-2/Tier-3 vendors" },
        ...
        <div className="container mx-auto max-w-4xl px-6">
          ...
          <section className="bg-gradient-to-br from-emerald-700 to-teal-900 text-white p-10 rounded-2xl mb-12">
            ...
            <div className="flex flex-wrap gap-4">
              <Link to="/erp" className="bg-white text-emerald-900 px-6 py-3 rounded-lg font-semibold hover:bg-emerald-50 flex items-center gap-2">Get a Quote <ArrowRight className="w-4 h-4" /></Link>
