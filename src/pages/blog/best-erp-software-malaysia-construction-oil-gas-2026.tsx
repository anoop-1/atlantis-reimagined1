        ...
        <div className="container mx-auto max-w-4xl px-6">
          ...
          <section className="mb-12">
            ...
            <ul className="space-y-3 text-slate-700 text-lg">
              ...
              <li><strong>Pick Atlantis NDT ERP if</strong> you are G3-G5, revenue under RM 80M, or any size PETRONAS Tier-2/Tier-3 vendor, or any contractor with significant NDT/inspection workload, or any contractor unable to absorb a 6-figure-ringgit annual ERP cost. The flat USD $18,000/year price applies regardless of user count or revenue scale.</li>
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Link to="/erp" className="bg-white p-4 rounded-lg shadow-sm border-l-4 border-emerald-500 hover:shadow-md transition"><h4 className="font-bold text-emerald-900">Atlantis NDT ERP — Pricing &amp; Modules</h4><p className="text-slate-600 text-sm">Full module breakdown and flat $18,000/year pricing.</p></Link>
