...
const faqs = [
    { question: "How much does the ASNT Level III exam cost in 2026?", answer: "As of May 2026, the ASNT Level III Method Exam fee is $570 for ASNT members and $720 for non-members per method. The mandatory Basic Exam (a one-time requirement, separate from any method) is $390 for members and $510 for non-members. Application/processing fees of approximately $115 (members) and $155 (non-members) apply on top of the exam. Most candidates also pay $175 per year for ASNT individual membership to access the member rate — which still nets out cheaper than non-member pricing the moment you sit for even one exam. Fees are subject to change; verify the current published schedule at asnt.org before applying." },
    { question: "What is the ASNT Level III renewal fee?", answer: "ASNT Level III certificates are valid for 5 years. The recertification fee in 2026 is $475 per method for ASNT members and $625 per method for non-members under the Points or Examination renewal paths. If you let your certification lapse and need a full Recertification Examination, the fee jumps to roughly the same as a new Method Exam ($570/$720). The Basic Exam does NOT require renewal — once you pass it, it's good for life as long as you maintain at least one active method. Renewal must be submitted within 6 months before the expiration date to avoid late fees of approximately $100." },
    ...
    { question: "Is ASNT membership worth $175/year just for the exam discount?", answer: "Yes — the math is decisively in favor of membership for anyone planning to sit any exam. ASNT individual membership costs $175/year (2026 rate). The member discount on a single Method Exam is $150 ($570 vs $720), the discount on the Basic Exam is $120 ($390 vs $510), and the discount on a recertification is $150 ($475 vs $625). Sitting any one of these as a member already recovers most of the annual dues. Beyond exam discounts, membership includes Materials Evaluation journal, access to ASNT standards drafts, conference discounts ($300+ savings on ASNT Annual Conference), and section networking. For working NDT professionals, ASNT membership is a no-brainer." },
    { question: "What is the total lifetime cost of ASNT Level III in 3 methods over 25 years?", answer: "Realistic total lifetime cost for an ASNT Level III certified in 3 methods (e.g., UT + RT + MT) over a 25-year career: Initial certification — Basic ($390) + 3 Method Exams ($570 x 3 = $1,710) + 4 application fees ($115 x 4 = $460) = $2,560. Renewals — 5 recertification cycles for 3 methods at $475 each = $7,125. ASNT membership — 25 years x $175 = $4,375. Prep materials and courses spread across 3 methods — $3,000-$6,000. Travel for exams (if not local) — $1,500-$3,000. Total: roughly $18,500-$23,000 over 25 years, or $750-$925 per year on average. Against the $30K-$60K annual salary premium ASNT Level III delivers, this is one of the highest ROI professional credentials in industrial inspection." },
    { question: "How does ASNT Level III cost compare to ISO 9712 Level 3?", answer: "ISO 9712 Level 3 certification (offered by bodies such as PCN, CSWIP, BINDT, and TUV) typically costs $1,200-$2,000 per method exam — significantly more expensive per exam than ASNT's $570-$720 member/non-member rates. However, ISO 9712 has a tighter renewal cycle (every 5 years with mandatory examination, no points option) and renewal fees of $400-$800. The cost gap closes over a full career, but ASNT remains the more economical pathway in the US market. ISO 9712 makes financial sense if you're working in Europe, the Middle East, or with operators that contractually require ISO certification. See our full ISO 9712 vs ASNT comparison for the breakdown." },
    ...
    { question: "What hidden costs should I budget for beyond the ASNT exam fee?", answer: "Beyond the headline $570 method exam, plan for: Application/processing fee ($115-$155), ASNT membership ($175/yr), Basic Exam ($390/$510) if first method, study materials and reference books ($300-$700 for the Programmed Instruction series + CP-105 plus method-specific Recommended Practice), formal prep course ($800-$2,500 depending on provider and format — Hellier, TPC, IRRSP partners), practice exam packages ($150-$400), travel to test center ($300-$1,500 if not local — ASNT computer-based testing is widely available but specimens may still require designated centers), and lost work days (1-2 days off for prep + exam). Realistic all-in cost for a first method: $2,500-$4,500 for self-funded candidates." },
    ...
    { question: "Are ASNT fees the same internationally or do they change by country?", answer: "ASNT fees are USD-denominated and standardized globally — a candidate sitting the exam in Houston pays the same exam fee as a candidate sitting in Dubai, Mumbai, or Singapore. However, test center surcharges (Prometric facilities outside the US apply a small administration fee, typically $25-$60), local currency conversion, and travel costs vary widely. ASNT exam sessions outside the US are less frequent — candidates in remote regions often combine exam sittings with the ASNT Annual Conference or regional ASNT events. All published fees on this page are subject to change without notice; verify the current schedule at asnt.org before paying. Atlantis NDT runs ASNT Level III prep and exam-routing support for candidates in the Middle East, India, and SE Asia." }
];
