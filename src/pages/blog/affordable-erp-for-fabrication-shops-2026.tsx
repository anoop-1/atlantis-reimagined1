  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <SEOHead
        ...
        description="Affordable ERP for fabrication shops 2026. Atlantis NDT ERP regional pricing vs Epicor / Global Shop / ECi / SAP B1 5-yr TCO. AWS D1.1 / ASME IX, PED, NDE travelers, L&T / BHEL / Bharat Forge integration."
      ...
      <div className="py-6 bg-white border-b">
        <div className="container mx-auto max-w-4xl px-6">
          <SocialShare title="Affordable ERP for Welding & Fabrication Shops 2026" description="regional pricing flat fabrication-shop ERP with AWS D1.1 / ASME IX / NDE traveler native." />
        </div>
      </div>
