...
const costByDiameter = [
    { diameter: "6\" (150 mm)", costPerKm: "Highest per-km tier", costPerMile: "Small-bore tooling premium", typicalRun: "10-30 km gathering lines", mobFee: "Mobilization dominates short runs" },
    { diameter: "10\"-12\" (250-300 mm)", costPerKm: "High per-km tier", costPerMile: "Falls as diameter rises", typicalRun: "20-80 km", mobFee: "Mobilization still a large share" },
    { diameter: "16\"-20\" (400-500 mm)", costPerKm: "Mid per-km tier", costPerMile: "Economies of scale begin", typicalRun: "50-150 km", mobFee: "Amortizes over longer runs" },
    { diameter: "24\" (600 mm)", costPerKm: "Mid-low per-km tier", costPerMile: "Standard transmission size", typicalRun: "80-200 km", mobFee: "Moderate share of total" },
    { diameter: "30\" (750 mm)", costPerKm: "Low per-km tier", costPerMile: "Volume economics", typicalRun: "100-300 km", mobFee: "Small share of total" },
    { diameter: "36\"-42\" (900-1050 mm)", costPerKm: "Lowest per-km tier", costPerMile: "Trunkline economics", typicalRun: "150-500 km trunklines", mobFee: "Smallest share of total" }
];
...
const topVendors = [
    ...
    { vendor: "Baker Hughes (PII/BHGE)", hq: "Cramlington, UK", flagship: "MagneScan HD, MagneScan Triax, Vectra", strength: "Original PII heritage, strong in gas transmission, dual-field MFL", priceTier: "Premium", typicalProjectMin: "40 km minimum-run threshold" },
    ...
    { vendor: "T.D. Williamson (TDW)", hq: "Tulsa, OK", flagship: "SpirALL MFL (spiral magnetization), Multidataset", strength: "Spiral MFL for axial crack detection, North American gas transmission", priceTier: "Mid-Premium", typicalProjectMin: "30 km minimum-run threshold" },
    { vendor: "Onstream Pipeline Inspection", hq: "Calgary, Canada", flagship: "HR-MFL combo tools", strength: "Cost-competitive HR-MFL, fast turnaround, distribution and gathering", priceTier: "Mid-Market", typicalProjectMin: "20 km minimum-run threshold" },
    { vendor: "Quest Integrity", hq: "Kent, WA", flagship: "InVista UT for unpiggable lines", strength: "Unpiggable, tight-bend, refinery piping", priceTier: "Specialty Premium", typicalProjectMin: "5 km minimum-run threshold" },
    { vendor: "Enduro Pipeline Services", hq: "Tulsa, OK", flagship: "MFL ILI for low-pressure systems", strength: "Low-flow / low-pressure gas distribution", priceTier: "Mid-Market", typicalProjectMin: "15 km minimum-run threshold" },
    { vendor: "Pipesurvey International", hq: "Netherlands", flagship: "MFL + caliper combos", strength: "European market, smaller-diameter expertise", priceTier: "Mid-Market", typicalProjectMin: "20 km minimum-run threshold" }
];
...
const costOptimization = [
    ...
    { strategy: "Reuse Recent Cleaning Pig Data", savings: "A meaningful saving per run", rationale: "If pipeline was cleaned recently for product reasons, skip redundant cleaning runs. Confirm with vendor." },
        ...
        "@graph": [
            {
                ...
                "description": "What drives MFL in-line inspection cost — diameter, run length, mobilization, dig verification — plus a vendor landscape (Rosen, Baker Hughes, NDT Global, TDW) and an honest MFL vs UT ILI decision matrix. Updated 2026.",
    ...
    return (
        <div className="min-h-screen bg-slate-50">
            ...
            <SEOHead
                ...
                description="MFL vs UT for pipeline in-line inspection: what each detects and misses, the cost drivers rather than rate cards, vendor landscape, and a decision matrix for choosing between them."
                ...
                <div className="container mx-auto max-w-4xl px-6">
                    ...
                    <section className="mb-12">
                        ...
                        <p className="text-slate-600 text-lg leading-relaxed mb-6">
                            MFL inline inspection (ILI) is priced per kilometer, and the rate moves over a wide band depending on pipeline diameter, total length, geography, and vendor tier. Small-diameter pipelines (6 inch) cost more per kilometer because tool mobilization is amortized over fewer kilometers; large-diameter trunklines (36 inch+) sit at the lowest per-km tier. The table below reflects fixed-fee turnkey pricing including pre-cleaning, gauge run, MFL data acquisition, Level 2 analysis report, and dig sheets - the four-line item buyers actually care about.
                        </p>
