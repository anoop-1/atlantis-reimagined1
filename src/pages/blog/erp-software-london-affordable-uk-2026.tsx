        ...
        <div className="container mx-auto max-w-4xl px-6">
          ...
          <section className="mb-12">
            ...
            <ul className="space-y-3 text-slate-700 text-lg">
              ...
              <li><strong>Atlantis NDT ERP</strong> — Engineering services, inspection firms, Aberdeen offshore-service vendors, any UK SME needing real ERP without 6-figure cost. Flat annual subscription regardless of user count — quote on request.</li>
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Link to="/erp" className="bg-white p-4 rounded-lg shadow-sm border-l-4 border-indigo-500 hover:shadow-md transition"><h4 className="font-bold text-indigo-900">Atlantis NDT ERP Pricing</h4><p className="text-slate-600 text-sm">Flat annual subscription with UK localization, MTD VAT, CIS, PSSR. Quote on request.</p></Link>
          ...
          <section className="bg-gradient-to-br from-indigo-700 to-blue-900 text-white p-10 rounded-2xl mb-12">
            <h2 className="text-3xl font-bold mb-4">Affordable, Accessible, Fully Customizable — Quote on Request</h2>
