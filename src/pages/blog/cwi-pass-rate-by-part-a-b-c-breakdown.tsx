...
const faqs = [
    ...
    { question: "How much does it cost to retake the CWI exam?", answer: "Retake fees depend on how many parts the candidate failed. As of 2026: single-part retake (one of A, B, or C) is approximately $375-$425; two-part retake is approximately $575-$650; full three-part retake is approximately $850-$1,100. Candidates have a 1-year window from the initial exam date to retake failed parts without restarting from scratch - after 1 year, the entire exam (all three parts) must be retaken. Retakes can be scheduled at any AWS Accredited Testing Facility (ATF) - the candidate does not need to attend a seminar again. Strategically, candidates who fail only Part B should focus retake prep on hands-on practice with weld replicas and fillet gauges, while Part C failures usually indicate poor code-book tabbing rather than weak welding knowledge." },
