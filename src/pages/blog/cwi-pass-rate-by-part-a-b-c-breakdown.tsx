...
const faqs = [
    ...
    { question: "What happens if I fail the CWI exam?", answer: "Failing the CWI exam (any part below 72%) does not end your certification path - it triggers a retake window. AWS retake policy as of 2026: candidates have 1 year from the original exam date to retake failed parts. During that year, candidates can retake any failed part(s) without retaking parts they passed. After 1 year, the entire exam (all three parts) must be retaken from scratch, regardless of which parts were previously passed. Retake fees scale with how many parts you resit - single part cheapest, full retake approaching the original exam fee. Tactically: schedule the retake within 60-90 days of the original exam while material is fresh; focus study time on the specific part(s) failed; if you failed Part B, get hands-on with plastic weld replicas and fillet weld gauges - reading more about weld inspection won't help, only practice will; if you failed Part C, retab your code book and consider switching to D1.1 if you originally chose a more difficult code (allowed at the discretion of AWS - check with your ATF). Most candidates who retake within 90 days pass on the second attempt." }
];

const passRateByPart = [
    { part: "Part A - Fundamentals", firstTime: "~70%", overall: "~85%", failure: "Welding metallurgy, NDT method limits, safety/health exposure limits", retake: "a scoped, quoted figure" },
    { part: "Part B - Practical", firstTime: "~50-55%", overall: "~75%", failure: "Time pressure (1.5 hr per scenario), wrong gauge selection, sloppy written reports", retake: "a scoped, quoted figure" },
    { part: "Part C - Code Book", firstTime: "~60-65%", overall: "~80%", failure: "Untabbed code book, chose unfamiliar code (B31.3 without piping experience)", retake: "a scoped, quoted figure" },
    { part: "All Three Combined", firstTime: "~30-40%", overall: "~65-70%", failure: "Cumulative probability - failing any one part fails the attempt", retake: "a scoped, quoted figure (full retest)" }
];
...
const seminarImpact = [
    { path: "Self-Study Only (no seminar)", firstTimePass: "~25-30%", studyHours: "200-300 hours", cost: "exam plus code books at current AWS rates" },
    { path: "Self-Study + AWS Seminar", firstTimePass: "~45-55%", studyHours: "150-200 hours + 40 hr seminar", cost: "a scoped, quoted figure exam + a scoped, quoted figure seminar = ~a scoped, quoted figure" },
    { path: "AWS Seminar + 5+ Years Field Experience", firstTimePass: "~65-75%", studyHours: "80-120 hours + 40 hr seminar", cost: "Same as above ~a scoped, quoted figure" },
    { path: "Third-Party Bootcamp + Self-Study", firstTimePass: "~40-50%", studyHours: "200 hours + 40 hr bootcamp", cost: "a scoped, quoted figure exam + a scoped, quoted figure bootcamp = ~a scoped, quoted figure" }
];
            ...
            <article className="py-16">
                <div className="container mx-auto max-w-4xl px-6">
                    ...
                    <section className="mb-12">
                        ...
                        <div className="bg-amber-50 border-l-4 border-amber-500 p-6">
                            <p className="text-amber-900">
                                <strong>Seminar economics:</strong> The AWS seminar costs ~a scoped, quoted figure. Single-part retake fees are ~a scoped, quoted figure each. If skipping the seminar leads to retaking just two parts, the candidate has already exceeded seminar cost - and lost months of CWI-eligible income. For most candidates, the seminar pays for itself in retake-avoidance alone.
                            </p>
                        </div>
                    </section>
