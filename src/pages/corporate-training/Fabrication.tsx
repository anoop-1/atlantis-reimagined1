...
const config: VerticalConfig = {
   ...
   methods: [
      { method: "Visual Testing per AWS D1.1 Clause 6.9 + CWI alignment", levels: "Level II + CWI / CSWIP cert", roleFit: "Shop welding inspectors, owner-rep QC", codeRef: "AWS D1.1 Clause 6, AWS B5.1 (CWI), ISO 17637" },
   ...
   tracks: [
      { role: "Shop Welding Inspector", progression: "Level II VT + MT + PT, then CWI / CSWIP 3.1 prep", coreMethods: "VT, MT, PT + CWI", hoursTotal: "200–240 instructor-led + 40-hour CWI prep" },
   ...
   caseStudy: {
      headline: "Major modular fabrication yard — Asia-Pacific — 56-engineer multi-method cohort",
      body: "An Asia-Pacific modular-build fabrication yard supplying topsides modules to a major LNG project needed to lift the QC bench to owner-spec readiness across a 22-month module-build campaign. Atlantis NDT delivered a phased cohort: 56 engineers across VT Level II + CWI prep, MT and PT Level II, UT Level II with PAUT extension, RT Level II, plus a separate welding engineering workshop on ASME IX procedure qualification for the engineering bench. First-attempt CWI pass rate landed at 78% (industry baseline 60%), Level II first-attempt pass rates above 90% on every method, and the owner's source-inspection audit closed each module-handover gate without personnel-qualification findings. Per-head training cost landed 31% below the previous arrangement of contracting prep through a third-party CWI school.",
   },
   cityLinks: [
