...
const config: VerticalConfig = {
   ...
   industryDisplay: "Power Generation",
   industryShort: "thermal power utilities, combined-cycle operators and OEM service crews",
   heroSubhead:
      "In-house NDT programs for boiler tubes, headers, steam piping, turbine components, and HRSG bundles. Built around ASME Section I, ASME B31.1 power piping, NBIC NB-23, and the EPRI guidelines that govern outage-window inspection of high-energy piping (HEP) and seam-welded LP steam piping (Mokrichev / Hartford-style failures the industry remembers).",
   primaryStandards: ["ASME Section I", "ASME B31.1", "NBIC NB-23", "ASME PCC-2", "EPRI guidelines (HEP)", "API 579-1 (FFS)", "ASME Section V"],
   methods: [
      { method: "Ultrasonic Testing — Conventional + PAUT + creep / linear-scan UT for HEP", levels: "Level II → III", roleFit: "Outage UT crews, HEP inspectors, header inspection leads", codeRef: "ASME V Article 4, EPRI HEP guidelines, ASME B31.1 §136" },
      { method: "Time-of-Flight Diffraction (TOFD)", levels: "Level II", roleFit: "Heavy-wall steam-drum and header inspectors", codeRef: "ASME V Article 4 Mandatory App III" },
      { method: "Eddy Current Testing — boiler / condenser tubing", levels: "Level II + III", roleFit: "Tube-bundle outage inspectors, condenser teams", codeRef: "ASME V Article 8, ASTM E309, EPRI tube-inspection guidelines" },
   ...
   wordCountHint:
      "Power generation NDT corporate training operates inside two constraints other verticals do not share at the same intensity. First, the outage window is sacred — the cohort schedule has to bend to the maintenance plan, not the other way round, and engineers have to be current on the methods they will run during the outage at the moment the unit comes down. Second, the asset population is aging in most developed-market utilities. Coal-fired plants commissioned in the 1970s and 1980s are still operating in much of the world; combined-cycle plants from the 1990s and 2000s are in the high-cycle-count phase of their life. Both conditions mean creep damage, fatigue cracking, and Type IV cracking on seam-welded HEP are actively present in the asset base. Our power-gen cohorts are built to those realities. Theory loads onto the LMS during normal operation and is sequenced to complete two weeks before the outage. PAUT, ET array, and TOFD practicals concentrate during the outage itself, with engineers running the methods on the real equipment under instructor oversight. We integrate the ASME B31.1 power piping code, ASME Section I boiler code, and NBIC NB-23 R-stamp / S-stamp framework throughout — generic SNT-TC-1A theory does not transfer cleanly to the way a jurisdictional Authorised Inspector reviews work in this industry. Eddy current training is given particular weight. Bobbin coil is foundational but rotating-probe and array techniques are necessary for the support-plate intersections, dent zones, and pitting patterns the modern condenser and steam-generator outage finds. Reliability and FFS training is run as a separate engineer-level workshop. API 579-1 Level 1 and Level 2 closures are well within in-house competence once the engineer has been through a structured workshop on general metal loss, local thin areas, pitting, blisters, weld misalignment, and crack-like flaw assessment — most utilities currently send those workloads to consultancy at significant cost. We close that gap with a focused workshop and the running case-study work needed to maintain currency. Send fleet profile, outage cycle, and headcount — we respond inside two business days with a written training plan.",
};

export default function PowerGenerationCorporateTraining() {
