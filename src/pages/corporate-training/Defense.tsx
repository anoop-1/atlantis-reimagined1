...
const config: VerticalConfig = {
   ...
   heroSubhead:
      "In-house NDT programs for defense primes, naval shipyards, military aviation depots, and ground-vehicle MRO operations. Built around MIL-STD-2154, MIL-STD-1907, NAVSEA technical publications (TP248, TP271), NAS 410, and the depot-maintenance written-practice expectations DCMA, NAVAIR, NAVSEA, AMC, AFMC, and allied defense customers actually audit against.",
   primaryStandards: ["NAS 410", "MIL-STD-2154", "MIL-STD-1907", "NAVSEA TP248 / TP271", "T.O. 33B-1-1 (USAF NDI)", "ASTM E1742", "ASTM E1444"],
   methods: [
      ...
      { method: "Visual Testing per MIL-STD-2154 / NAS 410", levels: "Level II", roleFit: "All depot inspectors as a baseline; structural visual leads", codeRef: "MIL-STD-2154, NAS 410, ASME V Article 9" },
   ],
   skillGaps: [
      { gap: "Depot inspectors holding generic SNT-TC-1A Level II without bridging to NAS 410 / MIL-STD written practice", impact: "DCMA / NAVAIR / NAVSEA audit findings; depot accreditation risk; mission-readiness consequences." },
   ...
   tracks: [
      { role: "Aviation Depot Inspector", progression: "Level II ET + UT + PT + MT, mapped to NAS 410 + T.O. 33B-1-1 + customer-platform written practice", coreMethods: "ET, UT, PT, MT", hoursTotal: "240–280 instructor-led + 1,200 OJT to NAS 410 hours" },
