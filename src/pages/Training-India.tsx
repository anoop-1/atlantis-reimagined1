                ...
                <div className="container mx-auto px-6">
                    ...
                    >
                        <h2 className="text-3xl md:text-4xl font-bold mb-4">
                            What Our India Clients Say
                        </h2>
                        <p className="text-muted-foreground max-w-2xl mx-auto">
                            Hear from NDT professionals across India who advanced their careers with Atlantis
                        </p>
                    </motion.div>
                            ...
                            <Card className="h-full">
                                <CardContent className="pt-6">
                                    ...
                                    <p className="text-muted-foreground mb-4 italic">
                                        "After completing my ASNT Level II certification from Atlantis, I got placed at L&T within one month. The practical training with real manufacturing components was invaluable."
                                    </p>
                                    <div className="font-semibold">Rajesh K.</div>
                                    <div className="text-sm text-muted-foreground">NDT Engineer, Mumbai, Maharashtra</div>
                                </CardContent>
                            </Card>
                        </motion.div>
                        ...
                        >
                            <Card className="h-full">
                                <CardContent className="pt-6">
                                    ...
                                    <p className="text-muted-foreground mb-4 italic">
                                        "Atlantis is the best NDT institute in Chennai. Their Level III instructors have excellent industry experience and the course fee is very reasonable compared to the quality of training."
                                    </p>
                                    <div className="font-semibold">Priya S.</div>
                                    <div className="text-sm text-muted-foreground">QA Manager, Chennai, Tamil Nadu</div>
                                </CardContent>
                            </Card>
                        </motion.div>
                        ...
                        >
                            <Card className="h-full">
                                <CardContent className="pt-6">
                                    ...
                                    <p className="text-muted-foreground mb-4 italic">
                                        "I completed my UT and RT Level II from Atlantis. The ASNT certification is recognized by ONGC, IOCL, and all major PSUs. I now work in the oil & gas sector with an excellent salary."
                                    </p>
                                    <div className="font-semibold">Amit V.</div>
                                    <div className="text-sm text-muted-foreground">Senior Inspector, Delhi NCR</div>
                                </CardContent>
                            </Card>
                        </motion.div>
                    </div>
