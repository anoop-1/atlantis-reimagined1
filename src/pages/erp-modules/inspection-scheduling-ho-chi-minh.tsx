...
const data = {
  ...
  "cityUseCases": [
    "A mid-size Ho Chi Minh City inspection contractor serving PetroVietnam (PVN) and Vietsovpetro offshore JV deploys inspection scheduling & interval management as a standalone module — replacing spreadsheets and disconnected SaaS — and reports 60-80% admin-time reduction within 90 days.",
    "A Ho Chi Minh City EPC quality team standardizes inspection scheduling & interval management across 4 simultaneous project sites in the Vietnam market. Daily reports, audit packages, and customer-format reports flow to Long Son Petrochemicals (SCG) portals automatically.",
    "A growing Ho Chi Minh City-based service provider integrates inspection scheduling & interval management with accounting (QuickBooks / Xero / Tally for India / Sage / Reliance ERP) and the CMMS used by Binh Son Refining (BSR, Dung Quat) — eliminating duplicate data entry and reducing customer-facing report turnaround from 5 days to <24 hours.",
    "A regulator-audit-driven Ho Chi Minh City inspection company uses inspection scheduling & interval management to pass PetroVietnam vendor approval and MOIT Ministry of Industry and Trade audits with zero findings — evidence packages assembled in 30 seconds vs. 80+ hours of manual prep."
  ],
  "cityOperators": [
    "PetroVietnam (PVN)",
  ...
  "cityPain": [
    "Inspection Scheduling & Interval Management tracked in spreadsheets — always 2 months behind Ho Chi Minh City operator-portal requirements",
  ...
  "faqs": [
    [
      "Is the inspection scheduling & interval management module configured for Ho Chi Minh City operators?",
...
export default function ErpMC_inspection_scheduling_ho_chi_minh() { return <ErpModuleCityPage {...data} />; }
