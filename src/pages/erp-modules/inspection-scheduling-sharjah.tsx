...
const data = {
  ...
  "cityUseCases": [
    "A mid-size Sharjah inspection contractor serving Sharjah National Oil Corporation (SNOC) and Crescent Petroleum deploys inspection scheduling & interval management as a standalone module — replacing spreadsheets and disconnected SaaS — and reports 60-80% admin-time reduction within 90 days.",
    "A Sharjah EPC quality team standardizes inspection scheduling & interval management across 4 simultaneous project sites in the UAE market. Daily reports, audit packages, and customer-format reports flow to BUTINAH Marine portals automatically.",
    "A growing Sharjah-based service provider integrates inspection scheduling & interval management with accounting (QuickBooks / Xero / Tally for India / Sage / Reliance ERP) and the CMMS used by Sharjah Cement — eliminating duplicate data entry and reducing customer-facing report turnaround from 5 days to <24 hours.",
    "A regulator-audit-driven Sharjah inspection company uses inspection scheduling & interval management to pass Sharjah Economic Development and Hamriyah Free Zone Authority (HFZA) audits with zero findings — evidence packages assembled in 30 seconds vs. 80+ hours of manual prep."
  ],
  "cityOperators": [
  ...
  "cityPain": [
    "Inspection Scheduling & Interval Management tracked in spreadsheets — always 2 months behind Sharjah operator-portal requirements",
  ...
  "faqs": [
    [
      "Is the inspection scheduling & interval management module configured for Sharjah operators?",
...
export default function ErpMC_inspection_scheduling_sharjah() { return <ErpModuleCityPage {...data} />; }
