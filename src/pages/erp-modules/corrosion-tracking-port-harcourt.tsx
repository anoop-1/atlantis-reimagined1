...
const data = {
  ...
  "cityUseCases": [
    "A mid-size Port Harcourt inspection contractor serving NNPCL Port Harcourt Refining Company (PHRC) and Shell SPDC deploys corrosion tracking & rbi as a standalone module — replacing spreadsheets and disconnected SaaS — and reports 60-80% admin-time reduction within 90 days.",
    "A Port Harcourt EPC quality team standardizes corrosion tracking & rbi across 4 simultaneous project sites in the Nigeria market. Daily reports, audit packages, and customer-format reports flow to Eni AGIP portals automatically.",
    "A growing Port Harcourt-based service provider integrates corrosion tracking & rbi with accounting (QuickBooks / Xero / Tally for India / Sage / Reliance ERP) and the CMMS used by TotalEnergies E&P Nigeria onshore — eliminating duplicate data entry and reducing customer-facing report turnaround from 5 days to <24 hours.",
    "A regulator-audit-driven Port Harcourt inspection company uses corrosion tracking & rbi to pass NUPRC upstream and NMDPRA downstream audits with zero findings — evidence packages assembled in 30 seconds vs. 80+ hours of manual prep."
  ],
  "cityOperators": [
  ...
  "cityPain": [
    "Corrosion Tracking & RBI tracked in spreadsheets — always 2 months behind Port Harcourt operator-portal requirements",
  ...
  "faqs": [
    [
      "Is the corrosion tracking & rbi module configured for Port Harcourt operators?",
