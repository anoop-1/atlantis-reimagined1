...
export default function NDTTrainingDenver() {
  const courseSchema = {
    "@context": "https://schema.org",
    "@type": "Course",
    "name": "NDT Training & Certification in Denver, CO",
    "description": "Professional ASNT SNT-TC-1A Level I, II, III NDT training in Denver. Oil & gas and infrastructure focus. All methods: UT, RT, MT, PT, ET, VT, PAUT, TOFD.",
  ...
  return (
    <div className="min-h-screen pt-20">
        ...
        <div className="container mx-auto px-6">
          <motion.div className="max-w-4xl mx-auto text-center" initial={{ y: 30, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.2 }}>
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              NDT Training in <span className="gradient-text">Denver, CO</span>
            </h1>
            <p className="text-xl text-muted-foreground leading-relaxed mb-8">
              Professional ASNT SNT-TC-1A Level I, II, and III NDT training in Denver. Oil & gas and infrastructure focus. All NDT methods. Hands-on labs. 95% pass rate.
            </p>
      ...
      <section className="py-20">
        <div className="container mx-auto max-w-6xl px-6">
          <h2 className="text-3xl font-bold mb-12 text-center">Oil & gas and infrastructure focus NDT Training in Denver</h2>
      ...
      <section className="py-16 bg-primary/5">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-2xl font-bold text-center mb-8">Complete NDT Solutions in Denver</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link to="/ndt-consulting-denver" className="bg-background rounded-xl p-6 shadow-sm hover:shadow-lg transition">
              <h3 className="font-semibold text-lg mb-2">NDT Consulting</h3>
              <p className="text-muted-foreground text-sm">Expert ASNT Level III consulting, procedure development, quality assurance, and on-site technical support for Denver industries.</p>
            </Link>
      ...
      <section className="py-16 bg-gradient-to-r from-primary/10 to-accent/10">
        <div className="container mx-auto max-w-4xl px-6 text-center">
          <h2 className="text-3xl font-bold mb-4">Start Your NDT Training in Denver</h2>
      ...
      <section className="py-8 bg-white border-t border-slate-200">
        <div className="container mx-auto max-w-6xl px-6">
          <RelatedCityProducts currentProduct="training" citySlug="denver" city="Denver" />
        </div>
      </section>
