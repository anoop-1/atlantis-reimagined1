...
export const metadata: Metadata = {
  title: 'Oil & Gas NDT Standards — ASME, ASTM, ISO & EN Codes',
  description: 'Complete guide to NDT standards used in oil and gas: ASME Section V, ASTM methods, API codes, ISO standards.',
  keywords: ["NDT standards","ASME Section V"],
  openGraph: { title: 'Oil & Gas NDT Standards — ASME, ASTM, ISO & EN Codes', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">Oil & Gas NDT Standards</span>
      </nav>

      <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
        Oil & Gas NDT Standards
      </h1>

      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          Complete guide to NDT standards used in oil and gas: ASME Section V, ASTM methods, API codes, ISO standards.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about oil & gas ndt standards.
