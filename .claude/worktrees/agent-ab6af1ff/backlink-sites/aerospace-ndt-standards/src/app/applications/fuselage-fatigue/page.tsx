...
export const metadata: Metadata = {
  title: 'Fuselage Fatigue Testing — Crack Detection & Life Extension',
  description: 'Fuselage fatigue inspection: eddy current for riveted joints, PAUT for bonded repairs, strain monitoring.',
  keywords: ["fuselage fatigue testing"],
  openGraph: { title: 'Fuselage Fatigue Testing — Crack Detection & Life Extension', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">Fuselage Fatigue Testing</span>
      </nav>
      ...
      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          Fuselage fatigue inspection: eddy current for riveted joints, PAUT for bonded repairs, strain monitoring.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about fuselage fatigue testing.
