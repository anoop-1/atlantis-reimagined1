...
export const metadata: Metadata = {
  title: 'Digital Radiography in Aviation — CR, DR & CT Scanning',
  description: 'Digital radiography for aerospace: computed radiography, direct digital, industrial CT scanning for castings.',
  keywords: ["digital radiography aviation"],
  openGraph: { title: 'Digital Radiography in Aviation — CR, DR & CT Scanning', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">Digital Radiography in Aviation</span>
      </nav>

      <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
        Digital Radiography in Aviation
      </h1>

      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          Digital radiography for aerospace: computed radiography, direct digital, industrial CT scanning for castings.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about digital radiography in aviation.
