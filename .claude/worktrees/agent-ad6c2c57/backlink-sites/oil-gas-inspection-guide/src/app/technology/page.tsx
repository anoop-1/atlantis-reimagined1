...
export const metadata: Metadata = {
  title: 'Oil & Gas Inspection Technology — Digital Twins, Drones & AI',
  description: 'Emerging inspection technology: digital twins for asset integrity, drone-based inspection, AI defect detection, automated UT.',
  keywords: ["inspection technology","digital twins oil gas"],
  openGraph: { title: 'Oil & Gas Inspection Technology — Digital Twins, Drones & AI', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">Oil & Gas Inspection Technology</span>
      </nav>

      <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
        Oil & Gas Inspection Technology
      </h1>

      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          Emerging inspection technology: digital twins for asset integrity, drone-based inspection, AI defect detection, automated UT.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about oil & gas inspection technology.
