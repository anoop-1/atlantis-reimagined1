...
export const metadata: Metadata = {
  title: 'AWS D1.1 Welding Standards — NDT Requirements for Structural Steel',
  description: 'AWS D1.1 NDT requirements: pre-qualified joints, inspection rates, RT/UT acceptance criteria for structural steel.',
  keywords: ["AWS D1.1"],
  openGraph: { title: 'AWS D1.1 Welding Standards — NDT Requirements for Structural Steel', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">AWS D1.1 Welding Standards</span>
      </nav>
      ...
      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          AWS D1.1 NDT requirements: pre-qualified joints, inspection rates, RT/UT acceptance criteria for structural steel.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about aws d1.1 welding standards.
