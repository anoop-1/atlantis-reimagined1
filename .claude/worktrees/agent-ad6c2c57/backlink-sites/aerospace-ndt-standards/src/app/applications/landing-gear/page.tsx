...
export const metadata: Metadata = {
  title: 'Landing Gear NDT — Magnetic Particle & Ultrasonic Inspection',
  description: 'Landing gear inspection methods: MT for surface cracks, UT for internal defects, dimensional checks.',
  keywords: ["landing gear NDT"],
  openGraph: { title: 'Landing Gear NDT — Magnetic Particle & Ultrasonic Inspection', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">Landing Gear NDT</span>
      </nav>
      ...
      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          Landing gear inspection methods: MT for surface cracks, UT for internal defects, dimensional checks.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about landing gear ndt.
