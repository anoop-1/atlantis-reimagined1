...
export const metadata: Metadata = {
  title: 'HRSG Inspection Guide — Heat Recovery Steam Generator NDT',
  description: 'HRSG NDT inspection: finned tube examination, header inspection, casing fatigue monitoring.',
  keywords: ["HRSG inspection"],
  openGraph: { title: 'HRSG Inspection Guide — Heat Recovery Steam Generator NDT', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">HRSG Inspection Guide</span>
      </nav>
      ...
      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          HRSG NDT inspection: finned tube examination, header inspection, casing fatigue monitoring.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about hrsg inspection guide.
