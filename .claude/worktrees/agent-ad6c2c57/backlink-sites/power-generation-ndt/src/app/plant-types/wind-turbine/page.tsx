...
export const metadata: Metadata = {
  title: 'Wind Turbine NDT — Blade, Tower & Foundation Inspection',
  description: 'Wind turbine inspection: blade composite NDT, tower weld inspection, foundation bolt testing.',
  keywords: ["wind turbine NDT"],
  openGraph: { title: 'Wind Turbine NDT — Blade, Tower & Foundation Inspection', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">Wind Turbine NDT</span>
      </nav>
      ...
      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          Wind turbine inspection: blade composite NDT, tower weld inspection, foundation bolt testing.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about wind turbine ndt.
        ...
        <section className="mb-8">
          ...
          <p>
            Compliance with international standards is essential. Organizations working with
             <a href="https://atlantisndt.com/blog/ultrasonic-testing" target="_blank" class="text-blue-600 hover:underline">ultrasonic testing guide</a>,  <a href="https://atlantisndt.com/ndt-for-power-generation" target="_blank" class="text-blue-600 hover:underline">power generation NDT services</a>,  <a href="https://atlantisndt.com/consulting" target="_blank" class="text-blue-600 hover:underline">ASNT Level III consulting</a>,  <a href="https://atlantisndt.com/training" target="_blank" class="text-blue-600 hover:underline">professional NDT training</a> ensure their programs meet all applicable code requirements.
          </p>
        </section>
