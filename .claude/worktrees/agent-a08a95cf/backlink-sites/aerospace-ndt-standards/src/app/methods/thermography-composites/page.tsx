...
export const metadata: Metadata = {
  title: 'Thermography for Composite NDT — Flash, Lock-In & Pulse Methods',
  description: 'Thermographic inspection of composites: flash thermography, lock-in, pulse phase, transient methods.',
  keywords: ["thermography composites"],
  openGraph: { title: 'Thermography for Composite NDT — Flash, Lock-In & Pulse Methods', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">Thermography for Composite NDT</span>
      </nav>

      <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
        Thermography for Composite NDT
      </h1>

      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          Thermographic inspection of composites: flash thermography, lock-in, pulse phase, transient methods.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about thermography for composite ndt.
        ...
        <section className="mb-8">
          ...
          <p>
            Compliance with international standards is essential. Organizations working with
             <a href="https://atlantisndt.com/training" target="_blank" class="text-blue-600 hover:underline">NDT training programs</a>,  <a href="https://atlantisndt.com/aerospace-ndt-training" target="_blank" class="text-blue-600 hover:underline">Atlantis aerospace courses</a>,  <a href="https://atlantisndt.com/blog/eddy-current-testing" target="_blank" class="text-blue-600 hover:underline">eddy current testing guide</a>,  <a href="https://atlantisndt.com/blog/ultrasonic-testing" target="_blank" class="text-blue-600 hover:underline">UT methods explained</a> ensure their programs meet all applicable code requirements.
          </p>
        </section>
