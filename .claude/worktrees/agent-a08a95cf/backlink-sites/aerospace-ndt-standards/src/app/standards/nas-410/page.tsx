...
export const metadata: Metadata = {
  title: 'NAS 410 Certification Guide — Aerospace NDT Qualification Requirements',
  description: 'NAS 410 certification requirements: training hours, experience, exam format, employer responsibilities.',
  keywords: ["NAS 410 certification"],
  openGraph: { title: 'NAS 410 Certification Guide — Aerospace NDT Qualification Requirements', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">NAS 410 Certification Guide</span>
      </nav>

      <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
        NAS 410 Certification Guide
      </h1>

      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          NAS 410 certification requirements: training hours, experience, exam format, employer responsibilities.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about nas 410 certification guide.
