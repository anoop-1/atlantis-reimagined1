...
export const metadata: Metadata = {
  title: 'Power Plant Types & NDT Requirements — Nuclear, Gas, Coal, Wind',
  description: 'NDT requirements by plant type: nuclear (ASME XI), gas turbine, coal-fired, wind, solar, hydro.',
  keywords: ["power plant NDT"],
  openGraph: { title: 'Power Plant Types & NDT Requirements — Nuclear, Gas, Coal, Wind', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">Power Plant Types & NDT Requirements</span>
      </nav>

      <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
        Power Plant Types & NDT Requirements
      </h1>

      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          NDT requirements by plant type: nuclear (ASME XI), gas turbine, coal-fired, wind, solar, hydro.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about power plant types & ndt requirements.
