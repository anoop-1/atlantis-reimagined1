...
export const metadata: Metadata = {
  title: 'Power Plant Components NDT — Turbines, Boilers, Generators & Piping',
  description: 'NDT for power plant components: steam turbine rotors, boiler tubes, generator stators, HRSG.',
  keywords: ["power plant components NDT"],
  openGraph: { title: 'Power Plant Components NDT — Turbines, Boilers, Generators & Piping', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">Power Plant Components NDT</span>
      </nav>

      <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
        Power Plant Components NDT
      </h1>

      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          NDT for power plant components: steam turbine rotors, boiler tubes, generator stators, HRSG.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about power plant components ndt.
