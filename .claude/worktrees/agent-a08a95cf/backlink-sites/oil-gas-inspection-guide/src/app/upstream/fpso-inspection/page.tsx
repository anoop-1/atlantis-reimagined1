...
export const metadata: Metadata = {
  title: 'FPSO Inspection Guide — Hull, Turret & Process Systems',
  description: 'FPSO inspection requirements: hull structural integrity, turret swivel, process equipment, fatigue monitoring.',
  keywords: ["FPSO inspection"],
  openGraph: { title: 'FPSO Inspection Guide — Hull, Turret & Process Systems', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">FPSO Inspection Guide</span>
      </nav>

      <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
        FPSO Inspection Guide
      </h1>

      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          FPSO inspection requirements: hull structural integrity, turret swivel, process equipment, fatigue monitoring.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about fpso inspection guide.
