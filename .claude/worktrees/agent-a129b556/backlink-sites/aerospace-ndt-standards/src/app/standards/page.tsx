...
export const metadata: Metadata = {
  title: 'Aerospace NDT Standards Overview — NAS 410, AMS, EN 4179',
  description: 'All aerospace NDT standards explained: NAS 410 qualification, AMS testing specs, EN 4179 European equivalent.',
  keywords: ["aerospace NDT standards"],
  openGraph: { title: 'Aerospace NDT Standards Overview — NAS 410, AMS, EN 4179', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">Aerospace NDT Standards Overview</span>
      </nav>

      <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
        Aerospace NDT Standards Overview
      </h1>

      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          All aerospace NDT standards explained: NAS 410 qualification, AMS testing specs, EN 4179 European equivalent.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about aerospace ndt standards overview.
