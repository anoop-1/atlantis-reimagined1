...
export const metadata: Metadata = {
  title: 'Aerospace NDT Salary Guide 2026 — By Role, Location & Certification',
  description: 'Aerospace NDT technician salaries: Level II $60K-$90K, Level III $100K-$150K+. MRO vs OEM pay comparison.',
  keywords: ["aerospace NDT salary"],
  openGraph: { title: 'Aerospace NDT Salary Guide 2026 — By Role, Location & Certification', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">Aerospace NDT Salary Guide 2026</span>
      </nav>

      <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
        Aerospace NDT Salary Guide 2026
      </h1>

      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          Aerospace NDT technician salaries: Level II $60K-$90K, Level III $100K-$150K+. MRO vs OEM pay comparison.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about aerospace ndt salary guide 2026.
