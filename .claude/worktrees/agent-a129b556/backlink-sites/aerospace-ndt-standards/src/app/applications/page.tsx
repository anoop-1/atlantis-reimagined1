...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Aerospace NDT Applications — Aircraft, Engine & Composite Inspection', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">Aerospace NDT Applications</span>
      </nav>
      ...
      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          NDT applications in aerospace: aircraft structural inspection, engine overhaul, composite material testing.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about aerospace ndt applications.
