...
export const metadata: Metadata = {
  title: 'API 571 Damage Mechanisms — Recognition & Prevention',
  description: 'All API 571 damage mechanisms explained: high temperature hydrogen attack, sulfidation, naphthenic acid corrosion, and more.',
  keywords: ["API 571","damage mechanisms"],
  openGraph: { title: 'API 571 Damage Mechanisms — Recognition & Prevention', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">API 571 Damage Mechanisms</span>
      </nav>
      ...
      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          All API 571 damage mechanisms explained: high temperature hydrogen attack, sulfidation, naphthenic acid corrosion, and more.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about api 571 damage mechanisms.
