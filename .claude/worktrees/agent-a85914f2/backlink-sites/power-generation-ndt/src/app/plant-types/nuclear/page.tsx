...
export const metadata: Metadata = {
  title: 'Nuclear Plant NDT — ASME Section XI, ISI & Safety-Critical Inspection',
  description: 'Nuclear NDT requirements: ASME XI in-service inspection, reactor vessel, steam generator, piping.',
  keywords: ["nuclear plant NDT"],
  openGraph: { title: 'Nuclear Plant NDT — ASME Section XI, ISI & Safety-Critical Inspection', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">Nuclear Plant NDT</span>
      </nav>
      ...
      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          Nuclear NDT requirements: ASME XI in-service inspection, reactor vessel, steam generator, piping.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about nuclear plant ndt.
