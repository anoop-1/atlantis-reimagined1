...
export const metadata: Metadata = {
  title: 'Composite Material NDT — CFRP, GFRP Inspection Methods',
  description: 'NDT methods for composite materials: ultrasonic C-scan, thermography, shearography, tap testing.',
  keywords: ["composite NDT"],
  openGraph: { title: 'Composite Material NDT — CFRP, GFRP Inspection Methods', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">Composite Material NDT</span>
      </nav>
      ...
      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          NDT methods for composite materials: ultrasonic C-scan, thermography, shearography, tap testing.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about composite material ndt.
