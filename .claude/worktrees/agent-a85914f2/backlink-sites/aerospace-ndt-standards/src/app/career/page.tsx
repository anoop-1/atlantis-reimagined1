...
export const metadata: Metadata = {
  title: 'Aerospace NDT Career Guide — Salaries, Certifications & Employers',
  description: 'Aerospace NDT career path: MRO vs OEM opportunities, salary ranges, required certifications.',
  keywords: ["aerospace NDT career"],
  openGraph: { title: 'Aerospace NDT Career Guide — Salaries, Certifications & Employers', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">Aerospace NDT Career Guide</span>
      </nav>

      <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
        Aerospace NDT Career Guide
      </h1>

      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          Aerospace NDT career path: MRO vs OEM opportunities, salary ranges, required certifications.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about aerospace ndt career guide.
