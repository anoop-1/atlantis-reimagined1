...
export const metadata: Metadata = {
  title: 'ASME Section V Guide — All NDT Articles Explained',
  description: 'ASME Section V breakdown: Article 1-14 covering UT, RT, MT, PT, ET, VT, TOFD, PAUT requirements.',
  keywords: ["ASME Section V"],
  openGraph: { title: 'ASME Section V Guide — All NDT Articles Explained', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">ASME Section V Guide</span>
      </nav>

      <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
        ASME Section V Guide
      </h1>

      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          ASME Section V breakdown: Article 1-14 covering UT, RT, MT, PT, ET, VT, TOFD, PAUT requirements.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about asme section v guide.
