...
export const metadata: Metadata = {
  title: 'Digital Twins for Oil & Gas — Asset Integrity & Predictive Maintenance',
  description: 'How digital twins transform oil and gas asset management: 3D visualization, predictive maintenance, turnaround planning.',
  keywords: ["digital twins oil gas"],
  openGraph: { title: 'Digital Twins for Oil & Gas — Asset Integrity & Predictive Maintenance', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">Digital Twins for Oil & Gas</span>
      </nav>
      ...
      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          How digital twins transform oil and gas asset management: 3D visualization, predictive maintenance, turnaround planning.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about digital twins for oil & gas.
