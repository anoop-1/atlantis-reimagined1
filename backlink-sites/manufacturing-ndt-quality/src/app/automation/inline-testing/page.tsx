...
export const metadata: Metadata = {
  title: 'In-Line NDT Testing — Real-Time Quality Control in Production',
  description: 'In-Line NDT Testing — Real-Time Quality Control in Production',
  
  openGraph: { title: 'In-Line NDT Testing — Real-Time Quality Control in Production', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">In-Line NDT Testing</span>
      </nav>
      ...
      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          In-Line NDT Testing — Real-Time Quality Control in Production
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about in-line ndt testing.
