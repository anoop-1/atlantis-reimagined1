...
export const metadata: Metadata = {
  title: "Plate Mill NDT Screening During Hot Rolling",
  description: "Practical guide for manufacturing QA: how to apply plate mill NDT in real inspection work, what auditors expect, and where most programs fall short.",
  keywords: ["plate mill NDT","hot rolled plate","plate inspection","rolling mill"],
  alternates: { canonical: "https://manufacturing-ndt-quality.vercel.app/practices/plate-mill-ndt-screening-during-rolling" },
  openGraph: {
    title: "Plate Mill NDT Screening During Hot Rolling",
    description: "Practical guide for manufacturing QA: how to apply plate mill NDT in real inspection work, what auditors expect, and where most programs fall short.",
    type: 'article',
    url: "https://manufacturing-ndt-quality.vercel.app/practices/plate-mill-ndt-screening-during-rolling",
    siteName: "Manufacturing NDT Quality",
    locale: 'en_US',
    publishedTime: "2025-12-06T00:00:00.000Z",
    modifiedTime: "2025-12-06T00:00:00.000Z",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Plate Mill NDT Screening During Hot Rolling",
  "description": "Practical guide for manufacturing QA: how to apply plate mill NDT in real inspection work, what auditors expect, and where most programs fall short.",
  "author": {
    "@type": "Person",
  ...
  "datePublished": "2025-12-06T00:00:00.000Z",
  "dateModified": "2025-12-06T00:00:00.000Z",
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://manufacturing-ndt-quality.vercel.app/practices/plate-mill-ndt-screening-during-rolling"
  },
  "keywords": "plate mill NDT, hot rolled plate, plate inspection, rolling mill"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>Plate Mill NDT Screening During Hot Rolling</span>
      </nav>
      <h1>Plate Mill NDT Screening During Hot Rolling</h1>
      <p className="text-sm text-gray-500 mb-8">By Florian Mautner, IWE &middot; Published 2025-12-06</p>
      <div dangerouslySetInnerHTML={{ __html: `<p>This article walks through the practical decisions manufacturing QA, OEM quality engineers, supplier auditors need to make when working on manufacturing & supplier-quality NDT. The goal is not theory — it is the kind of working knowledge an experienced inspector or engineer would share over a coffee on a job site, with enough rigor to point back to code and standard references when those decisions get challenged in audit. Throughout the piece we focus on the parts of plate mill ndt that turn into real schedule or budget pain when they go wrong.</p><h2>Why this comes up so often in the field</h2>
<p>Ask any manufacturing QA how often plate mill ndt drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<ul>
<li><strong>The decision points</strong> that drive most plate mill ndt programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any plate mill ndt engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<p>The textbook approach to plate mill ndt usually points engineers at one or two techniques. The field reality is messier; the technique that ranks best on a comparison chart is often not the one that fits the access, the schedule, or the inspector skill mix actually available on the day. We walk through three patterns we see repeatedly.</p>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of plate mill ndt should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize plate mill ndt in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p>
<p>Practical teams often cross-reference <a href="https://atlantisndt.com/digital-twin-surat" rel="noopener">Atlantis Digital Twin coverage for digital twin surat</a> to align their practice with what is already published in the wider community.</p><h3>How plate mill NDT fits into the bigger picture</h3>
<p>It is easy to study plate mill NDT as an isolated subject — most courses do exactly that — but the engineering value only appears when you place plate mill NDT alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.iaea.org/topics/non-destructive-testing" rel="noopener nofollow">the IAEA non-destructive testing programme</a> to align their practice with what is already published in the wider community. For most manufacturing QA the question is not "what is plate mill NDT?" but "where does plate mill NDT sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in plate mill NDT, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on hot rolled plate</h3>
<p>Three behaviours we see at high-performing operators consistently show up in hot rolled plate programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a hot rolled plate program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best plate inspection documentation packages we have seen share three patterns:</p>
<ul>
