...
export const metadata: Metadata = {
  title: "Supplier Quality Audit of an NDT Shop: A 50-Item Checklist",
  description: "Supplier Quality Audit of an NDT Shop explained for manufacturing QA — covering supplier quality audit, common pitfalls, and the data your audit packet needs.",
  keywords: ["supplier quality audit","NDT shop audit","AS9100 NDT","NADCAP supplier"],
  alternates: { canonical: "https://manufacturing-ndt-quality.vercel.app/practices/supplier-quality-audit-ndt-shop" },
  openGraph: {
    title: "Supplier Quality Audit of an NDT Shop: A 50-Item Checklist",
    description: "Supplier Quality Audit of an NDT Shop explained for manufacturing QA — covering supplier quality audit, common pitfalls, and the data your audit packet needs.",
    type: 'article',
    url: "https://manufacturing-ndt-quality.vercel.app/practices/supplier-quality-audit-ndt-shop",
    siteName: "Manufacturing NDT Quality",
    locale: 'en_US',
    publishedTime: "2025-07-26T00:00:00.000Z",
    modifiedTime: "2025-07-26T00:00:00.000Z",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Supplier Quality Audit of an NDT Shop: A 50-Item Checklist",
  "description": "Supplier Quality Audit of an NDT Shop explained for manufacturing QA — covering supplier quality audit, common pitfalls, and the data your audit packet needs.",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://manufacturing-ndt-quality.vercel.app/practices/supplier-quality-audit-ndt-shop"
  },
  "keywords": "supplier quality audit, NDT shop audit, AS9100 NDT, NADCAP supplier"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>Supplier Quality Audit of an NDT Shop: A 50-Item Checklist</span>
      </nav>
      <h1>Supplier Quality Audit of an NDT Shop: A 50-Item Checklist</h1>
      <p className="text-sm text-gray-500 mb-8">By Hannelore Veit, AS9100 LA &middot; Published 2025-07-26</p>
      <div dangerouslySetInnerHTML={{ __html: `<p>This article walks through the practical decisions manufacturing QA, OEM quality engineers, supplier auditors need to make when working on manufacturing & supplier-quality NDT. The goal is not theory — it is the kind of working knowledge an experienced inspector or engineer would share over a coffee on a job site, with enough rigor to point back to code and standard references when those decisions get challenged in audit. Throughout the piece we focus on the parts of supplier quality audit that turn into real schedule or budget pain when they go wrong.</p><h2>Why this comes up so often in the field</h2>
<p>Ask any manufacturing QA how often supplier quality audit drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<ul>
<li><strong>The decision points</strong> that drive most supplier quality audit programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any supplier quality audit engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<p>The textbook approach to supplier quality audit usually points engineers at one or two techniques. The field reality is messier; the technique that ranks best on a comparison chart is often not the one that fits the access, the schedule, or the inspector skill mix actually available on the day. We walk through three patterns we see repeatedly.</p>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of supplier quality audit should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize supplier quality audit in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p><h3>How supplier quality audit fits into the bigger picture</h3>
<p>It is easy to study supplier quality audit as an isolated subject — most courses do exactly that — but the engineering value only appears when you place supplier quality audit alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.aws.org/standards" rel="noopener nofollow">the AWS standards catalog</a> to align their practice with what is already published in the wider community. For most manufacturing QA the question is not "what is supplier quality audit?" but "where does supplier quality audit sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in supplier quality audit, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on NDT shop audit</h3>
<p>Three behaviours we see at high-performing operators consistently show up in NDT shop audit programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a NDT shop audit program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best AS9100 NDT documentation packages we have seen share three patterns:</p>
<ul>
