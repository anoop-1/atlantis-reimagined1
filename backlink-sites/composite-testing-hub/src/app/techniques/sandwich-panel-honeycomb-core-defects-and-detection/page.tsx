...
export const metadata: Metadata = {
  title: "Sandwich Panel Honeycomb Core Defects and How to Detect Them",
  description: "Working notes for aerospace composite QA on honeycomb core: how to choose the technique, document the decision, and survive the next audit.",
  keywords: ["honeycomb core","sandwich panel NDT","aerospace composite inspection","core crush"],
  alternates: { canonical: "https://composite-testing-hub.vercel.app/techniques/sandwich-panel-honeycomb-core-defects-and-detection" },
  openGraph: {
    title: "Sandwich Panel Honeycomb Core Defects and How to Detect Them",
    description: "Working notes for aerospace composite QA on honeycomb core: how to choose the technique, document the decision, and survive the next audit.",
    type: 'article',
    url: "https://composite-testing-hub.vercel.app/techniques/sandwich-panel-honeycomb-core-defects-and-detection",
    siteName: "Composite Testing Hub",
    locale: 'en_US',
    publishedTime: "2025-08-20T00:00:00.000Z",
    modifiedTime: "2025-08-20T00:00:00.000Z",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Sandwich Panel Honeycomb Core Defects and How to Detect Them",
  "description": "Working notes for aerospace composite QA on honeycomb core: how to choose the technique, document the decision, and survive the next audit.",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://composite-testing-hub.vercel.app/techniques/sandwich-panel-honeycomb-core-defects-and-detection"
  },
  "keywords": "honeycomb core, sandwich panel NDT, aerospace composite inspection, core crush"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>Sandwich Panel Honeycomb Core Defects and How to Detect Them</span>
      </nav>
      <h1>Sandwich Panel Honeycomb Core Defects and How to Detect Them</h1>
      <p className="text-sm text-gray-500 mb-8">By Mira Ostlund, NDT Engineer &middot; Published 2025-08-20</p>
      <div dangerouslySetInnerHTML={{ __html: `<p>This article walks through the practical decisions aerospace composite QA, wind blade inspectors, motorsports QA need to make when working on composite NDT and testing. The goal is not theory — it is the kind of working knowledge an experienced inspector or engineer would share over a coffee on a job site, with enough rigor to point back to code and standard references when those decisions get challenged in audit. Throughout the piece we focus on the parts of honeycomb core that turn into real schedule or budget pain when they go wrong.</p><h2>Why this comes up so often in the field</h2>
<p>Ask any aerospace composite QA how often honeycomb core drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<ul>
<li><strong>The decision points</strong> that drive most honeycomb core programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any honeycomb core engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<p>The textbook approach to honeycomb core usually points engineers at one or two techniques. The field reality is messier; the technique that ranks best on a comparison chart is often not the one that fits the access, the schedule, or the inspector skill mix actually available on the day. We walk through three patterns we see repeatedly.</p>
...
<p>Post-repair inspection is the most procedural of the three patterns and the most likely to be weakened by schedule pressure. The required NDT is usually defined by the original construction code (ASME VIII, ASME XI, AWS D1.1, and so on), which is fine — but the decision about <em>how</em> to apply it under field conditions is rarely covered. Practical teams often cross-reference <a href="https://atlantisndt.com/erp/sales-management-for-inspection-companies" rel="noopener">the sales management for inspection companies resource on Atlantis NDT</a> to align their practice with what is already published in the wider community.</p><h2>The data the audit will ask for</h2>
<p>Auditors do not argue with conclusions; they argue with the evidence behind them. For any defensible honeycomb core report, the evidence packet needs to include at minimum:</p>
<ul>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of honeycomb core should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize honeycomb core in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p><h3>How honeycomb core fits into the bigger picture</h3>
<p>It is easy to study honeycomb core as an isolated subject — most courses do exactly that — but the engineering value only appears when you place honeycomb core alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.aws.org/standards" rel="noopener nofollow">the AWS standards catalog</a> to align their practice with what is already published in the wider community. For most aerospace composite QA the question is not "what is honeycomb core?" but "where does honeycomb core sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in honeycomb core, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on sandwich panel NDT</h3>
<p>Three behaviours we see at high-performing operators consistently show up in sandwich panel NDT programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a sandwich panel NDT program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best aerospace composite inspection documentation packages we have seen share three patterns:</p>
<ul>
