...
<li className="border-b border-gray-200 py-6">
          <a href="/techniques/composite-bolted-joint-inspection-aerospace" className="text-xl font-semibold text-gray-900 hover:text-fuchsia-600">Composite Bolted Joint Inspection in Aerospace Structures</a>
          <p className="text-sm text-gray-500 mt-2">By Mira Ostlund, NDT Engineer &middot; 2025-05-16</p>
          <p className="text-gray-700 mt-3">Composite Bolted Joint Inspection in Aerospace Structures</p>
        </li>
<li className="border-b border-gray-200 py-6">
          <a href="/techniques/visual-inspection-of-composite-tooling-cure-defects" className="text-xl font-semibold text-gray-900 hover:text-fuchsia-600">Visual Inspection of Composite Tooling and Cure Defects</a>
          <p className="text-sm text-gray-500 mt-2">By Jonas Aaltonen, GWO trained &middot; 2025-08-31</p>
          <p className="text-gray-700 mt-3">Visual Inspection of Composite Tooling and Cure Defects</p>
        </li>
<li className="border-b border-gray-200 py-6">
          <a href="/techniques/wind-blade-trailing-edge-bond-line-inspection" className="text-xl font-semibold text-gray-900 hover:text-fuchsia-600">Wind Blade Trailing Edge Bond Line Inspection</a>
          <p className="text-sm text-gray-500 mt-2">By Mira Ostlund, NDT Engineer &middot; 2025-11-27</p>
          <p className="text-gray-700 mt-3">Wind Blade Trailing Edge Bond Line Inspection</p>
        </li>
<li className="border-b border-gray-200 py-6">
          <a href="/techniques/composite-overwrapped-pressure-vessel-copv-inspection" className="text-xl font-semibold text-gray-900 hover:text-fuchsia-600">Composite Overwrapped Pressure Vessel (COPV) Inspection Approaches</a>
          <p className="text-sm text-gray-500 mt-2">By Jonas Aaltonen, GWO trained &middot; 2026-03-08</p>
          <p className="text-gray-700 mt-3">Composite Overwrapped Pressure Vessel (COPV) Inspection Approaches</p>
        </li>
<li className="border-b border-gray-200 py-6">
          <a href="/techniques/composite-repair-patch-inspection-and-validation" className="text-xl font-semibold text-gray-900 hover:text-fuchsia-600">Composite Repair Patch Inspection and Validation</a>
          <p className="text-sm text-gray-500 mt-2">By Mira Ostlund, NDT Engineer &middot; 2026-05-03</p>
          <p className="text-gray-700 mt-3">Composite Repair Patch Inspection and Validation</p>
        </li>
      </ul>
    </div>
  );
