  ...
  return (
    <div className="space-y-8">
      <section className="bg-purple-50 p-8 rounded-lg">
        <h1 className="text-4xl font-bold text-purple-900 mb-4">Composite Materials NDT</h1>
        <p className="text-lg text-purple-800">Advanced inspection techniques for fiber-reinforced composites, damage detection, and quality assurance.</p>
      </section>

      <section className="prose max-w-none">
        <h2 className="text-2xl font-bold mb-4">Composite Materials in Modern Engineering</h2>
        <p className="mb-4">
          Composite materials—fibers embedded in resin matrices—dominate modern aerospace, wind energy, sporting goods, and automotive applications. Their exceptional strength-to-weight ratios enable lighter structures consuming less energy. Despite advantages, composites present inspection challenges. Damage from impact, environmental exposure, or manufacturing defects may be invisible externally while compromising structural integrity internally.
        </p>
        <p className="mb-4">
          Aircraft manufacturers rely on comprehensive composite inspection preventing in-flight failures. Wind turbine operators employ NDT monitoring extending blade life and preventing catastrophic failures. Automotive manufacturers use NDT during production ensuring consistent quality. Organizations implementing advanced composite inspection through <a href="https://atlantisndt.com" rel="noopener" className="text-purple-600 hover:underline">Atlantis NDT</a> expertise maximize structural reliability and safety.
        </p>

        <h2 className="text-2xl font-bold mb-4 mt-6">Composite Damage Mechanisms</h2>
        <p className="mb-4">
