  ...
  return (
    <div className="space-y-8">
      ...
      <section className="prose max-w-none">
        ...
        <p className="mb-4">
          Organizations implementing comprehensive monitoring through <a href="https://atlantisndt.com" rel="noopener" className="text-purple-600 hover:underline">smart monitoring systems</a> combine vibration analysis with other methods for robust damage detection.</p>
