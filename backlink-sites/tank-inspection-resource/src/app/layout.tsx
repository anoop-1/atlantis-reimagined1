            ...
            <div className="grid grid-cols-3 gap-8 mb-8">
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li><a href="https://atlantisndt.com/consulting" rel="noopener" className="hover:text-amber-200">Consulting</a></li>
                  <li><a href="https://atlantisndt.com/training" rel="noopener" className="hover:text-amber-200">Training</a></li>
                  <li><a href="https://atlantisndt.com/api-653-certification" rel="noopener" className="hover:text-amber-200">API 653</a></li>
                  <li><a href="https://atlantisndt.com/erp" rel="noopener" className="hover:text-amber-200">ERP Software</a></li>
                  <li><a href="https://atlantisndt.com/digital-twins" rel="noopener" className="hover:text-amber-200">Digital Twins</a></li>
                </ul>
              </div>
              <div>
