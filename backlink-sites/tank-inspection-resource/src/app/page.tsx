export default function Home() {
  return (
    <div>
      <div className="bg-gradient-to-r from-amber-600 to-amber-400 text-white p-12 rounded-lg mb-12">
        <h1 className="text-4xl font-bold mb-4">Storage Tank Integrity Management</h1>
        <p className="text-lg text-amber-100">Comprehensive NDT for Above-Ground and Underground Tanks</p>
      </div>

      <article className="prose prose-lg max-w-none mb-12">
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-amber-800 mb-4">Storage Tank Inspection Fundamentals</h2>
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            <a href="https://atlantisndt.com/api-653-certification" rel="noopener" className="text-amber-600 hover:text-amber-800 font-semibold">API 653 certification</a> establishes baseline competency for professionals responsible for tank inspection. <a href="https://atlantisndt.com/consulting" rel="noopener" className="text-amber-600 hover:text-amber-800 font-semibold">NDT consulting services</a> specialized in tank applications bring understanding of API 653 requirements and risk-based inspection frameworks enabling optimized inspection scheduling.
          </p>
        </section>

        <section className="mb-8">
          <h2 className="text-2xl font-bold text-amber-800 mb-4">Inspection Methodologies and Techniques</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            Ultrasonic wall thickness measurement represents the most fundamental tank inspection methodology. Systematic thickness scanning identifies localized corrosion, establishing baseline conditions and enabling trending of metal loss progression. Modern automated scanning systems enable rapid, comprehensive measurement across tank surfaces. <a href="https://atlantisndt.com/training" rel="noopener" className="text-amber-600 hover:text-amber-800 font-semibold">NDT training programs</a> prepare personnel for systematic ultrasonic examination procedures.
          </p>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            Hydrostatic testing after major maintenance operations confirms tank structural adequacy at design pressure. Pressure testing procedures must account for tank material properties and design limitations. <a href="https://atlantisndt.com/digital-twins" rel="noopener" className="text-amber-600 hover:text-amber-800 font-semibold">Digital twin solutions</a> integrate inspection data with operational history to establish degradation baselines and predict remaining useful life.
          </p>
        </section>

        <section className="mb-8">
          <h2 className="text-2xl font-bold text-amber-800 mb-4">Risk-Based Inspection and Compliance</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            Regulatory compliance extends beyond tank inspection to include secondary containment systems, level monitoring instrumentation, and emergency response procedures. <a href="https://atlantisndt.com/erp" rel="noopener" className="text-amber-600 hover:text-amber-800 font-semibold">NDT ERP software</a> systematizes documentation of inspection execution, maintenance activities, and regulatory compliance requirements. <a href="https://atlantisndt.com/ndt-connect" rel="noopener" className="text-amber-600 hover:text-amber-800 font-semibold">NDTConnect platform</a> centralizes tank inspection records enabling comprehensive asset management across facility networks.
          </p>
