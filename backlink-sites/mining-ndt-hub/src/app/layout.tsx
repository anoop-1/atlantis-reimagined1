            ...
            <div className="grid grid-cols-3 gap-8 mb-8">
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li><a href="https://atlantisndt.com" rel="noopener" className="text-yellow-700 hover:underline">NDT Consulting</a></li>
                  <li><a href="https://atlantisndt.com" rel="noopener" className="text-yellow-700 hover:underline">Training Programs</a></li>
                  <li><a href="https://atlantisndt.com" rel="noopener" className="text-yellow-700 hover:underline">Digital Twins</a></li>
                  <li><a href="https://ndt-connect.com" rel="noopener" className="text-yellow-700 hover:underline">Fleet Management</a></li>
                  <li><a href="https://atlantisndt.com" rel="noopener" className="text-yellow-700 hover:underline">Data Systems</a></li>
                </ul>
              </div>
              <div>
