  ...
  return (
    <div className="space-y-8">
      <section className="bg-yellow-50 p-8 rounded-lg">
        <h1 className="text-3xl font-bold text-yellow-900 mb-2">Equipment Inspection</h1>
        <p className="text-yellow-800">NDT methods for mining equipment condition assessment.</p>
      </section>

      <section className="prose max-w-none">
        <h2 className="text-2xl font-bold mb-4">Excavator and Shovel Inspection</h2>
        <p className="mb-4">
