...
export const metadata: Metadata = {
  title: "Haul Truck Tray and Tub Crack Mapping Over Equipment Life",
  description: "Working notes for mining mechanical engineers on haul truck tray: how to choose the technique, document the decision, and survive the next audit.",
  keywords: ["haul truck tray","truck body","tray crack","mining truck body"],
  alternates: { canonical: "https://mining-ndt-hub.vercel.app/mining/haul-truck-tray-and-tub-crack-mapping" },
  openGraph: {
    title: "Haul Truck Tray and Tub Crack Mapping Over Equipment Life",
    description: "Working notes for mining mechanical engineers on haul truck tray: how to choose the technique, document the decision, and survive the next audit.",
    type: 'article',
    url: "https://mining-ndt-hub.vercel.app/mining/haul-truck-tray-and-tub-crack-mapping",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Haul Truck Tray and Tub Crack Mapping Over Equipment Life",
  "description": "Working notes for mining mechanical engineers on haul truck tray: how to choose the technique, document the decision, and survive the next audit.",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://mining-ndt-hub.vercel.app/mining/haul-truck-tray-and-tub-crack-mapping"
  },
  "keywords": "haul truck tray, truck body, tray crack, mining truck body"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>Haul Truck Tray and Tub Crack Mapping Over Equipment Life</span>
      </nav>
      <h1>Haul Truck Tray and Tub Crack Mapping Over Equipment Life</h1>
      <p className="text-sm text-gray-500 mb-8">By Nadya Sharma, Mining Reliability Eng &middot; Published 2026-03-19</p>
      <div dangerouslySetInnerHTML={{ __html: `<p>This article walks through the practical decisions mining mechanical engineers, haul-truck and mill reliability leads need to make when working on mining equipment NDT. The goal is not theory — it is the kind of working knowledge an experienced inspector or engineer would share over a coffee on a job site, with enough rigor to point back to code and standard references when those decisions get challenged in audit. Throughout the piece we focus on the parts of haul truck tray that turn into real schedule or budget pain when they go wrong.</p><h2>Why this comes up so often in the field</h2>
<p>Ask any mining mechanical engineers how often haul truck tray drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<ul>
<li><strong>The decision points</strong> that drive most haul truck tray programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any haul truck tray engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<p>The textbook approach to haul truck tray usually points engineers at one or two techniques. The field reality is messier; the technique that ranks best on a comparison chart is often not the one that fits the access, the schedule, or the inspector skill mix actually available on the day. We walk through three patterns we see repeatedly.</p>
...
<p>Auditors do not argue with conclusions; they argue with the evidence behind them. For any defensible haul truck tray report, the evidence packet needs to include at minimum:</p>
<ul>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of haul truck tray should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize haul truck tray in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p>
<p>Practical teams often cross-reference <a href="https://atlantisndt.com/corporate-training/ammonia-plants" rel="noopener">the ammonia plants training programme</a> to align their practice with what is already published in the wider community.</p><h3>How haul truck tray fits into the bigger picture</h3>
<p>It is easy to study haul truck tray as an isolated subject — most courses do exactly that — but the engineering value only appears when you place haul truck tray alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.iaea.org/topics/non-destructive-testing" rel="noopener nofollow">the IAEA non-destructive testing programme</a> to align their practice with what is already published in the wider community. For most mining mechanical engineers the question is not "what is haul truck tray?" but "where does haul truck tray sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in haul truck tray, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on truck body</h3>
<p>Three behaviours we see at high-performing operators consistently show up in truck body programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a truck body program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best tray crack documentation packages we have seen share three patterns:</p>
<ul>
