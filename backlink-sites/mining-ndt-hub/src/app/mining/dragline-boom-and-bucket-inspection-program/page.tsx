...
export const metadata: Metadata = {
  title: "Dragline Boom and Bucket Inspection Program",
  description: "Working notes for mining mechanical engineers on dragline boom: how to choose the technique, document the decision, and survive the next audit.",
  keywords: ["dragline boom","dragline bucket","mining excavation","dragline NDT"],
  alternates: { canonical: "https://mining-ndt-hub.vercel.app/mining/dragline-boom-and-bucket-inspection-program" },
  openGraph: {
    title: "Dragline Boom and Bucket Inspection Program",
    description: "Working notes for mining mechanical engineers on dragline boom: how to choose the technique, document the decision, and survive the next audit.",
    type: 'article',
    url: "https://mining-ndt-hub.vercel.app/mining/dragline-boom-and-bucket-inspection-program",
    siteName: "Mining NDT Hub",
    locale: 'en_US',
    publishedTime: "2025-09-17T00:00:00.000Z",
    modifiedTime: "2025-09-17T00:00:00.000Z",
    authors: ["Nadya Sharma, Mining Reliability Eng"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Dragline Boom and Bucket Inspection Program",
  "description": "Working notes for mining mechanical engineers on dragline boom: how to choose the technique, document the decision, and survive the next audit.",
  "author": {
    "@type": "Person",
    "name": "Nadya Sharma, Mining Reliability Eng"
  },
  "publisher": {
    "@type": "Organization",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://mining-ndt-hub.vercel.app/mining/dragline-boom-and-bucket-inspection-program"
  },
  "keywords": "dragline boom, dragline bucket, mining excavation, dragline NDT"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>Dragline Boom and Bucket Inspection Program</span>
      </nav>
      <h1>Dragline Boom and Bucket Inspection Program</h1>
      <p className="text-sm text-gray-500 mb-8">By Nadya Sharma, Mining Reliability Eng &middot; Published 2025-09-17</p>
