...
export const metadata: Metadata = {
  title: 'NADCAP Accreditation Guide — NDT Audit Preparation & Requirements',
  description: 'NADCAP NDT accreditation process: audit preparation, checklist requirements, common findings.',
  keywords: ["NADCAP accreditation"],
  openGraph: { title: 'NADCAP Accreditation Guide — NDT Audit Preparation & Requirements', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">NADCAP Accreditation Guide</span>
      </nav>

      <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
        NADCAP Accreditation Guide
      </h1>

      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          NADCAP NDT accreditation process: audit preparation, checklist requirements, common findings.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about nadcap accreditation guide.
