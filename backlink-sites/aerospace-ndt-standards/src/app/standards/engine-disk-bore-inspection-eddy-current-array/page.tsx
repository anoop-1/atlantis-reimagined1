...
export const metadata: Metadata = {
  ...
  description: "Practical guide for aerospace NDT inspectors: how to apply engine disk inspection in real inspection work, what auditors expect, and where most programs fa...",
  keywords: ["engine disk inspection","eddy current array","aero engine NDT","rotating component NDT"],
  alternates: { canonical: "https://aerospace-ndt-standards.vercel.app/standards/engine-disk-bore-inspection-eddy-current-array" },
  openGraph: {
    title: "Engine Disk Bore Inspection: Eddy Current Array in Aero Engines",
    description: "Practical guide for aerospace NDT inspectors: how to apply engine disk inspection in real inspection work, what auditors expect, and where most programs fa...",
    type: 'article',
    url: "https://aerospace-ndt-standards.vercel.app/standards/engine-disk-bore-inspection-eddy-current-array",
    siteName: "Aerospace NDT Standards",
    locale: 'en_US',
    publishedTime: "2025-05-06T00:00:00.000Z",
    modifiedTime: "2025-05-06T00:00:00.000Z",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Engine Disk Bore Inspection: Eddy Current Array in Aero Engines",
  "description": "Practical guide for aerospace NDT inspectors: how to apply engine disk inspection in real inspection work, what auditors expect, and where most programs fa...",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://aerospace-ndt-standards.vercel.app/standards/engine-disk-bore-inspection-eddy-current-array"
  },
  "keywords": "engine disk inspection, eddy current array, aero engine NDT, rotating component NDT"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>Engine Disk Bore Inspection: Eddy Current Array in Aero Engines</span>
      </nav>
      <h1>Engine Disk Bore Inspection: Eddy Current Array in Aero Engines</h1>
      <p className="text-sm text-gray-500 mb-8">By Capt. Russell Fairchild, NANDTB Level III &middot; Published 2025-05-06</p>
      <div dangerouslySetInnerHTML={{ __html: `<p>This article walks through the practical decisions aerospace NDT inspectors, NAS 410 candidates, NADCAP auditors need to make when working on aerospace NDT and certification. The goal is not theory — it is the kind of working knowledge an experienced inspector or engineer would share over a coffee on a job site, with enough rigor to point back to code and standard references when those decisions get challenged in audit. Throughout the piece we focus on the parts of engine disk inspection that turn into real schedule or budget pain when they go wrong.</p><h2>Why this comes up so often in the field</h2>
<p>Ask any aerospace NDT inspectors how often engine disk inspection drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<ul>
<li><strong>The decision points</strong> that drive most engine disk inspection programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any engine disk inspection engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<p>Post-repair inspection is the most procedural of the three patterns and the most likely to be weakened by schedule pressure. The required NDT is usually defined by the original construction code (ASME VIII, ASME XI, AWS D1.1, and so on), which is fine — but the decision about <em>how</em> to apply it under field conditions is rarely covered. Practical teams often cross-reference <a href="https://atlantisndt.com/erp/field-service-ndt-inspection-companies-singapore" rel="noopener">the field service ndt inspection companies singapore resource on Atlantis NDT</a> to align their practice with what is already published in the wider community.</p><h2>The data the audit will ask for</h2>
<p>Auditors do not argue with conclusions; they argue with the evidence behind them. For any defensible engine disk inspection report, the evidence packet needs to include at minimum:</p>
<ul>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of engine disk inspection should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize engine disk inspection in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p><h3>How engine disk inspection fits into the bigger picture</h3>
<p>It is easy to study engine disk inspection as an isolated subject — most courses do exactly that — but the engineering value only appears when you place engine disk inspection alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.nrc.gov/reactors/operating/ops-experience.html" rel="noopener nofollow">the NRC operating experience archive</a> to align their practice with what is already published in the wider community. For most aerospace NDT inspectors the question is not "what is engine disk inspection?" but "where does engine disk inspection sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in engine disk inspection, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on eddy current array</h3>
<p>Three behaviours we see at high-performing operators consistently show up in eddy current array programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a eddy current array program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best aero engine NDT documentation packages we have seen share three patterns:</p>
<ul>
