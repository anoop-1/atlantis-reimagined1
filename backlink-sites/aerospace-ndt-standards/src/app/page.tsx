...
export const metadata: Metadata = {
  title: 'Aerospace NDT Standards — NAS 410, NADCAP & Aircraft Inspection',
  description: 'Complete resource for aerospace NDT: NAS 410 certification, NADCAP accreditation, composite inspection, engine testing.',
  keywords: ["aerospace NDT","NAS 410","NADCAP"],
  openGraph: { title: 'Aerospace NDT Standards — NAS 410, NADCAP & Aircraft Inspection', type: 'article' },
};
    ...
    <article className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          Complete resource for aerospace NDT: NAS 410 certification, NADCAP accreditation, composite inspection, engine testing.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about aerospace ndt standards.
