...
export const metadata: Metadata = {
  title: 'Eddy Current Testing for Aircraft — Surface & Subsurface Cracks',
  description: 'ECT in aviation: bolt hole inspection, surface crack detection, multi-layer structure testing, ECA arrays.',
  keywords: ["eddy current aircraft"],
  openGraph: { title: 'Eddy Current Testing for Aircraft — Surface & Subsurface Cracks', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">Eddy Current Testing for Aircraft</span>
      </nav>

      <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
        Eddy Current Testing for Aircraft
      </h1>

      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          ECT in aviation: bolt hole inspection, surface crack detection, multi-layer structure testing, ECA arrays.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about eddy current testing for aircraft.
