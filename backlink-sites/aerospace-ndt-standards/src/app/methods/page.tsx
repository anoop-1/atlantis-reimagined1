...
export const metadata: Metadata = {
  title: 'Aerospace NDT Methods — Specialized Techniques for Aviation',
  description: 'Specialized NDT methods for aerospace: PAUT, eddy current arrays, thermography, shearography, digital RT.',
  keywords: ["aerospace NDT methods"],
  openGraph: { title: 'Aerospace NDT Methods — Specialized Techniques for Aviation', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">Aerospace NDT Methods</span>
      </nav>
      ...
      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          Specialized NDT methods for aerospace: PAUT, eddy current arrays, thermography, shearography, digital RT.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about aerospace ndt methods.
