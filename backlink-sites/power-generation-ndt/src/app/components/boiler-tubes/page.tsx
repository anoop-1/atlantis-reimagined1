...
export const metadata: Metadata = {
  title: 'Boiler Tube Inspection — UT Thickness, IRIS & ECT Methods',
  description: 'Boiler tube NDT methods: manual UT, IRIS, eddy current, visual examination of waterwall tubes.',
  keywords: ["boiler tube inspection"],
  openGraph: { title: 'Boiler Tube Inspection — UT Thickness, IRIS & ECT Methods', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">Boiler Tube Inspection</span>
      </nav>
      ...
      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          Boiler tube NDT methods: manual UT, IRIS, eddy current, visual examination of waterwall tubes.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about boiler tube inspection.
