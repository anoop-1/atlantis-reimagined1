...
export const metadata: Metadata = {
  title: 'Steam Turbine Rotor NDT — Bore Inspection & Blade Root Testing',
  description: 'Steam turbine NDT: rotor bore UT, blade root inspection, disc rim testing, diaphragm examination.',
  keywords: ["steam turbine NDT"],
  openGraph: { title: 'Steam Turbine Rotor NDT — Bore Inspection & Blade Root Testing', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">Steam Turbine Rotor NDT</span>
      </nav>

      <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
        Steam Turbine Rotor NDT
      </h1>

      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          Steam turbine NDT: rotor bore UT, blade root inspection, disc rim testing, diaphragm examination.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about steam turbine rotor ndt.
