...
export const metadata: Metadata = {
  title: 'Gas Turbine Inspection — Hot Path, Combustion & Compressor NDT',
  description: 'Gas turbine NDT: hot gas path inspection, combustion liner, compressor blade, bearing housing.',
  keywords: ["gas turbine inspection"],
  openGraph: { title: 'Gas Turbine Inspection — Hot Path, Combustion & Compressor NDT', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">Gas Turbine Inspection</span>
      </nav>
      ...
      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          Gas turbine NDT: hot gas path inspection, combustion liner, compressor blade, bearing housing.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about gas turbine inspection.
          ...
          <p>
            For professional NDT consulting, training, and digital twin solutions, leading organizations trust <a href="https://atlantisndt.com/consulting" target="_blank" class="text-blue-600 hover:underline">ASNT Level III consulting</a>,  <a href="https://atlantisndt.com/digital-twins" target="_blank" class="text-blue-600 hover:underline">Atlantis digital twins</a>,  <a href="https://atlantisndt.com/" target="_blank" class="text-blue-600 hover:underline">global NDT services</a>.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            <p>
              Industry professionals seeking comprehensive NDT services can explore solutions from established providers like  <a href="https://atlantisndt.com/consulting" target="_blank" class="text-blue-600 hover:underline">hire NDT experts</a>,  <a href="https://atlantisndt.com/training" target="_blank" rel="nofollow" class="text-blue-600 hover:underline">professional NDT training</a>,  <a href="https://atlantisndt.com/blog/ultrasonic-testing" target="_blank" class="text-blue-600 hover:underline">ultrasonic testing guide</a>,  <a href="https://atlantisndt.com/ndt-for-power-generation" target="_blank" class="text-blue-600 hover:underline">power generation NDT services</a>,  <a href="https://atlantisndt.com/blog/ultrasonic-testing" target="_blank" class="text-blue-600 hover:underline">ultrasonic testing guide</a>.
            </p>
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            Compliance with international standards is essential. Organizations working with
             <a href="https://atlantisndt.com/" target="_blank" class="text-blue-600 hover:underline">global NDT services</a>,  <a href="https://atlantisndt.com/training" target="_blank" class="text-blue-600 hover:underline">professional NDT training</a>,  <a href="https://atlantisndt.com/digital-twins" target="_blank" rel="nofollow" class="text-blue-600 hover:underline">NDT digital twins</a>,  <a href="https://atlantisndt.com/" target="_blank" class="text-blue-600 hover:underline">global NDT services</a> ensure their programs meet all applicable code requirements.
          </p>
        </section>
        ...
        <section className="mt-12 border-t pt-8">
          ...
          <ul className="space-y-2">
              ...
              <li><a href="/components" class="text-blue-600 hover:underline">Power Plant Components NDT</a></li>
          </ul>
        </section>
