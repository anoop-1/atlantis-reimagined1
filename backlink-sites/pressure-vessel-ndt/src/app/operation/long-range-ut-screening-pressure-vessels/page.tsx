...
export const metadata: Metadata = {
  ...
  description: "Working notes for API 510 inspectors on long range UT: how to choose the technique, document the decision, and survive the next audit.",
  keywords: ["long range UT","guided wave testing","LRUT vessels","screening NDT"],
  alternates: { canonical: "https://pressure-vessel-ndt.vercel.app/operation/long-range-ut-screening-pressure-vessels" },
  openGraph: {
    title: "Long-Range UT Screening for Pressure Vessels: When It Adds Real Value",
    description: "Working notes for API 510 inspectors on long range UT: how to choose the technique, document the decision, and survive the next audit.",
    type: 'article',
    url: "https://pressure-vessel-ndt.vercel.app/operation/long-range-ut-screening-pressure-vessels",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Long-Range UT Screening for Pressure Vessels: When It Adds Real Value",
  "description": "Working notes for API 510 inspectors on long range UT: how to choose the technique, document the decision, and survive the next audit.",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://pressure-vessel-ndt.vercel.app/operation/long-range-ut-screening-pressure-vessels"
  },
  "keywords": "long range UT, guided wave testing, LRUT vessels, screening NDT"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>Long-Range UT Screening for Pressure Vessels: When It Adds Real Value</span>
      </nav>
      <h1>Long-Range UT Screening for Pressure Vessels: When It Adds Real Value</h1>
      <p className="text-sm text-gray-500 mb-8">By Inga Sørensen, API 510 Inspector &middot; Published 2026-04-22</p>
      <div dangerouslySetInnerHTML={{ __html: `<p>This article walks through the practical decisions API 510 inspectors, fixed-equipment engineers, OEM QA leads need to make when working on pressure vessel inspection. The goal is not theory — it is the kind of working knowledge an experienced inspector or engineer would share over a coffee on a job site, with enough rigor to point back to code and standard references when those decisions get challenged in audit. Throughout the piece we focus on the parts of long range ut that turn into real schedule or budget pain when they go wrong.</p><h2>Why this comes up so often in the field</h2>
<p>Ask any API 510 inspectors how often long range ut drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<ul>
<li><strong>The decision points</strong> that drive most long range ut programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any long range ut engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<p>The textbook approach to long range ut usually points engineers at one or two techniques. The field reality is messier; the technique that ranks best on a comparison chart is often not the one that fits the access, the schedule, or the inspector skill mix actually available on the day. We walk through three patterns we see repeatedly.</p>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of long range ut should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize long range ut in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p><h3>How long range UT fits into the bigger picture</h3>
<p>It is easy to study long range UT as an isolated subject — most courses do exactly that — but the engineering value only appears when you place long range UT alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.nrc.gov/reactors/operating/ops-experience.html" rel="noopener nofollow">NRC operating experience reports</a> to align their practice with what is already published in the wider community. For most API 510 inspectors the question is not "what is long range UT?" but "where does long range UT sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in long range UT, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on guided wave testing</h3>
<p>Three behaviours we see at high-performing operators consistently show up in guided wave testing programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a guided wave testing program.</p>
