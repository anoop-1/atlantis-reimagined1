...
<li className="border-b border-gray-200 py-6">
          <a href="/solutions/integrating-paut-files-into-an-integrity-platform" className="text-xl font-semibold text-gray-900 hover:text-blue-600">Integrating PAUT Files Into an Integrity Platform: Data Formats Compared</a>
          <p className="text-sm text-gray-500 mt-2">By Carlos Rabago, Solution Architect &middot; 2025-05-15</p>
          <p className="text-gray-700 mt-3">Integrating PAUT Files Into an Integrity Platform: Data Formats Compared</p>
        </li>
<li className="border-b border-gray-200 py-6">
          <a href="/solutions/role-based-access-control-for-inspection-data" className="text-xl font-semibold text-gray-900 hover:text-blue-600">Role-Based Access Control for Inspection Data: A Practical Setup</a>
          <p className="text-sm text-gray-500 mt-2">By Mireille Dubois, IT Architect &middot; 2025-09-12</p>
          <p className="text-gray-700 mt-3">Role-Based Access Control for Inspection Data: A Practical Setup</p>
        </li>
<li className="border-b border-gray-200 py-6">
          <a href="/solutions/api-first-ndt-software-evaluation-criteria" className="text-xl font-semibold text-gray-900 hover:text-blue-600">API-First NDT Software: Evaluation Criteria for Future-Proof Choice</a>
          <p className="text-sm text-gray-500 mt-2">By Carlos Rabago, Solution Architect &middot; 2025-12-11</p>
          <p className="text-gray-700 mt-3">API-First NDT Software: Evaluation Criteria for Future-Proof Choice</p>
        </li>
<li className="border-b border-gray-200 py-6">
          <a href="/solutions/inspection-photo-management-best-practices" className="text-xl font-semibold text-gray-900 hover:text-blue-600">Inspection Photo Management Best Practices for Large Projects</a>
          <p className="text-sm text-gray-500 mt-2">By Mireille Dubois, IT Architect &middot; 2026-03-10</p>
          <p className="text-gray-700 mt-3">Inspection Photo Management Best Practices for Large Projects</p>
        </li>
<li className="border-b border-gray-200 py-6">
          <a href="/solutions/choosing-a-cmms-aware-ndt-platform-2026" className="text-xl font-semibold text-gray-900 hover:text-blue-600">Choosing a CMMS-Aware NDT Platform in 2026</a>
          <p className="text-sm text-gray-500 mt-2">By Carlos Rabago, Solution Architect &middot; 2026-05-07</p>
          <p className="text-gray-700 mt-3">Choosing a CMMS-Aware NDT Platform in 2026</p>
        </li>
      </ul>
    </div>
  );
