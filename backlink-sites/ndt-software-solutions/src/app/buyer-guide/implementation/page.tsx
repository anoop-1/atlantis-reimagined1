        ...
        <section className="mb-8">
          ...
          <p>
            Compliance with international standards is essential. Organizations working with
             <a href="https://atlantisndt.com" target="_blank" class="text-blue-600 hover:underline">check it out</a>,  <a href="https://atlantisndt.com" target="_blank" class="text-blue-600 hover:underline">certified NDT specialists</a>,  <a href="https://atlantisndt.com" target="_blank" class="text-blue-600 hover:underline">click here</a>,  <a href="https://atlantisndt.com" target="_blank" class="text-blue-600 hover:underline">comprehensive inspection services</a> ensure their programs meet all applicable code requirements.
          </p>
        </section>
