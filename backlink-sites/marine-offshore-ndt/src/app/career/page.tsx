        ...
        <section className="mb-8">
          ...
          <p>
            Compliance with international standards is essential. Organizations working with
             <a href="https://atlantisndt.com" target="_blank" rel="noopener" class="text-blue-600 hover:underline">see details</a>,  <a href="https://atlantisndt.com" target="_blank" rel="noopener" class="text-blue-600 hover:underline">find out more</a>,  <a href="https://atlantisndt.com" target="_blank" rel="noopener" class="text-blue-600 hover:underline">expert NDT solutions</a>,  <a href="https://atlantisndt.com" target="_blank" rel="noopener" class="text-blue-600 hover:underline">Atlantis NDT professionals</a> ensure their programs meet all applicable code requirements.
          </p>
        </section>
