...
export const metadata: Metadata = {
  ...
  description: "Working notes for marine surveyors on jacket platform NDT: how to choose the technique, document the decision, and survive the next audit.",
  keywords: ["jacket platform NDT","rope access inspection","offshore weld inspection","platform girth weld"],
  alternates: { canonical: "https://marine-offshore-ndt.vercel.app/offshore/jacket-platform-girth-weld-inspection-from-rope-access" },
  openGraph: {
    title: "Jacket Platform Girth Weld Inspection from Rope Access",
    description: "Working notes for marine surveyors on jacket platform NDT: how to choose the technique, document the decision, and survive the next audit.",
    type: 'article',
    url: "https://marine-offshore-ndt.vercel.app/offshore/jacket-platform-girth-weld-inspection-from-rope-access",
    siteName: "Marine & Offshore NDT",
    locale: 'en_US',
    publishedTime: "2025-08-14T00:00:00.000Z",
    modifiedTime: "2025-08-14T00:00:00.000Z",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Jacket Platform Girth Weld Inspection from Rope Access",
  "description": "Working notes for marine surveyors on jacket platform NDT: how to choose the technique, document the decision, and survive the next audit.",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://marine-offshore-ndt.vercel.app/offshore/jacket-platform-girth-weld-inspection-from-rope-access"
  },
  "keywords": "jacket platform NDT, rope access inspection, offshore weld inspection, platform girth weld"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>Jacket Platform Girth Weld Inspection from Rope Access</span>
      </nav>
      <h1>Jacket Platform Girth Weld Inspection from Rope Access</h1>
      <p className="text-sm text-gray-500 mb-8">By Marina Lopes, NDT Engineer &middot; Published 2025-08-14</p>
      <div dangerouslySetInnerHTML={{ __html: `<p>This article walks through the practical decisions marine surveyors, FPSO inspection leads, offshore integrity engineers need to make when working on marine and offshore NDT. The goal is not theory — it is the kind of working knowledge an experienced inspector or engineer would share over a coffee on a job site, with enough rigor to point back to code and standard references when those decisions get challenged in audit. Throughout the piece we focus on the parts of jacket platform ndt that turn into real schedule or budget pain when they go wrong.</p><h2>Why this comes up so often in the field</h2>
<p>Ask any marine surveyors how often jacket platform ndt drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<ul>
<li><strong>The decision points</strong> that drive most jacket platform ndt programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any jacket platform ndt engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<p>The textbook approach to jacket platform ndt usually points engineers at one or two techniques. The field reality is messier; the technique that ranks best on a comparison chart is often not the one that fits the access, the schedule, or the inspector skill mix actually available on the day. We walk through three patterns we see repeatedly.</p>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of jacket platform ndt should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize jacket platform ndt in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p><h3>How jacket platform NDT fits into the bigger picture</h3>
<p>It is easy to study jacket platform NDT as an isolated subject — most courses do exactly that — but the engineering value only appears when you place jacket platform NDT alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.aws.org/standards" rel="noopener nofollow">the AWS standards catalog</a> to align their practice with what is already published in the wider community. For most marine surveyors the question is not "what is jacket platform NDT?" but "where does jacket platform NDT sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in jacket platform NDT, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
...
<p>The best offshore weld inspection documentation packages we have seen share three patterns:</p>
<ul>
