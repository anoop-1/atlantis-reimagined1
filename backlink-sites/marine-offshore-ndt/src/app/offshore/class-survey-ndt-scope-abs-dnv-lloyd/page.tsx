...
export default function ArticlePage() {
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <p className="text-sm text-gray-500 mb-8">By Erik Halvorsen, IIMS &middot; Published 2024-10-10</p>
...
<p>Below is the working matrix our team uses on day one of any class survey engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<p>Three behaviours we see at high-performing operators consistently show up in ABS DNV LR programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a ABS DNV LR program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best class society NDT documentation packages we have seen share three patterns:</p>
<ul>
