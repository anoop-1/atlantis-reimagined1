    ...
    <div>
      ...
      <article className="prose prose-lg max-w-none mb-12">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            Geothermal systems accessing subsurface heat extract thermal energy from earth's interior through deep wells and heat exchanger systems. Well integrity assessment ensures containment of geothermal fluid within designed boundaries. <a href="https://ndt-connect.com" rel="noopener" className="text-green-600 hover:text-green-800 font-semibold">NDTConnect platform</a> centralizes inspection documentation for distributed renewable energy facilities.
          </p>
