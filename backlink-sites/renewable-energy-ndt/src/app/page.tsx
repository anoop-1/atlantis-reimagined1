export default function Home() {
  return (
    <div>
      <div className="bg-gradient-to-r from-green-600 to-green-400 text-white p-12 rounded-lg mb-12">
        <h1 className="text-4xl font-bold mb-4">Renewable Energy Integrity Assurance</h1>
        <p className="text-lg text-green-100">NDT Solutions for Clean Energy Infrastructure</p>
      </div>

      <article className="prose prose-lg max-w-none mb-12">
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-green-800 mb-4">NDT in Renewable Energy Transition</h2>
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            <a href="https://atlantisndt.com/consulting" rel="noopener" className="text-green-600 hover:text-green-800 font-semibold">NDT consulting services</a> specialized in renewable energy applications bring understanding of equipment failure mechanisms and industry-specific inspection requirements. <a href="https://atlantisndt.com/training" rel="noopener" className="text-green-600 hover:text-green-800 font-semibold">NDT training programs</a> prepare personnel for renewable energy system assessment.
          </p>
        </section>

        <section className="mb-8">
          <h2 className="text-2xl font-bold text-green-800 mb-4">Wind Turbine System Assessment</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            Wind turbine generators, gearboxes, and structural components experience cyclic loading from wind pressure variations and vibration. Fatigue crack initiation in welded structures and bearing wear represent typical degradation mechanisms. Blade integrity assessment detects delamination and matrix cracking in composite materials. <a href="https://atlantisndt.com/ultrasonic-testing" rel="noopener" className="text-green-600 hover:text-green-800 font-semibold">Ultrasonic testing</a> assesses internal blade condition. Thermography identifies delamination zones indicating composite material degradation.
          </p>
          <p className="text-gray-700 leading-relaxed mb-4">
            Gearbox oil analysis combined with visual inspection and vibration monitoring detects emerging wear patterns before catastrophic failures occur. Bearing condition assessment through vibration analysis and thermography enables predictive maintenance replacing components before failures interrupt electricity generation. <a href="https://atlantisndt.com/digital-twins" rel="noopener" className="text-green-600 hover:text-green-800 font-semibold">Digital twin solutions</a> integrate turbine operational data with predictive models enabling optimal maintenance scheduling.
          </p>
          <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-green-800 mb-4">Solar and Geothermal System Integrity</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            Geothermal systems accessing subsurface heat extract thermal energy from earth's interior through deep wells and heat exchanger systems. Well integrity assessment ensures containment of geothermal fluid within designed boundaries. <a href="https://atlantisndt.com/ndt-connect" rel="noopener" className="text-green-600 hover:text-green-800 font-semibold">NDTConnect platform</a> centralizes inspection documentation for distributed renewable energy facilities.
          </p>
