export default function Geothermal() {
  return (
    <div>
      <h1 className="text-4xl font-bold text-green-800 mb-8">Geothermal Energy System Assessment</h1>
