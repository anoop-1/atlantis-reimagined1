export default function Wind() {
  return (
    <div>
      <h1 className="text-4xl font-bold text-green-800 mb-8">Wind Turbine NDT and Inspection</h1>
