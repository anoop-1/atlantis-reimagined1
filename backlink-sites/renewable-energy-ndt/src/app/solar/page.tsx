  ...
  return (
    <div>
      ...
      <article className="prose prose-lg max-w-none">
        ...
        <p className="text-gray-700 leading-relaxed mb-4">
          Power tower systems directing concentrated sunlight onto elevated receivers employ materials and equipment operating at extreme temperatures and pressures. Heliostat tracking systems must maintain accuracy to direct sunlight onto receivers. <a href="https://ndt-connect.com" rel="noopener" className="text-green-600 hover:text-green-800 font-semibold">NDTConnect platform</a> manages inspection documentation for large CSP facilities.
        </p>
