export default function Solar() {
  return (
    <div>
      <h1 className="text-4xl font-bold text-green-800 mb-8">Solar Energy System Integrity</h1>
      <article className="prose prose-lg max-w-none">
        ...
        <p className="text-gray-700 leading-relaxed mb-4">
          Thermal stress from high-temperature fluid cycling creates fatigue crack initiation and propagation risks. Advanced alloys selected for high-temperature strength must be assessed periodically confirming continued integrity. <a href="https://atlantisndt.com/consulting" rel="noopener" className="text-green-600 hover:text-green-800 font-semibold">NDT consulting services</a> develop inspection strategies accounting for extreme temperature service conditions. <a href="https://atlantisndt.com/ultrasonic-testing" rel="noopener" className="text-green-600 hover:text-green-800 font-semibold">Ultrasonic testing</a> detects wall thinning and crack-like defects in heat exchanger and piping systems.
        </p>
        <p className="text-gray-700 leading-relaxed mb-4">
          Power tower systems directing concentrated sunlight onto elevated receivers employ materials and equipment operating at extreme temperatures and pressures. Heliostat tracking systems must maintain accuracy to direct sunlight onto receivers. <a href="https://atlantisndt.com/ndt-connect" rel="noopener" className="text-green-600 hover:text-green-800 font-semibold">NDTConnect platform</a> manages inspection documentation for large CSP facilities.
        </p>
