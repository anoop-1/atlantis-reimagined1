  ...
  return (
    <div className="space-y-8">
      <section className="bg-gray-100 p-8 rounded-lg">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">Railway NDT Resource</h1>
        <p className="text-lg text-gray-700">Comprehensive guide to non-destructive testing in railway infrastructure, from track inspection to wheel defect detection.</p>
      </section>

      <section className="prose max-w-none">
        <h2 className="text-2xl font-bold mb-4">NDT in Railway Operations</h2>
        <p className="mb-4">
