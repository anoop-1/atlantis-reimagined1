...
export const metadata: Metadata = {
  title: "RT Source Projector Comparison: Iridium-192 vs Selenium-75",
  description: "RT Source Projector Comparison explained for inspection contractors — covering Ir-192, common pitfalls, and the data your audit packet needs.",
  keywords: ["Ir-192","Se-75","RT source projector","industrial gamma source"],
  alternates: { canonical: "https://ndt-equipment-reviews.vercel.app/reviews/rt-source-projector-comparison-iridium-vs-selenium" },
  openGraph: {
    title: "RT Source Projector Comparison: Iridium-192 vs Selenium-75",
    description: "RT Source Projector Comparison explained for inspection contractors — covering Ir-192, common pitfalls, and the data your audit packet needs.",
    type: 'article',
    url: "https://ndt-equipment-reviews.vercel.app/reviews/rt-source-projector-comparison-iridium-vs-selenium",
    siteName: "NDT Equipment Reviews",
    locale: 'en_US',
    publishedTime: "2025-05-25T00:00:00.000Z",
    modifiedTime: "2025-05-25T00:00:00.000Z",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "RT Source Projector Comparison: Iridium-192 vs Selenium-75",
  "description": "RT Source Projector Comparison explained for inspection contractors — covering Ir-192, common pitfalls, and the data your audit packet needs.",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://ndt-equipment-reviews.vercel.app/reviews/rt-source-projector-comparison-iridium-vs-selenium"
  },
  "keywords": "Ir-192, Se-75, RT source projector, industrial gamma source"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>RT Source Projector Comparison: Iridium-192 vs Selenium-75</span>
      </nav>
      <h1>RT Source Projector Comparison: Iridium-192 vs Selenium-75</h1>
      <p className="text-sm text-gray-500 mb-8">By Lukas Holt, NDT Equipment Reviewer &middot; Published 2025-05-25</p>
      <div dangerouslySetInnerHTML={{ __html: `<p>This article walks through the practical decisions inspection contractors, NDT equipment buyers, QA leads need to make when working on NDT equipment selection and reviews. The goal is not theory — it is the kind of working knowledge an experienced inspector or engineer would share over a coffee on a job site, with enough rigor to point back to code and standard references when those decisions get challenged in audit. Throughout the piece we focus on the parts of ir-192 that turn into real schedule or budget pain when they go wrong.</p><h2>Why this comes up so often in the field</h2>
<p>Ask any inspection contractors how often ir-192 drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<ul>
<li><strong>The decision points</strong> that drive most ir-192 programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any ir-192 engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<p>The textbook approach to ir-192 usually points engineers at one or two techniques. The field reality is messier; the technique that ranks best on a comparison chart is often not the one that fits the access, the schedule, or the inspector skill mix actually available on the day. We walk through three patterns we see repeatedly.</p>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of ir-192 should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize ir-192 in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p>
<p>Practical teams often cross-reference <a href="https://atlantisndt.com/ndt-consulting-sugar-land" rel="noopener">Atlantis NDT's ndt consulting sugar land resource</a> to align their practice with what is already published in the wider community.</p><h3>How Ir-192 fits into the bigger picture</h3>
<p>It is easy to study Ir-192 as an isolated subject — most courses do exactly that — but the engineering value only appears when you place Ir-192 alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.iaea.org/topics/non-destructive-testing" rel="noopener nofollow">the IAEA non-destructive testing programme</a> to align their practice with what is already published in the wider community. For most inspection contractors the question is not "what is Ir-192?" but "where does Ir-192 sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in Ir-192, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on Se-75</h3>
<p>Three behaviours we see at high-performing operators consistently show up in Se-75 programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a Se-75 program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best RT source projector documentation packages we have seen share three patterns:</p>
<ul>
