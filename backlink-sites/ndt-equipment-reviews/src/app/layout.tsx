            ...
            <div className="grid grid-cols-3 gap-8 mb-8">
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li><a href="https://atlantisndt.com" rel="noopener" className="text-teal-600 hover:underline">Equipment Selection</a></li>
                  <li><a href="https://atlantisndt.com" rel="noopener" className="text-teal-600 hover:underline">Instrument Training</a></li>
                  <li><a href="https://atlantisndt.com" rel="noopener" className="text-teal-600 hover:underline">Data Systems</a></li>
                  <li><a href="https://ndt-connect.com" rel="noopener" className="text-teal-600 hover:underline">Management Platforms</a></li>
                  <li><a href="https://atlantisndt.com" rel="noopener" className="text-teal-600 hover:underline">Integration Systems</a></li>
                </ul>
              </div>
              <div>
