export default function Automation() {
  return (
    <div>
      <h1 className="text-4xl font-bold text-violet-800 mb-8">Automated NDT Systems</h1>
