...
export const metadata: Metadata = {
  title: "Low-Frequency Eddy Current for Thick Aluminum and Clad Components",
  description: "Practical guide for NDT Level III engineers: how to apply low frequency eddy current in real inspection work, what auditors expect, and where most programs...",
  keywords: ["low frequency eddy current","LFEC","aircraft eddy current","clad layer"],
  alternates: { canonical: "https://advanced-ndt-techniques.vercel.app/deepdives/low-frequency-eddy-current-thick-aluminum-and-clad" },
  openGraph: {
    title: "Low-Frequency Eddy Current for Thick Aluminum and Clad Components",
    description: "Practical guide for NDT Level III engineers: how to apply low frequency eddy current in real inspection work, what auditors expect, and where most programs...",
    type: 'article',
    url: "https://advanced-ndt-techniques.vercel.app/deepdives/low-frequency-eddy-current-thick-aluminum-and-clad",
    siteName: "Advanced NDT Techniques",
    locale: 'en_US',
    publishedTime: "2025-09-25T00:00:00.000Z",
    modifiedTime: "2025-09-25T00:00:00.000Z",
    authors: ["Astrid Vinge, MSc NDT"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Low-Frequency Eddy Current for Thick Aluminum and Clad Components",
  "description": "Practical guide for NDT Level III engineers: how to apply low frequency eddy current in real inspection work, what auditors expect, and where most programs...",
  "author": {
    "@type": "Person",
    "name": "Astrid Vinge, MSc NDT"
  },
  "publisher": {
    "@type": "Organization",
    "name": "Advanced NDT Techniques Editorial",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://advanced-ndt-techniques.vercel.app/deepdives/low-frequency-eddy-current-thick-aluminum-and-clad"
  },
  "keywords": "low frequency eddy current, LFEC, aircraft eddy current, clad layer"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>Low-Frequency Eddy Current for Thick Aluminum and Clad Components</span>
      </nav>
      <h1>Low-Frequency Eddy Current for Thick Aluminum and Clad Components</h1>
      <p className="text-sm text-gray-500 mb-8">By Astrid Vinge, MSc NDT &middot; Published 2025-09-25</p>
      <div dangerouslySetInnerHTML={{ __html: `<p>This article walks through the practical decisions NDT Level III engineers, advanced technique specialists need to make when working on advanced NDT techniques. The goal is not theory — it is the kind of working knowledge an experienced inspector or engineer would share over a coffee on a job site, with enough rigor to point back to code and standard references when those decisions get challenged in audit. Throughout the piece we focus on the parts of low frequency eddy current that turn into real schedule or budget pain when they go wrong.</p><h2>Why this comes up so often in the field</h2>
<p>Ask any NDT Level III engineers how often low frequency eddy current drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<ul>
<li><strong>The decision points</strong> that drive most low frequency eddy current programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any low frequency eddy current engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<p>The textbook approach to low frequency eddy current usually points engineers at one or two techniques. The field reality is messier; the technique that ranks best on a comparison chart is often not the one that fits the access, the schedule, or the inspector skill mix actually available on the day. We walk through three patterns we see repeatedly.</p>
...
<p>Auditors do not argue with conclusions; they argue with the evidence behind them. For any defensible low frequency eddy current report, the evidence packet needs to include at minimum:</p>
<ul>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of low frequency eddy current should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize low frequency eddy current in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p>
<p>Practical teams often cross-reference <a href="https://atlantisndt.com/digital-twins" rel="noopener">the digital twin platform overview</a> to align their practice with what is already published in the wider community. Practical teams often cross-reference <a href="https://atlantisndt.com/corporate-training/battery-manufacturing" rel="noopener">the battery manufacturing training programme</a> to align their practice with what is already published in the wider community.</p><h3>How low frequency eddy current fits into the bigger picture</h3>
<p>It is easy to study low frequency eddy current as an isolated subject — most courses do exactly that — but the engineering value only appears when you place low frequency eddy current alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.ampp.org/" rel="noopener nofollow">AMPP (Association for Materials Protection and Performance)</a> to align their practice with what is already published in the wider community. For most NDT Level III engineers the question is not "what is low frequency eddy current?" but "where does low frequency eddy current sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in low frequency eddy current, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on LFEC</h3>
<p>Three behaviours we see at high-performing operators consistently show up in LFEC programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a LFEC program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best aircraft eddy current documentation packages we have seen share three patterns:</p>
<ul>
...
<h3>How LFEC fits into the bigger picture</h3>
<p>It is easy to study LFEC as an isolated subject — most courses do exactly that — but the engineering value only appears when you place LFEC alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.ampp.org/" rel="noopener nofollow">AMPP (Association for Materials Protection and Performance)</a> to align their practice with what is already published in the wider community. For most NDT Level III engineers the question is not "what is LFEC?" but "where does LFEC sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in LFEC, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on aircraft eddy current</h3>
<p>Three behaviours we see at high-performing operators consistently show up in aircraft eddy current programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a aircraft eddy current program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best clad layer documentation packages we have seen share three patterns:</p>
<ul>
<li>A short narrative section at the front of every report explaining the inspection objective in plain English. Auditors, regulators, and new hires all read the narrative first.</li>
<li>A consistent indication-numbering scheme that survives across multiple inspection campaigns, so an indication found in 2024 can be tracked through 2026 and 2028 without renaming.</li>
<li>An attached "open items" list with target dates, ownership, and the trigger that closes each item. This is the single most useful artifact for a turnaround manager.</li>
...
<li><a href="/deepdives/guided-wave-screening-program-design">Guided Wave Screening Program Design for Long Pipelines</a></li>
</ul>
` }} />
    </article>
  );
