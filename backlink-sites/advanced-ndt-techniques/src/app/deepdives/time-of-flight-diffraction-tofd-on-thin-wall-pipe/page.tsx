...
export const metadata: Metadata = {
  title: "Time-of-Flight Diffraction (TOFD) on Thin-Wall Pipe: Where It Struggles",
  description: "A field-oriented walkthrough of TOFD thin wall for NDT Level III engineers, with decision matrices, code references, and the documentation auditors actuall...",
  keywords: ["TOFD thin wall","TOFD pipe","TOFD limitations","thin wall NDT"],
  alternates: { canonical: "https://advanced-ndt-techniques.vercel.app/deepdives/time-of-flight-diffraction-tofd-on-thin-wall-pipe" },
  openGraph: {
    title: "Time-of-Flight Diffraction (TOFD) on Thin-Wall Pipe: Where It Struggles",
    description: "A field-oriented walkthrough of TOFD thin wall for NDT Level III engineers, with decision matrices, code references, and the documentation auditors actuall...",
    type: 'article',
    url: "https://advanced-ndt-techniques.vercel.app/deepdives/time-of-flight-diffraction-tofd-on-thin-wall-pipe",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Time-of-Flight Diffraction (TOFD) on Thin-Wall Pipe: Where It Struggles",
  "description": "A field-oriented walkthrough of TOFD thin wall for NDT Level III engineers, with decision matrices, code references, and the documentation auditors actuall...",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://advanced-ndt-techniques.vercel.app/deepdives/time-of-flight-diffraction-tofd-on-thin-wall-pipe"
  },
  "keywords": "TOFD thin wall, TOFD pipe, TOFD limitations, thin wall NDT"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>Time-of-Flight Diffraction (TOFD) on Thin-Wall Pipe: Where It Struggles</span>
      </nav>
      <h1>Time-of-Flight Diffraction (TOFD) on Thin-Wall Pipe: Where It Struggles</h1>
      <p className="text-sm text-gray-500 mb-8">By Diego Costa, ASNT NDT Level III &middot; Published 2026-05-14</p>
      <div dangerouslySetInnerHTML={{ __html: `<p>This article walks through the practical decisions NDT Level III engineers, advanced technique specialists need to make when working on advanced NDT techniques. The goal is not theory — it is the kind of working knowledge an experienced inspector or engineer would share over a coffee on a job site, with enough rigor to point back to code and standard references when those decisions get challenged in audit. Throughout the piece we focus on the parts of tofd thin wall that turn into real schedule or budget pain when they go wrong.</p><h2>Why this comes up so often in the field</h2>
<p>Ask any NDT Level III engineers how often tofd thin wall drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<ul>
<li><strong>The decision points</strong> that drive most tofd thin wall programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any tofd thin wall engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<p>The textbook approach to tofd thin wall usually points engineers at one or two techniques. The field reality is messier; the technique that ranks best on a comparison chart is often not the one that fits the access, the schedule, or the inspector skill mix actually available on the day. We walk through three patterns we see repeatedly.</p>
...
<p>Auditors do not argue with conclusions; they argue with the evidence behind them. For any defensible tofd thin wall report, the evidence packet needs to include at minimum:</p>
<ul>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of tofd thin wall should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize tofd thin wall in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p>
<p>Practical teams often cross-reference <a href="https://atlantisndt.com/erp/crm-for-environmental-testing-labs" rel="noopener">Atlantis NDT's crm for environmental testing labs ERP write-up</a> to align their practice with what is already published in the wider community. Practical teams often cross-reference <a href="https://atlantisndt.com/ndt-erp-long-beach" rel="noopener">the long beach NDT ERP page</a> to align their practice with what is already published in the wider community.</p><h3>How TOFD thin wall fits into the bigger picture</h3>
<p>It is easy to study TOFD thin wall as an isolated subject — most courses do exactly that — but the engineering value only appears when you place TOFD thin wall alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://atlantisndt.com/blog/conventional-ut-vs-phased-array-which-method-to-choose" rel="noopener">the conventional UT vs PAUT decision guide</a> to align their practice with what is already published in the wider community. For most NDT Level III engineers the question is not "what is TOFD thin wall?" but "where does TOFD thin wall sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in TOFD thin wall, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on TOFD pipe</h3>
<p>Three behaviours we see at high-performing operators consistently show up in TOFD pipe programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a TOFD pipe program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best TOFD limitations documentation packages we have seen share three patterns:</p>
<ul>
...
<h3>How TOFD pipe fits into the bigger picture</h3>
<p>It is easy to study TOFD pipe as an isolated subject — most courses do exactly that — but the engineering value only appears when you place TOFD pipe alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://atlantisndt.com/blog/conventional-ut-vs-phased-array-which-method-to-choose" rel="noopener">the conventional UT vs PAUT decision guide</a> to align their practice with what is already published in the wider community. For most NDT Level III engineers the question is not "what is TOFD pipe?" but "where does TOFD pipe sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in TOFD pipe, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
