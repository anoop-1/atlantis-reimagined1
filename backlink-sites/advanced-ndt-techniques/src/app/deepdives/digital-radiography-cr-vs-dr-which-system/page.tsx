...
export const metadata: Metadata = {
  title: "Digital Radiography: CR vs DR — Which System Fits Which Site?",
  description: "Working notes for NDT Level III engineers on digital radiography: how to choose the technique, document the decision, and survive the next audit.",
  keywords: ["digital radiography","CR vs DR","computed radiography","direct digital RT"],
  alternates: { canonical: "https://advanced-ndt-techniques.vercel.app/deepdives/digital-radiography-cr-vs-dr-which-system" },
  openGraph: {
    title: "Digital Radiography: CR vs DR — Which System Fits Which Site?",
    description: "Working notes for NDT Level III engineers on digital radiography: how to choose the technique, document the decision, and survive the next audit.",
    type: 'article',
    url: "https://advanced-ndt-techniques.vercel.app/deepdives/digital-radiography-cr-vs-dr-which-system",
    siteName: "Advanced NDT Techniques",
    locale: 'en_US',
    publishedTime: "2025-11-26T00:00:00.000Z",
    modifiedTime: "2025-11-26T00:00:00.000Z",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Digital Radiography: CR vs DR — Which System Fits Which Site?",
  "description": "Working notes for NDT Level III engineers on digital radiography: how to choose the technique, document the decision, and survive the next audit.",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://advanced-ndt-techniques.vercel.app/deepdives/digital-radiography-cr-vs-dr-which-system"
  },
  "keywords": "digital radiography, CR vs DR, computed radiography, direct digital RT"
};
...
<ul>
<li><strong>The decision points</strong> that drive most digital radiography programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any digital radiography engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<p>Post-repair inspection is the most procedural of the three patterns and the most likely to be weakened by schedule pressure. The required NDT is usually defined by the original construction code (ASME VIII, ASME XI, AWS D1.1, and so on), which is fine — but the decision about <em>how</em> to apply it under field conditions is rarely covered. Practical teams often cross-reference <a href="https://atlantisndt.com/blog/ai-predictive-maintenance-digital-twins-aviation-ndt" rel="noopener">the ai predictive maintenance digital twins aviation ndt reference</a> to align their practice with what is already published in the wider community.</p><h2>The data the audit will ask for</h2>
<p>Auditors do not argue with conclusions; they argue with the evidence behind them. For any defensible digital radiography report, the evidence packet needs to include at minimum:</p>
<ul>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of digital radiography should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize digital radiography in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p><h3>How digital radiography fits into the bigger picture</h3>
<p>It is easy to study digital radiography as an isolated subject — most courses do exactly that — but the engineering value only appears when you place digital radiography alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.iaea.org/topics/non-destructive-testing" rel="noopener nofollow">the IAEA non-destructive testing programme</a> to align their practice with what is already published in the wider community. For most NDT Level III engineers the question is not "what is digital radiography?" but "where does digital radiography sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in digital radiography, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on CR vs DR</h3>
<p>Three behaviours we see at high-performing operators consistently show up in CR vs DR programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a CR vs DR program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best computed radiography documentation packages we have seen share three patterns:</p>
<ul>
...
<h3>How CR vs DR fits into the bigger picture</h3>
<p>It is easy to study CR vs DR as an isolated subject — most courses do exactly that — but the engineering value only appears when you place CR vs DR alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.iaea.org/topics/non-destructive-testing" rel="noopener nofollow">the IAEA non-destructive testing programme</a> to align their practice with what is already published in the wider community. For most NDT Level III engineers the question is not "what is CR vs DR?" but "where does CR vs DR sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in CR vs DR, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
