...
export const metadata: Metadata = {
  title: "Eddy Current Array for Heat Exchanger Tubes: A Field Workflow",
  description: "Working notes for NDT Level III engineers on ECA heat exchanger: how to choose the technique, document the decision, and survive the next audit.",
  keywords: ["ECA heat exchanger","eddy current array tubes","IRIS","tube inspection"],
  alternates: { canonical: "https://advanced-ndt-techniques.vercel.app/deepdives/eddy-current-array-for-heat-exchanger-tubes" },
  openGraph: {
    title: "Eddy Current Array for Heat Exchanger Tubes: A Field Workflow",
    description: "Working notes for NDT Level III engineers on ECA heat exchanger: how to choose the technique, document the decision, and survive the next audit.",
    type: 'article',
    url: "https://advanced-ndt-techniques.vercel.app/deepdives/eddy-current-array-for-heat-exchanger-tubes",
    siteName: "Advanced NDT Techniques",
    locale: 'en_US',
    publishedTime: "2025-08-09T00:00:00.000Z",
    modifiedTime: "2025-08-09T00:00:00.000Z",
    authors: ["Diego Costa, ASNT NDT Level III"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Eddy Current Array for Heat Exchanger Tubes: A Field Workflow",
  "description": "Working notes for NDT Level III engineers on ECA heat exchanger: how to choose the technique, document the decision, and survive the next audit.",
  "author": {
    "@type": "Person",
    "name": "Diego Costa, ASNT NDT Level III"
  },
  "publisher": {
    "@type": "Organization",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://advanced-ndt-techniques.vercel.app/deepdives/eddy-current-array-for-heat-exchanger-tubes"
  },
  "keywords": "ECA heat exchanger, eddy current array tubes, IRIS, tube inspection"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>Eddy Current Array for Heat Exchanger Tubes: A Field Workflow</span>
      </nav>
      <h1>Eddy Current Array for Heat Exchanger Tubes: A Field Workflow</h1>
      <p className="text-sm text-gray-500 mb-8">By Diego Costa, ASNT NDT Level III &middot; Published 2025-08-09</p>
      <div dangerouslySetInnerHTML={{ __html: `<p>This article walks through the practical decisions NDT Level III engineers, advanced technique specialists need to make when working on advanced NDT techniques. The goal is not theory — it is the kind of working knowledge an experienced inspector or engineer would share over a coffee on a job site, with enough rigor to point back to code and standard references when those decisions get challenged in audit. Throughout the piece we focus on the parts of eca heat exchanger that turn into real schedule or budget pain when they go wrong.</p><h2>Why this comes up so often in the field</h2>
<p>Ask any NDT Level III engineers how often eca heat exchanger drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<ul>
<li><strong>The decision points</strong> that drive most eca heat exchanger programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any eca heat exchanger engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<p>The textbook approach to eca heat exchanger usually points engineers at one or two techniques. The field reality is messier; the technique that ranks best on a comparison chart is often not the one that fits the access, the schedule, or the inspector skill mix actually available on the day. We walk through three patterns we see repeatedly.</p>
...
<p>Auditors do not argue with conclusions; they argue with the evidence behind them. For any defensible eca heat exchanger report, the evidence packet needs to include at minimum:</p>
<ul>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of eca heat exchanger should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize eca heat exchanger in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p>
<p>Practical teams often cross-reference <a href="https://atlantisndt.com/ndt-erp-panama" rel="noopener">the affordable NDT ERP option for panama</a> to align their practice with what is already published in the wider community.</p><h3>How ECA heat exchanger fits into the bigger picture</h3>
<p>It is easy to study ECA heat exchanger as an isolated subject — most courses do exactly that — but the engineering value only appears when you place ECA heat exchanger alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://atlantisndt.com/blog/ultrasonic-testing" rel="noopener">the ultrasonic testing methods most often shortlisted</a> to align their practice with what is already published in the wider community. For most NDT Level III engineers the question is not "what is ECA heat exchanger?" but "where does ECA heat exchanger sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in ECA heat exchanger, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on eddy current array tubes</h3>
<p>Three behaviours we see at high-performing operators consistently show up in eddy current array tubes programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a eddy current array tubes program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best IRIS documentation packages we have seen share three patterns:</p>
<ul>
...
<h3>How eddy current array tubes fits into the bigger picture</h3>
<p>It is easy to study eddy current array tubes as an isolated subject — most courses do exactly that — but the engineering value only appears when you place eddy current array tubes alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://atlantisndt.com/blog/ultrasonic-testing" rel="noopener">the ultrasonic testing methods most often shortlisted</a> to align their practice with what is already published in the wider community. For most NDT Level III engineers the question is not "what is eddy current array tubes?" but "where does eddy current array tubes sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in eddy current array tubes, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on IRIS</h3>
<p>Three behaviours we see at high-performing operators consistently show up in IRIS programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a IRIS program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best tube inspection documentation packages we have seen share three patterns:</p>
<ul>
<li>A short narrative section at the front of every report explaining the inspection objective in plain English. Auditors, regulators, and new hires all read the narrative first.</li>
<li>A consistent indication-numbering scheme that survives across multiple inspection campaigns, so an indication found in 2024 can be tracked through 2026 and 2028 without renaming.</li>
<li>An attached "open items" list with target dates, ownership, and the trigger that closes each item. This is the single most useful artifact for a turnaround manager.</li>
