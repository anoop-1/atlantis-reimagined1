export default function Home() {
  return (
    <div>
      <div className="bg-gradient-to-r from-cyan-600 to-cyan-400 text-white p-12 rounded-lg mb-12">
        <h1 className="text-4xl font-bold mb-4">Subsea Infrastructure Integrity</h1>
        <p className="text-lg text-cyan-100">Advanced NDT for Deepwater Operations</p>
      </div>

      <article className="prose prose-lg max-w-none mb-12">
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-cyan-800 mb-4">Deepwater NDT Challenges</h2>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            Risers connecting subsea wellheads to surface platforms endure cyclic loading from wave action and current-induced vibration. Fatigue crack initiation and stress corrosion cracking represent typical failure mechanisms. Phased array ultrasonic examination combined with radiographic verification establishes baseline conditions and enables trending of crack-like defect progression. <a href="https://atlantisndt.com/digital-twins" rel="noopener" className="text-cyan-600 hover:text-cyan-800 font-semibold">Digital twin solutions</a> integrate deepwater inspection data with hydrodynamic models predicting environmental loads and enabling predictive maintenance decisions.
          </p>
          <p className="text-gray-700 leading-relaxed mb-4">
            Mooring systems and foundation structures require periodic inspection ensuring continued structural integrity. <a href="https://atlantisndt.com/blog/ultrasonic-testing-ultimate-guide" rel="noopener" className="text-cyan-600 hover:text-cyan-800 font-semibold">Ultrasonic testing guides</a> provide fundamental principles applicable to subsea assessment. Magnetic particle inspection of guide wires and chains confirms structural adequacy. NDT programs supporting deepwater installations represent significant capital investments but provide essential evidence of continued operability.
          </p>
        </section>

        <section className="mb-8">
          <h2 className="text-2xl font-bold text-cyan-800 mb-4">Equipment and Manifold Integrity</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            Subsea protection systems including corrosion inhibitor injection systems, thermal insulation, and cathodic protection require assessment ensuring continued effectiveness. <a href="https://atlantisndt.com/ndt-connect" rel="noopener" className="text-cyan-600 hover:text-cyan-800 font-semibold">NDTConnect platform</a> manages inspection documentation for deepwater asset networks spanning multiple installations and operational jurisdictions. Systematic data management ensures regulatory compliance and enables optimization of maintenance scheduling across distributed deepwater portfolios.
          </p>
