...
export const metadata: Metadata = {
  ...
  description: "Practical guide for subsea engineers: how to apply ROV inspection class in real inspection work, what auditors expect, and where most programs fall short.",
  keywords: ["ROV inspection class","observation ROV","work class ROV","subsea inspection"],
  alternates: { canonical: "https://subsea-inspection-guide.vercel.app/deepwater/rov-inspection-class-iii-vs-class-iv-which-tooling" },
  openGraph: {
    title: "ROV Inspection Class III vs Class IV: Which Tooling Fits Which Scope",
    description: "Practical guide for subsea engineers: how to apply ROV inspection class in real inspection work, what auditors expect, and where most programs fall short.",
    type: 'article',
    url: "https://subsea-inspection-guide.vercel.app/deepwater/rov-inspection-class-iii-vs-class-iv-which-tooling",
    siteName: "Subsea Inspection Guide",
    locale: 'en_US',
    publishedTime: "2024-09-08T00:00:00.000Z",
    modifiedTime: "2024-09-08T00:00:00.000Z",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "ROV Inspection Class III vs Class IV: Which Tooling Fits Which Scope",
  "description": "Practical guide for subsea engineers: how to apply ROV inspection class in real inspection work, what auditors expect, and where most programs fall short.",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://subsea-inspection-guide.vercel.app/deepwater/rov-inspection-class-iii-vs-class-iv-which-tooling"
  },
  "keywords": "ROV inspection class, observation ROV, work class ROV, subsea inspection"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>ROV Inspection Class III vs Class IV: Which Tooling Fits Which Scope</span>
      </nav>
      <h1>ROV Inspection Class III vs Class IV: Which Tooling Fits Which Scope</h1>
      <p className="text-sm text-gray-500 mb-8">By Captain Olav Berg, IMCA D 04 &middot; Published 2024-09-08</p>
      <div dangerouslySetInnerHTML={{ __html: `<p>This article walks through the practical decisions subsea engineers, ROV inspection contractors, integrity managers need to make when working on subsea inspection & integrity. The goal is not theory — it is the kind of working knowledge an experienced inspector or engineer would share over a coffee on a job site, with enough rigor to point back to code and standard references when those decisions get challenged in audit. Throughout the piece we focus on the parts of rov inspection class that turn into real schedule or budget pain when they go wrong.</p><h2>Why this comes up so often in the field</h2>
<p>Ask any subsea engineers how often rov inspection class drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<ul>
<li><strong>The decision points</strong> that drive most rov inspection class programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any rov inspection class engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<p>The textbook approach to rov inspection class usually points engineers at one or two techniques. The field reality is messier; the technique that ranks best on a comparison chart is often not the one that fits the access, the schedule, or the inspector skill mix actually available on the day. We walk through three patterns we see repeatedly.</p>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of rov inspection class should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize rov inspection class in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p><h3>How ROV inspection class fits into the bigger picture</h3>
<p>It is easy to study ROV inspection class as an isolated subject — most courses do exactly that — but the engineering value only appears when you place ROV inspection class alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.nrc.gov/reactors/operating/ops-experience.html" rel="noopener nofollow">the NRC operating experience archive</a> to align their practice with what is already published in the wider community. For most subsea engineers the question is not "what is ROV inspection class?" but "where does ROV inspection class sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in ROV inspection class, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on observation ROV</h3>
<p>Three behaviours we see at high-performing operators consistently show up in observation ROV programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a observation ROV program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best work class ROV documentation packages we have seen share three patterns:</p>
<ul>
...
<h3>How observation ROV fits into the bigger picture</h3>
<p>It is easy to study observation ROV as an isolated subject — most courses do exactly that — but the engineering value only appears when you place observation ROV alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.nrc.gov/reactors/operating/ops-experience.html" rel="noopener nofollow">the NRC operating experience archive</a> to align their practice with what is already published in the wider community. For most subsea engineers the question is not "what is observation ROV?" but "where does observation ROV sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in observation ROV, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
