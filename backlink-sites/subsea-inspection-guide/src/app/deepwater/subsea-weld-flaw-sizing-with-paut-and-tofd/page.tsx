...
export const metadata: Metadata = {
  ...
  description: "Practical guide for subsea engineers: how to apply subsea PAUT in real inspection work, what auditors expect, and where most programs fall short.",
  keywords: ["subsea PAUT","TOFD subsea","weld sizing","pipeline girth weld"],
  alternates: { canonical: "https://subsea-inspection-guide.vercel.app/deepwater/subsea-weld-flaw-sizing-with-paut-and-tofd" },
  openGraph: {
    title: "Subsea Weld Flaw Sizing With PAUT and TOFD: Field Workflow",
    description: "Practical guide for subsea engineers: how to apply subsea PAUT in real inspection work, what auditors expect, and where most programs fall short.",
    type: 'article',
    url: "https://subsea-inspection-guide.vercel.app/deepwater/subsea-weld-flaw-sizing-with-paut-and-tofd",
    siteName: "Subsea Inspection Guide",
    locale: 'en_US',
    publishedTime: "2025-11-19T00:00:00.000Z",
    modifiedTime: "2025-11-19T00:00:00.000Z",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Subsea Weld Flaw Sizing With PAUT and TOFD: Field Workflow",
  "description": "Practical guide for subsea engineers: how to apply subsea PAUT in real inspection work, what auditors expect, and where most programs fall short.",
  "author": {
    "@type": "Person",
  ...
  "datePublished": "2025-11-19T00:00:00.000Z",
  "dateModified": "2025-11-19T00:00:00.000Z",
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://subsea-inspection-guide.vercel.app/deepwater/subsea-weld-flaw-sizing-with-paut-and-tofd"
  },
  "keywords": "subsea PAUT, TOFD subsea, weld sizing, pipeline girth weld"
};
...
<ul>
<li><strong>The decision points</strong> that drive most subsea paut programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any subsea paut engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of subsea paut should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize subsea paut in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p><h3>How subsea PAUT fits into the bigger picture</h3>
<p>It is easy to study subsea PAUT as an isolated subject — most courses do exactly that — but the engineering value only appears when you place subsea PAUT alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.aws.org/standards" rel="noopener nofollow">the AWS standards catalog</a> to align their practice with what is already published in the wider community. For most subsea engineers the question is not "what is subsea PAUT?" but "where does subsea PAUT sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in subsea PAUT, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on TOFD subsea</h3>
<p>Three behaviours we see at high-performing operators consistently show up in TOFD subsea programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a TOFD subsea program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best weld sizing documentation packages we have seen share three patterns:</p>
<ul>
