...
export const metadata: Metadata = {
  ...
  description: "Working notes for subsea engineers on cathodic protection subsea: how to choose the technique, document the decision, and survive the next audit.",
  keywords: ["cathodic protection subsea","CP survey","DNV-RP-B401","subsea CP"],
  alternates: { canonical: "https://subsea-inspection-guide.vercel.app/deepwater/cathodic-protection-survey-deepwater-cp-monitoring" },
  openGraph: {
    title: "Cathodic Protection Survey for Deepwater Assets: CP Monitoring Best Practice",
    description: "Working notes for subsea engineers on cathodic protection subsea: how to choose the technique, document the decision, and survive the next audit.",
    type: 'article',
    url: "https://subsea-inspection-guide.vercel.app/deepwater/cathodic-protection-survey-deepwater-cp-monitoring",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Cathodic Protection Survey for Deepwater Assets: CP Monitoring Best Practice",
  "description": "Working notes for subsea engineers on cathodic protection subsea: how to choose the technique, document the decision, and survive the next audit.",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://subsea-inspection-guide.vercel.app/deepwater/cathodic-protection-survey-deepwater-cp-monitoring"
  },
  "keywords": "cathodic protection subsea, CP survey, DNV-RP-B401, subsea CP"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>Cathodic Protection Survey for Deepwater Assets: CP Monitoring Best Practice</span>
      </nav>
      <h1>Cathodic Protection Survey for Deepwater Assets: CP Monitoring Best Practice</h1>
      <p className="text-sm text-gray-500 mb-8">By Marisol Reyes, MSc Subsea Engineering &middot; Published 2025-06-04</p>
