...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'API Inspection Codes Explained — 510, 570, 653, 580, 571', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">API Inspection Codes Explained</span>
      </nav>
      ...
      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          Complete guide to API inspection codes used in oil and gas. Side-by-side comparison of API 510, 570, 653, 580, and 571.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about api inspection codes explained.
