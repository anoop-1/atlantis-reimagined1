...
export const metadata: Metadata = {
  title: 'API 510 Pressure Vessel Inspection — Complete Code Breakdown',
  description: 'API 510 pressure vessel inspection: MAWP calculations, corrosion rates, repair alterations, inspection intervals.',
  keywords: ["API 510","pressure vessel"],
  openGraph: { title: 'API 510 Pressure Vessel Inspection — Complete Code Breakdown', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">API 510 Pressure Vessel Inspection</span>
      </nav>
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-8">
          ...
          <p>
            This comprehensive resource covers everything you need to know about api 510 pressure vessel inspection.
