...
export const metadata: Metadata = {
  title: 'Downstream Refinery Inspection — Turnarounds, Tanks & Heat Exchangers',
  description: 'Refinery inspection guide: turnaround NDT planning, storage tank assessment, heat exchanger tube testing, fired heater inspection.',
  keywords: ["refinery inspection","turnaround NDT"],
  openGraph: { title: 'Downstream Refinery Inspection — Turnarounds, Tanks & Heat Exchangers', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">Downstream Refinery Inspection</span>
      </nav>

      <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
        Downstream Refinery Inspection
      </h1>

      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          Refinery inspection guide: turnaround NDT planning, storage tank assessment, heat exchanger tube testing, fired heater inspection.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about downstream refinery inspection.
