...
export const metadata: Metadata = {
  title: 'Oil & Gas NDT Glossary — 200+ Terms Defined',
  description: 'Complete glossary of oil and gas NDT terminology: from ACFM to zone discrimination, all terms explained.',
  keywords: ["NDT glossary"],
  openGraph: { title: 'Oil & Gas NDT Glossary — 200+ Terms Defined', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">Oil & Gas NDT Glossary</span>
      </nav>

      <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
        Oil & Gas NDT Glossary
      </h1>

      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          Complete glossary of oil and gas NDT terminology: from ACFM to zone discrimination, all terms explained.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about oil & gas ndt glossary.
