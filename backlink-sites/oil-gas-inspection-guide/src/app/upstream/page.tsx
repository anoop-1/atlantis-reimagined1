...
export const metadata: Metadata = {
  title: 'Upstream Oil & Gas Inspection — Offshore Platforms & Drilling',
  description: 'NDT inspection for upstream oil and gas: offshore platforms, drilling rigs, wellheads, subsea pipelines.',
  keywords: ["upstream inspection","offshore NDT"],
  openGraph: { title: 'Upstream Oil & Gas Inspection — Offshore Platforms & Drilling', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">Upstream Oil & Gas Inspection</span>
      </nav>

      <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
        Upstream Oil & Gas Inspection
      </h1>

      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          NDT inspection for upstream oil and gas: offshore platforms, drilling rigs, wellheads, subsea pipelines.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about upstream oil & gas inspection.
