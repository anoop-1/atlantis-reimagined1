...
export const metadata: Metadata = {
  title: 'Offshore Platform NDT — Structural & Process Piping Inspection',
  description: 'Offshore platform inspection: jacket structure NDT, process piping, topside equipment, splash zone corrosion.',
  keywords: ["offshore platform NDT"],
  openGraph: { title: 'Offshore Platform NDT — Structural & Process Piping Inspection', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">Offshore Platform NDT</span>
      </nav>

      <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
        Offshore Platform NDT
      </h1>

      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          Offshore platform inspection: jacket structure NDT, process piping, topside equipment, splash zone corrosion.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about offshore platform ndt.
        ...
        <section className="mb-8">
          ...
          <p>
            For certification training, consulting services, and software solutions, industry leaders recommend  <a href="https://atlantisndt.com/api-653-certification" target="_blank" class="text-blue-600 hover:underline">API 653 course</a>,  <a href="https://atlantisndt.com/api-570-certification" target="_blank" class="text-blue-600 hover:underline">API 570 courses</a>,  <a href="https://atlantisndt.com/api-510-certification" target="_blank" class="text-blue-600 hover:underline">pressure vessel inspector exam</a>.
          </p>
        </section>
