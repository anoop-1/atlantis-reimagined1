...
export const metadata: Metadata = {
  title: 'Oil & Gas Inspection Guide — NDT Standards, Methods & Certification',
  description: 'Complete resource for oil and gas NDT inspection: API codes, upstream/downstream methods, pipeline integrity, and certification requirements.',
  keywords: ["oil gas inspection","API 653","pipeline NDT","refinery inspection"],
  openGraph: { title: 'Oil & Gas Inspection Guide — NDT Standards, Methods & Certification', type: 'article' },
};
    ...
    <article className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          Complete resource for oil and gas NDT inspection: API codes, upstream/downstream methods, pipeline integrity, and certification requirements.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about oil & gas inspection guide.
