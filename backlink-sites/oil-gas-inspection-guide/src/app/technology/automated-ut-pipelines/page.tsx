...
export const metadata: Metadata = {
  title: 'Automated UT for Pipeline Inspection — AUT, Mechanized Scanning',
  description: 'Automated ultrasonic testing for pipeline girth welds: AUT vs manual UT, TOFD+PAUT zone discrimination.',
  keywords: ["automated UT pipeline"],
  openGraph: { title: 'Automated UT for Pipeline Inspection — AUT, Mechanized Scanning', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700">Automated UT for Pipeline Inspection</span>
      </nav>

      <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
        Automated UT for Pipeline Inspection
      </h1>

      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          Automated ultrasonic testing for pipeline girth welds: AUT vs manual UT, TOFD+PAUT zone discrimination.
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about automated ut for pipeline inspection.
