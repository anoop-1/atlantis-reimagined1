...
export const metadata: Metadata = {
  title: "Galvanic Corrosion Prevention: Design Choices and Inspection Strategy",
  description: "Practical guide for corrosion engineers: how to apply galvanic corrosion in real inspection work, what auditors expect, and where most programs fall short.",
  keywords: ["galvanic corrosion","dissimilar metal","bimetallic corrosion","galvanic isolation"],
  alternates: { canonical: "https://corrosion-management-ndt.vercel.app/management/galvanic-corrosion-prevention-design-and-inspection" },
  openGraph: {
    title: "Galvanic Corrosion Prevention: Design Choices and Inspection Strategy",
    description: "Practical guide for corrosion engineers: how to apply galvanic corrosion in real inspection work, what auditors expect, and where most programs fall short.",
    type: 'article',
    url: "https://corrosion-management-ndt.vercel.app/management/galvanic-corrosion-prevention-design-and-inspection",
    siteName: "Corrosion Management NDT",
    locale: 'en_US',
    publishedTime: "2026-03-14T00:00:00.000Z",
    modifiedTime: "2026-03-14T00:00:00.000Z",
    authors: ["Felipe Moraes, AMPP-certified"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Galvanic Corrosion Prevention: Design Choices and Inspection Strategy",
  "description": "Practical guide for corrosion engineers: how to apply galvanic corrosion in real inspection work, what auditors expect, and where most programs fall short.",
  "author": {
    "@type": "Person",
    "name": "Felipe Moraes, AMPP-certified"
  },
  "publisher": {
    "@type": "Organization",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://corrosion-management-ndt.vercel.app/management/galvanic-corrosion-prevention-design-and-inspection"
  },
  "keywords": "galvanic corrosion, dissimilar metal, bimetallic corrosion, galvanic isolation"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>Galvanic Corrosion Prevention: Design Choices and Inspection Strategy</span>
      </nav>
      <h1>Galvanic Corrosion Prevention: Design Choices and Inspection Strategy</h1>
      <p className="text-sm text-gray-500 mb-8">By Felipe Moraes, AMPP-certified &middot; Published 2026-03-14</p>
      <div dangerouslySetInnerHTML={{ __html: `<p>This article walks through the practical decisions corrosion engineers, AMPP-certified inspectors, materials managers need to make when working on corrosion management & monitoring. The goal is not theory — it is the kind of working knowledge an experienced inspector or engineer would share over a coffee on a job site, with enough rigor to point back to code and standard references when those decisions get challenged in audit. Throughout the piece we focus on the parts of galvanic corrosion that turn into real schedule or budget pain when they go wrong.</p><h2>Why this comes up so often in the field</h2>
<p>Ask any corrosion engineers how often galvanic corrosion drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<ul>
<li><strong>The decision points</strong> that drive most galvanic corrosion programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any galvanic corrosion engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of galvanic corrosion should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize galvanic corrosion in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p>
<p>Practical teams often cross-reference <a href="https://atlantisndt.com/ndt-consulting-galveston" rel="noopener">Atlantis NDT's ndt consulting galveston resource</a> to align their practice with what is already published in the wider community. Practical teams often cross-reference <a href="https://atlantisndt.com/erp/cmms-for-singapore" rel="noopener">the cmms for singapore ERP page on Atlantis NDT</a> to align their practice with what is already published in the wider community.</p><h3>How galvanic corrosion fits into the bigger picture</h3>
<p>It is easy to study galvanic corrosion as an isolated subject — most courses do exactly that — but the engineering value only appears when you place galvanic corrosion alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.asnt.org/" rel="noopener nofollow">the ASNT body of knowledge resources</a> to align their practice with what is already published in the wider community. For most corrosion engineers the question is not "what is galvanic corrosion?" but "where does galvanic corrosion sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in galvanic corrosion, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on dissimilar metal</h3>
<p>Three behaviours we see at high-performing operators consistently show up in dissimilar metal programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a dissimilar metal program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best bimetallic corrosion documentation packages we have seen share three patterns:</p>
<ul>
...
<h3>How dissimilar metal fits into the bigger picture</h3>
<p>It is easy to study dissimilar metal as an isolated subject — most courses do exactly that — but the engineering value only appears when you place dissimilar metal alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.asnt.org/" rel="noopener nofollow">the ASNT body of knowledge resources</a> to align their practice with what is already published in the wider community. For most corrosion engineers the question is not "what is dissimilar metal?" but "where does dissimilar metal sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in dissimilar metal, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on bimetallic corrosion</h3>
<p>Three behaviours we see at high-performing operators consistently show up in bimetallic corrosion programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a bimetallic corrosion program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best galvanic isolation documentation packages we have seen share three patterns:</p>
<ul>
<li>A short narrative section at the front of every report explaining the inspection objective in plain English. Auditors, regulators, and new hires all read the narrative first.</li>
<li>A consistent indication-numbering scheme that survives across multiple inspection campaigns, so an indication found in 2024 can be tracked through 2026 and 2028 without renaming.</li>
<li>An attached "open items" list with target dates, ownership, and the trigger that closes each item. This is the single most useful artifact for a turnaround manager.</li>
...
<p>If your current report template is missing one of those, that is the easiest documentation improvement you can make this quarter, and it costs nothing beyond a template update.</p>
<h3>Procurement and contract considerations</h3>
<p>galvanic corrosion engagements have a recurring procurement pitfall: the scope of work is written in inspection-deliverable language ("ten welds inspected by PAUT"), and the contract success criteria are written in commercial language ("on time, on budget, no NCRs"). Neither captures the engineering outcome the asset owner actually needs, which is a defensible decision about fitness for service. Contracts that explicitly include a deliverable like "decision-grade report with Level III rationale signed and dated" align all three parties — owner, integrity engineer, and contractor — around the same outcome.</p>
<h3>Training and competency considerations</h3>
<p>Tooling improvements in dissimilar metal usually outpace inspector training by 18–24 months. Phased array systems, advanced eddy current arrays, and automated scanners are now common; structured training pathways for those tools are less common. The implication for hiring managers is straightforward: budget for technique-specific training as part of the equipment purchase, not as a separate line item to be defended later.</p>
<p>Competency on a written exam does not equal competency on a job site. The most reliable way to check applied competency is a witnessed scan of a known-flaw block, evaluated independently by a Level III who did not run the scan.</p>
<h3>How bimetallic corrosion fits into the bigger picture</h3>
<p>It is easy to study bimetallic corrosion as an isolated subject — most courses do exactly that — but the engineering value only appears when you place bimetallic corrosion alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.asnt.org/" rel="noopener nofollow">the ASNT body of knowledge resources</a> to align their practice with what is already published in the wider community. For most corrosion engineers the question is not "what is bimetallic corrosion?" but "where does bimetallic corrosion sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in bimetallic corrosion, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
