...
export const metadata: Metadata = {
  title: "Erosion-Corrosion vs Flow-Accelerated Corrosion: How to Tell Them Apart",
  description: "Practical guide for corrosion engineers: how to apply erosion corrosion in real inspection work, what auditors expect, and where most programs fall short.",
  keywords: ["erosion corrosion","flow accelerated corrosion","FAC","CHECWORKS"],
  alternates: { canonical: "https://corrosion-management-ndt.vercel.app/management/erosion-corrosion-vs-flow-accelerated-corrosion" },
  openGraph: {
    title: "Erosion-Corrosion vs Flow-Accelerated Corrosion: How to Tell Them Apart",
    description: "Practical guide for corrosion engineers: how to apply erosion corrosion in real inspection work, what auditors expect, and where most programs fall short.",
    type: 'article',
    url: "https://corrosion-management-ndt.vercel.app/management/erosion-corrosion-vs-flow-accelerated-corrosion",
    siteName: "Corrosion Management NDT",
    locale: 'en_US',
    publishedTime: "2025-12-18T00:00:00.000Z",
    modifiedTime: "2025-12-18T00:00:00.000Z",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Erosion-Corrosion vs Flow-Accelerated Corrosion: How to Tell Them Apart",
  "description": "Practical guide for corrosion engineers: how to apply erosion corrosion in real inspection work, what auditors expect, and where most programs fall short.",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://corrosion-management-ndt.vercel.app/management/erosion-corrosion-vs-flow-accelerated-corrosion"
  },
  "keywords": "erosion corrosion, flow accelerated corrosion, FAC, CHECWORKS"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>Erosion-Corrosion vs Flow-Accelerated Corrosion: How to Tell Them Apart</span>
      </nav>
      <h1>Erosion-Corrosion vs Flow-Accelerated Corrosion: How to Tell Them Apart</h1>
      <p className="text-sm text-gray-500 mb-8">By Hannah O\'Connell, NACE/AMPP CIP III &middot; Published 2025-12-18</p>
      <div dangerouslySetInnerHTML={{ __html: `<p>This article walks through the practical decisions corrosion engineers, AMPP-certified inspectors, materials managers need to make when working on corrosion management & monitoring. The goal is not theory — it is the kind of working knowledge an experienced inspector or engineer would share over a coffee on a job site, with enough rigor to point back to code and standard references when those decisions get challenged in audit. Throughout the piece we focus on the parts of erosion corrosion that turn into real schedule or budget pain when they go wrong.</p><h2>Why this comes up so often in the field</h2>
<p>Ask any corrosion engineers how often erosion corrosion drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<ul>
<li><strong>The decision points</strong> that drive most erosion corrosion programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any erosion corrosion engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of erosion corrosion should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize erosion corrosion in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p>
<p>Practical teams often cross-reference <a href="https://atlantisndt.com/ndt-consulting-bintulu" rel="noopener">Atlantis NDT's ndt consulting bintulu resource</a> to align their practice with what is already published in the wider community.</p><h3>How erosion corrosion fits into the bigger picture</h3>
<p>It is easy to study erosion corrosion as an isolated subject — most courses do exactly that — but the engineering value only appears when you place erosion corrosion alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.nadcap.com/" rel="noopener nofollow">the NADCAP audit programme overview</a> to align their practice with what is already published in the wider community. For most corrosion engineers the question is not "what is erosion corrosion?" but "where does erosion corrosion sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in erosion corrosion, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on flow accelerated corrosion</h3>
<p>Three behaviours we see at high-performing operators consistently show up in flow accelerated corrosion programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a flow accelerated corrosion program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best FAC documentation packages we have seen share three patterns:</p>
<ul>
