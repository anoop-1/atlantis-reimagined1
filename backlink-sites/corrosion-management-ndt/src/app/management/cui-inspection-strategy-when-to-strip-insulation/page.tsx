...
export const metadata: Metadata = {
  ...
  description: "Working notes for corrosion engineers on CUI inspection: how to choose the technique, document the decision, and survive the next audit.",
  keywords: ["CUI inspection","pulsed eddy current","corrosion under insulation","API 583"],
  alternates: { canonical: "https://corrosion-management-ndt.vercel.app/management/cui-inspection-strategy-when-to-strip-insulation" },
  openGraph: {
    title: "CUI Inspection Strategy: When to Strip Insulation vs Use Pulsed Eddy Current",
    description: "Working notes for corrosion engineers on CUI inspection: how to choose the technique, document the decision, and survive the next audit.",
    type: 'article',
    url: "https://corrosion-management-ndt.vercel.app/management/cui-inspection-strategy-when-to-strip-insulation",
    siteName: "Corrosion Management NDT",
    locale: 'en_US',
    publishedTime: "2024-08-28T00:00:00.000Z",
    modifiedTime: "2024-08-28T00:00:00.000Z",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "CUI Inspection Strategy: When to Strip Insulation vs Use Pulsed Eddy Current",
  "description": "Working notes for corrosion engineers on CUI inspection: how to choose the technique, document the decision, and survive the next audit.",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://corrosion-management-ndt.vercel.app/management/cui-inspection-strategy-when-to-strip-insulation"
  },
  "keywords": "CUI inspection, pulsed eddy current, corrosion under insulation, API 583"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>CUI Inspection Strategy: When to Strip Insulation vs Use Pulsed Eddy Current</span>
      </nav>
      <h1>CUI Inspection Strategy: When to Strip Insulation vs Use Pulsed Eddy Current</h1>
      <p className="text-sm text-gray-500 mb-8">By Hannah O\'Connell, NACE/AMPP CIP III &middot; Published 2024-08-28</p>
      <div dangerouslySetInnerHTML={{ __html: `<p>This article walks through the practical decisions corrosion engineers, AMPP-certified inspectors, materials managers need to make when working on corrosion management & monitoring. The goal is not theory — it is the kind of working knowledge an experienced inspector or engineer would share over a coffee on a job site, with enough rigor to point back to code and standard references when those decisions get challenged in audit. Throughout the piece we focus on the parts of cui inspection that turn into real schedule or budget pain when they go wrong.</p><h2>Why this comes up so often in the field</h2>
<p>Ask any corrosion engineers how often cui inspection drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<ul>
<li><strong>The decision points</strong> that drive most cui inspection programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any cui inspection engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<p>The textbook approach to cui inspection usually points engineers at one or two techniques. The field reality is messier; the technique that ranks best on a comparison chart is often not the one that fits the access, the schedule, or the inspector skill mix actually available on the day. We walk through three patterns we see repeatedly.</p>
...
<p>Auditors do not argue with conclusions; they argue with the evidence behind them. For any defensible cui inspection report, the evidence packet needs to include at minimum:</p>
<ul>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of cui inspection should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize cui inspection in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p><h3>How CUI inspection fits into the bigger picture</h3>
<p>It is easy to study CUI inspection as an isolated subject — most courses do exactly that — but the engineering value only appears when you place CUI inspection alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://atlantisndt.com/blog/corrosion-under-insulation-cui-detection-guide" rel="noopener">the dedicated CUI detection guide</a> to align their practice with what is already published in the wider community. For most corrosion engineers the question is not "what is CUI inspection?" but "where does CUI inspection sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in CUI inspection, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on pulsed eddy current</h3>
<p>Three behaviours we see at high-performing operators consistently show up in pulsed eddy current programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a pulsed eddy current program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best corrosion under insulation documentation packages we have seen share three patterns:</p>
<ul>
...
<h3>How pulsed eddy current fits into the bigger picture</h3>
<p>It is easy to study pulsed eddy current as an isolated subject — most courses do exactly that — but the engineering value only appears when you place pulsed eddy current alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://atlantisndt.com/blog/corrosion-under-insulation-cui-detection-guide" rel="noopener">the dedicated CUI detection guide</a> to align their practice with what is already published in the wider community. For most corrosion engineers the question is not "what is pulsed eddy current?" but "where does pulsed eddy current sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in pulsed eddy current, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on corrosion under insulation</h3>
<p>Three behaviours we see at high-performing operators consistently show up in corrosion under insulation programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a corrosion under insulation program.</p>
