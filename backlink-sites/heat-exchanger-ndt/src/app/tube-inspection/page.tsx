  ...
  return (
    <div className="space-y-8">
      <section className="bg-rose-50 p-8 rounded-lg">
        <h1 className="text-3xl font-bold text-rose-900 mb-2">Tube Inspection Procedures</h1>
        <p className="text-rose-800">Systematic approaches to comprehensive heat exchanger tube assessment.</p>
      </section>

      <section className="prose max-w-none">
        <h2 className="text-2xl font-bold mb-4">Inspection Planning and Risk Assessment</h2>
        <p className="mb-4">
