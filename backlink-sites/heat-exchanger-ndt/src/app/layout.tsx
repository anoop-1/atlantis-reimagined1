            ...
            <div className="grid grid-cols-3 gap-8 mb-8">
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li><a href="https://atlantisndt.com" rel="noopener" className="text-rose-600 hover:underline">Technical Consulting</a></li>
                  <li><a href="https://atlantisndt.com" rel="noopener" className="text-rose-600 hover:underline">Specialist Training</a></li>
                  <li><a href="https://atlantisndt.com" rel="noopener" className="text-rose-600 hover:underline">Condition Tracking</a></li>
                  <li><a href="https://ndt-connect.com" rel="noopener" className="text-rose-600 hover:underline">Asset Management</a></li>
                  <li><a href="https://atlantisndt.com" rel="noopener" className="text-rose-600 hover:underline">Data Systems</a></li>
                </ul>
              </div>
              <div>
