...
export const metadata: Metadata = {
  title: "Tube-to-Tubesheet Weld Inspection: Methods That Hold Up to Audit",
  description: "Practical guide for heat exchanger inspectors: how to apply tube to tubesheet in real inspection work, what auditors expect, and where most programs fall s...",
  keywords: ["tube to tubesheet","tubesheet weld","heat exchanger weld","TEMA tubesheet"],
  alternates: { canonical: "https://heat-exchanger-ndt.vercel.app/tubes/tube-to-tubesheet-weld-inspection-techniques" },
  openGraph: {
    title: "Tube-to-Tubesheet Weld Inspection: Methods That Hold Up to Audit",
    description: "Practical guide for heat exchanger inspectors: how to apply tube to tubesheet in real inspection work, what auditors expect, and where most programs fall s...",
    type: 'article',
    url: "https://heat-exchanger-ndt.vercel.app/tubes/tube-to-tubesheet-weld-inspection-techniques",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Tube-to-Tubesheet Weld Inspection: Methods That Hold Up to Audit",
  "description": "Practical guide for heat exchanger inspectors: how to apply tube to tubesheet in real inspection work, what auditors expect, and where most programs fall s...",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://heat-exchanger-ndt.vercel.app/tubes/tube-to-tubesheet-weld-inspection-techniques"
  },
  "keywords": "tube to tubesheet, tubesheet weld, heat exchanger weld, TEMA tubesheet"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>Tube-to-Tubesheet Weld Inspection: Methods That Hold Up to Audit</span>
      </nav>
      <h1>Tube-to-Tubesheet Weld Inspection: Methods That Hold Up to Audit</h1>
      <p className="text-sm text-gray-500 mb-8">By Aiko Nakashima, Reliability Engineer &middot; Published 2026-02-21</p>
