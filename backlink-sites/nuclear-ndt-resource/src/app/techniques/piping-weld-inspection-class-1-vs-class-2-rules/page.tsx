...
export const metadata: Metadata = {
  ...
  description: "Practical guide for nuclear ISI engineers: how to apply ASME XI piping in real inspection work, what auditors expect, and where most programs fall short.",
  keywords: ["ASME XI piping","Class 1 piping","nuclear weld inspection","IWB IWC"],
  alternates: { canonical: "https://nuclear-ndt-resource.vercel.app/techniques/piping-weld-inspection-class-1-vs-class-2-rules" },
  openGraph: {
    title: "Piping Weld Inspection: ASME XI Class 1 vs Class 2 Rules",
    description: "Practical guide for nuclear ISI engineers: how to apply ASME XI piping in real inspection work, what auditors expect, and where most programs fall short.",
    type: 'article',
    url: "https://nuclear-ndt-resource.vercel.app/techniques/piping-weld-inspection-class-1-vs-class-2-rules",
    siteName: "Nuclear NDT Resource",
    locale: 'en_US',
    publishedTime: "2025-08-04T00:00:00.000Z",
    modifiedTime: "2025-08-04T00:00:00.000Z",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Piping Weld Inspection: ASME XI Class 1 vs Class 2 Rules",
  "description": "Practical guide for nuclear ISI engineers: how to apply ASME XI piping in real inspection work, what auditors expect, and where most programs fall short.",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://nuclear-ndt-resource.vercel.app/techniques/piping-weld-inspection-class-1-vs-class-2-rules"
  },
  "keywords": "ASME XI piping, Class 1 piping, nuclear weld inspection, IWB IWC"
};
...
<ul>
<li><strong>The decision points</strong> that drive most asme xi piping programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any asme xi piping engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of asme xi piping should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize asme xi piping in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p><h3>How ASME XI piping fits into the bigger picture</h3>
<p>It is easy to study ASME XI piping as an isolated subject — most courses do exactly that — but the engineering value only appears when you place ASME XI piping alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.nrc.gov/reactors/operating/ops-experience.html" rel="noopener nofollow">the NRC operating experience archive</a> to align their practice with what is already published in the wider community. For most nuclear ISI engineers the question is not "what is ASME XI piping?" but "where does ASME XI piping sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in ASME XI piping, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on Class 1 piping</h3>
<p>Three behaviours we see at high-performing operators consistently show up in Class 1 piping programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a Class 1 piping program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best nuclear weld inspection documentation packages we have seen share three patterns:</p>
<ul>
...
<h3>How Class 1 piping fits into the bigger picture</h3>
<p>It is easy to study Class 1 piping as an isolated subject — most courses do exactly that — but the engineering value only appears when you place Class 1 piping alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.nrc.gov/reactors/operating/ops-experience.html" rel="noopener nofollow">the NRC operating experience archive</a> to align their practice with what is already published in the wider community. For most nuclear ISI engineers the question is not "what is Class 1 piping?" but "where does Class 1 piping sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in Class 1 piping, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
