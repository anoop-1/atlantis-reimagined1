...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/reactor-systems`, lastModified: '2026-05-23', changeFrequency: 'weekly' as const, priority: 0.7 },
    { url: `${baseUrl}/regulatory`, lastModified: '2026-05-23', changeFrequency: 'weekly' as const, priority: 0.7 },
