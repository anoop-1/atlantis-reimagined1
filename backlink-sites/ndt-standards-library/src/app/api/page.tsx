  ...
  return (
    <div>
      ...
      <article className="prose prose-lg max-w-none">
        ...
        <p className="text-gray-700 leading-relaxed mb-4">
          API 510 addresses pressure vessel inspection, maintenance, and repair, establishing in-service inspection requirements for vessels operating at pressures exceeding atmospheric conditions. <a href="https://atlantisndt.com" rel="noopener" className="text-slate-600 hover:text-slate-800 font-semibold">API certifications</a> establish baseline competency for professionals responsible for vessel inspection and integrity management.
        </p>
        <p className="text-gray-700 leading-relaxed mb-4">
