...
export const metadata: Metadata = {
  title: "Choosing the Right Pipe Code: ASME B31.1 vs B31.3 vs B31.8",
  description: "Practical guide for NDT procedure writers: how to apply ASME B31 in real inspection work, what auditors expect, and where most programs fall short.",
  keywords: ["ASME B31","pipe code selection","B31.1 vs B31.3","ASME piping"],
  alternates: { canonical: "https://ndt-standards-library.vercel.app/library/choosing-the-right-pipe-code-asme-b31-1-vs-b31-3-vs-b31-8" },
  openGraph: {
    title: "Choosing the Right Pipe Code: ASME B31.1 vs B31.3 vs B31.8",
    description: "Practical guide for NDT procedure writers: how to apply ASME B31 in real inspection work, what auditors expect, and where most programs fall short.",
    type: 'article',
    url: "https://ndt-standards-library.vercel.app/library/choosing-the-right-pipe-code-asme-b31-1-vs-b31-3-vs-b31-8",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Choosing the Right Pipe Code: ASME B31.1 vs B31.3 vs B31.8",
  "description": "Practical guide for NDT procedure writers: how to apply ASME B31 in real inspection work, what auditors expect, and where most programs fall short.",
  "author": {
    "@type": "Person",
    "name": "Otavio Sá, PE"
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://ndt-standards-library.vercel.app/library/choosing-the-right-pipe-code-asme-b31-1-vs-b31-3-vs-b31-8"
  },
  "keywords": "ASME B31, pipe code selection, B31.1 vs B31.3, ASME piping"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>Choosing the Right Pipe Code: ASME B31.1 vs B31.3 vs B31.8</span>
      </nav>
      <h1>Choosing the Right Pipe Code: ASME B31.1 vs B31.3 vs B31.8</h1>
      <p className="text-sm text-gray-500 mb-8">By Otavio Sá, PE &middot; Published 2025-06-12</p>
      <div dangerouslySetInnerHTML={{ __html: `<p>This article walks through the practical decisions NDT procedure writers, code/standard specialists, integrity engineers need to make when working on NDT standards and codes reference. The goal is not theory — it is the kind of working knowledge an experienced inspector or engineer would share over a coffee on a job site, with enough rigor to point back to code and standard references when those decisions get challenged in audit. Throughout the piece we focus on the parts of asme b31 that turn into real schedule or budget pain when they go wrong.</p><h2>Why this comes up so often in the field</h2>
<p>Ask any NDT procedure writers how often asme b31 drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<ul>
<li><strong>The decision points</strong> that drive most asme b31 programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any asme b31 engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<p>The textbook approach to asme b31 usually points engineers at one or two techniques. The field reality is messier; the technique that ranks best on a comparison chart is often not the one that fits the access, the schedule, or the inspector skill mix actually available on the day. We walk through three patterns we see repeatedly.</p>
...
<p>Auditors do not argue with conclusions; they argue with the evidence behind them. For any defensible asme b31 report, the evidence packet needs to include at minimum:</p>
<ul>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of asme b31 should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize asme b31 in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p><h3>How ASME B31 fits into the bigger picture</h3>
<p>It is easy to study ASME B31 as an isolated subject — most courses do exactly that — but the engineering value only appears when you place ASME B31 alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.imca-int.com/" rel="noopener nofollow">the IMCA technical resources for offshore work</a> to align their practice with what is already published in the wider community. For most NDT procedure writers the question is not "what is ASME B31?" but "where does ASME B31 sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in ASME B31, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on pipe code selection</h3>
<p>Three behaviours we see at high-performing operators consistently show up in pipe code selection programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a pipe code selection program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best B31.1 vs B31.3 documentation packages we have seen share three patterns:</p>
<ul>
...
<h3>How pipe code selection fits into the bigger picture</h3>
<p>It is easy to study pipe code selection as an isolated subject — most courses do exactly that — but the engineering value only appears when you place pipe code selection alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.imca-int.com/" rel="noopener nofollow">the IMCA technical resources for offshore work</a> to align their practice with what is already published in the wider community. For most NDT procedure writers the question is not "what is pipe code selection?" but "where does pipe code selection sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in pipe code selection, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
