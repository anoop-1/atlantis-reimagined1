...
export const metadata: Metadata = {
  title: "ISO 9712 vs EN-ISO vs ASNT: Cross-Recognition Realities",
  description: "A field-oriented walkthrough of ISO 9712 for NDT procedure writers, with decision matrices, code references, and the documentation auditors actually want.",
  keywords: ["ISO 9712","EN ISO NDT","ASNT recognition","NDT certification cross border"],
  alternates: { canonical: "https://ndt-standards-library.vercel.app/library/iso-9712-vs-en-iso-vs-asnt-cross-recognition" },
  openGraph: {
    title: "ISO 9712 vs EN-ISO vs ASNT: Cross-Recognition Realities",
    description: "A field-oriented walkthrough of ISO 9712 for NDT procedure writers, with decision matrices, code references, and the documentation auditors actually want.",
    type: 'article',
    url: "https://ndt-standards-library.vercel.app/library/iso-9712-vs-en-iso-vs-asnt-cross-recognition",
    siteName: "NDT Standards Library",
    locale: 'en_US',
    publishedTime: "2025-01-31T00:00:00.000Z",
    modifiedTime: "2025-01-31T00:00:00.000Z",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "ISO 9712 vs EN-ISO vs ASNT: Cross-Recognition Realities",
  "description": "A field-oriented walkthrough of ISO 9712 for NDT procedure writers, with decision matrices, code references, and the documentation auditors actually want.",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://ndt-standards-library.vercel.app/library/iso-9712-vs-en-iso-vs-asnt-cross-recognition"
  },
  "keywords": "ISO 9712, EN ISO NDT, ASNT recognition, NDT certification cross border"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>ISO 9712 vs EN-ISO vs ASNT: Cross-Recognition Realities</span>
      </nav>
      <h1>ISO 9712 vs EN-ISO vs ASNT: Cross-Recognition Realities</h1>
      <p className="text-sm text-gray-500 mb-8">By Rabia Yousef, ASNT Level III &middot; Published 2025-01-31</p>
...
<p>Ask any NDT procedure writers how often iso 9712 drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<h3>Operator behaviours that actually move the needle on EN ISO NDT</h3>
...
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a EN ISO NDT program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best ASNT recognition documentation packages we have seen share three patterns:</p>
<ul>
...
<p>NDT certification cross border engagements have a recurring procurement pitfall: the scope of work is written in inspection-deliverable language ("ten welds inspected by PAUT"), and the contract success criteria are written in commercial language ("on time, on budget, no NCRs"). Neither captures the engineering outcome the asset owner actually needs, which is a defensible decision about fitness for service. Contracts that explicitly include a deliverable like "decision-grade report with Level III rationale signed and dated" align all three parties — owner, integrity engineer, and contractor — around the same outcome.</p>
