...
export const metadata: Metadata = {
  ...
  description: "A field-oriented walkthrough of HTHA inspection for refinery / petrochemical inspection teams, with decision matrices, code references, and the documentati...",
  keywords: ["HTHA inspection","API 941","hydrogen attack","TOFD HTHA"],
  alternates: { canonical: "https://petrochemical-ndt-hub.vercel.app/processes/high-temperature-hydrogen-attack-htha-inspection-strategy" },
  openGraph: {
    title: "High Temperature Hydrogen Attack (HTHA): Inspection Strategy for Refineries",
    description: "A field-oriented walkthrough of HTHA inspection for refinery / petrochemical inspection teams, with decision matrices, code references, and the documentati...",
    type: 'article',
    url: "https://petrochemical-ndt-hub.vercel.app/processes/high-temperature-hydrogen-attack-htha-inspection-strategy",
    siteName: "Petrochemical NDT Hub",
    locale: 'en_US',
    publishedTime: "2024-10-22T00:00:00.000Z",
    modifiedTime: "2024-10-22T00:00:00.000Z",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "High Temperature Hydrogen Attack (HTHA): Inspection Strategy for Refineries",
  "description": "A field-oriented walkthrough of HTHA inspection for refinery / petrochemical inspection teams, with decision matrices, code references, and the documentati...",
  "author": {
    "@type": "Person",
  ...
  "datePublished": "2024-10-22T00:00:00.000Z",
  "dateModified": "2024-10-22T00:00:00.000Z",
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://petrochemical-ndt-hub.vercel.app/processes/high-temperature-hydrogen-attack-htha-inspection-strategy"
  },
  "keywords": "HTHA inspection, API 941, hydrogen attack, TOFD HTHA"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>High Temperature Hydrogen Attack (HTHA): Inspection Strategy for Refineries</span>
      </nav>
      <h1>High Temperature Hydrogen Attack (HTHA): Inspection Strategy for Refineries</h1>
      <p className="text-sm text-gray-500 mb-8">By Dr. Karim Idrissi, Materials Engineer &middot; Published 2024-10-22</p>
      <div dangerouslySetInnerHTML={{ __html: `<p>This article walks through the practical decisions refinery / petrochemical inspection teams, fixed-equipment engineers need to make when working on petrochemical & refinery NDT. The goal is not theory — it is the kind of working knowledge an experienced inspector or engineer would share over a coffee on a job site, with enough rigor to point back to code and standard references when those decisions get challenged in audit. Throughout the piece we focus on the parts of htha inspection that turn into real schedule or budget pain when they go wrong.</p><h2>Why this comes up so often in the field</h2>
<p>Ask any refinery / petrochemical inspection teams how often htha inspection drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<ul>
<li><strong>The decision points</strong> that drive most htha inspection programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any htha inspection engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<p>Auditors do not argue with conclusions; they argue with the evidence behind them. For any defensible htha inspection report, the evidence packet needs to include at minimum:</p>
<ul>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of htha inspection should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize htha inspection in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p><h3>How HTHA inspection fits into the bigger picture</h3>
<p>It is easy to study HTHA inspection as an isolated subject — most courses do exactly that — but the engineering value only appears when you place HTHA inspection alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://atlantisndt.com/blog/asme-section-viii-division-1-pressure-vessel-ndt" rel="noopener">the ASME Section VIII Division 1 NDT rules</a> to align their practice with what is already published in the wider community. For most refinery / petrochemical inspection teams the question is not "what is HTHA inspection?" but "where does HTHA inspection sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in HTHA inspection, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on API 941</h3>
<p>Three behaviours we see at high-performing operators consistently show up in API 941 programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a API 941 program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best hydrogen attack documentation packages we have seen share three patterns:</p>
<ul>
...
<h3>How API 941 fits into the bigger picture</h3>
<p>It is easy to study API 941 as an isolated subject — most courses do exactly that — but the engineering value only appears when you place API 941 alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://atlantisndt.com/blog/asme-section-viii-division-1-pressure-vessel-ndt" rel="noopener">the ASME Section VIII Division 1 NDT rules</a> to align their practice with what is already published in the wider community. For most refinery / petrochemical inspection teams the question is not "what is API 941?" but "where does API 941 sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in API 941, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on hydrogen attack</h3>
<p>Three behaviours we see at high-performing operators consistently show up in hydrogen attack programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a hydrogen attack program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best TOFD HTHA documentation packages we have seen share three patterns:</p>
<ul>
<li>A short narrative section at the front of every report explaining the inspection objective in plain English. Auditors, regulators, and new hires all read the narrative first.</li>
<li>A consistent indication-numbering scheme that survives across multiple inspection campaigns, so an indication found in 2024 can be tracked through 2026 and 2028 without renaming.</li>
<li>An attached "open items" list with target dates, ownership, and the trigger that closes each item. This is the single most useful artifact for a turnaround manager.</li>
