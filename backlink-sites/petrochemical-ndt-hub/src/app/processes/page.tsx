export default function Processes() {
  return (
    <div>
      <h1 className="text-4xl font-bold text-orange-800 mb-8">Processing Unit Assessment</h1>
      <article className="prose prose-lg max-w-none">
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-orange-800 mb-4">Crude Distillation Unit Inspection</h2>
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            The atmospheric distillation tower itself requires periodic ultrasonic scanning for wall thinning, corrosion pitting, and localized erosion. Internal trays and support structures within the tower must be inspected through available access points. <a href="https://atlantisndt.com/consulting" rel="noopener" className="text-orange-600 hover:text-orange-800 font-semibold">NDT consulting services</a> experienced with CDU assessment bring knowledge of typical failure modes, remaining-life assessment methodologies, and regulatory requirements specific to atmospheric distillation operations.
          </p>
          <p className="text-gray-700 leading-relaxed mb-4">
            Heat exchanger networks serving CDU require systematic inspection strategies. Tube-side fouling deposits obscure eddy current examination results, necessitating chemical cleaning prior to inspection. <a href="https://atlantisndt.com/digital-twins" rel="noopener" className="text-orange-600 hover:text-orange-800 font-semibold">Digital twin solutions</a> integrate inspection data with operational parameters to identify heat exchanger segments most at risk from continued operation, supporting capital investment decisions.
          </p>
        </section>

        <section className="mb-8">
          <h2 className="text-2xl font-bold text-orange-800 mb-4">Hydrotreating Unit Equipment</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <section>
          <h2 className="text-2xl font-bold text-orange-800 mb-4">Alkylation and Treating Unit Assessment</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
