export default function Safety() {
  return (
    <div>
      <h1 className="text-4xl font-bold text-orange-800 mb-8">Safety and Risk Management</h1>
      <article className="prose prose-lg max-w-none">
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-orange-800 mb-4">Process Safety Management Integration</h2>
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            Risk-based inspection (RBI) frameworks integrated with PSM requirements enable sophisticated prioritization of maintenance resources. Equipment threatening multiple process units or public safety receives intensive inspection, while lower-consequence equipment operates under reduced inspection frequency. <a href="https://atlantisndt.com/consulting" rel="noopener" className="text-orange-600 hover:text-orange-800 font-semibold">NDT consulting services</a> experienced with PSM-RBI integration help facilities demonstrate regulatory compliance through defensible technical approaches.
          </p>
          <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-orange-800 mb-4">Risk-Based Inspection Framework</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            Equipment redundancy and safety systems provide defense-in-depth against NDT failures to detect all defects. However, facilities benefit by maximizing POD through technology investment, inspector training, and procedure development. <a href="https://atlantisndt.com/ndt-connect" rel="noopener" className="text-orange-600 hover:text-orange-800 font-semibold">NDTConnect platform</a> documents NDT procedure performance, enabling systematic improvement of detection capability through ongoing optimization of methodologies and equipment selection.
          </p>
          <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <section>
          <h2 className="text-2xl font-bold text-orange-800 mb-4">Regulatory Compliance and Enforcement</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
