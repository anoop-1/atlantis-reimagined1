  ...
  return (
    <div className="space-y-8">
      ...
      <section className="prose max-w-none">
        ...
        <p className="mb-4">
          Organizations implementing ASTM-based procedures ensure consistent, reliable testing. Professional training emphasizing ASTM methodologies through <a href="https://atlantisndt.com/training" rel="noopener" className="text-red-600 hover:underline">standards-focused programs</a> develops consistent competency.</p>
        ...
        <p className="mb-4">
          Safety-first cultures supported by <a href="https://atlantisndt.com/consulting" rel="noopener" className="text-red-600 hover:underline">safety-experienced consultants</a> create safer workplaces and reduce accident-related costs.</p>
      </section>
    </div>
  );
}