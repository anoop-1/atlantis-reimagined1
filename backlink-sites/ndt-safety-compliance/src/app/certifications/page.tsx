  ...
  return (
    <div className="space-y-8">
      <section className="bg-red-50 p-8 rounded-lg">
        <h1 className="text-3xl font-bold text-red-900 mb-2">Professional Certifications</h1>
        <p className="text-red-800">Credential pathways for NDT professionals demonstrating competency.</p>
      </section>

      <section className="prose max-w-none">
        <h2 className="text-2xl font-bold mb-4">ASNT Certification Levels</h2>
        <p className="mb-4">
        ...
        <p className="mb-4">
          API-certified roles command premium compensation and respect within petroleum industry. Rigorous exam preparation through <a href="https://atlantisndt.com" rel="noopener" className="text-red-600 hover:underline">specialized certification programs</a> maximizes success rates.</p>
