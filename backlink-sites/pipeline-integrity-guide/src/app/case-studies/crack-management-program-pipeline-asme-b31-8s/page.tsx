...
export const metadata: Metadata = {
  ...
  description: "Working notes for pipeline integrity engineers on pipeline crack management: how to choose the technique, document the decision, and survive the next audit.",
  keywords: ["pipeline crack management","ASME B31.8S","SCC pipeline","fatigue crack"],
  alternates: { canonical: "https://pipeline-integrity-guide.vercel.app/case-studies/crack-management-program-pipeline-asme-b31-8s" },
  openGraph: {
    title: "Pipeline Crack Management Program: Aligning with ASME B31.8S",
    description: "Working notes for pipeline integrity engineers on pipeline crack management: how to choose the technique, document the decision, and survive the next audit.",
    type: 'article',
    url: "https://pipeline-integrity-guide.vercel.app/case-studies/crack-management-program-pipeline-asme-b31-8s",
    siteName: "Pipeline Integrity Guide",
    locale: 'en_US',
    publishedTime: "2025-04-08T00:00:00.000Z",
    modifiedTime: "2025-04-08T00:00:00.000Z",
    authors: ["Linnea Söderberg, MSc, IWE"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Pipeline Crack Management Program: Aligning with ASME B31.8S",
  "description": "Working notes for pipeline integrity engineers on pipeline crack management: how to choose the technique, document the decision, and survive the next audit.",
  "author": {
    "@type": "Person",
    "name": "Linnea Söderberg, MSc, IWE"
  },
  "publisher": {
    "@type": "Organization",
    "name": "Pipeline Integrity Guide Editorial",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://pipeline-integrity-guide.vercel.app/case-studies/crack-management-program-pipeline-asme-b31-8s"
  },
  "keywords": "pipeline crack management, ASME B31.8S, SCC pipeline, fatigue crack"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>Pipeline Crack Management Program: Aligning with ASME B31.8S</span>
      </nav>
      <h1>Pipeline Crack Management Program: Aligning with ASME B31.8S</h1>
      <p className="text-sm text-gray-500 mb-8">By Linnea Söderberg, MSc, IWE &middot; Published 2025-04-08</p>
      <div dangerouslySetInnerHTML={{ __html: `<p>This article walks through the practical decisions pipeline integrity engineers, midstream operators, regulators need to make when working on pipeline integrity & inspection. The goal is not theory — it is the kind of working knowledge an experienced inspector or engineer would share over a coffee on a job site, with enough rigor to point back to code and standard references when those decisions get challenged in audit. Throughout the piece we focus on the parts of pipeline crack management that turn into real schedule or budget pain when they go wrong.</p><h2>Why this comes up so often in the field</h2>
<p>Ask any pipeline integrity engineers how often pipeline crack management drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<ul>
<li><strong>The decision points</strong> that drive most pipeline crack management programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any pipeline crack management engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<p>The textbook approach to pipeline crack management usually points engineers at one or two techniques. The field reality is messier; the technique that ranks best on a comparison chart is often not the one that fits the access, the schedule, or the inspector skill mix actually available on the day. We walk through three patterns we see repeatedly.</p>
...
<p>Post-repair inspection is the most procedural of the three patterns and the most likely to be weakened by schedule pressure. The required NDT is usually defined by the original construction code (ASME VIII, ASME XI, AWS D1.1, and so on), which is fine — but the decision about <em>how</em> to apply it under field conditions is rarely covered. Practical teams often cross-reference <a href="https://atlantisndt.com/blog/ndt-pipeline-integrity-inspection-guide" rel="noopener">the pipeline integrity overview that introduces crack management</a> to align their practice with what is already published in the wider community.</p><h2>The data the audit will ask for</h2>
<p>Auditors do not argue with conclusions; they argue with the evidence behind them. For any defensible pipeline crack management report, the evidence packet needs to include at minimum:</p>
<ul>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of pipeline crack management should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize pipeline crack management in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p><h3>How pipeline crack management fits into the bigger picture</h3>
<p>It is easy to study pipeline crack management as an isolated subject — most courses do exactly that — but the engineering value only appears when you place pipeline crack management alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.ampp.org/" rel="noopener nofollow">AMPP (Association for Materials Protection and Performance)</a> to align their practice with what is already published in the wider community. For most pipeline integrity engineers the question is not "what is pipeline crack management?" but "where does pipeline crack management sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in pipeline crack management, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on ASME B31.8S</h3>
<p>Three behaviours we see at high-performing operators consistently show up in ASME B31.8S programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a ASME B31.8S program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best SCC pipeline documentation packages we have seen share three patterns:</p>
<ul>
...
<h3>How ASME B31.8S fits into the bigger picture</h3>
<p>It is easy to study ASME B31.8S as an isolated subject — most courses do exactly that — but the engineering value only appears when you place ASME B31.8S alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.ampp.org/" rel="noopener nofollow">AMPP (Association for Materials Protection and Performance)</a> to align their practice with what is already published in the wider community. For most pipeline integrity engineers the question is not "what is ASME B31.8S?" but "where does ASME B31.8S sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in ASME B31.8S, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on SCC pipeline</h3>
<p>Three behaviours we see at high-performing operators consistently show up in SCC pipeline programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a SCC pipeline program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best fatigue crack documentation packages we have seen share three patterns:</p>
<ul>
<li>A short narrative section at the front of every report explaining the inspection objective in plain English. Auditors, regulators, and new hires all read the narrative first.</li>
<li>A consistent indication-numbering scheme that survives across multiple inspection campaigns, so an indication found in 2024 can be tracked through 2026 and 2028 without renaming.</li>
<li>An attached "open items" list with target dates, ownership, and the trigger that closes each item. This is the single most useful artifact for a turnaround manager.</li>
...
<p>If your current report template is missing one of those, that is the easiest documentation improvement you can make this quarter, and it costs nothing beyond a template update.</p>
<h3>Procurement and contract considerations</h3>
<p>pipeline crack management engagements have a recurring procurement pitfall: the scope of work is written in inspection-deliverable language ("ten welds inspected by PAUT"), and the contract success criteria are written in commercial language ("on time, on budget, no NCRs"). Neither captures the engineering outcome the asset owner actually needs, which is a defensible decision about fitness for service. Contracts that explicitly include a deliverable like "decision-grade report with Level III rationale signed and dated" align all three parties — owner, integrity engineer, and contractor — around the same outcome.</p>
