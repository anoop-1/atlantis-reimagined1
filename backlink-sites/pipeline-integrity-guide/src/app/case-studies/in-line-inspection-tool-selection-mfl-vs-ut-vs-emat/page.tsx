...
export const metadata: Metadata = {
  ...
  description: "Working notes for pipeline integrity engineers on in-line inspection: how to choose the technique, document the decision, and survive the next audit.",
  keywords: ["in-line inspection","MFL ILI","UT crawler","EMAT pipeline"],
  alternates: { canonical: "https://pipeline-integrity-guide.vercel.app/case-studies/in-line-inspection-tool-selection-mfl-vs-ut-vs-emat" },
  openGraph: {
    title: "In-Line Inspection Tool Selection: MFL vs UT vs EMAT",
    description: "Working notes for pipeline integrity engineers on in-line inspection: how to choose the technique, document the decision, and survive the next audit.",
    type: 'article',
    url: "https://pipeline-integrity-guide.vercel.app/case-studies/in-line-inspection-tool-selection-mfl-vs-ut-vs-emat",
    siteName: "Pipeline Integrity Guide",
    locale: 'en_US',
    publishedTime: "2024-08-19T00:00:00.000Z",
    modifiedTime: "2024-08-19T00:00:00.000Z",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "In-Line Inspection Tool Selection: MFL vs UT vs EMAT",
  "description": "Working notes for pipeline integrity engineers on in-line inspection: how to choose the technique, document the decision, and survive the next audit.",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://pipeline-integrity-guide.vercel.app/case-studies/in-line-inspection-tool-selection-mfl-vs-ut-vs-emat"
  },
  "keywords": "in-line inspection, MFL ILI, UT crawler, EMAT pipeline"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>In-Line Inspection Tool Selection: MFL vs UT vs EMAT</span>
      </nav>
      <h1>In-Line Inspection Tool Selection: MFL vs UT vs EMAT</h1>
      <p className="text-sm text-gray-500 mb-8">By Hector Alvarez, NACE-certified Pipeline Inspector &middot; Published 2024-08-19</p>
      <div dangerouslySetInnerHTML={{ __html: `<p>This article walks through the practical decisions pipeline integrity engineers, midstream operators, regulators need to make when working on pipeline integrity & inspection. The goal is not theory — it is the kind of working knowledge an experienced inspector or engineer would share over a coffee on a job site, with enough rigor to point back to code and standard references when those decisions get challenged in audit. Throughout the piece we focus on the parts of in-line inspection that turn into real schedule or budget pain when they go wrong.</p><h2>Why this comes up so often in the field</h2>
<p>Ask any pipeline integrity engineers how often in-line inspection drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<ul>
<li><strong>The decision points</strong> that drive most in-line inspection programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any in-line inspection engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of in-line inspection should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize in-line inspection in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p><h3>How in-line inspection fits into the bigger picture</h3>
<p>It is easy to study in-line inspection as an isolated subject — most courses do exactly that — but the engineering value only appears when you place in-line inspection alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.nrc.gov/reactors/operating/ops-experience.html" rel="noopener nofollow">NRC operating experience reports</a> to align their practice with what is already published in the wider community. For most pipeline integrity engineers the question is not "what is in-line inspection?" but "where does in-line inspection sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in in-line inspection, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on MFL ILI</h3>
<p>Three behaviours we see at high-performing operators consistently show up in MFL ILI programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a MFL ILI program.</p>
