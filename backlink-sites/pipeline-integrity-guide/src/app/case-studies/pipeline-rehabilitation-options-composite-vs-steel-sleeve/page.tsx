...
export const metadata: Metadata = {
  ...
  description: "A field-oriented walkthrough of pipeline repair for pipeline integrity engineers, with decision matrices, code references, and the documentation auditors a...",
  keywords: ["pipeline repair","composite sleeve","type B sleeve","PRCI repair"],
  alternates: { canonical: "https://pipeline-integrity-guide.vercel.app/case-studies/pipeline-rehabilitation-options-composite-vs-steel-sleeve" },
  openGraph: {
    title: "Pipeline Rehabilitation Options: Composite Sleeves vs Steel Sleeves",
    description: "A field-oriented walkthrough of pipeline repair for pipeline integrity engineers, with decision matrices, code references, and the documentation auditors a...",
    type: 'article',
    url: "https://pipeline-integrity-guide.vercel.app/case-studies/pipeline-rehabilitation-options-composite-vs-steel-sleeve",
    siteName: "Pipeline Integrity Guide",
    locale: 'en_US',
    publishedTime: "2026-04-04T00:00:00.000Z",
    modifiedTime: "2026-04-04T00:00:00.000Z",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Pipeline Rehabilitation Options: Composite Sleeves vs Steel Sleeves",
  "description": "A field-oriented walkthrough of pipeline repair for pipeline integrity engineers, with decision matrices, code references, and the documentation auditors a...",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://pipeline-integrity-guide.vercel.app/case-studies/pipeline-rehabilitation-options-composite-vs-steel-sleeve"
  },
  "keywords": "pipeline repair, composite sleeve, type B sleeve, PRCI repair"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>Pipeline Rehabilitation Options: Composite Sleeves vs Steel Sleeves</span>
      </nav>
      <h1>Pipeline Rehabilitation Options: Composite Sleeves vs Steel Sleeves</h1>
      <p className="text-sm text-gray-500 mb-8">By Linnea Söderberg, MSc, IWE &middot; Published 2026-04-04</p>
      <div dangerouslySetInnerHTML={{ __html: `<p>This article walks through the practical decisions pipeline integrity engineers, midstream operators, regulators need to make when working on pipeline integrity & inspection. The goal is not theory — it is the kind of working knowledge an experienced inspector or engineer would share over a coffee on a job site, with enough rigor to point back to code and standard references when those decisions get challenged in audit. Throughout the piece we focus on the parts of pipeline repair that turn into real schedule or budget pain when they go wrong.</p><h2>Why this comes up so often in the field</h2>
<p>Ask any pipeline integrity engineers how often pipeline repair drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<ul>
<li><strong>The decision points</strong> that drive most pipeline repair programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any pipeline repair engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<p>Post-repair inspection is the most procedural of the three patterns and the most likely to be weakened by schedule pressure. The required NDT is usually defined by the original construction code (ASME VIII, ASME XI, AWS D1.1, and so on), which is fine — but the decision about <em>how</em> to apply it under field conditions is rarely covered. Practical teams often cross-reference <a href="https://atlantisndt.com/blog/pipeline-corrosion-and-mechanical-damage-assessment" rel="noopener">the corresponding mechanical damage assessment notes</a> to align their practice with what is already published in the wider community.</p><h2>The data the audit will ask for</h2>
<p>Auditors do not argue with conclusions; they argue with the evidence behind them. For any defensible pipeline repair report, the evidence packet needs to include at minimum:</p>
<ul>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of pipeline repair should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize pipeline repair in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p><h3>How pipeline repair fits into the bigger picture</h3>
<p>It is easy to study pipeline repair as an isolated subject — most courses do exactly that — but the engineering value only appears when you place pipeline repair alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.dnv.com/services/structural-and-asset-integrity-services-2293" rel="noopener nofollow">DNV asset integrity services portfolio</a> to align their practice with what is already published in the wider community. For most pipeline integrity engineers the question is not "what is pipeline repair?" but "where does pipeline repair sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in pipeline repair, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on composite sleeve</h3>
<p>Three behaviours we see at high-performing operators consistently show up in composite sleeve programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a composite sleeve program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best type B sleeve documentation packages we have seen share three patterns:</p>
<ul>
...
<p>PRCI repair engagements have a recurring procurement pitfall: the scope of work is written in inspection-deliverable language ("ten welds inspected by PAUT"), and the contract success criteria are written in commercial language ("on time, on budget, no NCRs"). Neither captures the engineering outcome the asset owner actually needs, which is a defensible decision about fitness for service. Contracts that explicitly include a deliverable like "decision-grade report with Level III rationale signed and dated" align all three parties — owner, integrity engineer, and contractor — around the same outcome.</p>
