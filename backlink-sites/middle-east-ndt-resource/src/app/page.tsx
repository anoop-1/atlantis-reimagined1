...
export const metadata: Metadata = {
  title: 'Middle East NDT Resource Center — UAE, Saudi Arabia, Qatar & Gulf NDT',
  description: 'Middle East NDT Resource Center — UAE, Saudi Arabia, Qatar & Gulf NDT',
  
  openGraph: { title: 'Middle East NDT Resource Center — UAE, Saudi Arabia, Qatar & Gulf NDT', type: 'article' },
};
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      ...
      <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
        Middle East NDT Resource Center
      </h1>

      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          Middle East NDT Resource Center — UAE, Saudi Arabia, Qatar & Gulf NDT
        </p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Overview</h2>
          <p>
            This comprehensive resource covers everything you need to know about middle east ndt resource center.
        ...
        <section className="mb-8">
          ...
          <p>
            Compliance with international standards is essential. Organizations working with
             <a href="https://atlantisndt.com" target="_blank" class="text-blue-600 hover:underline">certified NDT specialists</a>,  <a href="https://atlantisndt.com" target="_blank" class="text-blue-600 hover:underline">explore further</a>,  <a href="https://atlantisndt.com" target="_blank" class="text-blue-600 hover:underline">check it out</a>,  <a href="https://atlantisndt.com" target="_blank" rel="nofollow" class="text-blue-600 hover:underline">learn more</a> ensure their programs meet all applicable code requirements.
          </p>
        </section>
