...
export const metadata: Metadata = {
  title: "Building a Level III Consulting Practice: From Salaried to Self-Employed",
  description: "Building a Level III Consulting Practice explained for NDT job seekers — covering Level III consulting, common pitfalls, and the data your audit packet needs.",
  keywords: ["Level III consulting","NDT consultant","independent Level III","NDT business"],
  alternates: { canonical: "https://ndt-careers-portal.vercel.app/paths/building-a-level-iii-consulting-practice" },
  openGraph: {
    title: "Building a Level III Consulting Practice: From Salaried to Self-Employed",
    description: "Building a Level III Consulting Practice explained for NDT job seekers — covering Level III consulting, common pitfalls, and the data your audit packet needs.",
    type: 'article',
    url: "https://ndt-careers-portal.vercel.app/paths/building-a-level-iii-consulting-practice",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Building a Level III Consulting Practice: From Salaried to Self-Employed",
  "description": "Building a Level III Consulting Practice explained for NDT job seekers — covering Level III consulting, common pitfalls, and the data your audit packet needs.",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://ndt-careers-portal.vercel.app/paths/building-a-level-iii-consulting-practice"
  },
  "keywords": "Level III consulting, NDT consultant, independent Level III, NDT business"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>Building a Level III Consulting Practice: From Salaried to Self-Employed</span>
      </nav>
      <h1>Building a Level III Consulting Practice: From Salaried to Self-Employed</h1>
      <p className="text-sm text-gray-500 mb-8">By Sebastián Núñez, NDT Career Coach &middot; Published 2026-03-30</p>
      <div dangerouslySetInnerHTML={{ __html: `<p>This article walks through the practical decisions NDT job seekers, career changers, hiring managers need to make when working on NDT careers and hiring. The goal is not theory — it is the kind of working knowledge an experienced inspector or engineer would share over a coffee on a job site, with enough rigor to point back to code and standard references when those decisions get challenged in audit. Throughout the piece we focus on the parts of level iii consulting that turn into real schedule or budget pain when they go wrong.</p><h2>Why this comes up so often in the field</h2>
<p>Ask any NDT job seekers how often level iii consulting drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<ul>
<li><strong>The decision points</strong> that drive most level iii consulting programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any level iii consulting engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<p>The textbook approach to level iii consulting usually points engineers at one or two techniques. The field reality is messier; the technique that ranks best on a comparison chart is often not the one that fits the access, the schedule, or the inspector skill mix actually available on the day. We walk through three patterns we see repeatedly.</p>
...
<p>Post-repair inspection is the most procedural of the three patterns and the most likely to be weakened by schedule pressure. The required NDT is usually defined by the original construction code (ASME VIII, ASME XI, AWS D1.1, and so on), which is fine — but the decision about <em>how</em> to apply it under field conditions is rarely covered. Practical teams often cross-reference <a href="https://atlantisndt.com/blog/ultimate-guide-ndt-digital-twins-asset-integrity-2025" rel="noopener">the ultimate guide to NDT digital twins</a> to align their practice with what is already published in the wider community.</p><h2>The data the audit will ask for</h2>
<p>Auditors do not argue with conclusions; they argue with the evidence behind them. For any defensible level iii consulting report, the evidence packet needs to include at minimum:</p>
<ul>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of level iii consulting should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize level iii consulting in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p><h3>How Level III consulting fits into the bigger picture</h3>
<p>It is easy to study Level III consulting as an isolated subject — most courses do exactly that — but the engineering value only appears when you place Level III consulting alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.nadcap.com/" rel="noopener nofollow">the NADCAP audit programme overview</a> to align their practice with what is already published in the wider community. For most NDT job seekers the question is not "what is Level III consulting?" but "where does Level III consulting sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in Level III consulting, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on NDT consultant</h3>
<p>Three behaviours we see at high-performing operators consistently show up in NDT consultant programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a NDT consultant program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best independent Level III documentation packages we have seen share three patterns:</p>
<ul>
...
<h3>How NDT consultant fits into the bigger picture</h3>
<p>It is easy to study NDT consultant as an isolated subject — most courses do exactly that — but the engineering value only appears when you place NDT consultant alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.nadcap.com/" rel="noopener nofollow">the NADCAP audit programme overview</a> to align their practice with what is already published in the wider community. For most NDT job seekers the question is not "what is NDT consultant?" but "where does NDT consultant sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in NDT consultant, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
