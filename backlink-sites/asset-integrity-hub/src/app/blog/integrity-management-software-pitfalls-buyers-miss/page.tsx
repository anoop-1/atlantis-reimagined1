...
export const metadata: Metadata = {
  title: "Integrity Management Software: Five Pitfalls Buyers Almost Always Miss",
  description: "A field-oriented walkthrough of integrity software for reliability engineers, with decision matrices, code references, and the documentation auditors actua...",
  keywords: ["integrity software","IDMS pitfalls","integrity management system","asset integrity software"],
  alternates: { canonical: "https://asset-integrity-hub.vercel.app/blog/integrity-management-software-pitfalls-buyers-miss" },
  openGraph: {
    title: "Integrity Management Software: Five Pitfalls Buyers Almost Always Miss",
    description: "A field-oriented walkthrough of integrity software for reliability engineers, with decision matrices, code references, and the documentation auditors actua...",
    type: 'article',
    url: "https://asset-integrity-hub.vercel.app/blog/integrity-management-software-pitfalls-buyers-miss",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Integrity Management Software: Five Pitfalls Buyers Almost Always Miss",
  "description": "A field-oriented walkthrough of integrity software for reliability engineers, with decision matrices, code references, and the documentation auditors actua...",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://asset-integrity-hub.vercel.app/blog/integrity-management-software-pitfalls-buyers-miss"
  },
  "keywords": "integrity software, IDMS pitfalls, integrity management system, asset integrity software"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>Integrity Management Software: Five Pitfalls Buyers Almost Always Miss</span>
      </nav>
      <h1>Integrity Management Software: Five Pitfalls Buyers Almost Always Miss</h1>
      <p className="text-sm text-gray-500 mb-8">By Yuki Nakamura, PhD, P.Eng &middot; Published 2026-03-04</p>
...
<h3>Operator behaviours that actually move the needle on IDMS pitfalls</h3>
<p>Three behaviours we see at high-performing operators consistently show up in IDMS pitfalls programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a IDMS pitfalls program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best integrity management system documentation packages we have seen share three patterns:</p>
<ul>
