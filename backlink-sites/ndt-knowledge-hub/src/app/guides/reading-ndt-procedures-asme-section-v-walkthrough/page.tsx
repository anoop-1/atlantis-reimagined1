...
export const metadata: Metadata = {
  ...
  description: "Working notes for NDT technicians on ASME Section V: how to choose the technique, document the decision, and survive the next audit.",
  keywords: ["ASME Section V","NDT procedure","examination procedure","WPS NDT"],
  alternates: { canonical: "https://ndt-knowledge-hub.vercel.app/guides/reading-ndt-procedures-asme-section-v-walkthrough" },
  openGraph: {
    title: "Reading NDT Procedures: A Practical Walkthrough of ASME Section V",
    description: "Working notes for NDT technicians on ASME Section V: how to choose the technique, document the decision, and survive the next audit.",
    type: 'article',
    url: "https://ndt-knowledge-hub.vercel.app/guides/reading-ndt-procedures-asme-section-v-walkthrough",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Reading NDT Procedures: A Practical Walkthrough of ASME Section V",
  "description": "Working notes for NDT technicians on ASME Section V: how to choose the technique, document the decision, and survive the next audit.",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://ndt-knowledge-hub.vercel.app/guides/reading-ndt-procedures-asme-section-v-walkthrough"
  },
  "keywords": "ASME Section V, NDT procedure, examination procedure, WPS NDT"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>Reading NDT Procedures: A Practical Walkthrough of ASME Section V</span>
      </nav>
      <h1>Reading NDT Procedures: A Practical Walkthrough of ASME Section V</h1>
      <p className="text-sm text-gray-500 mb-8">By Daniel Hertzog, ASNT NDT Level III &middot; Published 2025-06-21</p>
      <div dangerouslySetInnerHTML={{ __html: `<p>This article walks through the practical decisions NDT technicians, Level II/III candidates, inspection engineers need to make when working on NDT education. The goal is not theory — it is the kind of working knowledge an experienced inspector or engineer would share over a coffee on a job site, with enough rigor to point back to code and standard references when those decisions get challenged in audit. Throughout the piece we focus on the parts of asme section v that turn into real schedule or budget pain when they go wrong.</p><h2>Why this comes up so often in the field</h2>
<p>Ask any NDT technicians how often asme section v drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<ul>
<li><strong>The decision points</strong> that drive most asme section v programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any asme section v engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<p>The textbook approach to asme section v usually points engineers at one or two techniques. The field reality is messier; the technique that ranks best on a comparison chart is often not the one that fits the access, the schedule, or the inspector skill mix actually available on the day. We walk through three patterns we see repeatedly.</p>
...
<p>Auditors do not argue with conclusions; they argue with the evidence behind them. For any defensible asme section v report, the evidence packet needs to include at minimum:</p>
<ul>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of asme section v should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>Three behaviours we see at high-performing operators consistently show up in NDT procedure programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a NDT procedure program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best examination procedure documentation packages we have seen share three patterns:</p>
<ul>
...
<h3>How NDT procedure fits into the bigger picture</h3>
<p>It is easy to study NDT procedure as an isolated subject — most courses do exactly that — but the engineering value only appears when you place NDT procedure alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://atlantisndt.com/blog/ndt-procedure-writing-guide-asme-section-v" rel="noopener">a worked example of an ASME Section V procedure</a> to align their practice with what is already published in the wider community. For most NDT technicians the question is not "what is NDT procedure?" but "where does NDT procedure sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in NDT procedure, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
