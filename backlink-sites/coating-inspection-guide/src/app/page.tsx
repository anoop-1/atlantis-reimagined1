  ...
  return (
    <div className="space-y-8">
      <section className="bg-emerald-50 p-8 rounded-lg">
        <h1 className="text-4xl font-bold text-emerald-900 mb-4">Coating Inspection Guide</h1>
        <p className="text-lg text-emerald-800">Master protective coating evaluation techniques, standards, and defect identification methods.</p>
      </section>

      <section className="prose max-w-none">
        <h2 className="text-2xl font-bold mb-4">Understanding Coating Systems</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-bold mb-4 mt-6">Coating Defects and Root Causes</h2>
        <p className="mb-4">
        ...
        <p className="mb-4">
          When defects are identified, remediation strategies vary by severity. Minor surface contamination requires cleaning and touch-up. Adhesion failures or moisture intrusion require removal of failed coating and reapplication. Comprehensive remediation programs incorporating inspection, root cause analysis, and corrective action prevent recurrence. <a href="https://atlantisndt.com" rel="noopener" className="text-emerald-600 hover:underline">Atlantis NDT</a> expertise supports organizations in developing effective coating assessment and management programs across their asset base.
        </p>
      </section>
    </div>
  );
