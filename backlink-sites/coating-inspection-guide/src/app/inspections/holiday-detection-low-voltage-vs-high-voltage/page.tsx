...
export const metadata: Metadata = {
  title: "Holiday Detection: Low Voltage vs High Voltage Methods Compared",
  description: "Practical guide for AMPP coatings inspectors: how to apply holiday detection in real inspection work, what auditors expect, and where most programs fall sh...",
  keywords: ["holiday detection","pinhole detection","NACE SP0188","coating holiday"],
  alternates: { canonical: "https://coating-inspection-guide.vercel.app/inspections/holiday-detection-low-voltage-vs-high-voltage" },
  openGraph: {
    title: "Holiday Detection: Low Voltage vs High Voltage Methods Compared",
    description: "Practical guide for AMPP coatings inspectors: how to apply holiday detection in real inspection work, what auditors expect, and where most programs fall sh...",
    type: 'article',
    url: "https://coating-inspection-guide.vercel.app/inspections/holiday-detection-low-voltage-vs-high-voltage",
    siteName: "Coating Inspection Guide",
    locale: 'en_US',
    publishedTime: "2025-07-03T00:00:00.000Z",
    modifiedTime: "2025-07-03T00:00:00.000Z",
    authors: ["Pavlov Vance, NACE CIP"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Holiday Detection: Low Voltage vs High Voltage Methods Compared",
  "description": "Practical guide for AMPP coatings inspectors: how to apply holiday detection in real inspection work, what auditors expect, and where most programs fall sh...",
  "author": {
    "@type": "Person",
    "name": "Pavlov Vance, NACE CIP"
  },
  "publisher": {
    "@type": "Organization",
    "name": "Coating Inspection Guide Editorial",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://coating-inspection-guide.vercel.app/inspections/holiday-detection-low-voltage-vs-high-voltage"
  },
  "keywords": "holiday detection, pinhole detection, NACE SP0188, coating holiday"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>Holiday Detection: Low Voltage vs High Voltage Methods Compared</span>
      </nav>
      <h1>Holiday Detection: Low Voltage vs High Voltage Methods Compared</h1>
      <p className="text-sm text-gray-500 mb-8">By Pavlov Vance, NACE CIP &middot; Published 2025-07-03</p>
      <div dangerouslySetInnerHTML={{ __html: `<p>This article walks through the practical decisions AMPP coatings inspectors, blast/paint QC managers need to make when working on coating and corrosion inspection. The goal is not theory — it is the kind of working knowledge an experienced inspector or engineer would share over a coffee on a job site, with enough rigor to point back to code and standard references when those decisions get challenged in audit. Throughout the piece we focus on the parts of holiday detection that turn into real schedule or budget pain when they go wrong.</p><h2>Why this comes up so often in the field</h2>
<p>Ask any AMPP coatings inspectors how often holiday detection drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<ul>
<li><strong>The decision points</strong> that drive most holiday detection programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any holiday detection engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<p>The textbook approach to holiday detection usually points engineers at one or two techniques. The field reality is messier; the technique that ranks best on a comparison chart is often not the one that fits the access, the schedule, or the inspector skill mix actually available on the day. We walk through three patterns we see repeatedly.</p>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of holiday detection should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize holiday detection in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p><h3>How holiday detection fits into the bigger picture</h3>
<p>It is easy to study holiday detection as an isolated subject — most courses do exactly that — but the engineering value only appears when you place holiday detection alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.aws.org/standards" rel="noopener nofollow">the AWS standards catalog</a> to align their practice with what is already published in the wider community. For most AMPP coatings inspectors the question is not "what is holiday detection?" but "where does holiday detection sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in holiday detection, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on pinhole detection</h3>
<p>Three behaviours we see at high-performing operators consistently show up in pinhole detection programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a pinhole detection program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best NACE SP0188 documentation packages we have seen share three patterns:</p>
<ul>
...
<h3>How pinhole detection fits into the bigger picture</h3>
<p>It is easy to study pinhole detection as an isolated subject — most courses do exactly that — but the engineering value only appears when you place pinhole detection alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.aws.org/standards" rel="noopener nofollow">the AWS standards catalog</a> to align their practice with what is already published in the wider community. For most AMPP coatings inspectors the question is not "what is pinhole detection?" but "where does pinhole detection sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in pinhole detection, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on NACE SP0188</h3>
<p>Three behaviours we see at high-performing operators consistently show up in NACE SP0188 programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a NACE SP0188 program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best coating holiday documentation packages we have seen share three patterns:</p>
<ul>
<li>A short narrative section at the front of every report explaining the inspection objective in plain English. Auditors, regulators, and new hires all read the narrative first.</li>
<li>A consistent indication-numbering scheme that survives across multiple inspection campaigns, so an indication found in 2024 can be tracked through 2026 and 2028 without renaming.</li>
<li>An attached "open items" list with target dates, ownership, and the trigger that closes each item. This is the single most useful artifact for a turnaround manager.</li>
...
<p>If your current report template is missing one of those, that is the easiest documentation improvement you can make this quarter, and it costs nothing beyond a template update.</p>
<h3>Procurement and contract considerations</h3>
<p>holiday detection engagements have a recurring procurement pitfall: the scope of work is written in inspection-deliverable language ("ten welds inspected by PAUT"), and the contract success criteria are written in commercial language ("on time, on budget, no NCRs"). Neither captures the engineering outcome the asset owner actually needs, which is a defensible decision about fitness for service. Contracts that explicitly include a deliverable like "decision-grade report with Level III rationale signed and dated" align all three parties — owner, integrity engineer, and contractor — around the same outcome.</p>
<h3>Training and competency considerations</h3>
<p>Tooling improvements in pinhole detection usually outpace inspector training by 18–24 months. Phased array systems, advanced eddy current arrays, and automated scanners are now common; structured training pathways for those tools are less common. The implication for hiring managers is straightforward: budget for technique-specific training as part of the equipment purchase, not as a separate line item to be defended later.</p>
<p>Competency on a written exam does not equal competency on a job site. The most reliable way to check applied competency is a witnessed scan of a known-flaw block, evaluated independently by a Level III who did not run the scan.</p>
