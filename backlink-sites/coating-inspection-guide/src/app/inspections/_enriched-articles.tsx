...
<li className="border-b border-gray-200 py-6">
          <a href="/inspections/ndt-coating-inspector-day-one-jobsite-kit" className="text-xl font-semibold text-gray-900 hover:text-teal-600">Coating Inspector Day-One Jobsite Kit: What Belongs and What Does Not</a>
          <p className="text-sm text-gray-500 mt-2">By Renée Bouchard, AMPP CIP Level 3 &middot; 2025-05-23</p>
          <p className="text-gray-700 mt-3">Coating Inspector Day-One Jobsite Kit: What Belongs and What Does Not</p>
        </li>
<li className="border-b border-gray-200 py-6">
          <a href="/inspections/dew-point-vs-substrate-temp-painting-decision-rule" className="text-xl font-semibold text-gray-900 hover:text-teal-600">Dew Point vs Substrate Temperature: The Painting Decision Rule Every Inspector Should Know</a>
          <p className="text-sm text-gray-500 mt-2">By Pavlov Vance, NACE CIP &middot; 2025-09-02</p>
          <p className="text-gray-700 mt-3">Dew Point vs Substrate Temperature: The Painting Decision Rule Every Inspector Should Know</p>
        </li>
<li className="border-b border-gray-200 py-6">
          <a href="/inspections/fiber-glass-and-frp-coating-inspection-considerations" className="text-xl font-semibold text-gray-900 hover:text-teal-600">Fiberglass and FRP Coating Inspection Considerations</a>
          <p className="text-sm text-gray-500 mt-2">By Renée Bouchard, AMPP CIP Level 3 &middot; 2025-11-22</p>
          <p className="text-gray-700 mt-3">Fiberglass and FRP Coating Inspection Considerations</p>
        </li>
<li className="border-b border-gray-200 py-6">
          <a href="/inspections/tank-internal-lining-inspection-acceptance-criteria" className="text-xl font-semibold text-gray-900 hover:text-teal-600">Tank Internal Lining Inspection: Acceptance Criteria That Hold Up</a>
          <p className="text-sm text-gray-500 mt-2">By Pavlov Vance, NACE CIP &middot; 2026-02-27</p>
          <p className="text-gray-700 mt-3">Tank Internal Lining Inspection: Acceptance Criteria That Hold Up</p>
        </li>
<li className="border-b border-gray-200 py-6">
          <a href="/inspections/pipe-coating-fbe-vs-3lpe-vs-3lpp-when-each-fits" className="text-xl font-semibold text-gray-900 hover:text-teal-600">Pipe Coating: FBE vs 3LPE vs 3LPP — When Each Fits</a>
          <p className="text-sm text-gray-500 mt-2">By Renée Bouchard, AMPP CIP Level 3 &middot; 2026-05-09</p>
          <p className="text-gray-700 mt-3">Pipe Coating: FBE vs 3LPE vs 3LPP — When Each Fits</p>
        </li>
      </ul>
    </div>
  );
