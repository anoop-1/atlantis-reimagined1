...
export const metadata: Metadata = {
  title: "SSPC-SP10 vs SP5 Blast Profile Decisions on Carbon Steel",
  description: "A field-oriented walkthrough of SSPC SP10 for AMPP coatings inspectors, with decision matrices, code references, and the documentation auditors actually want.",
  keywords: ["SSPC SP10","NACE 2","blast profile","surface preparation"],
  alternates: { canonical: "https://coating-inspection-guide.vercel.app/inspections/ssp-sp10-vs-sp5-blast-profile-decisions" },
  openGraph: {
    title: "SSPC-SP10 vs SP5 Blast Profile Decisions on Carbon Steel",
    description: "A field-oriented walkthrough of SSPC SP10 for AMPP coatings inspectors, with decision matrices, code references, and the documentation auditors actually want.",
    type: 'article',
    url: "https://coating-inspection-guide.vercel.app/inspections/ssp-sp10-vs-sp5-blast-profile-decisions",
    siteName: "Coating Inspection Guide",
    locale: 'en_US',
    publishedTime: "2024-08-30T00:00:00.000Z",
    modifiedTime: "2024-08-30T00:00:00.000Z",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "SSPC-SP10 vs SP5 Blast Profile Decisions on Carbon Steel",
  "description": "A field-oriented walkthrough of SSPC SP10 for AMPP coatings inspectors, with decision matrices, code references, and the documentation auditors actually want.",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://coating-inspection-guide.vercel.app/inspections/ssp-sp10-vs-sp5-blast-profile-decisions"
  },
  "keywords": "SSPC SP10, NACE 2, blast profile, surface preparation"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>SSPC-SP10 vs SP5 Blast Profile Decisions on Carbon Steel</span>
      </nav>
      <h1>SSPC-SP10 vs SP5 Blast Profile Decisions on Carbon Steel</h1>
      <p className="text-sm text-gray-500 mb-8">By Renée Bouchard, AMPP CIP Level 3 &middot; Published 2024-08-30</p>
      <div dangerouslySetInnerHTML={{ __html: `<p>This article walks through the practical decisions AMPP coatings inspectors, blast/paint QC managers need to make when working on coating and corrosion inspection. The goal is not theory — it is the kind of working knowledge an experienced inspector or engineer would share over a coffee on a job site, with enough rigor to point back to code and standard references when those decisions get challenged in audit. Throughout the piece we focus on the parts of sspc sp10 that turn into real schedule or budget pain when they go wrong.</p><h2>Why this comes up so often in the field</h2>
<p>Ask any AMPP coatings inspectors how often sspc sp10 drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<ul>
<li><strong>The decision points</strong> that drive most sspc sp10 programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any sspc sp10 engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<p>The textbook approach to sspc sp10 usually points engineers at one or two techniques. The field reality is messier; the technique that ranks best on a comparison chart is often not the one that fits the access, the schedule, or the inspector skill mix actually available on the day. We walk through three patterns we see repeatedly.</p>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of sspc sp10 should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize sspc sp10 in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p><h3>How SSPC SP10 fits into the bigger picture</h3>
<p>It is easy to study SSPC SP10 as an isolated subject — most courses do exactly that — but the engineering value only appears when you place SSPC SP10 alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.imca-int.com/" rel="noopener nofollow">the IMCA technical resources for offshore work</a> to align their practice with what is already published in the wider community. For most AMPP coatings inspectors the question is not "what is SSPC SP10?" but "where does SSPC SP10 sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in SSPC SP10, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on NACE 2</h3>
<p>Three behaviours we see at high-performing operators consistently show up in NACE 2 programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a NACE 2 program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best blast profile documentation packages we have seen share three patterns:</p>
<ul>
...
<h3>How NACE 2 fits into the bigger picture</h3>
<p>It is easy to study NACE 2 as an isolated subject — most courses do exactly that — but the engineering value only appears when you place NACE 2 alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.imca-int.com/" rel="noopener nofollow">the IMCA technical resources for offshore work</a> to align their practice with what is already published in the wider community. For most AMPP coatings inspectors the question is not "what is NACE 2?" but "where does NACE 2 sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in NACE 2, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on blast profile</h3>
<p>Three behaviours we see at high-performing operators consistently show up in blast profile programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a blast profile program.</p>
