...
export const metadata: Metadata = {
  title: "Tank Internal Lining Inspection: Acceptance Criteria That Hold Up",
  description: "Practical guide for AMPP coatings inspectors: how to apply tank lining in real inspection work, what auditors expect, and where most programs fall short.",
  keywords: ["tank lining","internal lining inspection","tank coating acceptance","API 652"],
  alternates: { canonical: "https://coating-inspection-guide.vercel.app/inspections/tank-internal-lining-inspection-acceptance-criteria" },
  openGraph: {
    title: "Tank Internal Lining Inspection: Acceptance Criteria That Hold Up",
    description: "Practical guide for AMPP coatings inspectors: how to apply tank lining in real inspection work, what auditors expect, and where most programs fall short.",
    type: 'article',
    url: "https://coating-inspection-guide.vercel.app/inspections/tank-internal-lining-inspection-acceptance-criteria",
    siteName: "Coating Inspection Guide",
    locale: 'en_US',
    publishedTime: "2026-02-27T00:00:00.000Z",
    modifiedTime: "2026-02-27T00:00:00.000Z",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Tank Internal Lining Inspection: Acceptance Criteria That Hold Up",
  "description": "Practical guide for AMPP coatings inspectors: how to apply tank lining in real inspection work, what auditors expect, and where most programs fall short.",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://coating-inspection-guide.vercel.app/inspections/tank-internal-lining-inspection-acceptance-criteria"
  },
  "keywords": "tank lining, internal lining inspection, tank coating acceptance, API 652"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>Tank Internal Lining Inspection: Acceptance Criteria That Hold Up</span>
      </nav>
      <h1>Tank Internal Lining Inspection: Acceptance Criteria That Hold Up</h1>
      <p className="text-sm text-gray-500 mb-8">By Pavlov Vance, NACE CIP &middot; Published 2026-02-27</p>
