...
export const metadata: Metadata = {
  title: "Coating Failure Modes: Osmotic Blistering, Disbondment, and What Each Tells You",
  description: "Working notes for AMPP coatings inspectors on coating failure: how to choose the technique, document the decision, and survive the next audit.",
  keywords: ["coating failure","osmotic blistering","cathodic disbondment","paint failure analysis"],
  alternates: { canonical: "https://coating-inspection-guide.vercel.app/inspections/coating-failure-modes-osmotic-blistering-cathodic-disbondment" },
  openGraph: {
    title: "Coating Failure Modes: Osmotic Blistering, Disbondment, and What Each Tells You",
    description: "Working notes for AMPP coatings inspectors on coating failure: how to choose the technique, document the decision, and survive the next audit.",
    type: 'article',
    url: "https://coating-inspection-guide.vercel.app/inspections/coating-failure-modes-osmotic-blistering-cathodic-disbondment",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Coating Failure Modes: Osmotic Blistering, Disbondment, and What Each Tells You",
  "description": "Working notes for AMPP coatings inspectors on coating failure: how to choose the technique, document the decision, and survive the next audit.",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://coating-inspection-guide.vercel.app/inspections/coating-failure-modes-osmotic-blistering-cathodic-disbondment"
  },
  "keywords": "coating failure, osmotic blistering, cathodic disbondment, paint failure analysis"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>Coating Failure Modes: Osmotic Blistering, Disbondment, and What Each Tells You</span>
      </nav>
      <h1>Coating Failure Modes: Osmotic Blistering, Disbondment, and What Each Tells You</h1>
      <p className="text-sm text-gray-500 mb-8">By Pavlov Vance, NACE CIP &middot; Published 2026-04-19</p>
      <div dangerouslySetInnerHTML={{ __html: `<p>This article walks through the practical decisions AMPP coatings inspectors, blast/paint QC managers need to make when working on coating and corrosion inspection. The goal is not theory — it is the kind of working knowledge an experienced inspector or engineer would share over a coffee on a job site, with enough rigor to point back to code and standard references when those decisions get challenged in audit. Throughout the piece we focus on the parts of coating failure that turn into real schedule or budget pain when they go wrong.</p><h2>Why this comes up so often in the field</h2>
<p>Ask any AMPP coatings inspectors how often coating failure drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<ul>
<li><strong>The decision points</strong> that drive most coating failure programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any coating failure engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<p>The textbook approach to coating failure usually points engineers at one or two techniques. The field reality is messier; the technique that ranks best on a comparison chart is often not the one that fits the access, the schedule, or the inspector skill mix actually available on the day. We walk through three patterns we see repeatedly.</p>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of coating failure should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize coating failure in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p><h3>How coating failure fits into the bigger picture</h3>
<p>It is easy to study coating failure as an isolated subject — most courses do exactly that — but the engineering value only appears when you place coating failure alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.nrc.gov/reactors/operating/ops-experience.html" rel="noopener nofollow">NRC operating experience reports</a> to align their practice with what is already published in the wider community. For most AMPP coatings inspectors the question is not "what is coating failure?" but "where does coating failure sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in coating failure, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on osmotic blistering</h3>
<p>Three behaviours we see at high-performing operators consistently show up in osmotic blistering programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a osmotic blistering program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best cathodic disbondment documentation packages we have seen share three patterns:</p>
<ul>
