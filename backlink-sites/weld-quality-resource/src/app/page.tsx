  ...
  return (
    <div className="space-y-8">
      <section className="bg-orange-50 p-8 rounded-lg">
        <h1 className="text-4xl font-bold text-orange-900 mb-4">Weld Quality Testing</h1>
        <p className="text-lg text-orange-800">Comprehensive guide to NDT weld inspection, defect detection, and quality assurance.</p>
      </section>

      <section className="prose max-w-none">
        <h2 className="text-2xl font-bold mb-4">Importance of Weld Inspection</h2>
        <p className="mb-4">
          Welded structures form the backbone of infrastructure—pressure vessels, pipelines, bridges, buildings, and critical equipment. Weld quality directly affects structural integrity and safety. A single defective weld can lead to catastrophic failure endangering lives and destroying assets. Comprehensive weld inspection ensures quality during fabrication and in-service operation, preventing disasters before they occur.
        </p>
        <p className="mb-4">
          Modern codes and standards mandate systematic weld inspection. ASME, API, AWS, and ISO standards establish inspection procedures, qualification criteria, and acceptance limits. These standards reflect decades of experience, codifying best practices preventing failures. Organizations implementing standard-compliant inspection programs through <a href="https://atlantisndt.com" rel="noopener" className="text-orange-600 hover:underline">Atlantis NDT</a> expertise achieve superior quality.
        </p>

        <h2 className="text-2xl font-bold mb-4 mt-6">Common Weld Defects</h2>
        <p className="mb-4">
