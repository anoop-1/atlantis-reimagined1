...
export const metadata: Metadata = {
  ...
  description: "A field-oriented walkthrough of AWS D1.1 for CWIs, with decision matrices, code references, and the documentation auditors actually want.",
  keywords: ["AWS D1.1","weld acceptance criteria","incomplete fusion","weld defect"],
  alternates: { canonical: "https://weld-quality-resource.vercel.app/methods/aws-d1-1-weld-acceptance-cracks-vs-incomplete-fusion" },
  openGraph: {
    title: "AWS D1.1 Weld Acceptance: Cracks vs Incomplete Fusion vs Slag",
    description: "A field-oriented walkthrough of AWS D1.1 for CWIs, with decision matrices, code references, and the documentation auditors actually want.",
    type: 'article',
    url: "https://weld-quality-resource.vercel.app/methods/aws-d1-1-weld-acceptance-cracks-vs-incomplete-fusion",
    siteName: "Weld Quality Resource",
    locale: 'en_US',
    publishedTime: "2024-10-08T00:00:00.000Z",
    modifiedTime: "2024-10-08T00:00:00.000Z",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "AWS D1.1 Weld Acceptance: Cracks vs Incomplete Fusion vs Slag",
  "description": "A field-oriented walkthrough of AWS D1.1 for CWIs, with decision matrices, code references, and the documentation auditors actually want.",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://weld-quality-resource.vercel.app/methods/aws-d1-1-weld-acceptance-cracks-vs-incomplete-fusion"
  },
  "keywords": "AWS D1.1, weld acceptance criteria, incomplete fusion, weld defect"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>AWS D1.1 Weld Acceptance: Cracks vs Incomplete Fusion vs Slag</span>
      </nav>
      <h1>AWS D1.1 Weld Acceptance: Cracks vs Incomplete Fusion vs Slag</h1>
      <p className="text-sm text-gray-500 mb-8">By Wendell Park, AWS CWI &middot; Published 2024-10-08</p>
...
<p>Ask any CWIs how often aws d1.1 drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<p>If we had to summarize aws d1.1 in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p><h3>How AWS D1.1 fits into the bigger picture</h3>
<p>It is easy to study AWS D1.1 as an isolated subject — most courses do exactly that — but the engineering value only appears when you place AWS D1.1 alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://atlantisndt.com/blog/aws-d1-1-weld-acceptance-criteria-comprehensive-guide" rel="noopener">the comprehensive AWS D1.1 acceptance criteria guide</a> to align their practice with what is already published in the wider community. For most CWIs the question is not "what is AWS D1.1?" but "where does AWS D1.1 sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
...
<h3>Operator behaviours that actually move the needle on weld acceptance criteria</h3>
<p>Three behaviours we see at high-performing operators consistently show up in weld acceptance criteria programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a weld acceptance criteria program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best incomplete fusion documentation packages we have seen share three patterns:</p>
<ul>
...
<h3>How weld acceptance criteria fits into the bigger picture</h3>
<p>It is easy to study weld acceptance criteria as an isolated subject — most courses do exactly that — but the engineering value only appears when you place weld acceptance criteria alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://atlantisndt.com/blog/aws-d1-1-weld-acceptance-criteria-comprehensive-guide" rel="noopener">the comprehensive AWS D1.1 acceptance criteria guide</a> to align their practice with what is already published in the wider community. For most CWIs the question is not "what is weld acceptance criteria?" but "where does weld acceptance criteria sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in weld acceptance criteria, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on incomplete fusion</h3>
<p>Three behaviours we see at high-performing operators consistently show up in incomplete fusion programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a incomplete fusion program.</p>
