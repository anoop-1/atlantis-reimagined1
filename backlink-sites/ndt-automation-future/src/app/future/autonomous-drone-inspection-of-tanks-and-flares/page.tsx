...
export const metadata: Metadata = {
  title: "Autonomous Drone Inspection of Tanks and Flares: State of Play",
  description: "A field-oriented walkthrough of drone inspection for NDT software architects, with decision matrices, code references, and the documentation auditors actua...",
  keywords: ["drone inspection","autonomous drone NDT","flare drone","UAV inspection"],
  alternates: { canonical: "https://ndt-automation-future.vercel.app/future/autonomous-drone-inspection-of-tanks-and-flares" },
  openGraph: {
    title: "Autonomous Drone Inspection of Tanks and Flares: State of Play",
    description: "A field-oriented walkthrough of drone inspection for NDT software architects, with decision matrices, code references, and the documentation auditors actua...",
    type: 'article',
    url: "https://ndt-automation-future.vercel.app/future/autonomous-drone-inspection-of-tanks-and-flares",
    siteName: "NDT Automation Future",
    locale: 'en_US',
    publishedTime: "2025-09-23T00:00:00.000Z",
    modifiedTime: "2025-09-23T00:00:00.000Z",
    authors: ["Tessa Bjorklund, Software Architect"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Autonomous Drone Inspection of Tanks and Flares: State of Play",
  "description": "A field-oriented walkthrough of drone inspection for NDT software architects, with decision matrices, code references, and the documentation auditors actua...",
  "author": {
    "@type": "Person",
    "name": "Tessa Bjorklund, Software Architect"
  },
  "publisher": {
    "@type": "Organization",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://ndt-automation-future.vercel.app/future/autonomous-drone-inspection-of-tanks-and-flares"
  },
  "keywords": "drone inspection, autonomous drone NDT, flare drone, UAV inspection"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>Autonomous Drone Inspection of Tanks and Flares: State of Play</span>
      </nav>
      <h1>Autonomous Drone Inspection of Tanks and Flares: State of Play</h1>
      <p className="text-sm text-gray-500 mb-8">By Tessa Bjorklund, Software Architect &middot; Published 2025-09-23</p>
      <div dangerouslySetInnerHTML={{ __html: `<p>This article walks through the practical decisions NDT software architects, automation engineers, integrity digital leads need to make when working on NDT automation and AI-assisted inspection. The goal is not theory — it is the kind of working knowledge an experienced inspector or engineer would share over a coffee on a job site, with enough rigor to point back to code and standard references when those decisions get challenged in audit. Throughout the piece we focus on the parts of drone inspection that turn into real schedule or budget pain when they go wrong.</p><h2>Why this comes up so often in the field</h2>
<p>Ask any NDT software architects how often drone inspection drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<ul>
<li><strong>The decision points</strong> that drive most drone inspection programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any drone inspection engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<p>Auditors do not argue with conclusions; they argue with the evidence behind them. For any defensible drone inspection report, the evidence packet needs to include at minimum:</p>
<ul>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of drone inspection should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize drone inspection in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p>
<p>Practical teams often cross-reference <a href="https://atlantisndt.com/erp/accounting-ndt-inspection-companies-riyadh" rel="noopener">the accounting ndt inspection companies riyadh ERP page on Atlantis NDT</a> to align their practice with what is already published in the wider community. Practical teams often cross-reference <a href="https://atlantisndt.com/erp" rel="noopener">the affordable NDT ERP positioning page</a> to align their practice with what is already published in the wider community.</p><h3>How drone inspection fits into the bigger picture</h3>
<p>It is easy to study drone inspection as an isolated subject — most courses do exactly that — but the engineering value only appears when you place drone inspection alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.imca-int.com/" rel="noopener nofollow">the IMCA technical resources for offshore work</a> to align their practice with what is already published in the wider community. For most NDT software architects the question is not "what is drone inspection?" but "where does drone inspection sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in drone inspection, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on autonomous drone NDT</h3>
<p>Three behaviours we see at high-performing operators consistently show up in autonomous drone NDT programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a autonomous drone NDT program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best flare drone documentation packages we have seen share three patterns:</p>
<ul>
...
<h3>How autonomous drone NDT fits into the bigger picture</h3>
<p>It is easy to study autonomous drone NDT as an isolated subject — most courses do exactly that — but the engineering value only appears when you place autonomous drone NDT alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.imca-int.com/" rel="noopener nofollow">the IMCA technical resources for offshore work</a> to align their practice with what is already published in the wider community. For most NDT software architects the question is not "what is autonomous drone NDT?" but "where does autonomous drone NDT sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in autonomous drone NDT, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
