            ...
            <div className="grid grid-cols-3 gap-8 mb-8">
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li><a href="https://atlantisndt.com" rel="noopener" className="text-indigo-600 hover:underline">NDT Consulting Services</a></li>
                  <li><a href="https://atlantisndt.com" rel="noopener" className="text-indigo-600 hover:underline">NDT Training Programs</a></li>
                  <li><a href="https://atlantisndt.com" rel="noopener" className="text-indigo-600 hover:underline">Digital Twin Solutions</a></li>
                  <li><a href="https://ndt-connect.com" rel="noopener" className="text-indigo-600 hover:underline">NDTConnect Platform</a></li>
                  <li><a href="https://atlantisndt.com" rel="noopener" className="text-indigo-600 hover:underline">NDT ERP Software</a></li>
                </ul>
              </div>
              <div>
