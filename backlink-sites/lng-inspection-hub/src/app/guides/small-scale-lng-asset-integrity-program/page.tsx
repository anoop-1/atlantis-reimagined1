...
export const metadata: Metadata = {
  title: "Small-Scale LNG Asset Integrity: Building a Program Without Refinery Resources",
  description: "Small-Scale LNG Asset Integrity explained for LNG terminal engineers — covering small scale LNG, common pitfalls, and the data your audit packet needs.",
  keywords: ["small scale LNG","mini LNG integrity","micro LNG inspection","LNG bunkering"],
  alternates: { canonical: "https://lng-inspection-hub.vercel.app/guides/small-scale-lng-asset-integrity-program" },
  openGraph: {
    title: "Small-Scale LNG Asset Integrity: Building a Program Without Refinery Resources",
    description: "Small-Scale LNG Asset Integrity explained for LNG terminal engineers — covering small scale LNG, common pitfalls, and the data your audit packet needs.",
    type: 'article',
    url: "https://lng-inspection-hub.vercel.app/guides/small-scale-lng-asset-integrity-program",
    siteName: "LNG Inspection Hub",
    locale: 'en_US',
    publishedTime: "2025-11-21T00:00:00.000Z",
    modifiedTime: "2025-11-21T00:00:00.000Z",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Small-Scale LNG Asset Integrity: Building a Program Without Refinery Resources",
  "description": "Small-Scale LNG Asset Integrity explained for LNG terminal engineers — covering small scale LNG, common pitfalls, and the data your audit packet needs.",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://lng-inspection-hub.vercel.app/guides/small-scale-lng-asset-integrity-program"
  },
  "keywords": "small scale LNG, mini LNG integrity, micro LNG inspection, LNG bunkering"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>Small-Scale LNG Asset Integrity: Building a Program Without Refinery Resources</span>
      </nav>
      <h1>Small-Scale LNG Asset Integrity: Building a Program Without Refinery Resources</h1>
      <p className="text-sm text-gray-500 mb-8">By Magnus Tørrissen, IWE &middot; Published 2025-11-21</p>
      <div dangerouslySetInnerHTML={{ __html: `<p>This article walks through the practical decisions LNG terminal engineers, cryogenic tank inspectors, midstream LNG QA need to make when working on LNG inspection and cryogenic NDT. The goal is not theory — it is the kind of working knowledge an experienced inspector or engineer would share over a coffee on a job site, with enough rigor to point back to code and standard references when those decisions get challenged in audit. Throughout the piece we focus on the parts of small scale lng that turn into real schedule or budget pain when they go wrong.</p><h2>Why this comes up so often in the field</h2>
<p>Ask any LNG terminal engineers how often small scale lng drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<ul>
<li><strong>The decision points</strong> that drive most small scale lng programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any small scale lng engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<p>Auditors do not argue with conclusions; they argue with the evidence behind them. For any defensible small scale lng report, the evidence packet needs to include at minimum:</p>
<ul>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of small scale lng should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize small scale lng in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p>
<p>Practical teams often cross-reference <a href="https://atlantisndt.com/erp/field-service-management-for-ndt" rel="noopener">the field service management for ndt resource on Atlantis NDT</a> to align their practice with what is already published in the wider community.</p><h3>How small scale LNG fits into the bigger picture</h3>
<p>It is easy to study small scale LNG as an isolated subject — most courses do exactly that — but the engineering value only appears when you place small scale LNG alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.iaea.org/topics/non-destructive-testing" rel="noopener nofollow">the IAEA non-destructive testing programme</a> to align their practice with what is already published in the wider community. For most LNG terminal engineers the question is not "what is small scale LNG?" but "where does small scale LNG sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in small scale LNG, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on mini LNG integrity</h3>
<p>Three behaviours we see at high-performing operators consistently show up in mini LNG integrity programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a mini LNG integrity program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best micro LNG inspection documentation packages we have seen share three patterns:</p>
<ul>
...
<h3>How mini LNG integrity fits into the bigger picture</h3>
<p>It is easy to study mini LNG integrity as an isolated subject — most courses do exactly that — but the engineering value only appears when you place mini LNG integrity alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.iaea.org/topics/non-destructive-testing" rel="noopener nofollow">the IAEA non-destructive testing programme</a> to align their practice with what is already published in the wider community. For most LNG terminal engineers the question is not "what is mini LNG integrity?" but "where does mini LNG integrity sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in mini LNG integrity, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on micro LNG inspection</h3>
<p>Three behaviours we see at high-performing operators consistently show up in micro LNG inspection programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a micro LNG inspection program.</p>
