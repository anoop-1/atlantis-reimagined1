...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/terminals`, lastModified: '2026-05-24', changeFrequency: 'weekly' as const, priority: 0.7 },
    ...
    { url: `${baseUrl}/guides/lng-storage-tank-roof-inspection-from-inside-and-outside`, lastModified: '2025-05-19', changeFrequency: 'monthly' as const, priority: 0.7 },
    { url: `${baseUrl}/guides/lng-vaporizer-and-srv-inspection-program`, lastModified: '2025-09-15', changeFrequency: 'monthly' as const, priority: 0.7 },
    { url: `${baseUrl}/guides/lng-trailer-and-isotainer-inspection-checklist`, lastModified: '2025-12-13', changeFrequency: 'monthly' as const, priority: 0.7 },
    { url: `${baseUrl}/guides/gravity-base-structure-gbs-lng-inspection-considerations`, lastModified: '2026-03-13', changeFrequency: 'monthly' as const, priority: 0.7 },
    { url: `${baseUrl}/guides/lng-spill-protection-systems-inspection-and-test`, lastModified: '2026-05-11', changeFrequency: 'monthly' as const, priority: 0.7 }
  ];
}
