...
const corePages = [
  ...
  {
    path: "/compare",
    title: "Atlantis NDT ERP — All Comparisons | vs Maximo, SAP PM, Meridium, NetSuite, more",
    description: "Honest comparisons of Atlantis NDT ERP vs IBM Maximo, SAP S/4HANA Asset Management (SAP PM), Hexagon Meridium APM, AspenTech Mtell, GE Vernova APM, Bentley AssetWise, Oracle NetSuite, QuickBooks Online, Procore, ETQ Reliance — when each platform wins.",
    bodyH1: "Atlantis NDT ERP — Honest Competitor Comparisons",
    bodyText: "10 detailed comparison pages covering tier-1 enterprise platforms (IBM Maximo, SAP PM, Hexagon Meridium, AspenTech Mtell, GE Vernova APM, Bentley AssetWise) plus SMB / adjacent platforms (Oracle NetSuite, QuickBooks Online, Procore, ETQ Reliance). Each comparison includes when the competitor wins, when Atlantis wins, TCO breakdown, feature-by-feature table, migration guidance, and 3 buyer-scenario verdicts.",
  },
  {
  ...
  {
    path: "/compare/vs-aspentech-mtell",
    title: "Atlantis NDT ERP vs AspenTech Mtell 2026 — APM + ML vs NDT-Native ERP",
    description: "AspenTech Mtell predictive maintenance with ML anomaly detection vs Atlantis NDT ERP. When ML-driven APM wins (rotating equipment), when NDT-native ERP wins (inspection workflow, ASNT, audits).",
    bodyH1: "Atlantis NDT ERP vs AspenTech Mtell 2026 — APM + ML vs NDT-Native ERP",
    bodyText: "AspenTech Mtell is a leader in AI-driven anomaly detection for rotating equipment (pumps, compressors, turbines) using machine learning on plant historian (PI / IP.21) data streams. Atlantis NDT ERP doesn't compete with Mtell head-to-head — they solve different problems. Mtell predicts failures of dynamic equipment from vibration / lube / process data; Atlantis manages inspection workflow for static equipment (pressure vessels, piping, tanks) using NDT data. The honest read: a mature integrity p",
  },
  {
    path: "/compare/vs-ge-vernova-apm",
    title: "Atlantis NDT ERP vs GE Vernova APM 2026 — Predix-Derived APM Comparison",
    description: "GE Vernova APM (Predix APM successor) vs Atlantis NDT ERP. Power generation focus vs inspection-services focus. When GE Vernova APM wins for utilities, when Atlantis wins for service companies.",
    bodyH1: "Atlantis NDT ERP vs GE Vernova APM 2026 — Predix-Derived APM Comparison",
    bodyText: "GE Vernova APM (formerly Predix APM, before that Meridium APM under GE Digital) carries a long lineage in power generation and oil & gas asset performance management. It's the right choice for power utilities, generation operators, and large industrials where GE turbine / generator integration and historical APM-class workflows are valuable. Atlantis NDT ERP doesn't try to replace GE Vernova in those domains. Atlantis wins for inspection service companies and mid-size operators where GE Vernova'",
  },
  {
    path: "/compare/vs-bentley-assetwise",
    title: "Atlantis NDT ERP vs Bentley AssetWise 2026 — Honest Comparison",
    description: "Bentley AssetWise (formerly Ivara EXP) vs Atlantis NDT ERP. Infrastructure-asset APM vs inspection-services ERP. When Bentley wins (rail, roads, water), when Atlantis wins (inspection workflow).",
    bodyH1: "Atlantis NDT ERP vs Bentley AssetWise 2026 — Honest Comparison",
    bodyText: "Bentley AssetWise (which absorbed Ivara EXP) is strongest for linear and civil infrastructure asset performance management — rail, roads, bridges, water utilities, transmission grids. Its CAD / BIM ecosystem (MicroStation, OpenRoads, OpenBridge) makes Bentley the natural choice for asset owners where civil engineering data is the primary lens. Atlantis NDT ERP doesn't compete in those infrastructure domains. Atlantis wins for industrial inspection service companies, calibration laboratories, wel",
  },
  {
    path: "/compare/vs-netsuite",
    title: "Atlantis NDT ERP vs Oracle NetSuite 2026 — SMB ERP vs NDT-Native ERP",
    description: "Oracle NetSuite vs Atlantis NDT ERP. General-purpose SMB ERP (finance, inventory, CRM) vs NDT-native inspection ERP. When NetSuite + Atlantis combo wins, when single-platform Atlantis wins.",
    bodyH1: "Atlantis NDT ERP vs Oracle NetSuite 2026 — SMB ERP vs NDT-Native ERP",
    bodyText: "Oracle NetSuite is a leading SMB / mid-market ERP — financial accounting, inventory, CRM, e-commerce, professional services automation. It's the right choice when accounting and financial reporting is the primary business driver and inspection workflow is small. Atlantis NDT ERP and NetSuite typically aren't either-or — most inspection companies running NetSuite for financials use Atlantis for the inspection-specific workflow. This page covers when single-platform Atlantis is sufficient and when",
  },
  {
    path: "/compare/vs-quickbooks",
    title: "Atlantis NDT ERP vs QuickBooks Online 2026 — When QuickBooks Alone Isn't Enough",
    description: "QuickBooks Online vs Atlantis NDT ERP for inspection companies. When QuickBooks + spreadsheets is enough, when inspection workflow needs purpose-built tooling.",
    bodyH1: "Atlantis NDT ERP vs QuickBooks Online 2026 — When QuickBooks Alone Isn't Enough",
    bodyText: "QuickBooks Online (QBO) is the right choice for very small inspection contractors (1-5 people) where accounting is the primary software need and inspection workflow can be managed with spreadsheets and email. Atlantis NDT ERP doesn't replace QuickBooks — most Atlantis customers run QuickBooks + Atlantis side-by-side. This page covers when QuickBooks + spreadsheets is genuinely sufficient and when inspection workflow has outgrown that approach.",
  },
  {
    path: "/compare/vs-procore",
    title: "Atlantis NDT ERP vs Procore 2026 — Construction QA vs NDT-Native ERP",
    description: "Procore construction management vs Atlantis NDT ERP. Construction project management vs inspection-services ERP. When Procore wins (general contracting), when Atlantis wins (specialty inspection).",
    bodyH1: "Atlantis NDT ERP vs Procore 2026 — Construction QA vs NDT-Native ERP",
    bodyText: "Procore is the dominant construction management platform — project management, daily logs, RFIs, submittals, drawings, punch lists for general contractors, owners, and specialty contractors on construction projects. Atlantis NDT ERP overlaps with Procore only at the QA / QC layer for construction projects. The honest read: Procore wins for general construction project management; Atlantis wins for specialty industrial inspection workflow that extends beyond the construction phase into operating-",
  },
  {
    path: "/compare/vs-etq-reliance",
    title: "Atlantis NDT ERP vs ETQ Reliance 2026 — QMS Platform vs NDT-Native ERP",
    description: "ETQ Reliance QMS vs Atlantis NDT ERP. Dedicated QMS / EHS / compliance platform vs NDT-native ERP. When ETQ wins (regulated manufacturing), when Atlantis wins (inspection services).",
    bodyH1: "Atlantis NDT ERP vs ETQ Reliance 2026 — QMS Platform vs NDT-Native ERP",
    bodyText: "ETQ Reliance is a dedicated QMS / EHS / compliance platform serving regulated manufacturing — life sciences, food & beverage, chemicals, aerospace. Its strength is comprehensive nonconformance, CAPA, supplier quality, audit management, document control, and risk management as a configurable workflow platform. Atlantis NDT ERP includes a QMS module but is fundamentally an inspection-workflow ERP — not a dedicated QMS platform. The honest read: ETQ wins for regulated manufacturers where QMS is a p",
  },
  {
