# Atlantis NDT ERP — YouTube Shorts Scripts

**Created:** 2026-05-23
**Goal:** Amplify 4,000 ERP+DT clicks/30 days from pillar pages at `/erp/{app}-for-ndt-companies`
**Audience:** Inspection-company owners, ops directors, QA managers
**Cadence:** 5 Shorts/week x 5 weeks = 25 pillar Shorts + 5 evergreen
**Optimal post slot:** Tue / Wed / Thu, 9:00 AM CST (peak inspection-industry desktop time)

---

## POSTING SCHEDULE OVERVIEW

| Week | Mon | Tue 9am CST | Wed 9am CST | Thu 9am CST | Fri 9am CST | Sat |
|------|-----|-------------|-------------|-------------|-------------|-----|
| 1 | Evergreen #1 | Script 01 CRM | Script 02 Email | Script 03 Mktg Auto | Script 04 Sales | — |
| 2 | Evergreen #2 | Script 05 Inv | Script 06 Acct | Script 07 Invoice | Script 08 PM | — |
| 3 | Evergreen #3 | Script 09 Mfg | Script 10 CMMS | Script 11 Maint | Script 12 QMS | — |
| 4 | Evergreen #4 | Script 13 Docs | Script 14 Procure | Script 15 HR | Script 16 Time | — |
| 5 | Evergreen #5 | Script 17 Exp | Script 18 Helpdesk | Script 19 eCom | Script 20 POS | — |
| 6 | — | Script 21 Field | Script 22 Subs | Script 23 Studio | Script 24 Approve | Script 25 Events |

---

# EVERGREEN SHORTS (5)
General ERP / Digital Twin awareness. Re-run quarterly.
...
- VO "Built by NDT Level III." | Text: We use it ourselves
...
**Body (3-50s):**
- VO "Excel hides what's expiring." | Text: 3 expired techs on jobsite
- VO "Audit comes — you're cooked." | Text: $50K NCR
- VO "Open Atlantis HR module." | Text: Click "Certifications"
- VO "Filter expiring in ninety days." | Text: 7 techs flagged
- VO "Auto-email to each tech." | Text: Renewal reminder sent
- VO "Manager dashboard updates live." | Text: Compliance: 96%
- VO "Block job assignment if expired." | Text: System won't let you
- VO "ASNT ISO PCN CSWIP all native." | Text: Preloaded templates
...
- VO "Saved $162,000 year one." | Text: Bought 2 new UT scanners
...
**Body (3-50s):**
- VO "Number five — SAP B1." | Text: $180K — too bloated
...
**Body (3-50s):**
- VO "7 AM Excel guy." | Text: 14 tabs already open
- VO "7 AM Atlantis user." | Text: One dashboard, coffee in hand
- VO "9 AM Excel guy." | Text: Cert expired, tech on-site
- VO "9 AM Atlantis user." | Text: Auto-flagged, swap done
- VO "Noon Excel guy." | Text: Invoice math is wrong
- VO "Noon Atlantis user." | Text: Invoice auto-billed from PO
- VO "3 PM Excel guy." | Text: Client wants status
- VO "3 PM Atlantis user." | Text: Client portal — they self-serve
...
# PILLAR PAGE SHORTS (25)

---

## Script 01 — CRM for NDT Companies
**Pillar:** `/erp/crm-for-ndt-companies`
**Recommended post:** Week 1, Tue 9:00 AM CST

**Title:** Your CRM doesn't know what TOFD is. Mine does.
**Description:** Generic CRMs lose NDT deals. Atlantis NDT CRM tags leads by method (UT, RT, PA, TOFD), industry, and certification needed — auto-routes to certified techs. Free trial: atlantisndt.com/erp
**Tags:** #NDTCRM #SalesForNDT #InspectionLeads #UT #PhasedArray #TOFD #OdooCRM #NDTbusiness #OilAndGas #FabricationShop #B2BSales #PipelineSoftware #NDTConnect #ASNT #API510

**Hook (0-3s):** "Salesforce thinks PA means Pennsylvania."
**Body (3-50s):**
- VO "Generic CRMs don't speak NDT." | Text: "What's TOFD?" — your CRM
- VO "Atlantis tags by inspection method." | Text: UT, RT, MT, PT, PA, TOFD
- VO "Auto-routes to certified tech." | Text: ASNT Level II UT? Matched
- VO "Tracks client API standard." | Text: API 510, 570, 653, 1163
- VO "Quote built from method library." | Text: Pre-priced UT scans
- VO "PO converts to project instantly." | Text: One click — job live
...
## Script 02 — Email Marketing for NDT
**Pillar:** `/erp/email-marketing-software-for-ndt`
...
**Body (3-50s):**
- VO "Mailchimp pricing scales with you." | Text: 6,700 leads = $400/mo
- VO "Atlantis ERP email — included." | Text: $0 per send, ever
- VO "Segment by NDT method." | Text: UT-only campaign? Easy
- VO "Filter by API standard." | Text: API 653 tank shops only
- VO "Templates for inspection offers." | Text: Pre-written, pre-tested
- VO "A/B test subject lines." | Text: Built-in stats
...
## Script 03 — Marketing Automation for NDT
**Pillar:** `/erp/marketing-automation-for-ndt-companies`
...
**Body (3-50s):**
- VO "Founder on a tank inspection." | Text: 80ft, full PPE
- VO "Pipeline doesn't sleep." | Text: 47 leads in queue
- VO "New lead — UT scan inquiry." | Text: Auto-tag: O&G, method: UT
- VO "Workflow fires email one." | Text: "Here's our UT capabilities"
- VO "No open? Day 3 email two." | Text: Case study auto-sent
- VO "Clicked link? Score jumps." | Text: Lead score 80/100
...
## Script 04 — Sales Management for Inspection
**Pillar:** `/erp/sales-management-for-inspection-companies`
...
**Body (3-50s):**
- VO "One rep. One screen." | Text: No CRM tab juggle
- VO "Pipeline by inspection method." | Text: UT, RT, PA, TOFD lanes
- VO "Quote builder — pre-priced." | Text: $/foot UT, $/shot RT
- VO "Add scope — math auto-runs." | Text: 1,200ft pipe, 3 techs
- VO "Send PDF in fifteen seconds." | Text: Branded, signed-ready
- VO "Client e-signs in portal." | Text: PO uploads itself
...
## Script 05 — Inventory Management for NDT
**Pillar:** `/erp/inventory-management-for-ndt-companies`
...
**Body (3-50s):**
- VO "Probes go missing constantly." | Text: $4,200 each
- VO "Excel says — last seen March." | Text: Three months ago
- VO "Atlantis tracks by serial number." | Text: Every probe, every cal block
- VO "Assigned to truck 02, Tech Mike." | Text: GPS pinned, last scan today
- VO "Calibration due — auto-alert." | Text: 14 days to next cal
- VO "Overdue? Equipment locked." | Text: Can't dispatch un-cal'd gear
...
## Script 06 — Accounting Software for NDT
...
## Script 07 — Invoicing Software for NDT
**Pillar:** `/erp/invoicing-software-for-ndt-companies`
...
**Body (3-50s):**
- VO "End of month — invoice day." | Text: Last Friday of May
- VO "Old way — Excel + Word." | Text: 6 hours, 3 errors
- VO "Atlantis ERP — one button." | Text: "Generate all invoices"
- VO "Pulls from project milestones." | Text: 30% mob, 60% complete
- VO "T&M from approved timesheets." | Text: Auto-rolled by tech rate
- VO "Adds equipment day-rates." | Text: PA scanner $400/day
...
## Script 08 — Project Management for NDT
**Pillar:** `/erp/project-management-for-ndt-companies`
...
**Body (3-50s):**
- VO "Turnaround starts Monday 6 AM." | Text: 200 welds — 9-day window
- VO "Atlantis project — Gantt loaded." | Text: UT, RT, PA, MT lanes
- VO "Assign by ASNT level + method." | Text: Auto-matches certs
- VO "Tech rejects — system reroutes." | Text: Backup pre-assigned
- VO "Daily field report — mobile." | Text: Tech submits offline
- VO "Defects logged with photo." | Text: Linked to weld ID
...
## Script 09 — Manufacturing ERP for Fabrication Shops
**Pillar:** `/erp/manufacturing-erp-for-fabrication-shops`
...
**Body (3-50s):**
- VO "Fab shop builds pressure vessels." | Text: ASME Section VIII
- VO "Eight hundred welds in queue." | Text: Each needs MT, UT, RT
- VO "Atlantis MO links to weld map." | Text: Auto-generated weld IDs
- VO "Welder logs heat number." | Text: MTR auto-attached
- VO "NDT request fires on completion." | Text: UT tech notified
- VO "Inspector signs off in mobile." | Text: Pass/fail + photo
...
## Script 10 — CMMS for Inspection Companies
**Pillar:** `/erp/cmms-for-inspection-companies`
...
**Body (3-50s):**
- VO "Generic CMMS — built for facilities." | Text: HVAC + plumbing tickets
- VO "We don't need that." | Text: We inspect $1M assets
- VO "Atlantis CMMS — NDT-native." | Text: Cal schedules, PM by cycles
- VO "Equipment fleet by type." | Text: UT, RT, PA, MT scanners
- VO "PM triggers on usage hours." | Text: 500 hrs → service due
- VO "Cal expiry — 30/60/90 alerts." | Text: Auto-block job assignment
...
## Script 11 — Maintenance Management for NDT
**Pillar:** `/erp/maintenance-management-for-ndt`
...
**Body (3-50s):**
- VO "Phased-array failed at hour 480." | Text: Mid-tank inspection
- VO "Job stopped — 4 days lost." | Text: $80K rebook + travel
- VO "Atlantis tracks MTBF per asset." | Text: PA mean = 450 hrs
- VO "PM triggers at 380 hours." | Text: 70-hr safety buffer
- VO "Vibration sensors push data." | Text: Anomaly auto-flagged
- VO "Spare allocation auto-reserved." | Text: Truck 02 gets backup
...
## Script 12 — Quality Management for NDT
**Pillar:** `/erp/quality-management-for-ndt-companies`
...
**Body (3-50s):**
- VO "Auditor walks in Monday 9 AM." | Text: ISO 9001:2015 surveillance
- VO "Asks — show me NCR log." | Text: One click — 17 NCRs, 17 closed
- VO "Asks — CAPA effectiveness?" | Text: Repeat-rate graph live
- VO "Asks — training records?" | Text: ASNT cert audit pulled
- VO "Asks — calibration trail?" | Text: Every scanner — sign-off chain
- VO "Asks — document control?" | Text: Procedure rev history
...
## Script 13 — Document Control for NDT
**Pillar:** `/erp/document-control-for-ndt-companies`
...
**Body (3-50s):**
- VO "Tech printed procedure last year." | Text: Rev 3 — old
- VO "Latest is Rev 7." | Text: 4 revisions behind
- VO "Inspector flags wrong acceptance." | Text: Lawsuit territory
- VO "Atlantis enforces latest rev only." | Text: Old revs locked
- VO "Tech opens mobile — Rev 7 live." | Text: Stamped + signed
- VO "Approval chain — pre-set." | Text: QA → Level III → CEO
...
## Script 14 — Procurement for NDT
**Pillar:** `/erp/procurement-for-ndt-companies`
...
**Body (3-50s):**
- VO "Truck 02 — couplant empty." | Text: Mid-tank scan, no gel
- VO "Tech drives 2 hours back." | Text: $600 day lost
- VO "Atlantis min-stock — auto-trigger." | Text: Below 6 bottles? PO fires
- VO "Three vendors auto-RFQ." | Text: Magnaflux, Olympus, Sonotech
- VO "Best price + lead time wins." | Text: Vendor score auto-ranks
- VO "PO sent — confirmed by email." | Text: Vendor portal auto-update
...
## Script 15 — HR/Payroll for NDT
**Pillar:** `/erp/hr-payroll-for-ndt-companies`
...
**Body (3-50s):**
- VO "Friday — payroll day." | Text: 42 techs, 3 states, 1 KSA
- VO "Old way — 6 hours of math." | Text: Per-diem, OT, mob/demob
- VO "Atlantis pulls from timesheets." | Text: Approved by PM = ready
- VO "Per-diem auto by jobsite zone." | Text: Texas $65, KSA $120
- VO "OT auto past 40 hrs/week." | Text: Time-and-a-half rule
- VO "ASNT cert pay-bump auto." | Text: Level II = +$3/hr live
...
## Script 16 — Timesheet Software for NDT
**Pillar:** `/erp/timesheet-software-for-ndt-companies`
...
**Body (3-50s):**
- VO "Tank inspection — no cell signal." | Text: 80ft up, full PPE
- VO "Tech opens mobile timesheet." | Text: Offline mode kicks in
- VO "Clock-in — GPS pinned." | Text: 29.7°N, 95.3°W
- VO "Tags job + method + asset." | Text: Job 142, UT, Tank 7
- VO "Photos attach — defect log." | Text: Weld 23, indication 2mm
- VO "Comes down — syncs auto." | Text: Wifi hits, data pushes
...
## Script 17 — Expense Tracking for NDT
**Pillar:** `/erp/expense-tracking-for-ndt-companies`
...
**Body (3-50s):**
- VO "Tech back from 14-day shutdown." | Text: 47 receipts in pocket
- VO "Hotel, gas, food, PPE." | Text: $2,400 to reimburse
- VO "Atlantis mobile — snap each one." | Text: OCR pulls amount + vendor
- VO "Auto-categorize by type." | Text: Travel, fuel, meals, PPE
- VO "Tag to inspection job." | Text: Job 142 — refinery shutdown
- VO "Per-diem rules auto-apply." | Text: Houston $65/day cap
...
## Script 18 — Helpdesk for NDT
**Pillar:** `/erp/helpdesk-for-ndt-companies`
...
**Body (3-50s):**
- VO "Friday 11 PM — phone rings." | Text: Refinery PM, again
- VO "Wants UT report — yesterday's job." | Text: I'm in bed
- VO "Old way — wake up, find report." | Text: 45 min, no sleep
- VO "Atlantis client portal — live." | Text: Logs in, downloads PDF
- VO "Auto-tagged by method + job." | Text: UT, Tank 7, May 22
- VO "If portal fails — ticket auto-opens." | Text: SLA timer starts
...
## Script 19 — eCommerce for NDT
**Pillar:** `/erp/ecommerce-for-ndt-companies`
...
**Body (3-50s):**
- VO "We had spare couplant stock." | Text: Bulk-buy savings
- VO "Spun up online store in a day." | Text: Atlantis eCommerce — built-in
- VO "Stock syncs with main inventory." | Text: Truck stock untouched
- VO "B2B pricing tiers — auto." | Text: Net-30, volume discount
- VO "Tax + shipping by zone." | Text: TX + KSA + India routes
- VO "PayPal, Stripe, ACH live." | Text: Net-30 invoice option
...
## Script 20 — POS for NDT
**Pillar:** `/erp/pos-for-ndt-companies`
...
**Body (3-50s):**
- VO "ASNT 2026 — booth in Houston." | Text: 3 days, 8000 visitors
- VO "We sell training + accessories." | Text: Level II courses, gel kits
- VO "Atlantis POS on iPad." | Text: Live in 60 seconds
- VO "Tap product — UT Level II class." | Text: $850 — auto-loaded
- VO "Card swipe — Stripe terminal." | Text: Receipt emailed
- VO "Inventory deducts on sale." | Text: Gel kits, hard hats
...
## Script 21 — Field Service Management for NDT
**Pillar:** `/erp/field-service-management-for-ndt`
...
**Body (3-50s):**
- VO "Monday 6:55 AM — still in bed." | Text: 18 techs need jobs
- VO "Atlantis dispatch board — open." | Text: Mobile, full map view
- VO "Auto-suggests by ASNT cert." | Text: UT Level II for Job 142
- VO "Closest truck wins." | Text: Mike, 14 min away
- VO "Route optimized for 4 jobs." | Text: 38 mi saved per day
- VO "Mobile job sheet to tech." | Text: Address, scope, photos
...
## Script 22 — Subscription Management for NDT
**Pillar:** `/erp/subscription-management-for-ndt`
...
**Body (3-50s):**
- VO "Inspection used to be project-based." | Text: Feast and famine
- VO "We sold quarterly CUI contracts." | Text: $8K every 3 months
- VO "Atlantis subscription module." | Text: Auto-invoice schedule
- VO "Service auto-creates in calendar." | Text: Q2 → tech assigned
- VO "Reports auto-deliver to client." | Text: PDF + portal access
- VO "Renewal 60 days out — auto-email." | Text: Up-sell quote attached
...
## Script 23 — No-Code / Odoo Studio for NDT
**Pillar:** `/erp/no-code-customization-odoo-studio-for-ndt`
...
**Body (3-50s):**
- VO "Client wanted weld-procedure ID." | Text: Custom field on every job
- VO "SAP would quote $40K." | Text: Consulting + dev cycles
- VO "Atlantis runs Odoo Studio." | Text: Drag-drop, no code
- VO "Open job form — edit mode." | Text: Toolkit appears
- VO "Drag 'text field' to form." | Text: Label: WPS Number
- VO "Set required — link to project." | Text: 3 clicks done
...
## Script 24 — Approvals Workflows for NDT
**Pillar:** `/erp/approvals-workflows-for-ndt-companies`
...
**Body (3-50s):**
- VO "Inspector finishes UT scan." | Text: Indication at weld 14
- VO "Submits report — needs sign-off." | Text: Level III required
- VO "Workflow fires — auto-routed." | Text: To Level III on file
- VO "He's on a plane to Saudi." | Text: 35,000 ft, wifi on
- VO "Mobile push — opens report." | Text: Photos, data, indication
- VO "Reviews, e-signs, comments." | Text: 'Accept — within code'
...
## Script 25 — Events Management for NDT Conferences
**Pillar:** `/erp/events-management-for-ndt-conferences`
...
**Body (3-50s):**
- VO "Hosted UT Level II refresher." | Text: 120 registered
- VO "Atlantis Events — landing page live." | Text: SEO-ready, 1-hour build
- VO "Online registration + pay." | Text: $450 ticket, Stripe live
- VO "Confirmation email auto-fires." | Text: Calendar invite + map
- VO "Day-of — QR scan check-in." | Text: Badges auto-print
- VO "ASNT CEU credit tracked." | Text: 8 hrs logged per attendee
...
## B-Roll Asset Library to Build (one-time investment)
Film once, reuse across all 30 Shorts:
- Technician with UT probe on pipe (60s, multiple angles)
- Technician climbing tank with PPE (30s)
- Phased-array scanner in use (30s)
- Atlantis dashboard screen-recordings — every module (10 min total)
- Calibration sticker close-ups (15s)
- Fab shop welder striking arc (30s)
- Refinery aerial drone (30s — license stock if needed)
- Founder talking-head clips (5 min — A-roll)
- Mobile-app screen recordings (5 min — every flow)
- Stock pricing/quote PDFs (designed in Figma, 10 variants)

## Filming Workflow
- **Day 1 (single shoot day):** Founder A-roll for all 30 Shorts, talking-head segments
- **Day 2:** Field b-roll — tech, tank, fab shop, equipment
- **Day 3:** Screen recordings — every Atlantis module, every flow
- **Edit week:** Batch-edit 5 Shorts/day (templates locked), CapCut or Premiere
- **Voiceover:** ElevenLabs cloned voice from founder samples — $22/mo
- **Subtitles:** Auto via CapCut + manual review (3 min per Short)

## Hashtag Strategy
- 3 broad (#NDT #InspectionSoftware #OdooERP)
- 5 method-specific (#UT #PhasedArray #API510 #ASNT #ISO9712)
- 4 industry-specific (#OilAndGas #FabricationShop #Refinery #NDTConnect)
- 2-3 trend-rotating per script (current week's trending NDT/industrial tags)

## YouTube Shorts Algorithm Tips Applied
- Hook within 0-3s (every script does this)
- 8-12 visual cuts per Short = high retention (every script)
- Text-on-screen for sound-off viewers (every beat has text)
- CTA in description AND end-card (both)
- Pin top comment with link to specific pillar page (per Short)
- Cross-post to LinkedIn within 24 hours (B2B amplification)

## Posting Cadence (Final)
| Slot | Day | Time CST | Content |
|------|-----|----------|---------|
| Mon | Evergreen | 9:00 AM | Awareness rant/listicle |
| Tue | Pillar | 9:00 AM | Module-specific Short |
| Wed | Pillar | 9:00 AM | Module-specific Short |
| Thu | Pillar | 9:00 AM | Module-specific Short |
| Fri | Pillar | 9:00 AM | Module-specific Short |
| Sat-Sun | — | — | Rest / engage comments |

## Pillar-Page Link Strategy
Each Short's pinned comment + description should include the exact pillar URL:
- Script 01 → `atlantisndt.com/erp/crm-for-ndt-companies`
- Script 02 → `atlantisndt.com/erp/email-marketing-software-for-ndt`
- ... (same pattern for all 25)

## Conversion Tracking
- UTM-tag every pillar-page link: `?utm_source=youtube&utm_medium=shorts&utm_campaign=2026-05-erp-launch&utm_content=script-01-crm`
- GA4 event: "shorts_pillar_click"
- Target: 4,000 ERP+DT clicks/30 days, ~160 clicks/Short avg
- Conversion goal: 2% to free-trial signup = 80 trials → ~8 paying ($144K ARR)

---

**END OF FILE — 30 production-ready Shorts (5 evergreen + 25 pillar)**
